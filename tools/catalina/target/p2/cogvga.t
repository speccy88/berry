...
Original version by Total Spectrum Software Inc.

Modified for Catalina (removal of Spin methods) by Ross Higson.
Also, added the use of P2_REV_A - define this (see below) for Rev A silicon.
...
' hwcheck not used by Catalina - commented out by Ross Higson
...
'******************************************************************
'* Spin interfaces (not used by Catalina - commented out by Ross Higson)
'******************************************************************
VAR
  long mycog
  long hw_rev
