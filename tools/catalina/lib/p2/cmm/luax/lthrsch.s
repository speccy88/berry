...
C_cond_no_active_lp ' <symbol:cond_no_active_lp>
 ...
 alignl_label
C_shl0_69c22cf6_workerls_L000005 ' <symbol:workerls>
 long $0
...
C_workermain ' <symbol:workermain>
 ...
 alignl_p1
 long I32_LODI + (@C_shl0_69c22cf6_workerls_L000005)<<S32
...
C_workermain_17
 ...
 alignl_p1
 long I32_CALA + (@C_shl01_69c22cf6_sched_dec_lpcount_L000006)<<S32 ' CALL addrg
 alignl_p1
...
' C_workermain_7 ' (symbol refcount = 0)
 ...
 alignl_label
C_shl01_69c22cf6_sched_dec_lpcount_L000006 ' <symbol:sched_dec_lpcount>
 alignl_p1
 long I32_NEWF + 0<<S32
 alignl_p1
 ...
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl_p1
 long I32_BRNZ + (@C_shl01_69c22cf6_sched_dec_lpcount_L000006_30)<<S32 ' NEI4 reg coni
 word I16B_LODL + (r2)<<D16B
 alignl_p1
 ...
 long I32_CALA + (@C_pthread_cond_signal)<<S32 ' CALL addrg
 alignl_label
C_shl01_69c22cf6_sched_dec_lpcount_L000006_30
 word I16B_LODL + (r2)<<D16B
 alignl_p1
 long @C_mutex_lp_count ' reg ARG ADDRG
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
 alignl_p1
 long I32_CALA + (@C_pthread_mutex_unlock)<<S32 ' CALL addrg
' C_shl01_69c22cf6_sched_dec_lpcount_L000006_29 ' (symbol refcount = 0)
...
C_sched_init ' <symbol:sched_init>
 ...
 alignl_p1
 long I32_LODA + (@C_shl0_69c22cf6_workerls_L000005)<<S32
