...
DAT ' initialized data segment
 ...
 alignl_label
C_stf41_69c22cf6_pstart_L000003 ' <symbol:pstart>
 long $0

 alignl_label
C_stf42_69c22cf6_storageI_nitialized_L000004 ' <symbol:storageInitialized>
 byte $0
...
C_mountF_atV_olume ' <symbol:mountFatVolume>
 ...
 alignl_p1
 long @C_stf43_69c22cf6_fatscratch_L000005 ' reg ARG ADDRG
...
C_mountF_atV_olume_7
 alignl_p1
 long I32_LODA + (@C_stf43_69c22cf6_fatscratch_L000005+450)<<S32
...
C_mountF_atV_olume_19
 ...
 alignl_p1
 long I32_LODA + (@C_stf43_69c22cf6_fatscratch_L000005)<<S32
 ...
 alignl_p1
 long I32_LODA + (@C_stf41_69c22cf6_pstart_L000003)<<S32
...
C_mountF_atV_olume_10
 alignl_p1
 long I32_LODI + (@C_stf41_69c22cf6_pstart_L000003)<<S32
...
C_mountF_atV_olume_20
 ...
 alignl_p1
 long @C_stf4_69c22cf6_vi_L000002 ' reg ARG ADDRG
 alignl_p1
 long I32_LODI + (@C_stf41_69c22cf6_pstart_L000003)<<S32
...
C_mountF_atV_olume_22
 ...
 alignl_p1
 long I32_LODA + (@C_stf42_69c22cf6_storageI_nitialized_L000004)<<S32
 word I16A_WRBYTE + (r22)<<D16A + RI<<S16A ' ASGNU1 addrg reg
 alignl_p1
 long I32_LODA + (@C_stf4_69c22cf6_vi_L000002+1)<<S32
 word I16A_RDBYTE + (r22)<<D16A + RI<<S16A ' reg <- INDIRU1 addrg
 word I16B_TRN1 + (r22)<<D16B ' zero extend
...
' C_buildfn_33 ' (symbol refcount = 0)
 ...
 alignl_label
C_stf45_69c22cf6_upper_L000050 ' <symbol:upper>
 alignl_p1
 long I32_NEWF + 0<<S32
 alignl_p1
 ...
 word I16A_MOV + (r21)<<D16A + (r2)<<S16A ' reg var <- reg arg
 alignl_p1
 long I32_JMPA + (@C_stf45_69c22cf6_upper_L000050_53)<<S32 ' JUMPV addrg
 alignl_label
C_stf45_69c22cf6_upper_L000050_52
 word I16A_MOV + (r22)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r23)<<D16A + (r22)<<S16A
 word I16A_ADDSI + (r23)<<D16A + (1)<<S16A ' ADDP4 reg coni
 ...
 word I16A_WRBYTE + (r20)<<D16A + (r22)<<S16A ' ASGNU1 reg reg
 alignl_label
C_stf45_69c22cf6_upper_L000050_53
 word I16A_RDBYTE + (r22)<<D16A + (r21)<<S16A ' reg <- INDIRU1 reg
 word I16B_TRN1 + (r22)<<D16B ' zero extend
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl_p1
 long I32_BRNZ + (@C_stf45_69c22cf6_upper_L000050_52)<<S32 ' NEI4 reg coni
 word I16A_MOVI + (r22)<<D16A + (0)<<S16A ' reg <- coni
 word I16A_WRBYTE + (r22)<<D16A + (r23)<<S16A ' ASGNU1 reg reg
' C_stf45_69c22cf6_upper_L000050_51 ' (symbol refcount = 0)
 word I16B_POPM + 0<<S16B ' restore registers, do pop frame, do return
 alignl_p1
...
C_doD_ir ' <symbol:doDir>
 ...
 alignl_p1
 long I32_CALA + (@C_stf45_69c22cf6_upper_L000050)<<S32
...
C_doD_ir_56
 ...
 alignl_p1
 long @C_stf43_69c22cf6_fatscratch_L000005 ' reg <- addrg
...
C_doD_ir_55
 ...
 alignl_label
C_stf46_69c22cf6_listF_ile_L000076 ' <symbol:listFile>
 alignl_p1
 long I32_NEWF + 0<<S32
 alignl_p1
 ...
 word I16B_LODL + (r3)<<D16B
 alignl_p1
 long @C_stf46_69c22cf6_listF_ile_L000076_78_L000079 ' reg ARG ADDRG
 word I16B_CPREP + 33<<S16B ' arg size, rpsize = 8, spsize = 8
 alignl_p1
 long I32_CALA + (@C_printf)<<S32
 word I16A_ADDI + SP<<D16A + 4<<S16A ' CALL addrg
' C_stf46_69c22cf6_listF_ile_L000076_77 ' (symbol refcount = 0)
 word I16B_POPM + 0<<S16B ' restore registers, do pop frame, do return
 alignl_p1
...
C_listD_ir ' <symbol:listDir>
 ...
 word I16B_LODL + (r2)<<D16B
 alignl_p1
 long @C_stf46_69c22cf6_listF_ile_L000076 ' reg ARG ADDRG
...
C_listD_irS_tart_86
 ...
 long @C_stf43_69c22cf6_fatscratch_L000005 ' reg <- addrg
 alignl_p1
 long I32_LODA + (@C_stf48_69c22cf6_sdi_L000081+8)<<S32
 word I16A_WRLONG + (r22)<<D16A + RI<<S16A ' ASGNP4 addrg reg
 word I16B_LODL + (r2)<<D16B
 alignl_p1
 long @C_stf48_69c22cf6_sdi_L000081 ' reg ARG ADDRG
 word I16A_MOV + (r3)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
 word I16B_LODL + (r4)<<D16B
 alignl_p1
 long @C_stf4_69c22cf6_vi_L000002 ' reg ARG ADDRG
...
C_listD_irN_ext_92
 alignl_p1
 long I32_LODA + (@C_stf49_69c22cf6_sde_L000082)<<S32
 word I16A_RDBYTE + (r22)<<D16A + RI<<S16A ' reg <- INDIRU1 addrg
 word I16B_TRN1 + (r22)<<D16B ' zero extend
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl_p1
 ...
 word I16B_LODL + (r2)<<D16B
 alignl_p1
 long @C_stf49_69c22cf6_sde_L000082 ' reg ARG ADDRG
 word I16B_LODL + (r3)<<D16B
 alignl_p1
 long @C_stf4b_69c22cf6_fnam_L000084 ' reg ARG ADDRG
 word I16B_CPREP + 33<<S16B ' arg size, rpsize = 8, spsize = 8
 alignl_p1
 long I32_CALA + (@C_buildfn)<<S32
 word I16A_ADDI + SP<<D16A + 4<<S16A ' CALL addrg
 ...
 word I16B_LODL + (r4)<<D16B
 alignl_p1
 long @C_stf4a_69c22cf6_snm_L000083 ' reg ARG ADDRG
 word I16B_CPREP + 50<<S16B ' arg size, rpsize = 12, spsize = 12
 alignl_p1
 ...
 alignl_p1
 long @C_stf4a_69c22cf6_snm_L000083 ' reg <- addrg
 alignl_p1
...
DAT ' uninitialized data segment
 ...
 alignl_label
C_stf4b_69c22cf6_fnam_L000084 ' <symbol:fnam>
 byte 0[13]

 alignl_label
C_stf4a_69c22cf6_snm_L000083 ' <symbol:snm>
 byte 0[13]

 alignl_label
C_stf49_69c22cf6_sde_L000082 ' <symbol:sde>
 byte 0[32]

 alignl_label
C_stf48_69c22cf6_sdi_L000081 ' <symbol:sdi>
 byte 0[16]

 alignl_label
C_stf43_69c22cf6_fatscratch_L000005 ' <symbol:fatscratch>
 byte 0[512]

 alignl_label
C_stf4_69c22cf6_vi_L000002 ' <symbol:vi>
 byte 0[52]
...
C_listD_irN_ext_101_L000102 ' <symbol:101>
 ...
 alignl_label
C_stf46_69c22cf6_listF_ile_L000076_78_L000079 ' <symbol:78>
 byte 37
 byte 115
 byte 10
 byte 0
