...
' C_luaM__free__29 ' (symbol refcount = 0)
 ...
 alignl_label
C_s77s2_69c22cf5_tryagain_L000030 ' <symbol:tryagain>
 alignl_p1
 long I32_NEWF + 0<<S32
 alignl_p1
 long I32_PSHM + $fa8000<<S32 ' save registers
 ...
 alignl_p1
 long I32_BRNZ + (@C_s77s2_69c22cf5_tryagain_L000030_32)<<S32 ' NEI4 reg coni
 alignl_p1
 ...
 word I16A_MOV + (r22)<<D16A + (r0)<<S16A ' CVI, CVU or LOAD
 alignl_p1
 long I32_JMPA + (@C_s77s2_69c22cf5_tryagain_L000030_31)<<S32 ' JUMPV addrg
 alignl_label
C_s77s2_69c22cf5_tryagain_L000030_32
 word I16B_LODL + R0<<D16B
 alignl_p1
 long 0 ' RET con
 alignl_label
C_s77s2_69c22cf5_tryagain_L000030_31
 word I16B_POPM + 0<<S16B ' restore registers, do pop frame, do return
 alignl_p1
...
C_luaM__realloc_ ' <symbol:luaM_realloc_>
 ...
 word I16B_CPREP + 67<<S16B ' arg size, rpsize = 16, spsize = 16
 alignl_p1
 long I32_CALA + (@C_s77s2_69c22cf5_tryagain_L000030)<<S32
 word I16A_ADDI + SP<<D16A + 12<<S16A ' CALL addrg
 word I16A_MOV + (r13)<<D16A + (r0)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r22)<<D16A + (r13)<<S16A ' CVI, CVU or LOAD
 word I16A_CMPI + (r22)<<D16A + (0)<<S16A
