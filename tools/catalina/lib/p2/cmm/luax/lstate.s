...
'
 ...
 alignl_label
C_s6jg_69c22cf5_luai_makeseed_L000015 ' <symbol:luai_makeseed>
 alignl_p1
...
' C_s6jg_69c22cf5_luai_makeseed_L000015_16 ' (symbol refcount = 0)
...
' C_luaE__extendC_I__21 ' (symbol refcount = 0)
 ...
 alignl_label
C_s6jg1_69c22cf5_freeC_I__L000022 ' <symbol:freeCI>
 alignl_p1
 long I32_NEWF + 0<<S32
 alignl_p1
 ...
 word I16A_WRLONG + (r20)<<D16A + (r22)<<S16A ' ASGNP4 reg reg
 alignl_p1
 long I32_JMPA + (@C_s6jg1_69c22cf5_freeC_I__L000022_25)<<S32 ' JUMPV addrg
 alignl_label
C_s6jg1_69c22cf5_freeC_I__L000022_24
 word I16A_MOV + (r22)<<D16A + (r21)<<S16A
 word I16A_ADDSI + (r22)<<D16A + (12)<<S16A ' ADDP4 reg coni
 word I16A_RDLONG + (r19)<<D16A + (r22)<<S16A ' reg <- INDIRP4 reg
 alignl_p1
 ...
 word I16A_WRWORD + (r20)<<D16A + (r22)<<S16A ' ASGNU2 reg reg
 alignl_label
C_s6jg1_69c22cf5_freeC_I__L000022_25
 word I16A_MOV + (r21)<<D16A + (r19)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r22)<<D16A + (r19)<<S16A ' CVI, CVU or LOAD
 word I16A_CMPI + (r22)<<D16A + (0)<<S16A
 alignl_p1
 long I32_BRNZ + (@C_s6jg1_69c22cf5_freeC_I__L000022_24)<<S32 ' NEU4 reg coni
' C_s6jg1_69c22cf5_freeC_I__L000022_23 ' (symbol refcount = 0)
 word I16B_POPM + 0<<S16B ' restore registers, do pop frame, do return
 alignl_p1
...
' C_luaE__incC_stack_42 ' (symbol refcount = 0)
 ...
 alignl_label
C_s6jg3_69c22cf5_stack_init_L000045 ' <symbol:stack_init>
 alignl_p1
 long I32_NEWF + 0<<S32
 alignl_p1
 ...
 alignl_label
C_s6jg3_69c22cf5_stack_init_L000045_47
 word I16A_MOV + (r22)<<D16A + (r19)<<S16A
...
' C_s6jg3_69c22cf5_stack_init_L000045_48 ' (symbol refcount = 0)
 word I16A_ADDSI + (r19)<<D16A + (1)<<S16A ' ADDI4 reg coni
 alignl_p1
 long I32_MOVI + RI<<D32 + (45)<<S32
 word I16A_CMPS + (r19)<<D16A + RI<<S16A
 alignl_p1
 long I32_BR_B + (@C_s6jg3_69c22cf5_stack_init_L000045_47)<<S32 ' LTI4 reg coni
 word I16A_MOV + (r22)<<D16A + (r23)<<S16A
 word I16A_ADDSI + (r22)<<D16A + (12)<<S16A ' ADDP4 reg coni
 word I16A_MOV + (r20)<<D16A + (r23)<<S16A
 word I16A_ADDSI + (r20)<<D16A + (28)<<S16A ' ADDP4 reg coni
 ...
 word I16A_ADDSI + (r22)<<D16A + (20)<<S16A ' ADDP4 reg coni
 word I16A_WRLONG + (r17)<<D16A + (r22)<<S16A ' ASGNP4 reg reg
' C_s6jg3_69c22cf5_stack_init_L000045_46 ' (symbol refcount = 0)
 word I16B_POPM + 0<<S16B ' restore registers, do pop frame, do return
 alignl_p1

 alignl_label
C_s6jg4_69c22cf5_freestack_L000051 ' <symbol:freestack>
 alignl_p1
 long I32_NEWF + 0<<S32
 alignl_p1
 ...
 word I16A_CMPI + (r22)<<D16A + (0)<<S16A
 alignl_p1
 long I32_BRNZ + (@C_s6jg4_69c22cf5_freestack_L000051_53)<<S32 ' NEU4 reg coni
 alignl_p1
 long I32_JMPA + (@C_s6jg4_69c22cf5_freestack_L000051_52)<<S32 ' JUMPV addrg
 alignl_label
C_s6jg4_69c22cf5_freestack_L000051_53
 word I16A_MOV + (r22)<<D16A + (r23)<<S16A
 word I16A_ADDSI + (r22)<<D16A + (20)<<S16A ' ADDP4 reg coni
 alignl_p1
 ...
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
 alignl_p1
 long I32_CALA + (@C_s6jg1_69c22cf5_freeC_I__L000022)<<S32 ' CALL addrg
 word I16A_MOV + (r22)<<D16A + (r23)<<S16A
 word I16A_ADDSI + (r22)<<D16A + (28)<<S16A ' ADDP4 reg coni
 word I16A_RDLONG + (r22)<<D16A + (r22)<<S16A ' reg <- INDIRP4 reg
 word I16A_MOV + (r20)<<D16A + (r23)<<S16A
 ...
 word I16A_ADDI + SP<<D16A + 8<<S16A ' CALL addrg
 alignl_label
C_s6jg4_69c22cf5_freestack_L000051_52
 word I16B_POPM + 0<<S16B ' restore registers, do pop frame, do return
 alignl_p1

 alignl_label
C_s6jg5_69c22cf5_init_registry_L000055 ' <symbol:init_registry>
 alignl_p1
 long I32_NEWF + 4<<S32
 alignl_p1
 long I32_PSHM + $fa0000<<S32 ' save registers
 ...
 long I32_MOVI + (r20)<<D32 +(69)<<S32 ' reg <- conli
 word I16A_WRBYTE + (r20)<<D16A + (r22)<<S16A ' ASGNU1 reg reg
' C_s6jg5_69c22cf5_init_registry_L000055_56 ' (symbol refcount = 0)
 word I16B_POPM + 1<<S16B ' restore registers, do pop frame, do return
 alignl_p1

 alignl_label
C_s6jg6_69c22cf5_f_luaopen_L000057 ' <symbol:f_luaopen>
 alignl_p1
 long I32_NEWF + 0<<S32
 alignl_p1
 long I32_PSHM + $f80000<<S32 ' save registers
 ...
 word I16B_CPREP + 33<<S16B ' arg size, rpsize = 8, spsize = 8
 alignl_p1
 long I32_CALA + (@C_s6jg3_69c22cf5_stack_init_L000045)<<S32
 word I16A_ADDI + SP<<D16A + 4<<S16A ' CALL addrg
 word I16A_MOV + (r2)<<D16A + (r19)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r3)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
 word I16B_CPREP + 33<<S16B ' arg size, rpsize = 8, spsize = 8
 alignl_p1
 long I32_CALA + (@C_s6jg5_69c22cf5_init_registry_L000055)<<S32
 word I16A_ADDI + SP<<D16A + 4<<S16A ' CALL addrg
 word I16A_MOV + (r2)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
 alignl_p1
 ...
 word I16A_MOVI + (r20)<<D16A + (0)<<S16A ' reg <- coni
 word I16A_WRBYTE + (r20)<<D16A + (r22)<<S16A ' ASGNU1 reg reg
' C_s6jg6_69c22cf5_f_luaopen_L000057_58 ' (symbol refcount = 0)
 word I16B_POPM + 0<<S16B ' restore registers, do pop frame, do return
 alignl_p1

 alignl_label
C_s6jg7_69c22cf5_preinit_thread_L000059 ' <symbol:preinit_thread>
 alignl_p1
 ...
 word I16A_MOVI + (r20)<<D16A + (0)<<S16A ' reg <- coni
 word I16A_WRLONG + (r20)<<D16A + (r22)<<S16A ' ASGNI4 reg reg
' C_s6jg7_69c22cf5_preinit_thread_L000059_60 ' (symbol refcount = 0)
 word I16B_POPM + $80<<S16B ' restore registers, do not pop frame, do return
 alignl_p1

 alignl_label
C_s6jg8_69c22cf5_close_state_L000061 ' <symbol:close_state>
 alignl_p1
 long I32_NEWF + 0<<S32
 alignl_p1
 long I32_PSHM + $f00000<<S32 ' save registers
 ...
 alignl_p1
 long I32_BR_Z + (@C_s6jg8_69c22cf5_close_state_L000061_63)<<S32 ' EQI4 reg coni
 word I16A_MOV + (r2)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
 alignl_p1
 long I32_CALA + (@C_luaC__freeallobjects)<<S32 ' CALL addrg
 alignl_p1
 long I32_JMPA + (@C_s6jg8_69c22cf5_close_state_L000061_64)<<S32 ' JUMPV addrg
 alignl_label
C_s6jg8_69c22cf5_close_state_L000061_63
 word I16A_MOV + (r22)<<D16A + (r23)<<S16A
 word I16A_ADDSI + (r22)<<D16A + (20)<<S16A ' ADDP4 reg coni
 alignl_p1
 long I32_LODS + (r20)<<D32S + ((52)&$7FFFF)<<S32 ' reg <- cons
 ...
 long I32_CALA + (@C_luaC__freeallobjects)<<S32 ' CALL addrg
 alignl_label
C_s6jg8_69c22cf5_close_state_L000061_64
 word I16A_MOV + (r22)<<D16A + (r23)<<S16A
 word I16A_ADDSI + (r22)<<D16A + (16)<<S16A ' ADDP4 reg coni
 word I16A_RDLONG + (r22)<<D16A + (r22)<<S16A ' reg <- INDIRP4 reg
 alignl_p1
 ...
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
 alignl_p1
 long I32_CALA + (@C_s6jg4_69c22cf5_freestack_L000051)<<S32 ' CALL addrg
 word I16A_MOVI + (r2)<<D16A + (0)<<S16A ' reg ARG coni
 alignl_p1
...
' C_s6jg8_69c22cf5_close_state_L000061_62 ' (symbol refcount = 0)
 word I16B_POPM + 0<<S16B ' restore registers, do pop frame, do return
 alignl_p1
...
C_lua_newthread_66
 ...
 word I16B_CPREP + 33<<S16B ' arg size, rpsize = 8, spsize = 8
 alignl_p1
 long I32_CALA + (@C_s6jg7_69c22cf5_preinit_thread_L000059)<<S32
 word I16A_ADDI + SP<<D16A + 4<<S16A ' CALL addrg
 alignl_p1
 long I32_LODS + (r22)<<D32S + ((112)&$7FFFF)<<S32 ' reg <- cons
...
C_lua_newstate_80
 ...
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
 alignl_p1
 long I32_CALA + (@C_s6jg_69c22cf5_luai_makeseed_L000015)<<S32 ' CALL addrg
 alignl_p1
 long I32_LODS + (r20)<<D32S + ((52)&$7FFFF)<<S32 ' reg <- cons
 word I16A_ADDS + (r20)<<D16A + (r19)<<S16A ' ADDI/P (2)
...
' C_lua_newstate_83 ' (symbol refcount = 0)
 ...
 alignl_p1
 long @C_s6jg6_69c22cf5_f_luaopen_L000057 ' reg ARG ADDRG
 ...
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
 alignl_p1
 long I32_CALA + (@C_s6jg8_69c22cf5_close_state_L000061)<<S32 ' CALL addrg
