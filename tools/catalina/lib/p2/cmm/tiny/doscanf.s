...
'
 ...
 alignl_label
C_sqb4_69c22cf1_isspace_L000001 ' <symbol:isspace>
 alignl_p1
 long I32_PSHM + $800000<<S32 ' save registers
 word I16A_CMPSI + (r2)<<D16A + (0)<<S16A
 alignl_p1
 long I32_BR_Z + (@C_sqb4_69c22cf1_isspace_L000001_11)<<S32 ' EQI4 reg coni
 alignl_p1
 ...
 alignl_p1
 long I32_BRNZ + (@C_sqb4_69c22cf1_isspace_L000001_4)<<S32 ' NEI4 reg coni
 alignl_label
C_sqb4_69c22cf1_isspace_L000001_11
 word I16A_MOVI + (r23)<<D16A + (1)<<S16A ' reg <- coni
 alignl_p1
 long I32_JMPA + (@C_sqb4_69c22cf1_isspace_L000001_5)<<S32 ' JUMPV addrg
 alignl_label
C_sqb4_69c22cf1_isspace_L000001_4
 word I16A_MOVI + (r23)<<D16A + (0)<<S16A ' reg <- coni
 alignl_label
C_sqb4_69c22cf1_isspace_L000001_5
 word I16A_MOV + (r0)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
' C_sqb4_69c22cf1_isspace_L000001_2 ' (symbol refcount = 0)
 word I16B_POPM + $80<<S16B ' restore registers, do not pop frame, do return
 alignl_p1

 alignl_label
C_sqb41_69c22cf1_trim_L000012 ' <symbol:trim>
 alignl_p1
 long I32_NEWF + 0<<S32
 alignl_p1
 ...
 alignl_p1
 long I32_JMPA + (@C_sqb41_69c22cf1_trim_L000012_15)<<S32 ' JUMPV addrg
 alignl_label
C_sqb41_69c22cf1_trim_L000012_14
 word I16A_ADDSI + (r23)<<D16A + (1)<<S16A ' ADDP4 reg coni
 alignl_label
C_sqb41_69c22cf1_trim_L000012_15
 ...
 alignl_p1
 long I32_CALA + (@C_sqb4_69c22cf1_isspace_L000001)<<S32 ' CALL addrg
 word I16A_CMPSI + (r0)<<D16A + (0)<<S16A
 alignl_p1
 long I32_BRNZ + (@C_sqb41_69c22cf1_trim_L000012_14)<<S32 ' NEI4 reg coni
 word I16A_MOV + (r0)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
' C_sqb41_69c22cf1_trim_L000012_13 ' (symbol refcount = 0)
 word I16B_POPM + 0<<S16B ' restore registers, do pop frame, do return
 alignl_p1

 alignl_label
C_sqb42_69c22cf1__scanf_gets_L000017 ' <symbol:_scanf_gets>
 alignl_p1
 long I32_NEWF + 0<<S32
 alignl_p1
 ...
 alignl_p1
 long I32_JMPA + (@C_sqb42_69c22cf1__scanf_gets_L000017_20)<<S32 ' JUMPV addrg
 alignl_label
C_sqb42_69c22cf1__scanf_gets_L000017_19
 ...
 alignl_label
C_sqb42_69c22cf1__scanf_gets_L000017_20
 word I16A_MOV + (r22)<<D16A + (r19)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r19)<<D16A + (r22)<<S16A
 word I16A_SUBI + (r19)<<D16A + (1)<<S16A ' SUBU4 reg coni
 word I16A_CMPI + (r22)<<D16A + (0)<<S16A
 alignl_p1
 long I32_BR_Z + (@C_sqb42_69c22cf1__scanf_gets_L000017_22)<<S32 ' EQU4 reg coni
 word I16A_CMPSI + (r17)<<D16A + (0)<<S16A
 alignl_p1
 long I32_BRNZ + (@C_sqb42_69c22cf1__scanf_gets_L000017_19)<<S32 ' NEI4 reg coni
 word I16A_RDBYTE + (r22)<<D16A + (r23)<<S16A ' reg <- INDIRU1 reg
 word I16A_MOV + (r2)<<D16A + (r22)<<S16A ' CVUI
 word I16B_TRN1 + (r2)<<D16B ' zero extend
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
 ...
 word I16A_CMPSI + (r0)<<D16A + (0)<<S16A
 alignl_p1
 long I32_BR_Z + (@C_sqb42_69c22cf1__scanf_gets_L000017_19)<<S32 ' EQI4 reg coni
 alignl_label
C_sqb42_69c22cf1__scanf_gets_L000017_22
 word I16A_CMPSI + (r17)<<D16A + (0)<<S16A
 alignl_p1
 long I32_BRNZ + (@C_sqb42_69c22cf1__scanf_gets_L000017_23)<<S32 ' NEI4 reg coni
 word I16A_MOVI + (r22)<<D16A + (0)<<S16A ' reg <- coni
 word I16A_WRBYTE + (r22)<<D16A + (r21)<<S16A ' ASGNU1 reg reg
 alignl_label
C_sqb42_69c22cf1__scanf_gets_L000017_23
 word I16A_MOV + (r0)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
' C_sqb42_69c22cf1__scanf_gets_L000017_18 ' (symbol refcount = 0)
 word I16B_POPM + 0<<S16B ' restore registers, do pop frame, do return
 alignl_p1
...
C__doscanf_26
 ...
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
 alignl_p1
 long I32_CALA + (@C_sqb41_69c22cf1_trim_L000012)<<S32 ' CALL addrg
...
C__doscanf_49
 ...
 alignl_p1
 long I32_CALA + (@C_sqb42_69c22cf1__scanf_gets_L000017)<<S32
