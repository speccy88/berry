...
'
 ...
 alignl_label
C_spf0_69c22cf3_charT_oI_nt_L000001 ' <symbol:charToInt>
 alignl_p1
 ...
 alignl_p1
 long I32_BR_B + (@C_spf0_69c22cf3_charT_oI_nt_L000001_3)<<S32 ' LTI4 reg coni
 word I16A_MOV + (r22)<<D16A + (r2)<<S16A ' CVUI
 word I16B_TRN1 + (r22)<<D16B ' zero extend
 word I16A_SUBSI + (r22)<<D16A + (7)<<S16A ' SUBI4 reg coni
 word I16A_MOV + (r2)<<D16A + (r22)<<S16A ' CVI, CVU or LOAD
 alignl_label
C_spf0_69c22cf3_charT_oI_nt_L000001_3
 word I16A_MOV + (r22)<<D16A + (r2)<<S16A ' CVUI
 word I16B_TRN1 + (r22)<<D16B ' zero extend
 word I16A_CMPSI + (r22)<<D16A + (15)<<S16A
 alignl_p1
 long I32_BRBE + (@C_spf0_69c22cf3_charT_oI_nt_L000001_5)<<S32 ' LEI4 reg coni
 word I16A_MOV + (r22)<<D16A + (r2)<<S16A ' CVUI
 word I16B_TRN1 + (r22)<<D16B ' zero extend
 alignl_p1
 ...
 word I16A_MOV + (r2)<<D16A + (r22)<<S16A ' CVI, CVU or LOAD
 alignl_label
C_spf0_69c22cf3_charT_oI_nt_L000001_5
 word I16A_MOV + (r0)<<D16A + (r2)<<S16A ' CVUI
 word I16B_TRN1 + (r0)<<D16B ' zero extend
' C_spf0_69c22cf3_charT_oI_nt_L000001_2 ' (symbol refcount = 0)
...
C__scanf_getl_19
 ...
 alignl_p1
 long I32_CALA + (@C_spf0_69c22cf3_charT_oI_nt_L000001)<<S32 ' CALL addrg
