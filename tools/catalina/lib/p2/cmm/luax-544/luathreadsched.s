...
C_cond_no_active_lp ' <symbol:cond_no_active_lp>
 ...
 alignl ' align long
C_sdo8_664d6fab_workerls_L000005 ' <symbol:workerls>
 long $0
...
C_workermain ' <symbol:workermain>
 ...
 alignl ' align long
 long I32_LODI + (@C_sdo8_664d6fab_workerls_L000005)<<S32
...
C_workermain_17
 ...
 alignl ' align long
 long I32_CALA + (@C_sdo81_664d6fab_sched_dec_lpcount_L000006)<<S32 ' CALL addrg
 alignl ' align long
...
' C_workermain_7 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_sdo81_664d6fab_sched_dec_lpcount_L000006 ' <symbol:sched_dec_lpcount>
 alignl ' align long
 long I32_NEWF + 0<<S32
 alignl ' align long
 ...
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_sdo81_664d6fab_sched_dec_lpcount_L000006_30)<<S32 ' NEI4 reg coni
 word I16B_LODL + (r2)<<D16B
 alignl ' align long
 ...
 long I32_CALA + (@C_pthread_cond_signal)<<S32 ' CALL addrg
 alignl ' align long
C_sdo81_664d6fab_sched_dec_lpcount_L000006_30
 word I16B_LODL + (r2)<<D16B
 alignl ' align long
 long @C_mutex_lp_count ' reg ARG ADDRG
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
 alignl ' align long
 long I32_CALA + (@C_pthread_mutex_unlock)<<S32 ' CALL addrg
' C_sdo81_664d6fab_sched_dec_lpcount_L000006_29 ' (symbol refcount = 0)
...
C_sched_init ' <symbol:sched_init>
 ...
 alignl ' align long
 long I32_LODA + (@C_sdo8_664d6fab_workerls_L000005)<<S32
