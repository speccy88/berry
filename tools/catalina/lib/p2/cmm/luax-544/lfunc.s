...
' C_luaF__initupvals_17 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_sguo_664d6fa9_newupval_L000024 ' <symbol:newupval>
 alignl ' align long
 long I32_NEWF + 4<<S32
 alignl ' align long
 ...
 alignl ' align long
 long I32_BR_Z + (@C_sguo_664d6fa9_newupval_L000024_26)<<S32 ' EQU4 reg coni
 ...
 word I16A_WRLONG + (r20)<<D16A + (r22)<<S16A ' ASGNP4 reg reg
 alignl ' align long
C_sguo_664d6fa9_newupval_L000024_26
 ...
 alignl ' align long
 long I32_BRNZ + (@C_sguo_664d6fa9_newupval_L000024_28)<<S32 ' NEU4 reg reg
 alignl ' align long
 long I32_LODS + (r22)<<D32S + ((44)&$7FFFF)<<S32 ' reg <- cons
 word I16A_ADDS + (r22)<<D16A + (r23)<<S16A ' ADDI/P (2)
 ...
 alignl ' align long
C_sguo_664d6fa9_newupval_L000024_28
 word I16A_MOV + (r0)<<D16A + (r15)<<S16A ' CVI, CVU or LOAD
' C_sguo_664d6fa9_newupval_L000024_25 ' (symbol refcount = 0)
 word I16B_POPM + 1<<S16B ' restore registers, do pop frame, do return
 alignl ' align long
...
C_luaF__findupval_36
 ...
 alignl ' align long
 long I32_CALA + (@C_sguo_664d6fa9_newupval_L000024)<<S32
...
C_luaF__findupval_30
 ...
 alignl ' align long
C_sguo1_664d6fa9_callclosemethod_L000037 ' <symbol:callclosemethod>
 alignl ' align long
 long I32_NEWF + 4<<S32
 alignl ' align long
 ...
 alignl ' align long
 long I32_BR_Z + (@C_sguo1_664d6fa9_callclosemethod_L000037_39)<<S32 ' EQI4 reg coni
 ...
 word I16A_ADDI + SP<<D16A + 8<<S16A ' CALL addrg
 alignl ' align long
 long I32_JMPA + (@C_sguo1_664d6fa9_callclosemethod_L000037_40)<<S32 ' JUMPV addrg
 alignl ' align long
C_sguo1_664d6fa9_callclosemethod_L000037_39
 word I16A_MOVI + (r2)<<D16A + (0)<<S16A ' reg ARG coni
 word I16A_MOV + (r3)<<D16A + (r15)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r4)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
 word I16B_CPREP + 50<<S16B ' arg size, rpsize = 12, spsize = 12
 ...
 word I16A_ADDI + SP<<D16A + 8<<S16A ' CALL addrg
 alignl ' align long
C_sguo1_664d6fa9_callclosemethod_L000037_40
' C_sguo1_664d6fa9_callclosemethod_L000037_38 ' (symbol refcount = 0)
 word I16B_POPM + 1<<S16B ' restore registers, do pop frame, do return
 alignl ' align long

 alignl ' align long
C_sguo2_664d6fa9_checkclosemth_L000041 ' <symbol:checkclosemth>
 alignl ' align long
 ...
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_sguo2_664d6fa9_checkclosemth_L000041_43)<<S32 ' NEI4 reg coni
 word I16A_MOV + (r22)<<D16A + (r21)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r20)<<D16A + (r23)<<S16A
 ...
 word I16A_CMPI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_sguo2_664d6fa9_checkclosemth_L000041_45)<<S32 ' NEU4 reg coni
 word I16B_LODL + (r22)<<D16B
 alignl ' align long
 long @C_sguo2_664d6fa9_checkclosemth_L000041_47_L000048 ' reg <- addrg
 word I16B_LODF + ((-12)&$1FF)<<S16B
 word I16A_WRLONG + (r22)<<D16A + RI<<S16A ' ASGNP4 addrl16 reg
 alignl ' align long
C_sguo2_664d6fa9_checkclosemth_L000041_45
 word I16B_LODF + ((-12)&$1FF)<<S16B
 word I16A_RDLONG + (r2)<<D16A + RI<<S16A ' reg ARG INDIR ADDRLi
 word I16B_LODL + (r3)<<D16B
 alignl ' align long
 long @C_sguo2_664d6fa9_checkclosemth_L000041_49_L000050 ' reg ARG ADDRG
 word I16A_MOV + (r4)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
 word I16B_CPREP + 50<<S16B ' arg size, rpsize = 12, spsize = 12
 alignl ' align long
 ...
 word I16A_ADDI + SP<<D16A + 8<<S16A ' CALL addrg
 alignl ' align long
C_sguo2_664d6fa9_checkclosemth_L000041_43
' C_sguo2_664d6fa9_checkclosemth_L000041_42 ' (symbol refcount = 0)
 word I16B_POPM + 3<<S16B ' restore registers, do pop frame, do return
 alignl ' align long

 alignl ' align long
C_sguo5_664d6fa9_prepcallclosemth_L000051 ' <symbol:prepcallclosemth>
 alignl ' align long
 long I32_NEWF + 8<<S32
 alignl ' align long
 long I32_PSHM + $fa0000<<S32 ' save registers
 ...
 word I16A_CMPS + (r19)<<D16A + (r22)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_sguo5_664d6fa9_prepcallclosemth_L000051_53)<<S32 ' NEI4 reg reg
 word I16A_MOV + (r22)<<D16A + (r23)<<S16A
 word I16A_ADDSI + (r22)<<D16A + (16)<<S16A ' ADDP4 reg coni
 word I16A_RDLONG + (r22)<<D16A + (r22)<<S16A ' reg <- INDIRP4 reg
 alignl ' align long
 ...
 word I16A_WRLONG + (r22)<<D16A + RI<<S16A ' ASGNP4 addrl16 reg
 alignl ' align long
 long I32_JMPA + (@C_sguo5_664d6fa9_prepcallclosemth_L000051_54)<<S32 ' JUMPV addrg
 alignl ' align long
C_sguo5_664d6fa9_prepcallclosemth_L000051_53
 word I16A_MOV + (r22)<<D16A + (r21)<<S16A
 word I16A_ADDSI + (r22)<<D16A + (8)<<S16A ' ADDP4 reg coni
 word I16B_LODF + ((-12)&$1FF)<<S16B
 word I16A_WRLONG + (r22)<<D16A + RI<<S16A ' ASGNP4 addrl16 reg
 ...
 word I16A_ADDI + SP<<D16A + 8<<S16A ' CALL addrg
 alignl ' align long
C_sguo5_664d6fa9_prepcallclosemth_L000051_54
 word I16A_MOV + (r2)<<D16A + (r17)<<S16A ' CVI, CVU or LOAD
 word I16B_LODF + ((-12)&$1FF)<<S16B
 word I16A_RDLONG + (r3)<<D16A + RI<<S16A ' reg ARG INDIR ADDRLi
 word I16B_LODF + ((-8)&$1FF)<<S16B
 ...
 word I16B_CPREP + 67<<S16B ' arg size, rpsize = 16, spsize = 16
 alignl ' align long
 long I32_CALA + (@C_sguo1_664d6fa9_callclosemethod_L000037)<<S32
 word I16A_ADDI + SP<<D16A + 12<<S16A ' CALL addrg
' C_sguo5_664d6fa9_prepcallclosemth_L000051_52 ' (symbol refcount = 0)
...
C_luaF__newtbcupval_56
 ...
 alignl ' align long
 long I32_CALA + (@C_sguo2_664d6fa9_checkclosemth_L000041)<<S32
...
' C_luaF__closeupval_65 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_sguo6_664d6fa9_poptbclist_L000074 ' <symbol:poptbclist>
 alignl ' align long
 ...
 alignl ' align long
 long I32_JMPA + (@C_sguo6_664d6fa9_poptbclist_L000074_77)<<S32 ' JUMPV addrg
 alignl ' align long
C_sguo6_664d6fa9_poptbclist_L000074_76
 word I16B_LODL + (r22)<<D16B
 alignl ' align long
 long -524280 ' reg <- con
 word I16A_ADDS + (r23)<<D16A + (r22)<<S16A ' ADDI/P (1)
 alignl ' align long
C_sguo6_664d6fa9_poptbclist_L000074_77
 ...
 word I16A_CMP + (r22)<<D16A + (r20)<<S16A
 alignl ' align long
 long I32_BRBE + (@C_sguo6_664d6fa9_poptbclist_L000074_79)<<S32 ' LEU4 reg reg
 word I16A_MOV + (r22)<<D16A + (r23)<<S16A
 word I16A_ADDSI + (r22)<<D16A + (6)<<S16A ' ADDP4 reg coni
 word I16A_RDWORD + (r22)<<D16A + (r22)<<S16A ' reg <- INDIRU2 reg
 word I16B_TRN2 + (r22)<<D16B ' zero extend
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_sguo6_664d6fa9_poptbclist_L000074_76)<<S32 ' EQI4 reg coni
 alignl ' align long
C_sguo6_664d6fa9_poptbclist_L000074_79
 alignl ' align long
 long I32_LODS + (r22)<<D32S + ((36)&$7FFFF)<<S32 ' reg <- cons
 word I16A_ADDS + (r22)<<D16A + (r2)<<S16A ' ADDI/P (2)
 word I16A_WRLONG + (r23)<<D16A + (r22)<<S16A ' ASGNP4 reg reg
' C_sguo6_664d6fa9_poptbclist_L000074_75 ' (symbol refcount = 0)
 word I16B_POPM + $80<<S16B ' restore registers, do not pop frame, do return
 alignl ' align long
...
C_luaF__close_81
 ...
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
 alignl ' align long
 long I32_CALA + (@C_sguo6_664d6fa9_poptbclist_L000074)<<S32 ' CALL addrg
 word I16A_MOV + (r2)<<D16A + (r17)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r3)<<D16A + (r19)<<S16A ' CVI, CVU or LOAD
 ...
 word I16B_CPREP + 67<<S16B ' arg size, rpsize = 16, spsize = 16
 alignl ' align long
 long I32_CALA + (@C_sguo5_664d6fa9_prepcallclosemth_L000051)<<S32
 word I16A_ADDI + SP<<D16A + 12<<S16A ' CALL addrg
 word I16A_MOV + (r22)<<D16A + (r23)<<S16A
...
DAT ' const data segment
 ...
 alignl ' align long
C_sguo2_664d6fa9_checkclosemth_L000041_49_L000050 ' <symbol:49>
 byte 118
 byte 97
 byte 114
 byte 105
 ...
 alignl ' align long
C_sguo2_664d6fa9_checkclosemth_L000041_47_L000048 ' <symbol:47>
 byte 63
 byte 0
