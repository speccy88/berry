...
'
 ...
 alignl_label
C_snp0_69c22d1f_do_write_L000003 ' <symbol:do_write>
 alignl_p1
 long I32_NEWF + 0<<S32
 alignl_p1
 ...
 alignl_p1
 long I32_JMPA + (@C_snp0_69c22d1f_do_write_L000003_6)<<S32 ' JUMPV addrg
 alignl_label
C_snp0_69c22d1f_do_write_L000003_5
 word I16A_SUBS + (r19)<<D16A + (r17)<<S16A ' SUBI/P (1)
 word I16A_ADDS + (r21)<<D16A + (r17)<<S16A ' ADDI/P (2)
 alignl_label
C_snp0_69c22d1f_do_write_L000003_6
 ...
 alignl_p1
 long I32_BRBE + (@C_snp0_69c22d1f_do_write_L000003_8)<<S32 ' LEI4 reg coni
 word I16A_CMPS + (r17)<<D16A + (r19)<<S16A
 alignl_p1
 long I32_BR_B + (@C_snp0_69c22d1f_do_write_L000003_5)<<S32 ' LTI4 reg reg
 alignl_label
C_snp0_69c22d1f_do_write_L000003_8
 word I16A_CMPSI + (r17)<<D16A + (0)<<S16A
 alignl_p1
 long I32_BRBE + (@C_snp0_69c22d1f_do_write_L000003_10)<<S32 ' LEI4 reg coni
 word I16A_MOVI + (r15)<<D16A + (1)<<S16A ' reg <- coni
 alignl_p1
 long I32_JMPA + (@C_snp0_69c22d1f_do_write_L000003_11)<<S32 ' JUMPV addrg
 alignl_label
C_snp0_69c22d1f_do_write_L000003_10
 word I16A_MOVI + (r15)<<D16A + (0)<<S16A ' reg <- coni
 alignl_label
C_snp0_69c22d1f_do_write_L000003_11
 word I16A_MOV + (r0)<<D16A + (r15)<<S16A ' CVI, CVU or LOAD
' C_snp0_69c22d1f_do_write_L000003_4 ' (symbol refcount = 0)
 word I16B_POPM + 0<<S16B ' restore registers, do pop frame, do return
 alignl_p1

 alignl_label
C_snp01_69c22d1f_get_buf_L000012 ' <symbol:get_buf>
 alignl_p1
 long I32_NEWF + 0<<S32
 alignl_p1
...
' C_snp01_69c22d1f_get_buf_L000012_13 ' (symbol refcount = 0)
 word I16B_POPM + 0<<S16B ' restore registers, do pop frame, do return
 alignl_p1
...
C___flushbuf_19
 ...
 alignl_p1
 long I32_CALA + (@C_snp01_69c22d1f_get_buf_L000012)<<S32 ' CALL addrg
...
C___flushbuf_47
 ...
 word I16B_CPREP + 50<<S16B ' arg size, rpsize = 12, spsize = 12
 alignl_p1
 long I32_CALA + (@C_snp0_69c22d1f_do_write_L000003)<<S32
 word I16A_ADDI + SP<<D16A + 8<<S16A ' CALL addrg
 word I16A_CMPSI + (r0)<<D16A + (0)<<S16A
 alignl_p1
