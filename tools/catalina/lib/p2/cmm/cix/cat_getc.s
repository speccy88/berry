...
DAT ' initialized data segment
 ...
 alignl_label
C_s4uc_69c22d1c_unget_count_L000002 ' <symbol:unget_count>
 long 0
...
C_catalina_getc ' <symbol:catalina_getc>
 ...
 alignl_p1
 long I32_LODI + (@C_s4uc_69c22d1c_unget_count_L000002)<<S32
 ...
 alignl_p1
 long @C_s4uc_69c22d1c_unget_count_L000002 ' reg <- addrg
 word I16A_RDLONG + (r22)<<D16A + (r22)<<S16A ' reg <- INDIRI4 reg
 word I16A_SUBSI + (r22)<<D16A + (1)<<S16A ' SUBI4 reg coni
 alignl_p1
 long I32_LODA + (@C_s4uc_69c22d1c_unget_count_L000002)<<S32
 word I16A_WRLONG + (r22)<<D16A + RI<<S16A ' ASGNI4 addrg reg
 word I16A_SHLI + (r22)<<D16A + (2)<<S16A ' SHLI4 reg coni
 word I16B_LODL + (r20)<<D16B
 alignl_p1
 long @C_s4uc1_69c22d1c_unget_buff_L000003 ' reg <- addrg
...
DAT ' uninitialized data segment
 ...
 alignl_label
C_s4uc1_69c22d1c_unget_buff_L000003 ' <symbol:unget_buff>
 byte 0[40]
