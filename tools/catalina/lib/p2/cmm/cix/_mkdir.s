...
'
 ...
 alignl_label
C_sh4g_69c22d1c__mkleaf_L000002 ' <symbol:_mkleaf>
 alignl_p1
 ...
 alignl_p1
 long I32_BR_Z + (@C_sh4g_69c22d1c__mkleaf_L000002_4)<<S32 ' EQU4 reg coni
 word I16A_MOVI + R0<<D16A + (6)<<S16A ' RET coni
 alignl_p1
 long I32_JMPA + (@C_sh4g_69c22d1c__mkleaf_L000002_3)<<S32 ' JUMPV addrg
 alignl_label
C_sh4g_69c22d1c__mkleaf_L000002_4
 alignl_p1
 long I32_LODF + ((-544)&$FFFFFF)<<S32 
 word I16A_MOV + (r2)<<D16A + RI<<S16A ' reg ARG ADDRL
 alignl_p1
 ...
 alignl_label
C_sh4g_69c22d1c__mkleaf_L000002_3
 ...
 alignl_label
C_sh4g1_69c22d1c__mkpath_L000006 ' <symbol:_mkpath>
 alignl_p1
 ...
 alignl_p1
 long I32_BRNZ + (@C_sh4g1_69c22d1c__mkpath_L000006_8)<<S32 ' NEU4 reg reg
 ...
 alignl_p1
 long I32_BRNZ + (@C_sh4g1_69c22d1c__mkpath_L000006_10)<<S32 ' NEI4 reg reg
 word I16A_NEGI + (r0)<<D16A + (-($ffffffff)&$1F)<<S16A ' reg <- conn
 alignl_p1
 long I32_JMPA + (@C_sh4g1_69c22d1c__mkpath_L000006_7)<<S32 ' JUMPV addrg
 alignl_label
C_sh4g1_69c22d1c__mkpath_L000006_10
 alignl_label
C_sh4g1_69c22d1c__mkpath_L000006_8
 word I16A_CMPSI + (r21)<<D16A + (0)<<S16A
 alignl_p1
 long I32_BRNZ + (@C_sh4g1_69c22d1c__mkpath_L000006_12)<<S32 ' NEI4 reg coni
 word I16A_MOV + (r2)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
 alignl_p1
 long I32_CALA + (@C_sh4g_69c22d1c__mkleaf_L000002)<<S32 ' CALL addrg
 word I16A_MOV + (r15)<<D16A + (r0)<<S16A ' CVI, CVU or LOAD
 word I16A_CMPI + (r15)<<D16A + (0)<<S16A
 alignl_p1
 long I32_BR_Z + (@C_sh4g1_69c22d1c__mkpath_L000006_14)<<S32 ' EQU4 reg coni
 ...
 long I32_JMPA + (@C_sh4g1_69c22d1c__mkpath_L000006_7)<<S32 ' JUMPV addrg
 alignl_label
C_sh4g1_69c22d1c__mkpath_L000006_14
 word I16A_MOVI + R0<<D16A + (0)<<S16A ' RET coni
 alignl_p1
 long I32_JMPA + (@C_sh4g1_69c22d1c__mkpath_L000006_7)<<S32 ' JUMPV addrg
 alignl_label
C_sh4g1_69c22d1c__mkpath_L000006_12
 word I16A_MOVI + (r22)<<D16A + (0)<<S16A ' reg <- coni
 ...
 alignl_p1
 long I32_JMPA + (@C_sh4g1_69c22d1c__mkpath_L000006_17)<<S32 ' JUMPV addrg
 alignl_label
C_sh4g1_69c22d1c__mkpath_L000006_19
 word I16B_LODF + ((-72)&$1FF)<<S16B
 ...
 alignl_label
C_sh4g1_69c22d1c__mkpath_L000006_20
 word I16A_CMPS + (r19)<<D16A + (r17)<<S16A
 alignl_p1
 long I32_BRAE + (@C_sh4g1_69c22d1c__mkpath_L000006_22)<<S32 ' GEI4 reg reg
 ...
 alignl_p1
 long I32_BRNZ + (@C_sh4g1_69c22d1c__mkpath_L000006_19)<<S32 ' NEI4 reg coni
 alignl_label
C_sh4g1_69c22d1c__mkpath_L000006_22
 word I16B_LODF + ((-72)&$1FF)<<S16B
 word I16A_MOV + (r22)<<D16A + RI<<S16A ' reg <- addrl16
 word I16A_ADDS + (r22)<<D16A + (r19)<<S16A ' ADDI/P (2)
 ...
 word I16A_CMPI + (r0)<<D16A + (3)<<S16A
 alignl_p1
 long I32_BRNZ + (@C_sh4g1_69c22d1c__mkpath_L000006_23)<<S32 ' NEU4 reg coni
 word I16B_LODF + ((-72)&$1FF)<<S16B
 word I16A_MOV + (r2)<<D16A + RI<<S16A ' reg ARG ADDRLi
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
 alignl_p1
 ...
 word I16A_CMPI + (r15)<<D16A + (0)<<S16A
 alignl_p1
 long I32_BR_Z + (@C_sh4g1_69c22d1c__mkpath_L000006_24)<<S32 ' EQU4 reg coni
 word I16A_CMPI + (r15)<<D16A + (6)<<S16A
 alignl_p1
 long I32_BR_Z + (@C_sh4g1_69c22d1c__mkpath_L000006_24)<<S32 ' EQU4 reg coni
 word I16A_MOV + (r0)<<D16A + (r15)<<S16A ' CVI, CVU or LOAD
 ...
 long I32_JMPA + (@C_sh4g1_69c22d1c__mkpath_L000006_7)<<S32 ' JUMPV addrg
 alignl_label
C_sh4g1_69c22d1c__mkpath_L000006_23
 word I16B_LODF + ((-72)&$1FF)<<S16B
 word I16A_MOV + (r22)<<D16A + RI<<S16A ' reg <- addrl16
 word I16A_ADDS + (r22)<<D16A + (r19)<<S16A ' ADDI/P (2)
 word I16A_MOV + (r20)<<D16A + (r19)<<S16A ' ADDI/P
 ...
 word I16A_ADDSI + (r19)<<D16A + (1)<<S16A ' ADDI4 reg coni
 alignl_label
C_sh4g1_69c22d1c__mkpath_L000006_24
 alignl_label
C_sh4g1_69c22d1c__mkpath_L000006_17
 word I16A_CMPS + (r19)<<D16A + (r17)<<S16A
 alignl_p1
 long I32_BR_B + (@C_sh4g1_69c22d1c__mkpath_L000006_20)<<S32 ' LTI4 reg reg
 word I16A_MOVI + R0<<D16A + (0)<<S16A ' RET coni
 alignl_label
C_sh4g1_69c22d1c__mkpath_L000006_7
 word I16B_POPM + $180<<S16B ' restore registers, do not pop frame, do not return
 alignl_p1
...
C__mkdir ' <symbol:_mkdir>
 ...
 word I16B_CPREP + 33<<S16B ' arg size, rpsize = 8, spsize = 8
 alignl_p1
 long I32_CALA + (@C_sh4g1_69c22d1c__mkpath_L000006)<<S32
 word I16A_ADDI + SP<<D16A + 4<<S16A ' CALL addrg
 word I16A_MOV + (r22)<<D16A + (r0)<<S16A ' CVI, CVU or LOAD
