...
'
 ...
 alignl_label
C_sq8s_69c22cfb__seed_L000001 ' <symbol:_seed>
 alignl_p1
 long I32_PSHM + $400000<<S32 ' save registers
' loading argument C_sq8s_69c22cfb__seed_L000001_3_L000004 to PASM eliminated
'START PASM ... 
 word I16B_PASM
 alignl
...
' loading argument C_sq8s_69c22cfb__seed_L000001_5_L000006 to PASM eliminated
'START PASM ... 
getct r0
...
' C_sq8s_69c22cfb__seed_L000001_2 ' (symbol refcount = 0)
...
C_getrand ' <symbol:getrand>
 ...
 alignl_p1
 long I32_CALA + (@C_sq8s_69c22cfb__seed_L000001)<<S32 ' CALL addrg
 word I16A_MOV + (r22)<<D16A + (r0)<<S16A ' CVI, CVU or LOAD
