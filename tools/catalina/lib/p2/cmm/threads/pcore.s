...
DAT ' initialized data segment
 ...
 alignl_label
C_s20o_69c22cef_K_ernel_lock_L000004 ' <symbol:Kernel_lock>
 long -1

 alignl_label
C_s20o1_69c22cef_P_thread_L_ock_L000005 ' <symbol:Pthread_Lock>
 long -1

 alignl_label
C_s20o2_69c22cef_P_rintf_L_ock_L000006 ' <symbol:Printf_Lock>
 long -1

 alignl_label
C_s20o3_69c22cef_O_nce_L_ock_L000007 ' <symbol:Once_Lock>
 long -1

 alignl_label
C_s20o4_69c22cef_concurrency_L000008 ' <symbol:concurrency>
 long 0
...
DAT ' code segment
 ...
 alignl_label
C_s20o5_69c22cef__ensure_lock_L000009 ' <symbol:_ensure_lock>
 alignl_p1
 long I32_NEWF + 0<<S32
 alignl_p1
 ...
 alignl_p1
 long I32_BR_A + (@C_s20o5_69c22cef__ensure_lock_L000009_11)<<S32 ' GTI4 reg coni
 ...
 alignl_label
C_s20o5_69c22cef__ensure_lock_L000009_11
' C_s20o5_69c22cef__ensure_lock_L000009_10 ' (symbol refcount = 0)
...
C__pthread_init_lock_pool ' <symbol:_pthread_init_lock_pool>
 ...
 word I16A_MOV + (r23)<<D16A + (r2)<<S16A ' reg var <- reg arg
 alignl_p1
 long I32_LODI + (@C_s20o_69c22cef_K_ernel_lock_L000004)<<S32
 ...
 alignl_p1
 long I32_LODA + (@C_s20o_69c22cef_K_ernel_lock_L000004)<<S32
...
C__pthread_init_lock_pool_14
 ...
 alignl_p1
 long I32_LODI + (@C_s20o1_69c22cef_P_thread_L_ock_L000005)<<S32
 word I16A_MOV + (r22)<<D16A + RI<<S16A ' reg <- INDIRI4 addrg
 word I16A_NEGI + (r20)<<D16A + (-(-1)&$1F)<<S16A ' reg <- conn
 word I16A_CMPS + (r22)<<D16A + (r20)<<S16A
 alignl_p1
 ...
 long I32_CALA + (@C__locknew)<<S32 ' CALL addrg
 alignl_p1
 long I32_LODA + (@C_s20o1_69c22cef_P_thread_L_ock_L000005)<<S32
 word I16A_WRLONG + (r0)<<D16A + RI<<S16A ' ASGNI4 addrg reg
 alignl_p1
 long I32_LODI + (@C_s20o1_69c22cef_P_thread_L_ock_L000005)<<S32
 word I16A_MOV + (r2)<<D16A + RI<<S16A ' reg ARG INDIR ADDRG
...
C__pthread_init_lock_pool_16
 word I16B_LODL + (r2)<<D16B
 alignl_p1
 long @C_s20o2_69c22cef_P_rintf_L_ock_L000006 ' reg ARG ADDRG
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
 alignl_p1
 long I32_CALA + (@C_s20o5_69c22cef__ensure_lock_L000009)<<S32 ' CALL addrg
 word I16B_LODL + (r2)<<D16B
 alignl_p1
 long @C_s20o3_69c22cef_O_nce_L_ock_L000007 ' reg ARG ADDRG
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
 alignl_p1
 long I32_CALA + (@C_s20o5_69c22cef__ensure_lock_L000009)<<S32 ' CALL addrg
...
C_pthread_printf_26
 alignl_p1
 long I32_LODI + (@C_s20o2_69c22cef_P_rintf_L_ock_L000006)<<S32
 word I16A_MOV + (r2)<<D16A + RI<<S16A ' reg ARG INDIR ADDRG
...
' C_pthread_equal_56 ' (symbol refcount = 0)
 ...
 alignl_label
C_s20od_69c22cef_dummy_function_L000060 ' <symbol:dummy_function>
 alignl_p1
 ...
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl_p1
 long I32_BRNZ + (@C_s20od_69c22cef_dummy_function_L000060_62)<<S32 ' NEI4 reg coni
 word I16B_LODF + ((-8)&$1FF)<<S16B
 ...
 alignl_label
C_s20od_69c22cef_dummy_function_L000060_62
 word I16B_LODF + ((-8)&$1FF)<<S16B
 word I16A_RDLONG + (r0)<<D16A + RI<<S16A ' reg <- INDIRI4 addrl16
' C_s20od_69c22cef_dummy_function_L000060_61 ' (symbol refcount = 0)
...
C_pthread_create_70
 ...
 alignl_p1
 long @C_s20od_69c22cef_dummy_function_L000060 ' reg ARG ADDRG
...
C_pthread_create_64
 ...
 alignl_label
C_s20oe_69c22cef_foreman_L000075 ' <symbol:foreman>
 alignl_p1
 long I32_NEWF + 0<<S32
 alignl_p1
 ...
 long I32_CALA + (@C__thread_set_lock)<<S32 ' CALL addrg
 alignl_p1
 long I32_JMPA + (@C_s20oe_69c22cef_foreman_L000075_78)<<S32 ' JUMPV addrg
 alignl_label
C_s20oe_69c22cef_foreman_L000075_77
 alignl_p1
 ...
 long I32_CALA + (@C__thread_wait)<<S32 ' CALL addrg
 alignl_label
C_s20oe_69c22cef_foreman_L000075_78
 alignl_p1
 long I32_JMPA + (@C_s20oe_69c22cef_foreman_L000075_77)<<S32 ' JUMPV addrg
 word I16A_MOVI + R0<<D16A + (0)<<S16A ' RET coni
' C_s20oe_69c22cef_foreman_L000075_76 ' (symbol refcount = 0)
 word I16B_POPM + 0<<S16B ' restore registers, do pop frame, do return
 alignl_p1
...
C_pthread_createaffinity_81
 ...
 word I16B_LODL + (r5)<<D16B
 alignl_p1
 long @C_s20oe_69c22cef_foreman_L000075 ' reg ARG ADDRG
 word I16B_CPREP + 67<<S16B ' arg size, rpsize = 16, spsize = 16
 alignl_p1
...
C_pthread_once ' <symbol:pthread_once>
 ...
 long I32_CALA + (@C__pthread_init_lock_pool)<<S32 ' CALL addrg
 alignl_p1
 long I32_LODI + (@C_s20o3_69c22cef_O_nce_L_ock_L000007)<<S32
 word I16A_MOV + (r2)<<D16A + RI<<S16A ' reg ARG INDIR ADDRG
 word I16B_LODL + (r3)<<D16B
 alignl_p1
 long @C__P_thread_P_ool ' reg ARG ADDRG
...
C_pthread_setconcurrency ' <symbol:pthread_setconcurrency>
 alignl_p1
 long I32_LODA + (@C_s20o4_69c22cef_concurrency_L000008)<<S32
...
C_pthread_getconcurrency ' <symbol:pthread_getconcurrency>
 alignl_p1
 long I32_LODI + (@C_s20o4_69c22cef_concurrency_L000008)<<S32
