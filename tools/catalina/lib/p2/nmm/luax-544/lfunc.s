...
' C_luaF__initupvals_17 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_sa3s_664d7048_newupval_L000024 ' <symbol:newupval>
 calld PA,#NEWF
 sub SP, #4
 calld PA,#PSHM
 ...
 cmp r22,  #0 wz
 if_z jmp #\C_sa3s_664d7048_newupval_L000024_26 ' EQU4
 mov r22, r13
 adds r22, #16 ' ADDP4 coni
 mov r20, r15
 adds r20, #12 ' ADDP4 coni
 wrlong r20, r22 ' ASGNP4 reg reg
C_sa3s_664d7048_newupval_L000024_26
 ...
 cmp r22, r20 wz
 if_nz jmp #\C_sa3s_664d7048_newupval_L000024_28  ' NEU4
 mov r22, r23
 adds r22, #44 ' ADDP4 coni
 mov r20, r23
 adds r20, #16 ' ADDP4 coni
...
C_sa3s_664d7048_newupval_L000024_28
 mov r0, r15 ' CVI, CVU or LOAD
' C_sa3s_664d7048_newupval_L000024_25 ' (symbol refcount = 0)
 calld PA,#POPM ' restore registers
 add SP, #4 ' framesize
 calld PA,#RETF
...
C_luaF__findupval_36
 ...
 calld PA,#CALA
 long @C_sa3s_664d7048_newupval_L000024
...
C_luaF__findupval_30
 ...
 alignl ' align long
C_sa3s1_664d7048_callclosemethod_L000037 ' <symbol:callclosemethod>
 calld PA,#NEWF
 sub SP, #4
 calld PA,#PSHM
 ...
 wrlong r20, r22 ' ASGNP4 reg reg
 cmps r17,  #0 wz
 if_z jmp #\C_sa3s1_664d7048_callclosemethod_L000037_39 ' EQI4
 ...
 long @C_luaD__call
 add SP, #8 ' CALL addrg
 jmp #\@C_sa3s1_664d7048_callclosemethod_L000037_40 ' JUMPV addrg
C_sa3s1_664d7048_callclosemethod_L000037_39
 mov r2, #0 ' reg ARG coni
 mov r3, r15 ' CVI, CVU or LOAD
 mov r4, r23 ' CVI, CVU or LOAD
 mov BC, #12 ' arg size, rpsize = 12, spsize = 12
 ...
 add SP, #8 ' CALL addrg
C_sa3s1_664d7048_callclosemethod_L000037_40
' C_sa3s1_664d7048_callclosemethod_L000037_38 ' (symbol refcount = 0)
 calld PA,#POPM ' restore registers
 add SP, #4 ' framesize
 calld PA,#RETF
 ...
 alignl ' align long
C_sa3s2_664d7048_checkclosemth_L000041 ' <symbol:checkclosemth>
 calld PA,#NEWF
 sub SP, #12
 calld PA,#PSHM
 ...
 cmps r22,  #0 wz
 if_nz jmp #\C_sa3s2_664d7048_checkclosemth_L000041_43 ' NEI4
 mov r22, r21 ' CVI, CVU or LOAD
 mov r20, r23
 ...
 rdlong r22, r22 ' reg <- INDIRP4 reg
 cmp r22,  #0 wz
 if_nz jmp #\C_sa3s2_664d7048_checkclosemth_L000041_45  ' NEU4
 mov RI, ##@C_sa3s2_664d7048_checkclosemth_L000041_47_L000048
 mov BC, FP
 sub BC, #-(-12)
 wrlong RI, BC ' ASGNP4 addrli addrg
C_sa3s2_664d7048_checkclosemth_L000041_45
 mov RI, FP
 sub RI, #-(-12)
 rdlong r2, RI ' reg ARG INDIR ADDRLi
 mov r3, ##@C_sa3s2_664d7048_checkclosemth_L000041_49_L000050 ' reg ARG ADDRG
 mov r4, r23 ' CVI, CVU or LOAD
 mov BC, #12 ' arg size, rpsize = 12, spsize = 12
 sub SP, #8 ' stack space for reg ARGs
 calld PA,#CALA
 ...
 add SP, #8 ' CALL addrg
C_sa3s2_664d7048_checkclosemth_L000041_43
' C_sa3s2_664d7048_checkclosemth_L000041_42 ' (symbol refcount = 0)
 calld PA,#POPM ' restore registers
 add SP, #12 ' framesize
 calld PA,#RETF
 ...
 alignl ' align long
C_sa3s5_664d7048_prepcallclosemth_L000051 ' <symbol:prepcallclosemth>
 calld PA,#NEWF
 sub SP, #8
 calld PA,#PSHM
 ...
 mov r22, ##-1 ' reg <- con
 cmps r19, r22 wz
 if_nz jmp #\C_sa3s5_664d7048_prepcallclosemth_L000051_53 ' NEI4
 mov r22, r23
 adds r22, #16 ' ADDP4 coni
 rdlong r22, r22 ' reg <- INDIRP4 reg
 adds r22, #44 ' ADDP4 coni
 ...
 jmp #\@C_sa3s5_664d7048_prepcallclosemth_L000051_54 ' JUMPV addrg
C_sa3s5_664d7048_prepcallclosemth_L000051_53
 mov r22, r21
 adds r22, #8 ' ADDP4 coni
 mov RI, FP
 sub RI, #-(-12)
 ...
 add SP, #8 ' CALL addrg
C_sa3s5_664d7048_prepcallclosemth_L000051_54
 mov r2, r17 ' CVI, CVU or LOAD
 mov RI, FP
 sub RI, #-(-12)
 rdlong r3, RI ' reg ARG INDIR ADDRLi
 ...
 sub SP, #12 ' stack space for reg ARGs
 calld PA,#CALA
 long @C_sa3s1_664d7048_callclosemethod_L000037
 add SP, #12 ' CALL addrg
' C_sa3s5_664d7048_prepcallclosemth_L000051_52 ' (symbol refcount = 0)
 calld PA,#POPM ' restore registers
 add SP, #8 ' framesize
 calld PA,#RETF
...
C_luaF__newtbcupval_56
 ...
 calld PA,#CALA
 long @C_sa3s2_664d7048_checkclosemth_L000041
 add SP, #4 ' CALL addrg
...
' C_luaF__closeupval_65 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_sa3s6_664d7048_poptbclist_L000074 ' <symbol:poptbclist>
 calld PA,#PSHM
 ...
 jmp #\@C_sa3s6_664d7048_poptbclist_L000074_77 ' JUMPV addrg
C_sa3s6_664d7048_poptbclist_L000074_76
 mov r22, ##-524280 ' reg <- con
 adds r23, r22 ' ADDI/P (1)
C_sa3s6_664d7048_poptbclist_L000074_77
 mov r22, r23 ' CVI, CVU or LOAD
 mov r20, r2
 adds r20, #28 ' ADDP4 coni
 rdlong r20, r20 ' reg <- INDIRP4 reg
 cmp r22, r20 wcz 
 if_be jmp #\C_sa3s6_664d7048_poptbclist_L000074_79 ' LEU4
 mov r22, r23
 adds r22, #6 ' ADDP4 coni
 rdword r22, r22 ' reg <- CVUI4 INDIRU2 reg
 cmps r22,  #0 wz
 if_z jmp #\C_sa3s6_664d7048_poptbclist_L000074_76 ' EQI4
C_sa3s6_664d7048_poptbclist_L000074_79
 mov r22, r2
 adds r22, #36 ' ADDP4 coni
 wrlong r23, r22 ' ASGNP4 reg reg
' C_sa3s6_664d7048_poptbclist_L000074_75 ' (symbol refcount = 0)
 calld PA,#POPM ' restore registers
 calld PA,#RETN
...
C_luaF__close_81
 ...
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 calld PA,#CALA
 long @C_sa3s6_664d7048_poptbclist_L000074 ' CALL addrg
 mov r2, r17 ' CVI, CVU or LOAD
 mov r3, r19 ' CVI, CVU or LOAD
 ...
 sub SP, #12 ' stack space for reg ARGs
 calld PA,#CALA
 long @C_sa3s5_664d7048_prepcallclosemth_L000051
 add SP, #12 ' CALL addrg
 mov r22, r23
...
DAT ' const data segment
 ...
 alignl ' align long
C_sa3s2_664d7048_checkclosemth_L000041_49_L000050 ' <symbol:49>
 byte 118
 byte 97
 byte 114
 byte 105
 ...
 alignl ' align long
C_sa3s2_664d7048_checkclosemth_L000041_47_L000048 ' <symbol:47>
 byte 63
 byte 0
