...
C_hyper_readL_ong ' <symbol:hyper_readLong>
 ...
 mov r22, ##-1 ' reg <- con
 cmps r15, r22 wz
 if_nz jmp #\C_hyper_readL_ong_3 ' NEI4
 mov r0, ##-15 ' RET con
 jmp #\@C_hyper_readL_ong_2 ' JUMPV addrg
C_hyper_readL_ong_3
 mov BC, #0 ' arg size, rpsize = 0, spsize = 0
 calld PA,#CALA
 ...
 cmps r22,  #0 wcz
 if_ae jmp #\C_hyper_readL_ong_5 ' GEI4
 mov r0, ##-28 ' RET con
 jmp #\@C_hyper_readL_ong_2 ' JUMPV addrg
C_hyper_readL_ong_5
 mov r22, r17
...
' C_hyper_readL_ong_8 ' (symbol refcount = 0)
 cmps r19,  #0 wcz
 if_b jmp #\C_hyper_readL_ong_7 ' LTI4
 mov r22, r17
...
C_hyper_writeL_ong ' <symbol:hyper_writeLong>
 ...
 mov r22, ##-1 ' reg <- con
 cmps r15, r22 wz
 if_nz jmp #\C_hyper_writeL_ong_11 ' NEI4
 mov r0, ##-15 ' RET con
 jmp #\@C_hyper_writeL_ong_10 ' JUMPV addrg
C_hyper_writeL_ong_11
 ...
 rdlong r22, r17 ' reg <- INDIRI4 reg
 cmps r22,  #0 wcz
 if_ae jmp #\C_hyper_writeL_ong_13 ' GEI4
 mov r0, ##-28 ' RET con
 jmp #\@C_hyper_writeL_ong_10 ' JUMPV addrg
C_hyper_writeL_ong_13
 ...
 mov r22, r17
 adds r22, #4 ' ADDP4 coni
 rdlong r20, r23 ' reg <- INDIRU4 reg
 wrlong r20, r22 ' ASGNI4 reg reg
 mov r22, #14 ' reg <- coni
 shl r22, #28 ' LSHI4 coni
 mov r20, r21 ' CVI, CVU or LOAD
...
' C_hyper_writeL_ong_16 ' (symbol refcount = 0)
 cmps r19,  #0 wcz
 if_b jmp #\C_hyper_writeL_ong_15 ' LTI4
 neg r0, r19 ' NEGI4
