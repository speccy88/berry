...
C_hyper_fill ' <symbol:hyper_fill>
 ...
 mov r22, ##-1 ' reg <- con
 cmps r11, r22 wz
 if_nz jmp #\C_hyper_fill_3 ' NEI4
 mov r0, ##-15 ' RET con
 jmp #\@C_hyper_fill_2 ' JUMPV addrg
C_hyper_fill_3
 cmps r17,  #1 wz
 if_z jmp #\C_hyper_fill_7 ' EQI4
 cmps r17,  #2 wz
 if_z jmp #\C_hyper_fill_8 ' EQI4
 cmps r17,  #4 wz
 if_z jmp #\C_hyper_fill_9 ' EQI4
 jmp #\@C_hyper_fill_5 ' JUMPV addrg
C_hyper_fill_7
 mov r22, #12 ' reg <- coni
 ...
 jmp #\@C_hyper_fill_6 ' JUMPV addrg
C_hyper_fill_8
 mov r22, #13 ' reg <- coni
 shl r22, #28 ' LSHI4 coni
 mov RI, FP
...
C_hyper_fill_6
 cmps r21,  #0 wz
 if_nz jmp #\C_hyper_fill_10 ' NEI4
 mov r0, #0 ' reg <- coni
 jmp #\@C_hyper_fill_2 ' JUMPV addrg
C_hyper_fill_10
 mov BC, #0 ' arg size, rpsize = 0, spsize = 0
 ...
 cmps r22,  #0 wcz
 if_ae jmp #\C_hyper_fill_12 ' GEI4
 mov r0, ##-28 ' RET con
 jmp #\@C_hyper_fill_2 ' JUMPV addrg
C_hyper_fill_12
 mov r22, r13
