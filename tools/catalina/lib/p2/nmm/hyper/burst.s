...
C_hyper_read ' <symbol:hyper_read>
 ...
 mov r22, ##-1 ' reg <- con
 cmps r13, r22 wz
 if_nz jmp #\C_hyper_read_3 ' NEI4
 mov r0, ##-15 ' RET con
 jmp #\@C_hyper_read_2 ' JUMPV addrg
C_hyper_read_3
 cmps r19,  #0 wz
 if_nz jmp #\C_hyper_read_5 ' NEI4
 mov r0, #0 ' reg <- coni
 jmp #\@C_hyper_read_2 ' JUMPV addrg
C_hyper_read_5
 mov BC, #0 ' arg size, rpsize = 0, spsize = 0
...
C_hyper_write ' <symbol:hyper_write>
 ...
 mov r22, ##-1 ' reg <- con
 cmps r13, r22 wz
 if_nz jmp #\C_hyper_write_13 ' NEI4
 mov r0, ##-15 ' RET con
 jmp #\@C_hyper_write_12 ' JUMPV addrg
C_hyper_write_13
 cmps r19,  #0 wz
 if_nz jmp #\C_hyper_write_15 ' NEI4
 mov r0, #0 ' reg <- coni
 jmp #\@C_hyper_write_12 ' JUMPV addrg
C_hyper_write_15
 mov BC, #0 ' arg size, rpsize = 0, spsize = 0
 ...
 rdlong r22, r15 ' reg <- INDIRI4 reg
 cmps r22,  #0 wcz
 if_ae jmp #\C_hyper_write_17 ' GEI4
 mov r0, ##-28 ' RET con
 jmp #\@C_hyper_write_12 ' JUMPV addrg
C_hyper_write_17
 mov r22, r15
...
' C_hyper_write_20 ' (symbol refcount = 0)
 cmps r17,  #0 wcz
 if_b jmp #\C_hyper_write_19 ' LTI4
 neg r0, r17 ' NEGI4
C_hyper_write_12
 calld PA,#POPM ' restore registers
 calld PA,#RETF
