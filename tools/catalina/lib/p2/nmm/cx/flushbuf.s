...
'
 ...
 alignl ' align long
C_susk_69c22d99_do_write_L000003 ' <symbol:do_write>
 calld PA,#NEWF
 calld PA,#PSHM
 ...
 jmp #\@C_susk_69c22d99_do_write_L000003_6 ' JUMPV addrg
C_susk_69c22d99_do_write_L000003_5
 subs r19, r17 ' SUBI/P (1)
 adds r21, r17 ' ADDI/P (2)
C_susk_69c22d99_do_write_L000003_6
 ...
 cmps r0,  #0 wcz
 if_be jmp #\C_susk_69c22d99_do_write_L000003_8 ' LEI4
 cmps r17, r19 wcz
 if_b jmp #\C_susk_69c22d99_do_write_L000003_5 ' LTI4
C_susk_69c22d99_do_write_L000003_8
 cmps r17,  #0 wcz
 if_be jmp #\C_susk_69c22d99_do_write_L000003_10 ' LEI4
 mov r15, #1 ' reg <- coni
 jmp #\@C_susk_69c22d99_do_write_L000003_11 ' JUMPV addrg
C_susk_69c22d99_do_write_L000003_10
 mov r15, #0 ' reg <- coni
C_susk_69c22d99_do_write_L000003_11
 mov r0, r15 ' CVI, CVU or LOAD
' C_susk_69c22d99_do_write_L000003_4 ' (symbol refcount = 0)
 calld PA,#POPM ' restore registers
 calld PA,#RETF


 alignl ' align long
C_susk1_69c22d99_get_buf_L000012 ' <symbol:get_buf>
 calld PA,#NEWF
 calld PA,#PSHM
...
' C_susk1_69c22d99_get_buf_L000012_13 ' (symbol refcount = 0)
 calld PA,#POPM ' restore registers
 calld PA,#RETF
...
C___flushbuf_19
 ...
 calld PA,#CALA
 long @C_susk1_69c22d99_get_buf_L000012 ' CALL addrg
 mov r20, r21
...
C___flushbuf_47
 ...
 sub SP, #8 ' stack space for reg ARGs
 calld PA,#CALA
 long @C_susk_69c22d99_do_write_L000003
 add SP, #8 ' CALL addrg
 cmps r0,  #0 wz
 if_nz jmp #\C___flushbuf_43 ' NEI4
 mov r22, r21
