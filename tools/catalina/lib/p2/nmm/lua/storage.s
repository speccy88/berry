...
DAT ' initialized data segment
 ...
 alignl ' align long
C_s118s1_69c22d59_pstart_L000003 ' <symbol:pstart>
 long $0

 alignl ' align long
C_s118s2_69c22d59_storageI_nitialized_L000004 ' <symbol:storageInitialized>
 byte $0
...
C_mountF_atV_olume ' <symbol:mountFatVolume>
 ...
 mov r4, ##@C_s118s3_69c22d59_fatscratch_L000005 ' reg ARG ADDRG
...
C_mountF_atV_olume_7
 mov r22, ##@C_s118s3_69c22d59_fatscratch_L000005+450 ' reg <- addrg
...
C_mountF_atV_olume_19
 ...
 mov RI, ##@C_s118s3_69c22d59_fatscratch_L000005
 ...
 wrlong r0, ##@C_s118s1_69c22d59_pstart_L000003 ' ASGNU4 addrg reg
 jmp #\@C_mountF_atV_olume_10 ' JUMPV addrg
C_mountF_atV_olume_9
 mov r22, #0 ' reg <- coni
 wrlong r22, ##@C_s118s1_69c22d59_pstart_L000003 ' ASGNU4 addrg reg
 mov r0, #0 ' reg <- coni
 jmp #\@C_mountF_atV_olume_6 ' JUMPV addrg
C_mountF_atV_olume_10
 mov r22, ##@C_s118s1_69c22d59_pstart_L000003
...
C_mountF_atV_olume_20
 mov r2, ##@C_s118s_69c22d59_vi_L000002 ' reg ARG ADDRG
 mov r3, ##@C_s118s1_69c22d59_pstart_L000003
 rdlong r3, r3
 ' reg ARG INDIR ADDRG
 mov r4, ##@C_s118s3_69c22d59_fatscratch_L000005 ' reg ARG ADDRG
 mov r5, #0 ' reg ARG coni
...
C_mountF_atV_olume_22
 mov r22, #1 ' reg <- coni
 wrbyte r22, ##@C_s118s2_69c22d59_storageI_nitialized_L000004 ' ASGNU1 addrg reg
 mov r22, ##@C_s118s_69c22d59_vi_L000002+1 ' reg <- addrg
 rdbyte r22, r22 ' reg <- CVUI4 INDIRU1 reg
 cmps r22,  #0 wz
...
' C_buildfn_33 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_s118s5_69c22d59_upper_L000050 ' <symbol:upper>
 calld PA,#NEWF
 calld PA,#PSHM
 long $f00000 ' save registers
 mov r23, r3 ' reg var <- reg arg
 mov r21, r2 ' reg var <- reg arg
 jmp #\@C_s118s5_69c22d59_upper_L000050_53 ' JUMPV addrg
C_s118s5_69c22d59_upper_L000050_52
 mov r22, r23 ' CVI, CVU or LOAD
 mov r23, r22
 adds r23, #1 ' ADDP4 coni
 ...
 wrbyte r20, r22 ' ASGNU1 reg reg
C_s118s5_69c22d59_upper_L000050_53
 rdbyte r22, r21 ' reg <- CVUI4 INDIRU1 reg
 cmps r22,  #0 wz
 if_nz jmp #\C_s118s5_69c22d59_upper_L000050_52 ' NEI4
 mov r22, #0 ' reg <- coni
 wrbyte r22, r23 ' ASGNU1 reg reg
' C_s118s5_69c22d59_upper_L000050_51 ' (symbol refcount = 0)
 calld PA,#POPM ' restore registers
 calld PA,#RETF
...
C_doD_ir ' <symbol:doDir>
 ...
 calld PA,#CALA
 long @C_s118s5_69c22d59_upper_L000050
 add SP, #4 ' CALL addrg
 mov r22, ##@C_s118s2_69c22d59_storageI_nitialized_L000004 ' reg <- addrg
 rdbyte r22, r22 ' reg <- CVUI4 INDIRU1 reg
 cmps r22,  #0 wz
...
C_doD_ir_56
 ...
 mov r4, ##@C_s118s_69c22d59_vi_L000002 ' reg ARG ADDRG
 mov BC, #12 ' arg size, rpsize = 12, spsize = 12
 sub SP, #8 ' stack space for reg ARGs
 calld PA,#CALA
...
C_doD_ir_55
 ...
 alignl ' align long
C_s118s6_69c22d59_listF_ile_L000076 ' <symbol:listFile>
 calld PA,#NEWF
 calld PA,#PSHM
 ...
 mov r3, ##@C_s118s6_69c22d59_listF_ile_L000076_78_L000079 ' reg ARG ADDRG
 mov BC, #8 ' arg size, rpsize = 8, spsize = 8
 sub SP, #4 ' stack space for reg ARGs
 calld PA,#CALA
 long @C_printf
 add SP, #4 ' CALL addrg
' C_s118s6_69c22d59_listF_ile_L000076_77 ' (symbol refcount = 0)
 calld PA,#POPM ' restore registers
 calld PA,#RETF
...
C_listD_ir ' <symbol:listDir>
 ...
 mov r23, r3 ' reg var <- reg arg
 mov r21, r2 ' reg var <- reg arg
 mov r2, ##@C_s118s6_69c22d59_listF_ile_L000076 ' reg ARG ADDRG
...
C_listD_irS_tart_86
 ...
 long @C_memset
 add SP, #8 ' CALL addrg
 mov r22, ##@C_s118s3_69c22d59_fatscratch_L000005 ' reg <- addrg
 wrlong r22, ##@C_s118s8_69c22d59_sdi_L000081+8 ' ASGNP4 addrg reg
 mov r2, ##@C_s118s8_69c22d59_sdi_L000081 ' reg ARG ADDRG
 mov r3, r23 ' CVI, CVU or LOAD
 mov r4, ##@C_s118s_69c22d59_vi_L000002 ' reg ARG ADDRG
 mov BC, #12 ' arg size, rpsize = 12, spsize = 12
 sub SP, #8 ' stack space for reg ARGs
...
C_listD_irN_ext_92
 mov r22, ##@C_s118s9_69c22d59_sde_L000082 ' reg <- addrg
 rdbyte r22, r22 ' reg <- CVUI4 INDIRU1 reg
 cmps r22,  #0 wz
 if_z jmp #\C_listD_irN_ext_95 ' EQI4
 mov r2, ##@C_s118s9_69c22d59_sde_L000082 ' reg ARG ADDRG
 mov r3, ##@C_s118sb_69c22d59_fnam_L000084 ' reg ARG ADDRG
 mov BC, #8 ' arg size, rpsize = 8, spsize = 8
 sub SP, #4 ' stack space for reg ARGs
 calld PA,#CALA
 long @C_buildfn
 ...
 mov r2, ##@C_s118sb_69c22d59_fnam_L000084 ' reg ARG ADDRG
 mov r3, ##@C_listD_irN_ext_101_L000102 ' reg ARG ADDRG
 mov r4, ##@C_s118sa_69c22d59_snm_L000083 ' reg ARG ADDRG
 mov BC, #12 ' arg size, rpsize = 12, spsize = 12
 sub SP, #8 ' stack space for reg ARGs
 calld PA,#CALA
 long @C_sprintf
 add SP, #8 ' CALL addrg
 mov r0, ##@C_s118sa_69c22d59_snm_L000083 ' reg <- addrg
...
C_listD_irN_ext_93
 mov r2, ##@C_s118s9_69c22d59_sde_L000082 ' reg ARG ADDRG
 mov r3, ##@C_s118s8_69c22d59_sdi_L000081 ' reg ARG ADDRG
 mov r4, ##@C_s118s_69c22d59_vi_L000002 ' reg ARG ADDRG
 mov BC, #12 ' arg size, rpsize = 12, spsize = 12
 sub SP, #8 ' stack space for reg ARGs
 calld PA,#CALA
...
DAT ' uninitialized data segment
 ...
 alignl ' align long
C_s118sb_69c22d59_fnam_L000084 ' <symbol:fnam>
 byte 0[13]

 alignl ' align long
C_s118sa_69c22d59_snm_L000083 ' <symbol:snm>
 byte 0[13]

 alignl ' align long
C_s118s9_69c22d59_sde_L000082 ' <symbol:sde>
 byte 0[32]

 alignl ' align long
C_s118s8_69c22d59_sdi_L000081 ' <symbol:sdi>
 byte 0[16]

 alignl ' align long
C_s118s3_69c22d59_fatscratch_L000005 ' <symbol:fatscratch>
 byte 0[512]

 alignl ' align long
C_s118s_69c22d59_vi_L000002 ' <symbol:vi>
 byte 0[52]
...
C_listD_irN_ext_101_L000102 ' <symbol:101>
 ...
 alignl ' align long
C_s118s6_69c22d59_listF_ile_L000076_78_L000079 ' <symbol:78>
 byte 37
 byte 115
 byte 10
 byte 0
