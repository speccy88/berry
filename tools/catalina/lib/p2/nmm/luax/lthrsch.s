...
C_cond_no_active_lp ' <symbol:cond_no_active_lp>
 ...
 alignl ' align long
C_skds_69c22d58_workerls_L000005 ' <symbol:workerls>
 long $0
...
C_workermain ' <symbol:workermain>
 ...
 mov r3, ##@C_skds_69c22d58_workerls_L000005
 rdlong r3, r3
 ' reg ARG INDIR ADDRG
...
C_workermain_16
 ...
 long @C_lua_pushlightuserdata
 add SP, #4 ' CALL addrg
 mov r2, ##@C_skds_69c22d58_workerls_L000005
 rdlong r2, r2
 ' reg ARG INDIR ADDRG
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 calld PA,#CALA
...
C_workermain_17
 ...
 mov BC, #0 ' arg size, rpsize = 0, spsize = 0
 calld PA,#CALA
 long @C_skds1_69c22d58_sched_dec_lpcount_L000006 ' CALL addrg
...
' C_workermain_7 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_skds1_69c22d58_sched_dec_lpcount_L000006 ' <symbol:sched_dec_lpcount>
 calld PA,#NEWF
 calld PA,#PSHM
 ...
 rdlong r22, r22 ' reg <- INDIRI4 reg
 cmps r22,  #0 wz
 if_nz jmp #\C_skds1_69c22d58_sched_dec_lpcount_L000006_30 ' NEI4
 mov r2, ##@C_cond_no_active_lp ' reg ARG ADDRG
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 calld PA,#CALA
 long @C_pthread_cond_signal ' CALL addrg
C_skds1_69c22d58_sched_dec_lpcount_L000006_30
 mov r2, ##@C_mutex_lp_count ' reg ARG ADDRG
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 calld PA,#CALA
 long @C_pthread_mutex_unlock ' CALL addrg
' C_skds1_69c22d58_sched_dec_lpcount_L000006_29 ' (symbol refcount = 0)
 calld PA,#POPM ' restore registers
 calld PA,#RETF
...
C_sched_init ' <symbol:sched_init>
 ...
 wrlong r0, ##@C_skds_69c22d58_workerls_L000005 ' ASGNP4 addrg reg
 mov r22, #0 ' reg <- coni
 mov r2, r22 ' CVI, CVU or LOAD
 mov r3, r22 ' CVI, CVU or LOAD
 mov r4, ##@C_skds_69c22d58_workerls_L000005
 rdlong r4, r4
 ' reg ARG INDIR ADDRG
 mov BC, #12 ' arg size, rpsize = 12, spsize = 12
 sub SP, #8 ' stack space for reg ARGs
