...
C_m_bound_limits ' <symbol:m_bound_limits>
 ...
 wrlong r22, ##@C_s1mk_69c22d5c_m_min_L000002 ' ASGNI4 addrg reg
 wrlong r4, ##@C_s1mk1_69c22d5c_m_max_L000003 ' ASGNI4 addrg reg
 mov r22, FP
 add r22, #12 ' reg <- addrfi
 rdlong r22, r22 ' reg <- INDIRI4 reg
 wrlong r22, ##@C_s1mk_69c22d5c_m_min_L000002+4 ' ASGNI4 addrg reg
 wrlong r3, ##@C_s1mk1_69c22d5c_m_max_L000003+4 ' ASGNI4 addrg reg
 wrlong r5, ##@C_s1mk_69c22d5c_m_min_L000002+8 ' ASGNI4 addrg reg
 wrlong r2, ##@C_s1mk1_69c22d5c_m_max_L000003+8 ' ASGNI4 addrg reg
...
C_m_bound_scales ' <symbol:m_bound_scales>
 wrlong r4, ##@C_s1mk2_69c22d5c_m_div_L000004 ' ASGNI4 addrg reg
 wrlong r3, ##@C_s1mk2_69c22d5c_m_div_L000004+4 ' ASGNI4 addrg reg
 wrlong r2, ##@C_s1mk2_69c22d5c_m_div_L000004+8 ' ASGNI4 addrg reg
...
C_m_bound_preset_20
 ...
 mov r20, ##@C_s1mk2_69c22d5c_m_div_L000004 ' reg <- addrg
 ...
 mov r22, r17
 shl r22, #2 ' LSHI4 coni
 mov r20, ##@C_s1mk3_69c22d5c_m_acc_L000005 ' reg <- addrg
 adds r20, r22 ' ADDI/P (2)
 mov r18, FP
 sub r18, #-(-16) ' reg <- addrli
 adds r18, r22 ' ADDI/P (2)
 rdlong r18, r18 ' reg <- INDIRI4 reg
 mov r16, ##@C_s1mk_69c22d5c_m_min_L000002 ' reg <- addrg
...
C_m_limit_25
 ...
 mov r18, ##@C_s1mk1_69c22d5c_m_max_L000003 ' reg <- addrg
 adds r18, r22 ' ADDI/P (2)
 rdlong r18, r18 ' reg <- INDIRI4 reg
 mov r16, ##@C_s1mk_69c22d5c_m_min_L000002 ' reg <- addrg
 adds r22, r16 ' ADDI/P (1)
...
C_m_bound_31
 ...
 mov r18, ##@C_s1mk_69c22d5c_m_min_L000002 ' reg <- addrg
 adds r18, r20 ' ADDI/P (2)
 rdlong r18, r18 ' reg <- INDIRI4 reg
 mov r16, ##@C_s1mk3_69c22d5c_m_acc_L000005 ' reg <- addrg
...
DAT ' uninitialized data segment
 ...
 alignl ' align long
C_s1mk3_69c22d5c_m_acc_L000005 ' <symbol:m_acc>
 byte 0[12]

 alignl ' align long
C_s1mk2_69c22d5c_m_div_L000004 ' <symbol:m_div>
 byte 0[12]

 alignl ' align long
C_s1mk1_69c22d5c_m_max_L000003 ' <symbol:m_max>
 byte 0[12]

 alignl ' align long
C_s1mk_69c22d5c_m_min_L000002 ' <symbol:m_min>
 byte 0[12]
