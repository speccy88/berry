...
' C__set_service_lock_4 ' (symbol refcount = 0)
 ...
 cmps r19,  #16 wcz
 if_b jmp #\C__set_service_lock_3 ' LTI4
 mov r21, #1 ' reg <- coni
C__set_service_lock_7
 ...
 cmps r17,  #0 wcz
 if_be jmp #\C__set_service_lock_11 ' LEI4
 mov BC, #0 ' arg size, rpsize = 0, spsize = 0
 calld PA,#CALA
 long @C__registry ' CALL addrg
 neg r20, r21 ' NEGI4
 ...
 cmps r11,  #16 wcz
 if_b jmp #\C__set_service_lock_13 ' LTI4
 mov BC, #0 ' arg size, rpsize = 0, spsize = 0
 calld PA,#CALA
 long @C__registry ' CALL addrg
 neg r20, r21 ' NEGI4
 ...
 mov r20, ##-1 ' reg <- con
 cmps r22, r20 wz
 if_nz jmp #\C__set_service_lock_15 ' NEI4
 cmps r23,  #0 wcz
 if_b jmp #\C__set_service_lock_17 ' LTI4
 mov r22, r13
 shl r22, #2 ' LSHI4 coni
 mov r20, FP
 sub r20, #-(-68) ' reg <- addrli
 ...
 jmp #\@C__set_service_lock_18 ' JUMPV addrg
C__set_service_lock_17
 ...
 mov r20, ##-1 ' reg <- con
 cmps r22, r20 wz
 if_nz jmp #\C__set_service_lock_19 ' NEI4
 mov r0, ##-1 ' RET con
 jmp #\@C__set_service_lock_2 ' JUMPV addrg
...
' C__set_service_lock_8 ' (symbol refcount = 0)
 ...
 cmps r21,  #96 wcz
 if_be jmp #\C__set_service_lock_7 ' LEI4
 mov r0, #0 ' reg <- coni
