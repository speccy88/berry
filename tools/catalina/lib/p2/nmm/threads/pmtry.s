...
C_pthread_mutex_trylock_3
 ...
 mov r20, ##-1 ' reg <- con
 cmps r22, r20 wz
 if_nz jmp #\C_pthread_mutex_trylock_5 ' NEI4
 mov r22, #12 ' reg <- coni
 wrlong r22, ##@C_errno ' ASGNI4 addrg reg
 mov r0, r22 ' CVI, CVU or LOAD
 jmp #\@C_pthread_mutex_trylock_2 ' JUMPV addrg
C_pthread_mutex_trylock_5
 ...
 cmp r22,  #0 wz
 if_z jmp #\C_pthread_mutex_trylock_9 ' EQU4
 mov r22, #16 ' reg <- coni
 wrlong r22, ##@C_errno ' ASGNI4 addrg reg
 mov r0, r22 ' CVI, CVU or LOAD
 jmp #\@C_pthread_mutex_trylock_2 ' JUMPV addrg
C_pthread_mutex_trylock_9
 ...
 cmp r20, r22 wz
 if_nz jmp #\C_pthread_mutex_trylock_11  ' NEU4
 mov r22, #35 ' reg <- coni
 wrlong r22, ##@C_errno ' ASGNI4 addrg reg
 mov r0, r22 ' CVI, CVU or LOAD
 jmp #\@C_pthread_mutex_trylock_2 ' JUMPV addrg
...
C_pthread_mutex_trylock_7
 ...
 rdlong r22, r23 ' reg <- INDIRI4 reg
 cmps r22,  #2 wz
 if_nz jmp #\C_pthread_mutex_trylock_13 ' NEI4
 mov r22, r23
 adds r22, #4 ' ADDP4 coni
 rdlong r22, r22 ' reg <- INDIRP4 reg
 cmp r22,  #0 wz
 if_nz jmp #\C_pthread_mutex_trylock_15  ' NEU4
 mov r22, r23
 adds r22, #12 ' ADDP4 coni
 ...
 cmps r19,  #0 wz
 if_z jmp #\C_pthread_mutex_trylock_17 ' EQI4
 mov r22, r23
 adds r22, #4 ' ADDP4 coni
...
C_pthread_mutex_trylock_15
 ...
 cmp r22, r20 wz
 if_nz jmp #\C_pthread_mutex_trylock_19  ' NEU4
 mov r22, r23
 adds r22, #8 ' ADDP4 coni
 rdlong r22, r22 ' reg <- INDIRU4 reg
 mov r20, ##$7fffffff ' reg <- con
 cmp r22, r20 wcz 
 if_ae jmp #\C_pthread_mutex_trylock_21 ' GEU4
 mov r22, r23
 adds r22, #8 ' ADDP4 coni
 rdlong r20, r22 ' reg <- INDIRU4 reg
 add r20, #1 ' ADDU4 coni
 wrlong r20, r22 ' ASGNU4 reg reg
 jmp #\@C_pthread_mutex_trylock_20 ' JUMPV addrg
...
C_pthread_mutex_trylock_13
 ...
 mov r19, r0 ' CVI, CVU or LOAD
 cmps r19,  #0 wz
 if_z jmp #\C_pthread_mutex_trylock_23 ' EQI4
 mov r22, r23
 adds r22, #4 ' ADDP4 coni
 rdlong r22, r22 ' reg <- INDIRP4 reg
 mov r20, r21 ' CVI, CVU or LOAD
 cmp r22, r20 wz
 if_nz jmp #\C_pthread_mutex_trylock_25  ' NEU4
 mov r22, #16 ' reg <- coni
 wrlong r22, ##@C_errno ' ASGNI4 addrg reg
 mov r0, r22 ' CVI, CVU or LOAD
 jmp #\@C_pthread_mutex_trylock_2 ' JUMPV addrg
