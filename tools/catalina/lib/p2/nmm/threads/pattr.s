...
C_pthread_attr_init ' <symbol:pthread_attr_init>
 ...
 cmp r22,  #0 wz
 if_nz jmp #\C_pthread_attr_init_3  ' NEU4
 mov r22, #22 ' reg <- coni
 wrlong r22, ##@C_errno ' ASGNI4 addrg reg
 mov r0, r22 ' CVI, CVU or LOAD
 jmp #\@C_pthread_attr_init_2 ' JUMPV addrg
...
C_pthread_attr_destroy ' <symbol:pthread_attr_destroy>
 ...
 cmp r22,  #0 wz
 if_nz jmp #\C_pthread_attr_destroy_6  ' NEU4
 mov r22, #22 ' reg <- coni
 wrlong r22, ##@C_errno ' ASGNI4 addrg reg
 mov r0, r22 ' CVI, CVU or LOAD
 jmp #\@C_pthread_attr_destroy_5 ' JUMPV addrg
...
C_pthread_attr_setstack ' <symbol:pthread_attr_setstack>
 ...
 cmp r22,  #0 wz
 if_nz jmp #\C_pthread_attr_setstack_10  ' NEU4
 mov r22, #22 ' reg <- coni
 wrlong r22, ##@C_errno ' ASGNI4 addrg reg
 mov r0, r22 ' CVI, CVU or LOAD
 jmp #\@C_pthread_attr_setstack_9 ' JUMPV addrg
...
C_pthread_attr_getstack ' <symbol:pthread_attr_getstack>
 ...
 mov r22, r4 ' CVI, CVU or LOAD
 cmp r22,  #0 wz
 if_nz jmp #\C_pthread_attr_getstack_13  ' NEU4
 mov r22, #22 ' reg <- coni
 wrlong r22, ##@C_errno ' ASGNI4 addrg reg
 mov r0, r22 ' CVI, CVU or LOAD
 jmp #\@C_pthread_attr_getstack_12 ' JUMPV addrg
...
C_pthread_attr_setstacksize ' <symbol:pthread_attr_setstacksize>
 ...
 cmp r22,  #0 wz
 if_nz jmp #\C_pthread_attr_setstacksize_16  ' NEU4
 mov r22, #22 ' reg <- coni
 wrlong r22, ##@C_errno ' ASGNI4 addrg reg
 mov r0, r22 ' CVI, CVU or LOAD
 jmp #\@C_pthread_attr_setstacksize_15 ' JUMPV addrg
...
C_pthread_attr_getstacksize ' <symbol:pthread_attr_getstacksize>
 ...
 mov r22, r3 ' CVI, CVU or LOAD
 cmp r22,  #0 wz
 if_nz jmp #\C_pthread_attr_getstacksize_19  ' NEU4
 mov r22, #22 ' reg <- coni
 wrlong r22, ##@C_errno ' ASGNI4 addrg reg
 mov r0, r22 ' CVI, CVU or LOAD
 jmp #\@C_pthread_attr_getstacksize_18 ' JUMPV addrg
...
C_pthread_attr_setguardsize ' <symbol:pthread_attr_setguardsize>
 ...
 mov r22, r3 ' CVI, CVU or LOAD
 cmp r22,  #0 wz
 if_nz jmp #\C_pthread_attr_setguardsize_22  ' NEU4
 mov r22, #22 ' reg <- coni
 wrlong r22, ##@C_errno ' ASGNI4 addrg reg
 mov r0, r22 ' CVI, CVU or LOAD
 jmp #\@C_pthread_attr_setguardsize_21 ' JUMPV addrg
...
C_pthread_attr_getguardsize ' <symbol:pthread_attr_getguardsize>
 ...
 cmp r20, r22 wz
 if_z jmp #\C_pthread_attr_getguardsize_27 ' EQU4
 mov r20, r2 ' CVI, CVU or LOAD
 cmp r20, r22 wz
 if_nz jmp #\C_pthread_attr_getguardsize_25  ' NEU4
C_pthread_attr_getguardsize_27
 mov r22, #22 ' reg <- coni
 wrlong r22, ##@C_errno ' ASGNI4 addrg reg
 mov r0, r22 ' CVI, CVU or LOAD
 jmp #\@C_pthread_attr_getguardsize_24 ' JUMPV addrg
...
C_pthread_attr_setdetachstate ' <symbol:pthread_attr_setdetachstate>
 ...
 mov r22, r3 ' CVI, CVU or LOAD
 cmp r22,  #0 wz
 if_z jmp #\C_pthread_attr_setdetachstate_31 ' EQU4
 cmps r2,  #1 wz
 if_z jmp #\C_pthread_attr_setdetachstate_29 ' EQI4
 cmps r2,  #0 wz
 if_z jmp #\C_pthread_attr_setdetachstate_29 ' EQI4
C_pthread_attr_setdetachstate_31
 ...
 wrlong r22, ##@C_errno ' ASGNI4 addrg reg
 mov r0, r22 ' CVI, CVU or LOAD
 jmp #\@C_pthread_attr_setdetachstate_28 ' JUMPV addrg
...
C_pthread_attr_getdetachstate ' <symbol:pthread_attr_getdetachstate>
 ...
 mov r20, r3 ' CVI, CVU or LOAD
 cmp r20, r22 wz
 if_z jmp #\C_pthread_attr_getdetachstate_35 ' EQU4
 mov r20, r2 ' CVI, CVU or LOAD
 cmp r20, r22 wz
 if_nz jmp #\C_pthread_attr_getdetachstate_33  ' NEU4
C_pthread_attr_getdetachstate_35
 mov r22, #22 ' reg <- coni
 wrlong r22, ##@C_errno ' ASGNI4 addrg reg
 mov r0, r22 ' CVI, CVU or LOAD
 jmp #\@C_pthread_attr_getdetachstate_32 ' JUMPV addrg
...
C_pthread_attr_setscope ' <symbol:pthread_attr_setscope>
 ...
 mov r22, r3 ' CVI, CVU or LOAD
 cmp r22,  #0 wz
 if_z jmp #\C_pthread_attr_setscope_39 ' EQU4
 cmps r2,  #1 wz
 if_z jmp #\C_pthread_attr_setscope_37 ' EQI4
 cmps r2,  #0 wz
 if_z jmp #\C_pthread_attr_setscope_37 ' EQI4
C_pthread_attr_setscope_39
 ...
 wrlong r22, ##@C_errno ' ASGNI4 addrg reg
 mov r0, r22 ' CVI, CVU or LOAD
 jmp #\@C_pthread_attr_setscope_36 ' JUMPV addrg
...
C_pthread_attr_getscope ' <symbol:pthread_attr_getscope>
 ...
 mov r20, r3 ' CVI, CVU or LOAD
 cmp r20, r22 wz
 if_z jmp #\C_pthread_attr_getscope_43 ' EQU4
 mov r20, r2 ' CVI, CVU or LOAD
 cmp r20, r22 wz
 if_nz jmp #\C_pthread_attr_getscope_41  ' NEU4
C_pthread_attr_getscope_43
 mov r22, #22 ' reg <- coni
 wrlong r22, ##@C_errno ' ASGNI4 addrg reg
 mov r0, r22 ' CVI, CVU or LOAD
 jmp #\@C_pthread_attr_getscope_40 ' JUMPV addrg
...
C_pthread_attr_setschedpolicy ' <symbol:pthread_attr_setschedpolicy>
 ...
 mov r22, r3 ' CVI, CVU or LOAD
 cmp r22,  #0 wz
 if_z jmp #\C_pthread_attr_setschedpolicy_47 ' EQU4
 cmps r2,  #0 wz
 if_z jmp #\C_pthread_attr_setschedpolicy_45 ' EQI4
C_pthread_attr_setschedpolicy_47
 mov r22, #22 ' reg <- coni
 wrlong r22, ##@C_errno ' ASGNI4 addrg reg
 mov r0, r22 ' CVI, CVU or LOAD
 jmp #\@C_pthread_attr_setschedpolicy_44 ' JUMPV addrg
...
C_pthread_attr_getschedpolicy ' <symbol:pthread_attr_getschedpolicy>
 ...
 mov r20, r3 ' CVI, CVU or LOAD
 cmp r20, r22 wz
 if_z jmp #\C_pthread_attr_getschedpolicy_51 ' EQU4
 mov r20, r2 ' CVI, CVU or LOAD
 cmp r20, r22 wz
 if_nz jmp #\C_pthread_attr_getschedpolicy_49  ' NEU4
C_pthread_attr_getschedpolicy_51
 mov r22, #22 ' reg <- coni
 wrlong r22, ##@C_errno ' ASGNI4 addrg reg
 mov r0, r22 ' CVI, CVU or LOAD
 jmp #\@C_pthread_attr_getschedpolicy_48 ' JUMPV addrg
...
C_pthread_attr_setschedparam ' <symbol:pthread_attr_setschedparam>
 ...
 mov r20, r3 ' CVI, CVU or LOAD
 cmp r20, r22 wz
 if_z jmp #\C_pthread_attr_setschedparam_56 ' EQU4
 mov r20, r2 ' CVI, CVU or LOAD
 cmp r20, r22 wz
 if_z jmp #\C_pthread_attr_setschedparam_56 ' EQU4
 rdlong r22, r2 ' reg <- INDIRI4 reg
 cmps r22,  #1 wcz
 if_ae jmp #\C_pthread_attr_setschedparam_53 ' GEI4
C_pthread_attr_setschedparam_56
 mov r22, #22 ' reg <- coni
 wrlong r22, ##@C_errno ' ASGNI4 addrg reg
 mov r0, r22 ' CVI, CVU or LOAD
 jmp #\@C_pthread_attr_setschedparam_52 ' JUMPV addrg
...
C_pthread_attr_getschedparam ' <symbol:pthread_attr_getschedparam>
 ...
 mov r20, r3 ' CVI, CVU or LOAD
 cmp r20, r22 wz
 if_z jmp #\C_pthread_attr_getschedparam_60 ' EQU4
 mov r20, r2 ' CVI, CVU or LOAD
 cmp r20, r22 wz
 if_nz jmp #\C_pthread_attr_getschedparam_58  ' NEU4
C_pthread_attr_getschedparam_60
 mov r22, #22 ' reg <- coni
 wrlong r22, ##@C_errno ' ASGNI4 addrg reg
 mov r0, r22 ' CVI, CVU or LOAD
 jmp #\@C_pthread_attr_getschedparam_57 ' JUMPV addrg
...
C_pthread_setschedparam ' <symbol:pthread_setschedparam>
 ...
 cmp r20, r22 wz
 if_z jmp #\C_pthread_setschedparam_65 ' EQU4
 mov r20, r19 ' CVI, CVU or LOAD
 cmp r20, r22 wz
 if_z jmp #\C_pthread_setschedparam_65 ' EQU4
 rdlong r22, r19 ' reg <- INDIRI4 reg
 cmps r22,  #1 wcz
 if_ae jmp #\C_pthread_setschedparam_62 ' GEI4
C_pthread_setschedparam_65
 mov r22, #22 ' reg <- coni
 wrlong r22, ##@C_errno ' ASGNI4 addrg reg
 mov r0, r22 ' CVI, CVU or LOAD
 jmp #\@C_pthread_setschedparam_61 ' JUMPV addrg
...
C_pthread_getschedparam ' <symbol:pthread_getschedparam>
 ...
 mov r20, r23 ' CVI, CVU or LOAD
 cmp r20, r22 wz
 if_z jmp #\C_pthread_getschedparam_69 ' EQU4
 mov r20, r19 ' CVI, CVU or LOAD
 cmp r20, r22 wz
 if_nz jmp #\C_pthread_getschedparam_67  ' NEU4
C_pthread_getschedparam_69
 mov r22, #22 ' reg <- coni
 wrlong r22, ##@C_errno ' ASGNI4 addrg reg
 mov r0, r22 ' CVI, CVU or LOAD
 jmp #\@C_pthread_getschedparam_66 ' JUMPV addrg
