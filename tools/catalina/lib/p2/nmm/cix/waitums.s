...
'
 ...
 alignl ' align long
C_su087_69c22d81_recalculate_L000008 ' <symbol:recalculate>
 calld PA,#NEWF
 calld PA,#PSHM
 long $fc0000 ' save registers
 mov r23, r2 ' reg var <- reg arg
 wrlong r23, ##@C_su08_69c22d81_old_freq_L000001 ' ASGNU4 addrg reg
 ...
 getqx r0
  ...
  allowi
 #endif
 wrlong r0, ##@C_su081_69c22d81_cnt_usec_L000002 ' ASGNU4 addrg reg
 ...
 getqx r0
  ...
  allowi
 #endif
 wrlong r0, ##@C_su082_69c22d81_cnt_msec_L000003 ' ASGNU4 addrg reg
 mov r2, #0 ' reg ARG coni
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 calld PA,#CALA
 long @C__wait ' CALL addrg
 wrlong r0, ##@C_su083_69c22d81_min_tick_L000004 ' ASGNU4 addrg reg
 ...
 mov r22, ##@C_su086_69c22d81_overhead_L000007 ' reg <- addrg
 mov r20, r19 ' SUBU
 sub r20, r21 ' SUBU (3)
 mov r18, ##@C_su083_69c22d81_min_tick_L000004
 rdlong r18, r18 ' reg <- INDIRU4 addrg
 sub r20, r18 ' SUBU (1)
 wrlong r20, ##@C_su086_69c22d81_overhead_L000007 ' ASGNU4 addrg reg
 rdlong r22, r22 ' reg <- INDIRU4 reg
 cmp r22,  #100 wcz 
 if_be jmp #\C_su087_69c22d81_recalculate_L000008_10 ' LEU4
 mov r22, ##@C_su086_69c22d81_overhead_L000007 ' reg <- addrg
 rdlong r22, r22 ' reg <- INDIRU4 reg
 sub r22, #100 ' SUBU4 coni
 wrlong r22, ##@C_su086_69c22d81_overhead_L000007 ' ASGNU4 addrg reg
C_su087_69c22d81_recalculate_L000008_10
 mov r22, ##@C_su086_69c22d81_overhead_L000007
 rdlong r22, r22 ' reg <- INDIRU4 addrg
 mov r20, ##@C_su081_69c22d81_cnt_usec_L000002
 ...
 getqx r0
  ...
  allowi
 #endif
 wrlong r0, ##@C_su084_69c22d81_min_usec_L000005 ' ASGNU4 addrg reg
 mov r20, ##@C_su082_69c22d81_cnt_msec_L000003
 rdlong r20, r20 ' reg <- INDIRU4 addrg
 add r22, r20 ' ADDU (1)
 ...
 getqx r0
  ...
  allowi
 #endif
 wrlong r0, ##@C_su085_69c22d81_min_msec_L000006 ' ASGNU4 addrg reg
' C_su087_69c22d81_recalculate_L000008_9 ' (symbol refcount = 0)
...
C_min_waitus ' <symbol:min_waitus>
 ...
 mov r22, ##@C_su08_69c22d81_old_freq_L000001
 rdlong r22, r22 ' reg <- INDIRU4 addrg
 cmp r23, r22 wz
 ...
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 calld PA,#CALA
 long @C_su087_69c22d81_recalculate_L000008 ' CALL addrg
C_min_waitus_13
 mov r0, ##@C_su084_69c22d81_min_usec_L000005
...
C_min_waitms ' <symbol:min_waitms>
 ...
 long @C_su087_69c22d81_recalculate_L000008 ' CALL addrg
C_min_waitms_16
 mov r0, ##@C_su085_69c22d81_min_msec_L000006
 rdlong r0, r0 ' reg <- INDIRU4 addrg
...
C_min_wait ' <symbol:min_wait>
 ...
 long @C_su087_69c22d81_recalculate_L000008 ' CALL addrg
C_min_wait_19
 mov r0, ##@C_su083_69c22d81_min_tick_L000004
 rdlong r0, r0 ' reg <- INDIRU4 addrg
...
C__iwaitus ' <symbol:_iwaitus>
 ...
 long @C_su087_69c22d81_recalculate_L000008 ' CALL addrg
C__iwaitus_28
 mov r22, ##@C_su084_69c22d81_min_usec_L000005
 rdlong r22, r22 ' reg <- INDIRU4 addrg
 cmp r23, r22 wcz 
...
C__iwaitus_31
 mov r19, ##@C_su084_69c22d81_min_usec_L000005
 rdlong r19, r19 ' reg <- INDIRU4 addrg
C__iwaitus_32
 mov r2, r19 ' CVI, CVU or LOAD
 mov r3, ##@C_su081_69c22d81_cnt_usec_L000002
 rdlong r3, r3
 ' reg ARG INDIR ADDRG
...
C__iwaitms ' <symbol:_iwaitms>
 ...
 long @C_su087_69c22d81_recalculate_L000008 ' CALL addrg
C__iwaitms_34
 mov r22, ##@C_su085_69c22d81_min_msec_L000006
 rdlong r22, r22 ' reg <- INDIRU4 addrg
 cmp r23, r22 wcz 
...
C__iwaitms_37
 mov r19, ##@C_su085_69c22d81_min_msec_L000006
 rdlong r19, r19 ' reg <- INDIRU4 addrg
C__iwaitms_38
 mov r2, r19 ' CVI, CVU or LOAD
 mov r3, ##@C_su082_69c22d81_cnt_msec_L000003
 rdlong r3, r3
 ' reg ARG INDIR ADDRG
 mov BC, #8 ' arg size, rpsize = 8, spsize = 8
 sub SP, #4 ' stack space for reg ARGs
...
C__waitus ' <symbol:_waitus>
 ...
 long @C_su087_69c22d81_recalculate_L000008 ' CALL addrg
C__waitus_43
 mov r22, ##@C_su081_69c22d81_cnt_usec_L000002
 rdlong r22, r22 ' reg <- INDIRU4 addrg
 #ifndef NO_INTERRUPTS
  stalli
 #endif
 ...
 mov r20, ##@C_su086_69c22d81_overhead_L000007
 rdlong r20, r20 ' reg <- INDIRU4 addrg
 cmp r22, r20 wcz 
...
C__waitus_47
 mov r22, ##@C_su083_69c22d81_min_tick_L000004
 rdlong r22, r22 ' reg <- INDIRU4 addrg
 mov r2, r21 ' SUBU
 sub r2, r22 ' SUBU (3)
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
...
C__waitus_48
 ...
 mov r22, r19 ' CVI, CVU or LOAD
 mov r20, ##@C_su083_69c22d81_min_tick_L000004
 rdlong r20, r20 ' reg <- INDIRU4 addrg
 cmp r22, r20 wcz 
...
C__waitus_50
 ...
 mov r2, ##@C_su083_69c22d81_min_tick_L000004
 rdlong r2, r2
 ' reg ARG INDIR ADDRG
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 calld PA,#CALA
...
C__waitms ' <symbol:_waitms>
 ...
 long @C_su087_69c22d81_recalculate_L000008 ' CALL addrg
C__waitms_57
 mov r22, ##@C_su082_69c22d81_cnt_msec_L000003
 rdlong r22, r22 ' reg <- INDIRU4 addrg
 #ifndef NO_INTERRUPTS
  stalli
 #endif
...
DAT ' uninitialized data segment
 ...
 alignl ' align long
C_su086_69c22d81_overhead_L000007 ' <symbol:overhead>
 byte 0[4]

 alignl ' align long
C_su085_69c22d81_min_msec_L000006 ' <symbol:min_msec>
 byte 0[4]

 alignl ' align long
C_su084_69c22d81_min_usec_L000005 ' <symbol:min_usec>
 byte 0[4]

 alignl ' align long
C_su083_69c22d81_min_tick_L000004 ' <symbol:min_tick>
 byte 0[4]

 alignl ' align long
C_su082_69c22d81_cnt_msec_L000003 ' <symbol:cnt_msec>
 byte 0[4]

 alignl ' align long
C_su081_69c22d81_cnt_usec_L000002 ' <symbol:cnt_usec>
 byte 0[4]

 alignl ' align long
C_su08_69c22d81_old_freq_L000001 ' <symbol:old_freq>
 byte 0[4]
