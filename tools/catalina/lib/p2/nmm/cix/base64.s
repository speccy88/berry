...
DAT ' const data segment
 ...
 alignl ' align long
C_svt4_69c22d81_cb64_L000003 ' <symbol:cb64>
 byte 65
 byte 66
 byte 67
 byte 68
 ...
 alignl ' align long
C_svt41_69c22d81_cd64_L000004 ' <symbol:cd64>
 byte 124
 byte 36
 byte 36
 byte 36
...
DAT ' code segment
 ...
 alignl ' align long
C_svt42_69c22d81_encodeblock_L000005 ' <symbol:encodeblock>
 calld PA,#PSHM
 long $f50000 ' save registers
 rdbyte r22, r4 ' reg <- CVUI4 INDIRU1 reg
 sar r22, #2 ' RSHI4 coni
 mov r20, ##@C_svt4_69c22d81_cb64_L000003 ' reg <- addrg
 ...
 mov r22, RI ' RSHI (2)
 or r22, r18 ' BORI/U (2)
 mov r18, ##@C_svt4_69c22d81_cb64_L000003 ' reg <- addrg
 adds r22, r18 ' ADDI/P (1)
 rdbyte r22, r22 ' reg <- INDIRU1 reg
 wrbyte r22, r20 ' ASGNU1 reg reg
 cmps r2,  #1 wcz
 if_be jmp #\C_svt42_69c22d81_encodeblock_L000005_8 ' LEI4
 mov r22, r4
 ...
 jmp #\@C_svt42_69c22d81_encodeblock_L000005_9 ' JUMPV addrg
C_svt42_69c22d81_encodeblock_L000005_8
 mov r23, #61 ' reg <- coni
C_svt42_69c22d81_encodeblock_L000005_9
 mov r22, r3
 adds r22, #2 ' ADDP4 coni
 mov r20, r23 ' CVI, CVU or LOAD
 wrbyte r20, r22 ' ASGNU1 reg reg
 cmps r2,  #2 wcz
 if_be jmp #\C_svt42_69c22d81_encodeblock_L000005_11 ' LEI4
 mov r22, r4
 adds r22, #2 ' ADDP4 coni
 rdbyte r22, r22 ' reg <- CVUI4 INDIRU1 reg
 ...
 jmp #\@C_svt42_69c22d81_encodeblock_L000005_12 ' JUMPV addrg
C_svt42_69c22d81_encodeblock_L000005_11
 mov r21, #61 ' reg <- coni
C_svt42_69c22d81_encodeblock_L000005_12
 mov r22, r3
 adds r22, #3 ' ADDP4 coni
 mov r20, r21 ' CVI, CVU or LOAD
 wrbyte r20, r22 ' ASGNU1 reg reg
' C_svt42_69c22d81_encodeblock_L000005_6 ' (symbol refcount = 0)
...
' C_encode_buff_22 ' (symbol refcount = 0)
 ...
 calld PA,#CALA
 long @C_svt42_69c22d81_encodeblock_L000005
 add SP, #8 ' CALL addrg
 mov r15, #0 ' reg <- coni
C_encode_buff_29
 cmps r11, r19 wcz
...
' C_encode_buff_13 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_svt43_69c22d81_decodeblock_L000040 ' <symbol:decodeblock>
 calld PA,#PSHM
 ...
 or r20, r18 ' BORI/U (1)
 wrbyte r20, r22 ' ASGNU1 reg reg
' C_svt43_69c22d81_decodeblock_L000040_41 ' (symbol refcount = 0)
 calld PA,#POPM ' restore registers
 calld PA,#RETN
...
C_decode_buff_57
 mov r22, ##@C_svt41_69c22d81_cd64_L000004-43 ' reg <- addrg
 adds r22, r15 ' ADDI/P (2)
 rdbyte r22, r22 ' reg <- CVUI4 INDIRU1 reg
 mov RI, FP
 sub RI, #-(-16)
...
C_decode_buff_70
 ...
 calld PA,#CALA
 long @C_svt43_69c22d81_decodeblock_L000040
 add SP, #4 ' CALL addrg
 mov r11, #0 ' reg <- coni
