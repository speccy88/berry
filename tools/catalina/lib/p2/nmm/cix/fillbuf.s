...
C___fillbuf_14
 ...
 cmps r22,  #0 wz
 if_nz jmp #\C___fillbuf_16 ' NEI4
 mov r22, r23
 adds r22, #16 ' ADDP4 coni
 rdlong r22, r22 ' reg <- INDIRP4 reg
 cmp r22,  #0 wz
 if_nz jmp #\C___fillbuf_16  ' NEU4
 ...
 rdlong r22, r22 ' reg <- INDIRP4 reg
 cmp r22,  #0 wz
 if_nz jmp #\C___fillbuf_18  ' NEU4
 mov r22, r23
 adds r22, #8 ' ADDP4 coni
 rdlong r20, r22 ' reg <- INDIRI4 reg
 or r20, #4 ' BORI4 coni
 wrlong r20, r22 ' ASGNI4 reg reg
 jmp #\@C___fillbuf_19 ' JUMPV addrg
C___fillbuf_18
 mov r22, r23
 adds r22, #8 ' ADDP4 coni
 rdlong r20, r22 ' reg <- INDIRI4 reg
...
C___fillbuf_20
 ...
 cmp r20,  #0 wz
 if_z jmp #\C___fillbuf_24 ' EQU4
 adds r22, #8 ' ADDP4 coni
 rdlong r22, r22 ' reg <- INDIRI4 reg
 and r22, #64 ' BANDI4 coni
 cmps r22,  #0 wz
 if_z jmp #\C___fillbuf_24 ' EQI4
 mov r22, r21
 shl r22, #2 ' LSHI4 coni
 mov r20, ##@C___iotab ' reg <- addrg
 adds r22, r20 ' ADDI/P (1)
...
' C___fillbuf_21 ' (symbol refcount = 0)
 ...
 cmps r21,  #64 wcz
 if_b jmp #\C___fillbuf_20 ' LTI4
 mov r22, r23
 adds r22, #16 ' ADDP4 coni
 rdlong r22, r22 ' reg <- INDIRP4 reg
 cmp r22,  #0 wz
 if_nz jmp #\C___fillbuf_28  ' NEU4
 mov r22, r23
 adds r22, #16 ' ADDP4 coni
 mov r20, r23
...
C___fillbuf_28
 ...
 cmps r22,  #0 wcz
 if_a jmp #\C___fillbuf_30 ' GTI4
 rdlong r22, r23 ' reg <- INDIRI4 reg
 cmps r22,  #0 wz
 if_nz jmp #\C___fillbuf_32 ' NEI4
 mov r22, r23
 adds r22, #8 ' ADDP4 coni
 rdlong r20, r22 ' reg <- INDIRI4 reg
 or r20, #16 ' BORI4 coni
 wrlong r20, r22 ' ASGNI4 reg reg
 jmp #\@C___fillbuf_33 ' JUMPV addrg
C___fillbuf_32
 mov r22, r23
 adds r22, #8 ' ADDP4 coni
 rdlong r20, r22 ' reg <- INDIRI4 reg
