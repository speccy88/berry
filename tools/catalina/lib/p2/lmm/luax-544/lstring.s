...
' C_luaS__hashlongstr_22 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_s32g_664d6d32_tablerehash_L000025 ' <symbol:tablerehash>
 jmp #PSHM
 long $fa0000 ' save registers
 mov r23, r3 ' CVI, CVU or LOAD
 jmp #JMPA
 long @C_s32g_664d6d32_tablerehash_L000025_30 ' JUMPV addrg
C_s32g_664d6d32_tablerehash_L000025_27
 mov r22, r23
...
' C_s32g_664d6d32_tablerehash_L000025_28 ' (symbol refcount = 0)
 adds r23, #1 ' ADDI4 coni
C_s32g_664d6d32_tablerehash_L000025_30
 cmps r23, r2 wcz
 jmp #BR_B
 long @C_s32g_664d6d32_tablerehash_L000025_27 ' LTI4
 mov r23, #0 ' reg <- coni
 jmp #JMPA
 long @C_s32g_664d6d32_tablerehash_L000025_34 ' JUMPV addrg
C_s32g_664d6d32_tablerehash_L000025_31
 mov r22, r23
 shl r22, #2 ' LSHI4 coni
 adds r22, r4 ' ADDI/P (1)
 ...
 wrlong r20, r22 ' ASGNP4 reg reg
 jmp #JMPA
 long @C_s32g_664d6d32_tablerehash_L000025_36 ' JUMPV addrg
C_s32g_664d6d32_tablerehash_L000025_35
 mov r22, r21
 adds r22, #12 ' ADDP4 coni
...
C_s32g_664d6d32_tablerehash_L000025_36
 mov r22, r21 ' CVI, CVU or LOAD
 cmp r22,  #0 wz
 jmp #BRNZ
 long @C_s32g_664d6d32_tablerehash_L000025_35 ' NEU4
' C_s32g_664d6d32_tablerehash_L000025_32 ' (symbol refcount = 0)
 adds r23, #1 ' ADDI4 coni
C_s32g_664d6d32_tablerehash_L000025_34
 cmps r23, r3 wcz
 jmp #BR_B
 long @C_s32g_664d6d32_tablerehash_L000025_31 ' LTI4
' C_s32g_664d6d32_tablerehash_L000025_26 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 jmp #RETN
...
C_luaS__resize ' <symbol:luaS_resize>
 ...
 sub SP, #8 ' stack space for reg ARGs
 jmp #CALA
 long @C_s32g_664d6d32_tablerehash_L000025
 add SP, #8 ' CALL addrg
C_luaS__resize_39
 mov r22, r21 ' CVI, CVU or LOAD
 mov r2, r22
...
' C_luaS__init_58 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_s32g2_664d6d32_createstrobj_L000069 ' <symbol:createstrobj>
 jmp #NEWF
 sub SP, #8
 jmp #PSHM
...
' C_s32g2_664d6d32_createstrobj_L000069_70 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 add SP, #8 ' framesize
 jmp #RETF
...
C_luaS__createlngstrobj ' <symbol:luaS_createlngstrobj>
 ...
 sub SP, #12 ' stack space for reg ARGs
 jmp #CALA
 long @C_s32g2_664d6d32_createstrobj_L000069
 add SP, #12 ' CALL addrg
...
' C_luaS__remove_72 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_s32g3_664d6d32_growstrtab_L000076 ' <symbol:growstrtab>
 jmp #NEWF
 jmp #PSHM
 long $f00000 ' save registers
 mov r23, r3 ' reg var <- reg arg
 ...
 cmps r22, r20 wz
 jmp #BRNZ
 long @C_s32g3_664d6d32_growstrtab_L000076_78 ' NEI4
 ...
 cmps r22, r20 wz
 jmp #BRNZ
 long @C_s32g3_664d6d32_growstrtab_L000076_80 ' NEI4
 ...
 long @C_luaD__throw
 add SP, #4 ' CALL addrg
C_s32g3_664d6d32_growstrtab_L000076_80
C_s32g3_664d6d32_growstrtab_L000076_78
 mov r22, r21
 adds r22, #8 ' ADDP4 coni
 rdlong r22, r22 ' reg <- INDIRI4 reg
 jmp #LODL
 ...
 cmps r22, r20 wcz
 jmp #BR_A
 long @C_s32g3_664d6d32_growstrtab_L000076_82 ' GTI4
 mov r22, r21
 adds r22, #8 ' ADDP4 coni
 rdlong r22, r22 ' reg <- INDIRI4 reg
 mov r2, r22
 ...
 long @C_luaS__resize
 add SP, #4 ' CALL addrg
C_s32g3_664d6d32_growstrtab_L000076_82
' C_s32g3_664d6d32_growstrtab_L000076_77 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 jmp #RETF


 alignl ' align long
C_s32g4_664d6d32_internshrstr_L000084 ' <symbol:internshrstr>
 jmp #NEWF
 jmp #PSHM
 ...
 jmp #JMPA
 long @C_s32g4_664d6d32_internshrstr_L000084_89 ' JUMPV addrg
C_s32g4_664d6d32_internshrstr_L000084_86
 mov r22, r17
 ...
 cmp r19, r22 wz
 jmp #BRNZ
 long @C_s32g4_664d6d32_internshrstr_L000084_90 ' NEU4
 mov r22, #1 ' reg <- coni
 mov r0, r22 ' setup r0/r1 (2)
 ...
 cmps r0,  #0 wz
 jmp #BRNZ
 long @C_s32g4_664d6d32_internshrstr_L000084_90 ' NEI4
 mov r22, r17
 adds r22, #5 ' ADDP4 coni
 rdbyte r22, r22 ' reg <- INDIRU1 reg
 and r22, cviu_m1 ' zero extend
 ...
 cmps r22,  #0 wz
 jmp #BR_Z
 long @C_s32g4_664d6d32_internshrstr_L000084_92 ' EQI4
 mov r22, r17
 adds r22, #5 ' ADDP4 coni
 ...
 xor r20, #24 ' BXORI4 coni
 wrbyte r20, r22 ' ASGNU1 reg reg
C_s32g4_664d6d32_internshrstr_L000084_92
 mov r0, r17 ' CVI, CVU or LOAD
 jmp #JMPA
 long @C_s32g4_664d6d32_internshrstr_L000084_85 ' JUMPV addrg
C_s32g4_664d6d32_internshrstr_L000084_90
' C_s32g4_664d6d32_internshrstr_L000084_87 ' (symbol refcount = 0)
 mov r22, r17
 adds r22, #12 ' ADDP4 coni
 rdlong r17, r22 ' reg <- INDIRP4 reg
C_s32g4_664d6d32_internshrstr_L000084_89
 mov r22, r17 ' CVI, CVU or LOAD
 cmp r22,  #0 wz
 jmp #BRNZ
 long @C_s32g4_664d6d32_internshrstr_L000084_86 ' NEU4
 mov r22, r13
 adds r22, #4 ' ADDP4 coni
 rdlong r22, r22 ' reg <- INDIRI4 reg
 mov r20, r13
 ...
 cmps r22, r20 wcz
 jmp #BR_B
 long @C_s32g4_664d6d32_internshrstr_L000084_94 ' LTI4
 mov r2, r13 ' CVI, CVU or LOAD
 mov r3, r23 ' CVI, CVU or LOAD
 mov BC, #8 ' arg size, rpsize = 8, spsize = 8
 sub SP, #4 ' stack space for reg ARGs
 jmp #CALA
 long @C_s32g3_664d6d32_growstrtab_L000076
 add SP, #4 ' CALL addrg
 mov r22, r13
 adds r22, #8 ' ADDP4 coni
 rdlong r22, r22 ' reg <- INDIRI4 reg
 ...
 mov r11, r22 ' ADDI/P
 adds r11, r20 ' ADDI/P (3)
C_s32g4_664d6d32_internshrstr_L000084_94
 ...
 wrlong r20, r22 ' ASGNI4 reg reg
 mov r0, r17 ' CVI, CVU or LOAD
C_s32g4_664d6d32_internshrstr_L000084_85
 jmp #POPM ' restore registers
 jmp #RETF
...
C_luaS__newlstr ' <symbol:luaS_newlstr>
 ...
 sub SP, #8 ' stack space for reg ARGs
 jmp #CALA
 long @C_s32g4_664d6d32_internshrstr_L000084
 add SP, #8 ' CALL addrg
 mov r22, r0 ' CVI, CVU or LOAD
 jmp #JMPA
