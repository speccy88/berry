...
' C_luaM__free__29 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_suik2_69c22b61_tryagain_L000030 ' <symbol:tryagain>
 jmp #NEWF
 jmp #PSHM
 long $fa8000 ' save registers
 mov r23, r5 ' reg var <- reg arg
 ...
 cmps r20, r22 wz
 jmp #BRNZ
 long @C_suik2_69c22b61_tryagain_L000030_32 ' NEI4
 mov r20, r15
 ...
 mov r22, r0 ' CVI, CVU or LOAD
 jmp #JMPA
 long @C_suik2_69c22b61_tryagain_L000030_31 ' JUMPV addrg
C_suik2_69c22b61_tryagain_L000030_32
 jmp #LODL
 long 0
 mov r0, RI ' reg <- con
C_suik2_69c22b61_tryagain_L000030_31
 jmp #POPM ' restore registers
 jmp #RETF
...
C_luaM__realloc_ ' <symbol:luaM_realloc_>
 ...
 sub SP, #12 ' stack space for reg ARGs
 jmp #CALA
 long @C_suik2_69c22b61_tryagain_L000030
 add SP, #12 ' CALL addrg
 mov r13, r0 ' CVI, CVU or LOAD
