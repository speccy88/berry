...
C_hyper_readL_ong ' <symbol:hyper_readLong>
 ...
 cmps r15, r22 wz
 jmp #BRNZ
 long @C_hyper_readL_ong_3 ' NEI4
 jmp #LODL
 long -15
 mov r0, RI ' reg <- con
 jmp #JMPA
 long @C_hyper_readL_ong_2 ' JUMPV addrg
C_hyper_readL_ong_3
 mov BC, #0 ' arg size, rpsize = 0, spsize = 0
 jmp #CALA
...
C_hyper_writeL_ong ' <symbol:hyper_writeLong>
 ...
 cmps r15, r22 wz
 jmp #BRNZ
 long @C_hyper_writeL_ong_11 ' NEI4
 jmp #LODL
 long -15
 mov r0, RI ' reg <- con
 jmp #JMPA
 long @C_hyper_writeL_ong_10 ' JUMPV addrg
C_hyper_writeL_ong_11
 ...
 cmps r22,  #0 wcz
 jmp #BRAE
 long @C_hyper_writeL_ong_13 ' GEI4
 jmp #LODL
 long -28
 mov r0, RI ' reg <- con
 jmp #JMPA
...
' C_hyper_writeL_ong_16 ' (symbol refcount = 0)
 cmps r19,  #0 wcz
 jmp #BR_B
 long @C_hyper_writeL_ong_15 ' LTI4
 neg r0, r19 ' NEGI4
