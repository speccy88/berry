...
' C_luaF__initupvals_19 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_ssts_69c22b60_newupval_L000026 ' <symbol:newupval>
 jmp #NEWF
 sub SP, #4
 jmp #PSHM
 long $fa8000 ' save registers
 ...
 cmp r22,  #0 wz
 jmp #BR_Z
 long @C_ssts_69c22b60_newupval_L000026_28 ' EQU4
 mov r22, r15
 adds r22, #16 ' ADDP4 coni
 mov r20, r17
 adds r20, #12 ' ADDP4 coni
 wrlong r20, r22 ' ASGNP4 reg reg
C_ssts_69c22b60_newupval_L000026_28
 ...
 cmp r22, r20 wz
 jmp #BRNZ
 long @C_ssts_69c22b60_newupval_L000026_30 ' NEU4
 mov r22, r23
 adds r22, #44 ' ADDP4 coni
 mov r20, r23
 adds r20, #16 ' ADDP4 coni
...
C_ssts_69c22b60_newupval_L000026_30
 mov r0, r17 ' CVI, CVU or LOAD
' C_ssts_69c22b60_newupval_L000026_27 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 add SP, #4 ' framesize
 jmp #RETF
...
C_luaF__findupval_38
 ...
 sub SP, #8 ' stack space for reg ARGs
 jmp #CALA
 long @C_ssts_69c22b60_newupval_L000026
 add SP, #8 ' CALL addrg
...
C_luaF__findupval_32
 ...
 alignl ' align long
C_ssts1_69c22b60_callclosemethod_L000039 ' <symbol:callclosemethod>
 jmp #NEWF
 sub SP, #4
 jmp #PSHM
 ...
 cmps r17,  #0 wz
 jmp #BR_Z
 long @C_ssts1_69c22b60_callclosemethod_L000039_41 ' EQI4
 ...
 add SP, #8 ' CALL addrg
 jmp #JMPA
 long @C_ssts1_69c22b60_callclosemethod_L000039_42 ' JUMPV addrg
C_ssts1_69c22b60_callclosemethod_L000039_41
 mov r2, #0 ' reg ARG coni
 mov r3, r15 ' CVI, CVU or LOAD
 mov r4, r23 ' CVI, CVU or LOAD
 mov BC, #12 ' arg size, rpsize = 12, spsize = 12
 ...
 add SP, #8 ' CALL addrg
C_ssts1_69c22b60_callclosemethod_L000039_42
' C_ssts1_69c22b60_callclosemethod_L000039_40 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 add SP, #4 ' framesize
 jmp #RETF
 ...
 alignl ' align long
C_ssts2_69c22b60_checkclosemth_L000043 ' <symbol:checkclosemth>
 jmp #NEWF
 sub SP, #12
 jmp #PSHM
 ...
 cmps r22,  #0 wz
 jmp #BRNZ
 long @C_ssts2_69c22b60_checkclosemth_L000043_45 ' NEI4
 mov r22, r21 ' CVI, CVU or LOAD
 mov r20, r23
 ...
 cmp r22,  #0 wz
 jmp #BRNZ
 long @C_ssts2_69c22b60_checkclosemth_L000043_47 ' NEU4
 jmp #LODL
 long @C_ssts2_69c22b60_checkclosemth_L000043_49_L000050
 mov BC, FP
 sub BC, #-(-12)
 wrlong RI, BC ' ASGNP4 addrli addrg
C_ssts2_69c22b60_checkclosemth_L000043_47
 mov RI, FP
 sub RI, #-(-12)
 rdlong r2, RI ' reg ARG INDIR ADDRLi
 jmp #LODL
 long @C_ssts2_69c22b60_checkclosemth_L000043_51_L000052
 ...
 add SP, #8 ' CALL addrg
C_ssts2_69c22b60_checkclosemth_L000043_45
' C_ssts2_69c22b60_checkclosemth_L000043_44 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 add SP, #12 ' framesize
 jmp #RETF
 ...
 alignl ' align long
C_ssts5_69c22b60_prepcallclosemth_L000053 ' <symbol:prepcallclosemth>
 jmp #NEWF
 sub SP, #8
 jmp #PSHM
 ...
 cmps r19, r22 wz
 jmp #BRNZ
 long @C_ssts5_69c22b60_prepcallclosemth_L000053_55 ' NEI4
 mov r22, r23
 adds r22, #16 ' ADDP4 coni
 rdlong r22, r22 ' reg <- INDIRP4 reg
 adds r22, #44 ' ADDP4 coni
 ...
 jmp #JMPA
 long @C_ssts5_69c22b60_prepcallclosemth_L000053_56 ' JUMPV addrg
C_ssts5_69c22b60_prepcallclosemth_L000053_55
 mov r22, r21
 adds r22, #8 ' ADDP4 coni
 jmp #LODF
 long -12
 ...
 add SP, #8 ' CALL addrg
C_ssts5_69c22b60_prepcallclosemth_L000053_56
 mov r2, r17 ' CVI, CVU or LOAD
 mov RI, FP
 sub RI, #-(-12)
 rdlong r3, RI ' reg ARG INDIR ADDRLi
 ...
 sub SP, #12 ' stack space for reg ARGs
 jmp #CALA
 long @C_ssts1_69c22b60_callclosemethod_L000039
 add SP, #12 ' CALL addrg
' C_ssts5_69c22b60_prepcallclosemth_L000053_54 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 add SP, #8 ' framesize
 jmp #RETF
...
C_luaF__newtbcupval_58
 ...
 jmp #CALA
 long @C_ssts2_69c22b60_checkclosemth_L000043
 add SP, #4 ' CALL addrg
 jmp #JMPA
...
' C_luaF__closeupval_67 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_ssts6_69c22b60_poptbclist_L000078 ' <symbol:poptbclist>
 jmp #PSHM
 ...
 jmp #JMPA
 long @C_ssts6_69c22b60_poptbclist_L000078_81 ' JUMPV addrg
C_ssts6_69c22b60_poptbclist_L000078_80
 jmp #LODL
 long -524280
 mov r22, RI ' reg <- con
 adds r23, r22 ' ADDI/P (1)
C_ssts6_69c22b60_poptbclist_L000078_81
 ...
 cmp r22, r20 wcz 
 jmp #BRBE
 long @C_ssts6_69c22b60_poptbclist_L000078_83 ' LEU4
 mov r22, r23
 adds r22, #6 ' ADDP4 coni
 rdword r22, r22 ' reg <- INDIRU2 reg
 and r22, cviu_m2 ' zero extend
 cmps r22,  #0 wz
 jmp #BR_Z
 long @C_ssts6_69c22b60_poptbclist_L000078_80 ' EQI4
C_ssts6_69c22b60_poptbclist_L000078_83
 mov r22, r2
 adds r22, #36 ' ADDP4 coni
 wrlong r23, r22 ' ASGNP4 reg reg
' C_ssts6_69c22b60_poptbclist_L000078_79 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 jmp #RETN
...
C_luaF__close_85
 ...
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 jmp #CALA
 long @C_ssts6_69c22b60_poptbclist_L000078 ' CALL addrg
 mov r2, r17 ' CVI, CVU or LOAD
 mov r3, r19 ' CVI, CVU or LOAD
 ...
 sub SP, #12 ' stack space for reg ARGs
 jmp #CALA
 long @C_ssts5_69c22b60_prepcallclosemth_L000053
 add SP, #12 ' CALL addrg
 mov r22, r23
...
DAT ' const data segment
 ...
 alignl ' align long
C_ssts2_69c22b60_checkclosemth_L000043_51_L000052 ' <symbol:51>
 byte 118
 byte 97
 byte 114
 byte 105
 ...
 alignl ' align long
C_ssts2_69c22b60_checkclosemth_L000043_49_L000050 ' <symbol:49>
 byte 63
 byte 0
