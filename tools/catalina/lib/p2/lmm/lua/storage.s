...
DAT ' initialized data segment
 ...
 alignl ' align long
C_sluc1_69c22b62_pstart_L000003 ' <symbol:pstart>
 long $0

 alignl ' align long
C_sluc2_69c22b62_storageI_nitialized_L000004 ' <symbol:storageInitialized>
 byte $0
...
C_mountF_atV_olume ' <symbol:mountFatVolume>
 ...
 jmp #LODL
 long @C_sluc3_69c22b62_fatscratch_L000005
...
C_mountF_atV_olume_7
 jmp #LODL
 long @C_sluc3_69c22b62_fatscratch_L000005+450
...
C_mountF_atV_olume_19
 ...
 jmp #LODL
 long @C_sluc1_69c22b62_pstart_L000003
...
C_mountF_atV_olume_20
 jmp #LODL
 long @C_sluc_69c22b62_vi_L000002
...
C_mountF_atV_olume_22
 mov r22, #1 ' reg <- coni
 jmp #LODL
 long @C_sluc2_69c22b62_storageI_nitialized_L000004
 wrbyte r22, RI ' ASGNU1 addrg reg
 jmp #LODL
 long @C_sluc_69c22b62_vi_L000002+1
 rdbyte r22, RI ' reg <- INDIRU1 addrg
 and r22, cviu_m1 ' zero extend
 cmps r22,  #0 wz
 jmp #BRNZ
...
' C_buildfn_33 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_sluc5_69c22b62_upper_L000050 ' <symbol:upper>
 jmp #NEWF
 jmp #PSHM
 ...
 mov r21, r2 ' reg var <- reg arg
 jmp #JMPA
 long @C_sluc5_69c22b62_upper_L000050_53 ' JUMPV addrg
C_sluc5_69c22b62_upper_L000050_52
 mov r22, r23 ' CVI, CVU or LOAD
 mov r23, r22
 adds r23, #1 ' ADDP4 coni
 ...
 wrbyte r20, r22 ' ASGNU1 reg reg
C_sluc5_69c22b62_upper_L000050_53
 rdbyte r22, r21 ' reg <- INDIRU1 reg
 and r22, cviu_m1 ' zero extend
 cmps r22,  #0 wz
 jmp #BRNZ
 long @C_sluc5_69c22b62_upper_L000050_52 ' NEI4
 mov r22, #0 ' reg <- coni
 wrbyte r22, r23 ' ASGNU1 reg reg
' C_sluc5_69c22b62_upper_L000050_51 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 jmp #RETF
...
C_doD_ir ' <symbol:doDir>
 ...
 jmp #CALA
 long @C_sluc5_69c22b62_upper_L000050
 add SP, #4 ' CALL addrg
 jmp #LODL
 long @C_sluc2_69c22b62_storageI_nitialized_L000004
 rdbyte r22, RI ' reg <- INDIRU1 addrg
...
C_doD_ir_55
 ...
 alignl ' align long
C_sluc6_69c22b62_listF_ile_L000076 ' <symbol:listFile>
 jmp #NEWF
 jmp #PSHM
 ...
 jmp #LODL
 long @C_sluc6_69c22b62_listF_ile_L000076_78_L000079
 mov r3, RI ' reg ARG ADDRG
 mov BC, #8 ' arg size, rpsize = 8, spsize = 8
 sub SP, #4 ' stack space for reg ARGs
 jmp #CALA
 long @C_printf
 add SP, #4 ' CALL addrg
' C_sluc6_69c22b62_listF_ile_L000076_77 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 jmp #RETF
...
C_listD_ir ' <symbol:listDir>
 ...
 mov r21, r2 ' reg var <- reg arg
 jmp #LODL
 long @C_sluc6_69c22b62_listF_ile_L000076
 mov r2, RI ' reg ARG ADDRG
...
C_listD_irS_tart_86
 ...
 jmp #LODL
 long @C_sluc8_69c22b62_sdi_L000081+8
 wrlong r22, RI ' ASGNP4 addrg reg
 jmp #LODL
 long @C_sluc8_69c22b62_sdi_L000081
 mov r2, RI ' reg ARG ADDRG
 mov r3, r23 ' CVI, CVU or LOAD
 jmp #LODL
 long @C_sluc_69c22b62_vi_L000002
...
C_listD_irN_ext_92
 jmp #LODL
 long @C_sluc9_69c22b62_sde_L000082
 rdbyte r22, RI ' reg <- INDIRU1 addrg
 and r22, cviu_m1 ' zero extend
 cmps r22,  #0 wz
 jmp #BR_Z
 ...
 mov r2, RI ' reg ARG ADDRG
 jmp #LODL
 long @C_slucb_69c22b62_fnam_L000084
 mov r3, RI ' reg ARG ADDRG
 mov BC, #8 ' arg size, rpsize = 8, spsize = 8
 sub SP, #4 ' stack space for reg ARGs
 jmp #CALA
 ...
 mov r3, RI ' reg ARG ADDRG
 jmp #LODL
 long @C_sluca_69c22b62_snm_L000083
 mov r4, RI ' reg ARG ADDRG
 mov BC, #12 ' arg size, rpsize = 12, spsize = 12
 sub SP, #8 ' stack space for reg ARGs
 jmp #CALA
...
DAT ' uninitialized data segment
 ...
 alignl ' align long
C_slucb_69c22b62_fnam_L000084 ' <symbol:fnam>
 byte 0[13]

 alignl ' align long
C_sluca_69c22b62_snm_L000083 ' <symbol:snm>
 byte 0[13]

 alignl ' align long
C_sluc9_69c22b62_sde_L000082 ' <symbol:sde>
 byte 0[32]

 alignl ' align long
C_sluc8_69c22b62_sdi_L000081 ' <symbol:sdi>
 byte 0[16]

 alignl ' align long
C_sluc3_69c22b62_fatscratch_L000005 ' <symbol:fatscratch>
 byte 0[512]

 alignl ' align long
C_sluc_69c22b62_vi_L000002 ' <symbol:vi>
 byte 0[52]
...
C_listD_irN_ext_101_L000102 ' <symbol:101>
 ...
 alignl ' align long
C_sluc6_69c22b62_listF_ile_L000076_78_L000079 ' <symbol:78>
 byte 37
 byte 115
 byte 10
 byte 0
