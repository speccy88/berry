...
DAT ' initialized data segment
 ...
 alignl ' align long
C_s320_69c22b74_startupD_ata_L000002 ' <symbol:startupData>
 long $0

 alignl ' align long
C_s3201_69c22b74_deviceD_ata_L000003 ' <symbol:deviceData>
 long $0

 alignl ' align long
C_s3202_69c22b74_Q_osD_ata_L000004 ' <symbol:QosData>
 long $0

 alignl ' align long
C_s3203_69c22b74_mailboxes_L000005 ' <symbol:mailboxes>
 long $0

 alignl ' align long
C_s3204_69c22b74_drivercog_L000006 ' <symbol:drivercog>
 long -1

 alignl ' align long
C_s3205_69c22b74_driverlock_L000007 ' <symbol:driverlock>
 long -1

 alignl ' align long
C_s3206_69c22b74_delayT_able_L000008 ' <symbol:delayTable>
 long $7
 long $57bcf00
 long $8f0d180
 long $c474f80
...
C_psram_getM_ailbox ' <symbol:psram_getMailbox>
 ...
 jmp #LODI
 long @C_s3203_69c22b74_mailboxes_L000005
...
C_psram_initialize ' <symbol:psram_initialize>
 ...
 jmp #LODI
 long @C_s320_69c22b74_startupD_ata_L000002
 ...
 jmp #LODL
 long @C_s3204_69c22b74_drivercog_L000006
 ...
 jmp #LODL
 long @C_s3201_69c22b74_deviceD_ata_L000003
 ...
 jmp #LODL
 long @C_s3202_69c22b74_Q_osD_ata_L000004
 mov r22, RI ' reg <- addrg
 ...
 wrlong r22, RI ' ASGNP4 addrg reg
 jmp #LODL
 long @C_s3205_69c22b74_driverlock_L000007
 mov r22, RI ' reg <- addrg
 mov r20, r18
...
' C_psram_getD_riverL_ock_30 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_s3207_69c22b74_psram_modifyB_ankP_arams_L000031 ' <symbol:psram_modifyBankParams>
 jmp #NEWF
 jmp #PSHM
 ...
 cmps r22, r20 wz
 jmp #BRNZ
 long @C_s3207_69c22b74_psram_modifyB_ankP_arams_L000031_33 ' NEI4
 jmp #LODL
 long -15
 mov r0, RI ' reg <- con
 jmp #JMPA
 long @C_s3207_69c22b74_psram_modifyB_ankP_arams_L000031_32 ' JUMPV addrg
C_s3207_69c22b74_psram_modifyB_ankP_arams_L000031_33
 jmp #LODI
 long @C_s3204_69c22b74_drivercog_L000006
 mov r2, RI ' reg ARG INDIR ADDRG
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 ...
 jmp #JMPA
 long @C_s3207_69c22b74_psram_modifyB_ankP_arams_L000031_36 ' JUMPV addrg
C_s3207_69c22b74_psram_modifyB_ankP_arams_L000031_35
 mov r2, #1 ' reg ARG coni
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 jmp #CALA
 long @C__waitms ' CALL addrg
C_s3207_69c22b74_psram_modifyB_ankP_arams_L000031_36
 jmp #LODI
 long @C_s3205_69c22b74_driverlock_L000007
 mov r2, RI ' reg ARG INDIR ADDRG
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 ...
 cmps r0,  #0 wz
 jmp #BR_Z
 long @C_s3207_69c22b74_psram_modifyB_ankP_arams_L000031_35 ' EQI4
 mov r15, #0 ' reg <- coni
C_s3207_69c22b74_psram_modifyB_ankP_arams_L000031_38
 mov r22, r15
 shl r22, #2 ' LSHI4 coni
 jmp #LODI
 long @C_s3201_69c22b74_deviceD_ata_L000003
...
C_s3207_69c22b74_psram_modifyB_ankP_arams_L000031_42
 rdlong r19, r17 ' reg <- INDIRI4 reg
' C_s3207_69c22b74_psram_modifyB_ankP_arams_L000031_43 ' (symbol refcount = 0)
 cmps r19,  #0 wcz
 jmp #BR_B
 long @C_s3207_69c22b74_psram_modifyB_ankP_arams_L000031_42 ' LTI4
 cmps r19,  #0 wz
 jmp #BRNZ
 long @C_s3207_69c22b74_psram_modifyB_ankP_arams_L000031_45 ' NEI4
 mov r22, r15
 shl r22, #2 ' LSHI4 coni
 jmp #LODI
 long @C_s3201_69c22b74_deviceD_ata_L000003
 ...
 wrlong r13, r22 ' ASGNI4 reg reg
 jmp #JMPA
 long @C_s3207_69c22b74_psram_modifyB_ankP_arams_L000031_46 ' JUMPV addrg
C_s3207_69c22b74_psram_modifyB_ankP_arams_L000031_45
 neg r19, r19 ' NEGI4
 jmp #JMPA
 long @C_s3207_69c22b74_psram_modifyB_ankP_arams_L000031_40 ' JUMPV addrg
C_s3207_69c22b74_psram_modifyB_ankP_arams_L000031_46
' C_s3207_69c22b74_psram_modifyB_ankP_arams_L000031_39 ' (symbol refcount = 0)
 adds r15, #1 ' ADDI4 coni
 cmps r15,  #2 wcz
 jmp #BR_B
 long @C_s3207_69c22b74_psram_modifyB_ankP_arams_L000031_38 ' LTI4
C_s3207_69c22b74_psram_modifyB_ankP_arams_L000031_40
 jmp #LODI
 long @C_s3205_69c22b74_driverlock_L000007
 mov r2, RI ' reg ARG INDIR ADDRG
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
...
C_s3207_69c22b74_psram_modifyB_ankP_arams_L000031_32
 jmp #POPM ' restore registers
 jmp #RETF


 alignl ' align long
C_s3208_69c22b74_psram_lookupD_elay_L000047 ' <symbol:psram_lookupDelay>
 jmp #PSHM
 ...
 shl r22, #2 ' LSHI4 coni
 jmp #LODL
 long @C_s3206_69c22b74_delayT_able_L000008
 mov r20, RI ' reg <- addrg
 adds r22, r20 ' ADDI/P (1)
 rdlong r22, r22 ' reg <- INDIRU4 reg
 mov r21, r22 ' CVI, CVU or LOAD
 jmp #JMPA
 long @C_s3208_69c22b74_psram_lookupD_elay_L000047_50 ' JUMPV addrg
C_s3208_69c22b74_psram_lookupD_elay_L000047_49
 mov r22, r2 ' CVI, CVU or LOAD
 mov r20, r23
 shl r20, #2 ' LSHI4 coni
 jmp #LODL
 long @C_s3206_69c22b74_delayT_able_L000008+4
 mov r18, RI ' reg <- addrg
 adds r20, r18 ' ADDI/P (1)
 rdlong r20, r20 ' reg <- INDIRU4 reg
 cmp r22, r20 wcz 
 jmp #BRAE
 long @C_s3208_69c22b74_psram_lookupD_elay_L000047_53 ' GEU4
 jmp #JMPA
 long @C_s3208_69c22b74_psram_lookupD_elay_L000047_51 ' JUMPV addrg
C_s3208_69c22b74_psram_lookupD_elay_L000047_53
 adds r23, #1 ' ADDI4 coni
 adds r21, #1 ' ADDI4 coni
C_s3208_69c22b74_psram_lookupD_elay_L000047_50
 mov r22, r23
 shl r22, #2 ' LSHI4 coni
 jmp #LODL
 long @C_s3206_69c22b74_delayT_able_L000008+4
 ...
 cmp r22,  #0 wz
 jmp #BRNZ
 long @C_s3208_69c22b74_psram_lookupD_elay_L000047_49 ' NEU4
C_s3208_69c22b74_psram_lookupD_elay_L000047_51
 mov r0, r21 ' CVI, CVU or LOAD
' C_s3208_69c22b74_psram_lookupD_elay_L000047_48 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 jmp #RETN
...
C_psram_setD_elay ' <symbol:psram_setDelay>
 ...
 jmp #CALA
 long @C_s3207_69c22b74_psram_modifyB_ankP_arams_L000031
 add SP, #4 ' CALL addrg
 mov r22, r0 ' CVI, CVU or LOAD
...
C_psram_setF_requency_58
 ...
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 jmp #CALA
 long @C_s3208_69c22b74_psram_lookupD_elay_L000047 ' CALL addrg
 mov r22, r0 ' CVI, CVU or LOAD
