...
C_psram_fill ' <symbol:psram_fill>
 ...
 cmps r11, r22 wz
 jmp #BRNZ
 long @C_psram_fill_3 ' NEI4
 jmp #LODL
 long -15
 mov r0, RI ' reg <- con
 jmp #JMPA
 long @C_psram_fill_2 ' JUMPV addrg
C_psram_fill_3
 cmps r17,  #1 wz
 jmp #BR_Z
 long @C_psram_fill_7 ' EQI4
 cmps r17,  #2 wz
 jmp #BR_Z
 long @C_psram_fill_8 ' EQI4
 cmps r17,  #4 wz
 jmp #BR_Z
 long @C_psram_fill_9 ' EQI4
 jmp #JMPA
 long @C_psram_fill_5 ' JUMPV addrg
C_psram_fill_7
 mov r22, #12 ' reg <- coni
 ...
 jmp #JMPA
 long @C_psram_fill_6 ' JUMPV addrg
C_psram_fill_8
 mov r22, #13 ' reg <- coni
 shl r22, #28 ' LSHI4 coni
 jmp #LODF
