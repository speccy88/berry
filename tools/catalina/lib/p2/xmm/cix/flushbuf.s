...
'
 ...
 alignl ' align long
C_svmo_69c22c5c_do_write_L000003 ' <symbol:do_write>
 jmp #NEWF
 jmp #PSHM
 ...
 jmp #JMPA
 long @C_svmo_69c22c5c_do_write_L000003_6 ' JUMPV addrg
C_svmo_69c22c5c_do_write_L000003_5
 subs r19, r17 ' SUBI/P (1)
 adds r21, r17 ' ADDI/P (2)
C_svmo_69c22c5c_do_write_L000003_6
 ...
 cmps r0,  #0 wz,wc
 jmp #BRBE
 long @C_svmo_69c22c5c_do_write_L000003_8 ' LEI4
 cmps r17, r19 wz,wc
 jmp #BR_B
 long @C_svmo_69c22c5c_do_write_L000003_5 ' LTI4
C_svmo_69c22c5c_do_write_L000003_8
 cmps r17,  #0 wz,wc
 jmp #BRBE
 long @C_svmo_69c22c5c_do_write_L000003_10 ' LEI4
 mov r15, #1 ' reg <- coni
 jmp #JMPA
 long @C_svmo_69c22c5c_do_write_L000003_11 ' JUMPV addrg
C_svmo_69c22c5c_do_write_L000003_10
 mov r15, #0 ' reg <- coni
C_svmo_69c22c5c_do_write_L000003_11
 mov r0, r15 ' CVI, CVU or LOAD
' C_svmo_69c22c5c_do_write_L000003_4 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 jmp #RETF


 alignl ' align long
C_svmo1_69c22c5c_get_buf_L000012 ' <symbol:get_buf>
 jmp #NEWF
 jmp #PSHM
...
' C_svmo1_69c22c5c_get_buf_L000012_13 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 jmp #RETF
...
C___flushbuf_19
 ...
 jmp #CALA
 long @C_svmo1_69c22c5c_get_buf_L000012 ' CALL addrg
 mov r20, r21
...
C___flushbuf_47
 ...
 sub SP, #8 ' stack space for reg ARGs
 jmp #CALA
 long @C_svmo_69c22c5c_do_write_L000003
 add SP, #8 ' CALL addrg
 cmps r0,  #0 wz
 jmp #BRNZ
 long @C___flushbuf_43 ' NEI4
