...
C_D_F_S__U_nlinkF_ile_15
 ...
 cmps r22,  #0 wz
 jmp #BRNZ
 long @C_D_F_S__U_nlinkF_ile_25 ' NEI4
 mov r22, FP
 sub r22, #-(-20) ' reg <- addrli
 ...
 cmp r22, r20 wz,wc 
 jmp #BRAE
 long @C_D_F_S__U_nlinkF_ile_28 ' GEU4
C_D_F_S__U_nlinkF_ile_25
 ...
 cmps r20, r22 wz
 jmp #BRNZ
 long @C_D_F_S__U_nlinkF_ile_27 ' NEI4
 mov r22, FP
 sub r22, #-(-20) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRU4 regl
 jmp #LODL
...
C_D_F_S__U_nlinkF_ile_27
 ...
 cmps r22,  #2 wz
 jmp #BRNZ
 long @C_D_F_S__U_nlinkF_ile_29 ' NEI4
 mov r22, FP
 sub r22, #-(-20) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRU4 regl
 jmp #LODL
...
C_D_F_S__U_nlinkF_ile_29
 ...
 cmp r22,  #0 wz
 jmp #BRNZ
 long @C_D_F_S__U_nlinkF_ile_14 ' NEU4
