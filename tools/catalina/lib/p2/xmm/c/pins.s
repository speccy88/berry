...
C_getpin_2
 ...
 cmp r22,  #0 wz
 jmp #BR_Z
 long @C_getpin_8 ' EQU4
 mov r21, #1 ' reg <- coni
 jmp #JMPA
 long @C_getpin_9 ' JUMPV addrg
C_getpin_8
 mov r21, #0 ' reg <- coni
C_getpin_9
 mov r0, r21 ' CVI, CVU or LOAD
...
C_setpin ' <symbol:setpin>
 ...
 cmps r3,  #32 wz,wc
 jmp #BRAE
 long @C_setpin_11 ' GEI4
 mov r22, #1 ' reg <- coni
 shl r22, r3 ' LSHI/U (1)
 mov r23, r22 ' CVI, CVU or LOAD
 cmps r2,  #0 wz
 jmp #BR_Z
 long @C_setpin_13 ' EQI4
 or _OUTA, r23 ' ASGNU4 special BOR4 special reg
 jmp #JMPA
 long @C_setpin_14 ' JUMPV addrg
C_setpin_13
 mov r22, r23
 xor r22, all_1s ' BCOMU4
...
C_setpin_11
 ...
 cmps r2,  #0 wz
 jmp #BR_Z
 long @C_setpin_15 ' EQI4
 or _OUTB, r23 ' ASGNU4 special BOR4 special reg
 jmp #JMPA
 long @C_setpin_16 ' JUMPV addrg
C_setpin_15
 mov r22, r23
 xor r22, all_1s ' BCOMU4
...
C_togglepin ' <symbol:togglepin>
 ...
 or _DIRA, r23 ' ASGNU4 special BOR4 special reg
 jmp #JMPA
 long @C_togglepin_19 ' JUMPV addrg
C_togglepin_18
 mov r22, #1 ' reg <- coni
 mov r20, r2
 subs r20, #32 ' SUBI4 coni
