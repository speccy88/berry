...
'
 ...
 alignl ' align long
C_s102c_69c22c1b_s_prnt_L000001 ' <symbol:s_prnt>
 jmp #PSHM
 long $500000 ' save registers
 jmp #JMPA
 long @C_s102c_69c22c1b_s_prnt_L000001_4 ' JUMPV addrg
C_s102c_69c22c1b_s_prnt_L000001_3
 cmp r4,  #0 wz
 jmp #BRNZ
 long @C_s102c_69c22c1b_s_prnt_L000001_6 ' NEU4
 jmp #JMPA
 long @C_s102c_69c22c1b_s_prnt_L000001_5 ' JUMPV addrg
C_s102c_69c22c1b_s_prnt_L000001_6
...
C_s102c_69c22c1b_s_prnt_L000001_4
 mov r22, #0 ' reg <- coni
 cmps r2, r22 wz,wc
 jmp #BR_A
 long @C_s102c_69c22c1b_s_prnt_L000001_3 ' GTI4
 cmps r2, r22 wz,wc
 jmp #BRAE
 long @C_s102c_69c22c1b_s_prnt_L000001_8 ' GEI4
 mov RI, r3
 jmp #RBYT
 mov r20, BC ' reg <- INDIRU1 reg
 ...
 cmps r20, r22 wz
 jmp #BRNZ
 long @C_s102c_69c22c1b_s_prnt_L000001_3 ' NEI4
C_s102c_69c22c1b_s_prnt_L000001_8
C_s102c_69c22c1b_s_prnt_L000001_5
 mov r0, r5 ' CVI, CVU or LOAD
' C_s102c_69c22c1b_s_prnt_L000001_2 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 jmp #RETN


 alignl ' align long
C_s102c1_69c22c1b_u_prnt_L000009 ' <symbol:u_prnt>
 jmp #NEWF
 sub SP, #4
 jmp #PSHM
 ...
 cmps r22, r20 wz,wc
 jmp #BR_A
 long @C_s102c1_69c22c1b_u_prnt_L000009_13 ' GTI4
 cmps r17, r20 wz,wc
 jmp #BRAE
 long @C_s102c1_69c22c1b_u_prnt_L000009_11 ' GEI4
 cmp r19,  #0 wz
 jmp #BR_Z
 long @C_s102c1_69c22c1b_u_prnt_L000009_11 ' EQU4
C_s102c1_69c22c1b_u_prnt_L000009_13
 mov r2, r17 ' CVI, CVU or LOAD
 mov r3, r19 ' CVI, CVU or LOAD
 cmp r21,  #0 wz
 jmp #BR_Z
 long @C_s102c1_69c22c1b_u_prnt_L000009_15 ' EQU4
 mov r15, r21
 sub r15, #1 ' SUBU4 coni
 jmp #JMPA
 long @C_s102c1_69c22c1b_u_prnt_L000009_16 ' JUMPV addrg
C_s102c1_69c22c1b_u_prnt_L000009_15
 mov r15, #0 ' reg <- coni
C_s102c1_69c22c1b_u_prnt_L000009_16
 mov r4, r15 ' CVI, CVU or LOAD
 mov r5, r23 ' CVI, CVU or LOAD
 mov BC, #16 ' arg size, rpsize = 16, spsize = 16
 sub SP, #12 ' stack space for reg ARGs
 jmp #CALA
 long @C_s102c1_69c22c1b_u_prnt_L000009
 add SP, #12 ' CALL addrg
 mov r23, r0 ' CVI, CVU or LOAD
C_s102c1_69c22c1b_u_prnt_L000009_11
 cmp r21,  #0 wz
 jmp #BR_Z
 long @C_s102c1_69c22c1b_u_prnt_L000009_17 ' EQU4
 ...
 mov BC, r20
 jmp #WBYT ' ASGNU1 reg reg
C_s102c1_69c22c1b_u_prnt_L000009_17
 mov r0, r23 ' CVI, CVU or LOAD
' C_s102c1_69c22c1b_u_prnt_L000009_10 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 add SP, #4 ' framesize
 jmp #RETF
...
C_strftime_36
 ...
 sub SP, #12 ' stack space for reg ARGs
 jmp #CALA
 long @C_s102c_69c22c1b_s_prnt_L000001
 add SP, #12 ' CALL addrg
 mov r23, r0 ' CVI, CVU or LOAD
 mov r22, r23 ' CVI, CVU or LOAD
