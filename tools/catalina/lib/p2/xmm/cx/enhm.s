...
C_m_bound_limits ' <symbol:m_bound_limits>
 ...
 jmp #LODL
 long @C_s84o_69c22c61_m_min_L000002
 mov BC, r22
 jmp #WLNG ' ASGNI4 addrg reg
 jmp #LODL
 long @C_s84o1_69c22c61_m_max_L000003
 mov BC, r4
 jmp #WLNG ' ASGNI4 addrg reg
 mov r22, FP
 ...
 rdlong r22, r22 ' reg <- INDIRI4 regl
 jmp #LODL
 long @C_s84o_69c22c61_m_min_L000002+4
 mov BC, r22
 jmp #WLNG ' ASGNI4 addrg reg
 jmp #LODL
 long @C_s84o1_69c22c61_m_max_L000003+4
 mov BC, r3
 jmp #WLNG ' ASGNI4 addrg reg
 jmp #LODL
 long @C_s84o_69c22c61_m_min_L000002+8
 mov BC, r5
 jmp #WLNG ' ASGNI4 addrg reg
 jmp #LODL
 long @C_s84o1_69c22c61_m_max_L000003+8
 mov BC, r2
 jmp #WLNG ' ASGNI4 addrg reg
...
C_m_bound_scales ' <symbol:m_bound_scales>
 jmp #LODL
 long @C_s84o2_69c22c61_m_div_L000004
 mov BC, r4
 jmp #WLNG ' ASGNI4 addrg reg
 jmp #LODL
 long @C_s84o2_69c22c61_m_div_L000004+4
 mov BC, r3
 jmp #WLNG ' ASGNI4 addrg reg
 jmp #LODL
 long @C_s84o2_69c22c61_m_div_L000004+8
 mov BC, r2
 jmp #WLNG ' ASGNI4 addrg reg
...
C_m_bound_preset_20
 ...
 shl r22, #2 ' LSHI4 coni
 jmp #LODL
 long @C_s84o3_69c22c61_m_acc_L000005
 mov r20, RI ' reg <- addrg
...
DAT ' uninitialized data segment
 ...
 alignl ' align long
C_s84o3_69c22c61_m_acc_L000005 ' <symbol:m_acc>
 byte 0[12]

 alignl ' align long
C_s84o2_69c22c61_m_div_L000004 ' <symbol:m_div>
 byte 0[12]

 alignl ' align long
C_s84o1_69c22c61_m_max_L000003 ' <symbol:m_max>
 byte 0[12]

 alignl ' align long
C_s84o_69c22c61_m_min_L000002 ' <symbol:m_min>
 byte 0[12]
