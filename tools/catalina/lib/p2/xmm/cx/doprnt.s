...
'
 ...
 alignl ' align long
C_s117k_69c22c69_gnum_L000001 ' <symbol:gnum>
 jmp #PSHM
 ...
 cmps r22,  #42 wz
 jmp #BRNZ
 long @C_s117k_69c22c69_gnum_L000001_3 ' NEI4
 mov RI, r2
 jmp #RLNG
 ...
 jmp #JMPA
 long @C_s117k_69c22c69_gnum_L000001_4 ' JUMPV addrg
C_s117k_69c22c69_gnum_L000001_3
 mov r23, #0 ' reg <- coni
 jmp #JMPA
 long @C_s117k_69c22c69_gnum_L000001_6 ' JUMPV addrg
C_s117k_69c22c69_gnum_L000001_5
 mov r22, #10 ' reg <- coni
 ...
 adds r4, #1 ' ADDP4 coni
C_s117k_69c22c69_gnum_L000001_6
 mov RI, r4
 jmp #RBYT
 mov r22, BC ' reg <- INDIRU1 reg
 and r22, cviu_m1 ' zero extend
 ...
 cmps r22,  #0 wz,wc
 jmp #BR_B
 long @C_s117k_69c22c69_gnum_L000001_8 ' LTI4
 cmps r21,  #9 wz,wc
 jmp #BRBE
 long @C_s117k_69c22c69_gnum_L000001_5 ' LEI4
C_s117k_69c22c69_gnum_L000001_8
 mov RI, r3
 mov BC, r23
 jmp #WLNG ' ASGNI4 reg reg
C_s117k_69c22c69_gnum_L000001_4
 mov r0, r4 ' CVI, CVU or LOAD
' C_s117k_69c22c69_gnum_L000001_2 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 jmp #RETN


 alignl ' align long
C_s117k1_69c22c69_o_print_L000009 ' <symbol:o_print>
 jmp #NEWF
 sub SP, #12
 jmp #PSHM
 ...
 cmps r13, r22 wz
 jmp #BR_Z
 long @C_s117k1_69c22c69_o_print_L000009_14 ' EQI4
 cmps r13, r22 wz,wc
 jmp #BR_B
 long @C_s117k1_69c22c69_o_print_L000009_11 ' LTI4
' C_s117k1_69c22c69_o_print_L000009_22 ' (symbol refcount = 0)
 cmps r13,  #64 wz
 jmp #BR_Z
 long @C_s117k1_69c22c69_o_print_L000009_17 ' EQI4
 jmp #JMPA
 long @C_s117k1_69c22c69_o_print_L000009_11 ' JUMPV addrg
C_s117k1_69c22c69_o_print_L000009_14
 cmps r17,  #0 wz
 jmp #BR_Z
 long @C_s117k1_69c22c69_o_print_L000009_15 ' EQI4
 mov r22, FP
 ...
 jmp #JMPA
 long @C_s117k1_69c22c69_o_print_L000009_12 ' JUMPV addrg
C_s117k1_69c22c69_o_print_L000009_15
 mov r22, FP
 add r22, #8 ' reg <- addrfi
 rdlong r22, r22 ' reg <- INDIRP4 regl
 mov RI, r22
 ...
 jmp #JMPA
 long @C_s117k1_69c22c69_o_print_L000009_12 ' JUMPV addrg
C_s117k1_69c22c69_o_print_L000009_17
 cmps r17,  #0 wz
 jmp #BR_Z
 long @C_s117k1_69c22c69_o_print_L000009_18 ' EQI4
 mov r22, FP
 add r22, #8 ' reg <- addrfi
 rdlong r22, r22 ' reg <- INDIRP4 regl
 mov RI, r22
 ...
 jmp #JMPA
 long @C_s117k1_69c22c69_o_print_L000009_12 ' JUMPV addrg
C_s117k1_69c22c69_o_print_L000009_18
 mov r22, FP
 add r22, #8 ' reg <- addrfi
 rdlong r22, r22 ' reg <- INDIRP4 regl
 mov RI, r22
 ...
 jmp #JMPA
 long @C_s117k1_69c22c69_o_print_L000009_12 ' JUMPV addrg
C_s117k1_69c22c69_o_print_L000009_11
 cmps r17,  #0 wz
 jmp #BR_Z
 long @C_s117k1_69c22c69_o_print_L000009_20 ' EQI4
 mov r22, FP
 add r22, #8 ' reg <- addrfi
 rdlong r22, r22 ' reg <- INDIRP4 regl
 mov RI, r22
 ...
 jmp #JMPA
 long @C_s117k1_69c22c69_o_print_L000009_12 ' JUMPV addrg
C_s117k1_69c22c69_o_print_L000009_20
 mov r22, FP
 add r22, #8 ' reg <- addrfi
 rdlong r22, r22 ' reg <- INDIRP4 regl
 mov RI, r22
 ...
 sub RI, #-(-8)
 wrlong r22, RI ' ASGNU4 addrli reg
C_s117k1_69c22c69_o_print_L000009_12
 cmps r17,  #0 wz
 jmp #BR_Z
 long @C_s117k1_69c22c69_o_print_L000009_23 ' EQI4
 mov r22, FP
 sub r22, #-(-12) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRI4 regl
 cmps r22,  #0 wz,wc
 jmp #BRAE
 long @C_s117k1_69c22c69_o_print_L000009_25 ' GEI4
 ...
 wrlong r22, RI ' ASGNI4 addrli reg
 jmp #JMPA
 long @C_s117k1_69c22c69_o_print_L000009_26 ' JUMPV addrg
C_s117k1_69c22c69_o_print_L000009_25
 mov r22, FP
 add r22, #12 ' reg <- addrfi
 rdlong r22, r22 ' reg <- INDIRI4 regl
 ...
 cmps r22,  #0 wz
 jmp #BR_Z
 long @C_s117k1_69c22c69_o_print_L000009_27 ' EQI4
 mov r22, r23 ' CVI, CVU or LOAD
 mov r23, r22
 adds r23, #1 ' ADDP4 coni
 mov r20, #43 ' reg <- coni
 ...
 jmp #WBYT ' ASGNU1 reg reg
 jmp #JMPA
 long @C_s117k1_69c22c69_o_print_L000009_28 ' JUMPV addrg
C_s117k1_69c22c69_o_print_L000009_27
 mov r22, FP
 add r22, #12 ' reg <- addrfi
 rdlong r22, r22 ' reg <- INDIRI4 regl
 ...
 cmps r22,  #0 wz
 jmp #BR_Z
 long @C_s117k1_69c22c69_o_print_L000009_29 ' EQI4
 mov r22, r23 ' CVI, CVU or LOAD
 mov r23, r22
 adds r23, #1 ' ADDP4 coni
 mov r20, #32 ' reg <- coni
 ...
 mov BC, r20
 jmp #WBYT ' ASGNU1 reg reg
C_s117k1_69c22c69_o_print_L000009_29
C_s117k1_69c22c69_o_print_L000009_28
C_s117k1_69c22c69_o_print_L000009_26
 mov r22, FP
 sub r22, #-(-12) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRI4 regl
 mov RI, FP
 sub RI, #-(-8)
 wrlong r22, RI ' ASGNU4 addrli reg
C_s117k1_69c22c69_o_print_L000009_23
 mov r22, FP
 add r22, #12 ' reg <- addrfi
 rdlong r22, r22 ' reg <- INDIRI4 regl
 ...
 cmps r22,  #0 wz
 jmp #BR_Z
 long @C_s117k1_69c22c69_o_print_L000009_31 ' EQI4
 mov r22, r21 ' CVUI
 and r22, cviu_m1 ' zero extend
 cmps r22,  #111 wz
 jmp #BRNZ
 long @C_s117k1_69c22c69_o_print_L000009_31 ' NEI4
 mov r22, r23 ' CVI, CVU or LOAD
 mov r23, r22
 adds r23, #1 ' ADDP4 coni
 mov r20, #48 ' reg <- coni
 ...
 mov BC, r20
 jmp #WBYT ' ASGNU1 reg reg
C_s117k1_69c22c69_o_print_L000009_31
 mov r22, FP
 sub r22, #-(-8) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRU4 regl
 cmp r22,  #0 wz
 jmp #BRNZ
 long @C_s117k1_69c22c69_o_print_L000009_33 ' NEU4
 cmps r19,  #0 wz
 jmp #BRNZ
 long @C_s117k1_69c22c69_o_print_L000009_34 ' NEI4
 mov r0, r23 ' CVI, CVU or LOAD
 jmp #JMPA
 long @C_s117k1_69c22c69_o_print_L000009_10 ' JUMPV addrg
C_s117k1_69c22c69_o_print_L000009_33
 mov r22, FP
 add r22, #12 ' reg <- addrfi
 rdlong r22, r22 ' reg <- INDIRI4 regl
 and r22, #8 ' BANDI4 coni
 cmps r22,  #0 wz
 jmp #BR_Z
 long @C_s117k1_69c22c69_o_print_L000009_40 ' EQI4
 mov r22, r21 ' CVUI
 and r22, cviu_m1 ' zero extend
 cmps r22,  #120 wz
 jmp #BR_Z
 long @C_s117k1_69c22c69_o_print_L000009_39 ' EQI4
 cmps r22,  #88 wz
 jmp #BR_Z
 long @C_s117k1_69c22c69_o_print_L000009_39 ' EQI4
C_s117k1_69c22c69_o_print_L000009_40
 mov r22, r21 ' CVUI
 and r22, cviu_m1 ' zero extend
 cmps r22,  #112 wz
 jmp #BRNZ
 long @C_s117k1_69c22c69_o_print_L000009_37 ' NEI4
C_s117k1_69c22c69_o_print_L000009_39
 mov r22, r23 ' CVI, CVU or LOAD
 mov r23, r22
 adds r23, #1 ' ADDP4 coni
 mov r20, #48 ' reg <- coni
 ...
 cmps r20,  #88 wz
 jmp #BRNZ
 long @C_s117k1_69c22c69_o_print_L000009_42 ' NEI4
 mov r11, #88 ' reg <- coni
 jmp #JMPA
 long @C_s117k1_69c22c69_o_print_L000009_43 ' JUMPV addrg
C_s117k1_69c22c69_o_print_L000009_42
 mov r11, #120 ' reg <- coni
C_s117k1_69c22c69_o_print_L000009_43
 mov r20, r11 ' CVI, CVU or LOAD
 mov RI, r22
 mov BC, r20
 jmp #WBYT ' ASGNU1 reg reg
C_s117k1_69c22c69_o_print_L000009_37
C_s117k1_69c22c69_o_print_L000009_34
 mov r11, r21 ' CVUI
 and r11, cviu_m1 ' zero extend
 mov r22, #105 ' reg <- coni
 cmps r11, r22 wz
 jmp #BR_Z
 long @C_s117k1_69c22c69_o_print_L000009_49 ' EQI4
 cmps r11, r22 wz,wc
 jmp #BR_A
 long @C_s117k1_69c22c69_o_print_L000009_52 ' GTI4
' C_s117k1_69c22c69_o_print_L000009_51 ' (symbol refcount = 0)
 mov r22, #88 ' reg <- coni
 cmps r11, r22 wz
 jmp #BR_Z
 long @C_s117k1_69c22c69_o_print_L000009_50 ' EQI4
 cmps r11, r22 wz,wc
 jmp #BR_B
 long @C_s117k1_69c22c69_o_print_L000009_44 ' LTI4
' C_s117k1_69c22c69_o_print_L000009_53 ' (symbol refcount = 0)
 cmps r11,  #98 wz
 jmp #BR_Z
 long @C_s117k1_69c22c69_o_print_L000009_47 ' EQI4
 cmps r11,  #100 wz
 jmp #BR_Z
 long @C_s117k1_69c22c69_o_print_L000009_49 ' EQI4
 jmp #JMPA
 long @C_s117k1_69c22c69_o_print_L000009_44 ' JUMPV addrg
C_s117k1_69c22c69_o_print_L000009_52
 mov r22, #111 ' reg <- coni
 cmps r11, r22 wz
 jmp #BR_Z
 long @C_s117k1_69c22c69_o_print_L000009_48 ' EQI4
 cmps r11,  #112 wz
 jmp #BR_Z
 long @C_s117k1_69c22c69_o_print_L000009_50 ' EQI4
 cmps r11, r22 wz,wc
 jmp #BR_B
 long @C_s117k1_69c22c69_o_print_L000009_44 ' LTI4
' C_s117k1_69c22c69_o_print_L000009_54 ' (symbol refcount = 0)
 cmps r11,  #117 wz
 jmp #BR_Z
 long @C_s117k1_69c22c69_o_print_L000009_49 ' EQI4
 cmps r11,  #120 wz
 ...
 jmp #JMPA
 long @C_s117k1_69c22c69_o_print_L000009_44 ' JUMPV addrg
C_s117k1_69c22c69_o_print_L000009_47
 mov r22, #2 ' reg <- coni
 mov RI, FP
 sub RI, #-(-16)
 wrlong r22, RI ' ASGNI4 addrli reg
 jmp #JMPA
 long @C_s117k1_69c22c69_o_print_L000009_45 ' JUMPV addrg
C_s117k1_69c22c69_o_print_L000009_48
 mov r22, #8 ' reg <- coni
 mov RI, FP
 sub RI, #-(-16)
 wrlong r22, RI ' ASGNI4 addrli reg
 jmp #JMPA
 long @C_s117k1_69c22c69_o_print_L000009_45 ' JUMPV addrg
C_s117k1_69c22c69_o_print_L000009_49
 mov r22, #10 ' reg <- coni
 mov RI, FP
 sub RI, #-(-16)
 wrlong r22, RI ' ASGNI4 addrli reg
 jmp #JMPA
 long @C_s117k1_69c22c69_o_print_L000009_45 ' JUMPV addrg
C_s117k1_69c22c69_o_print_L000009_50
 mov r22, #16 ' reg <- coni
 mov RI, FP
 sub RI, #-(-16)
 wrlong r22, RI ' ASGNI4 addrli reg
C_s117k1_69c22c69_o_print_L000009_44
C_s117k1_69c22c69_o_print_L000009_45
 ...
 cmps r22,  #88 wz
 jmp #BRNZ
 long @C_s117k1_69c22c69_o_print_L000009_55 ' NEI4
 jmp #JMPA
 long @C_s117k1_69c22c69_o_print_L000009_58 ' JUMPV addrg
C_s117k1_69c22c69_o_print_L000009_57
 mov RI, r15
 jmp #RBYT
 mov r22, BC ' reg <- INDIRU1 reg
 mov r2, r22 ' CVUI
...
C_s117k1_69c22c69_o_print_L000009_58
 mov r22, r15 ' CVI, CVU or LOAD
 mov r20, r23 ' CVI, CVU or LOAD
 cmp r22, r20 wz
 jmp #BRNZ
 long @C_s117k1_69c22c69_o_print_L000009_57 ' NEU4
C_s117k1_69c22c69_o_print_L000009_55
 mov r0, r23 ' CVI, CVU or LOAD
C_s117k1_69c22c69_o_print_L000009_10
 jmp #POPM ' restore registers
 add SP, #12 ' framesize
 jmp #RETF
...
C__doprnt_72
 ...
 jmp #CALA
 long @C_s117k_69c22c69_gnum_L000001
 add SP, #8 ' CALL addrg
 mov r23, r0 ' CVI, CVU or LOAD
 mov r22, r23 ' CVI, CVU or LOAD
 mov r20, FP
...
C__doprnt_139
 ...
 jmp #CALA
 long @C_s117k1_69c22c69_o_print_L000009
