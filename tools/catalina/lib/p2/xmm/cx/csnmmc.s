...
' C__cogstart_N_M_M__cog_10 ' (symbol refcount = 0)
 ...
 cmps r15, r22 wz,wc
 jmp #BR_B
 long @C__cogstart_N_M_M__cog_9 ' LTI4
 mov r15, #0 ' reg <- coni
C__cogstart_N_M_M__cog_13
 mov r22, r15
 shl r22, #2 ' LSHI4 coni
 jmp #LODF
 long -4100
 ...
 mov BC, r22
 jmp #WLNG ' ASGNI4 reg reg
' C__cogstart_N_M_M__cog_14 ' (symbol refcount = 0)
 adds r15, #1 ' ADDI4 coni
 cmps r15,  #106 wz,wc
 jmp #BR_B
 long @C__cogstart_N_M_M__cog_13 ' LTI4
 jmp #LODF
 long -4100
...
' C__cogstart_N_M_M__cog_2 ' (symbol refcount = 0)
