...
DAT ' code segment
 ...
 alignl ' align long
C_sgos_664d6e73_index2value_L000013 ' <symbol:index2value>
 jmp #NEWF
 sub SP, #8
 jmp #PSHM
 ...
 cmps r2,  #0 wz,wc
 jmp #BRBE
 long @C_sgos_664d6e73_index2value_L000013_15 ' LEI4
 mov r22, r2
 ...
 cmp r22, r20 wz,wc 
 jmp #BR_B
 long @C_sgos_664d6e73_index2value_L000013_17' LTU4
 mov r22, r3
 ...
 jmp #JMPA
 long @C_sgos_664d6e73_index2value_L000013_14 ' JUMPV addrg
C_sgos_664d6e73_index2value_L000013_17
 mov r22, FP
 sub r22, #-(-12) ' reg <- addrli
 rdlong r0, r22 ' reg <- INDIRP4 regl
 jmp #JMPA
 long @C_sgos_664d6e73_index2value_L000013_14 ' JUMPV addrg
C_sgos_664d6e73_index2value_L000013_15
 jmp #LODL
 long -1001000
 mov r22, RI ' reg <- con
 cmps r2, r22 wz,wc
 jmp #BRBE
 long @C_sgos_664d6e73_index2value_L000013_19 ' LEI4
 mov r22, r2
 shl r22, #3 ' LSHI4 coni
 mov r20, r3
 adds r20, #12 ' ADDP4 coni
 ...
 jmp #JMPA
 long @C_sgos_664d6e73_index2value_L000013_14 ' JUMPV addrg
C_sgos_664d6e73_index2value_L000013_19
 jmp #LODL
 long -1001000
 mov r22, RI ' reg <- con
 cmps r2, r22 wz
 jmp #BRNZ
 long @C_sgos_664d6e73_index2value_L000013_21 ' NEI4
 mov r22, r3
 adds r22, #16 ' ADDP4 coni
 mov RI, r22
 jmp #RLNG
 ...
 jmp #JMPA
 long @C_sgos_664d6e73_index2value_L000013_14 ' JUMPV addrg
C_sgos_664d6e73_index2value_L000013_21
 jmp #LODL
 long -1001000
 mov r22, RI ' reg <- con
 subs r2, r22
 ...
 cmps r22,  #102 wz
 jmp #BRNZ
 long @C_sgos_664d6e73_index2value_L000013_23 ' NEI4
 mov r22, FP
 sub r22, #-(-8) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRP4 regl
 mov RI, r22
 ...
 cmps r2, r22 wz,wc
 jmp #BR_A
 long @C_sgos_664d6e73_index2value_L000013_26 ' GTI4
 mov r22, r2
 shl r22, #3 ' LSHI4 coni
 ...
 jmp #JMPA
 long @C_sgos_664d6e73_index2value_L000013_27 ' JUMPV addrg
C_sgos_664d6e73_index2value_L000013_26
 mov r22, r3
 adds r22, #16 ' ADDP4 coni
 mov RI, r22
 jmp #RLNG
...
C_sgos_664d6e73_index2value_L000013_27
 mov r0, r23 ' CVI, CVU or LOAD
 jmp #JMPA
 long @C_sgos_664d6e73_index2value_L000013_14 ' JUMPV addrg
C_sgos_664d6e73_index2value_L000013_23
 mov r22, r3
 adds r22, #16 ' ADDP4 coni
 mov RI, r22
 jmp #RLNG
 ...
 mov r0, r22
 adds r0, #44 ' ADDP4 coni
C_sgos_664d6e73_index2value_L000013_14
 ...
 alignl ' align long
C_sgos1_664d6e73_index2stack_L000028 ' <symbol:index2stack>
 jmp #NEWF
 sub SP, #8
 jmp #PSHM
 ...
 cmps r2,  #0 wz,wc
 jmp #BRBE
 long @C_sgos1_664d6e73_index2stack_L000028_30 ' LEI4
 mov r22, r2
 shl r22, #3 ' LSHI4 coni
 mov r20, FP
 sub r20, #-(-8) ' reg <- addrli
 ...
 rdlong r0, r22 ' reg <- INDIRP4 regl
 jmp #JMPA
 long @C_sgos1_664d6e73_index2stack_L000028_29 ' JUMPV addrg
C_sgos1_664d6e73_index2stack_L000028_30
 mov r22, r2
 shl r22, #3 ' LSHI4 coni
 mov r20, r3
 adds r20, #12 ' ADDP4 coni
 ...
 mov r0, r22 ' ADDI/P
 adds r0, r20 ' ADDI/P (3)
C_sgos1_664d6e73_index2stack_L000028_29
 jmp #POPM ' restore registers
 add SP, #8 ' framesize
 jmp #RETF
...
C_lua_closeslot ' <symbol:lua_closeslot>
 ...
 jmp #CALA
 long @C_sgos1_664d6e73_index2stack_L000028
 add SP, #4 ' CALL addrg
 mov r19, r0 ' CVI, CVU or LOAD
 mov r2, #0 ' reg ARG coni
 jmp #LODL
...
' C_lua_closeslot_65 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_sgos3_664d6e73_reverse_L000066 ' <symbol:reverse>
 jmp #NEWF
 sub SP, #8
 jmp #PSHM
 long $f00000 ' save registers
 jmp #JMPA
 long @C_sgos3_664d6e73_reverse_L000066_71 ' JUMPV addrg
C_sgos3_664d6e73_reverse_L000066_68
 mov r23, FP
 ...
 mov BC, r20
 jmp #WBYT ' ASGNU1 reg reg
' C_sgos3_664d6e73_reverse_L000066_69 ' (symbol refcount = 0)
 adds r3, #8 ' ADDP4 coni
 jmp #LODL
 long -8
 mov r22, RI ' reg <- con
 adds r2, r22 ' ADDI/P (1)
C_sgos3_664d6e73_reverse_L000066_71
 mov r22, r3 ' CVI, CVU or LOAD
 mov r20, r2 ' CVI, CVU or LOAD
 cmp r22, r20 wz,wc 
 jmp #BR_B
 long @C_sgos3_664d6e73_reverse_L000066_68' LTU4
' C_sgos3_664d6e73_reverse_L000066_67 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 add SP, #8 ' framesize
 jmp #RETF
...
C_lua_rotate_75
 ...
 sub SP, #8 ' stack space for reg ARGs
 jmp #CALA
 long @C_sgos3_664d6e73_reverse_L000066
 add SP, #8 ' CALL addrg
...
C_lua_copy ' <symbol:lua_copy>
 ...
 sub SP, #4 ' stack space for reg ARGs
 jmp #CALA
 long @C_sgos_664d6e73_index2value_L000013
 add SP, #4 ' CALL addrg
 mov r17, r0 ' CVI, CVU or LOAD
...
C_lua_tocfunction_175
 ...
 alignl ' align long
C_sgos5_664d6e73_touserdata_L000180 ' <symbol:touserdata>
 jmp #PSHM
 ...
 cmps r23, r22 wz
 jmp #BR_Z
 long @C_sgos5_664d6e73_touserdata_L000180_189 ' EQI4
 cmps r23, r22 wz,wc
 jmp #BR_B
 long @C_sgos5_664d6e73_touserdata_L000180_182 ' LTI4
' C_sgos5_664d6e73_touserdata_L000180_190 ' (symbol refcount = 0)
 cmps r23,  #7 wz
 jmp #BR_Z
 long @C_sgos5_664d6e73_touserdata_L000180_185 ' EQI4
 jmp #JMPA
 long @C_sgos5_664d6e73_touserdata_L000180_182 ' JUMPV addrg
C_sgos5_664d6e73_touserdata_L000180_185
 mov RI, r2
 jmp #RLNG
 mov r22, BC ' reg <- INDIRP4 reg
 adds r22, #6 ' ADDP4 coni
 ...
 cmps r22,  #0 wz
 jmp #BRNZ
 long @C_sgos5_664d6e73_touserdata_L000180_187 ' NEI4
 mov r21, #16 ' reg <- coni
 jmp #JMPA
 long @C_sgos5_664d6e73_touserdata_L000180_188 ' JUMPV addrg
C_sgos5_664d6e73_touserdata_L000180_187
 mov RI, r2
 jmp #RLNG
 mov r22, BC ' reg <- INDIRP4 reg
 adds r22, #6 ' ADDP4 coni
...
C_sgos5_664d6e73_touserdata_L000180_188
 mov RI, r2
 jmp #RLNG
 mov r22, BC ' reg <- INDIRP4 reg
 mov r0, r21 ' ADDI/P
 ...
 jmp #JMPA
 long @C_sgos5_664d6e73_touserdata_L000180_181 ' JUMPV addrg
C_sgos5_664d6e73_touserdata_L000180_189
 mov RI, r2
 jmp #RLNG
 mov r0, BC ' reg <- INDIRP4 reg
 jmp #JMPA
 long @C_sgos5_664d6e73_touserdata_L000180_181 ' JUMPV addrg
C_sgos5_664d6e73_touserdata_L000180_182
 jmp #LODL
 long 0
 mov r0, RI ' reg <- con
C_sgos5_664d6e73_touserdata_L000180_181
 jmp #POPM ' restore registers
 jmp #RETN
...
C_lua_touserdata ' <symbol:lua_touserdata>
 ...
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 jmp #CALA
 long @C_sgos5_664d6e73_touserdata_L000180 ' CALL addrg
 mov r22, r0 ' CVI, CVU or LOAD
...
' C_lua_pushthread_241 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_sgos7_664d6e73_auxgetstr_L000245 ' <symbol:auxgetstr>
 jmp #NEWF
 sub SP, #12
 jmp #PSHM
 long $faa000 ' save registers
 ...
 cmps r22,  #69 wz
 jmp #BR_Z
 long @C_sgos7_664d6e73_auxgetstr_L000245_251 ' EQI4
 jmp #LODL
 long 0
 mov r17, RI ' reg <- con
 mov r15, #0 ' reg <- coni
 jmp #JMPA
 long @C_sgos7_664d6e73_auxgetstr_L000245_252 ' JUMPV addrg
C_sgos7_664d6e73_auxgetstr_L000245_251
 mov RI, FP
 sub RI, #-(-8)
 rdlong r2, RI ' reg ARG INDIR ADDRLi
 mov RI, r21
 ...
 cmps r22,  #0 wz
 jmp #BR_Z
 long @C_sgos7_664d6e73_auxgetstr_L000245_253 ' EQI4
 mov r13, #1 ' reg <- coni
 jmp #JMPA
 long @C_sgos7_664d6e73_auxgetstr_L000245_254 ' JUMPV addrg
C_sgos7_664d6e73_auxgetstr_L000245_253
 mov r13, #0 ' reg <- coni
C_sgos7_664d6e73_auxgetstr_L000245_254
 mov r15, r13 ' CVI, CVU or LOAD
C_sgos7_664d6e73_auxgetstr_L000245_252
 cmps r15,  #0 wz
 jmp #BR_Z
 long @C_sgos7_664d6e73_auxgetstr_L000245_247 ' EQI4
 mov r22, r23
 adds r22, #12 ' ADDP4 coni
 mov RI, r22
 jmp #RLNG
 ...
 jmp #WLNG ' ASGNP4 reg reg
 jmp #JMPA
 long @C_sgos7_664d6e73_auxgetstr_L000245_248 ' JUMPV addrg
C_sgos7_664d6e73_auxgetstr_L000245_247
 mov r22, r23
 adds r22, #12 ' ADDP4 coni
 mov RI, r22
 jmp #RLNG
 ...
 add SP, #16 ' CALL addrg
C_sgos7_664d6e73_auxgetstr_L000245_248
 mov r22, r23
 adds r22, #12 ' ADDP4 coni
 mov RI, r22
 jmp #RLNG
...
' C_sgos7_664d6e73_auxgetstr_L000245_246 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 add SP, #12 ' framesize
 jmp #RETF
...
C_lua_getglobal ' <symbol:lua_getglobal>
 ...
 sub SP, #8 ' stack space for reg ARGs
 jmp #CALA
 long @C_sgos7_664d6e73_auxgetstr_L000245
 add SP, #8 ' CALL addrg
 mov r22, r0 ' CVI, CVU or LOAD
...
' C_lua_geti_266 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_sgos8_664d6e73_finishrawget_L000278 ' <symbol:finishrawget>
 jmp #NEWF
 sub SP, #8
 jmp #PSHM
 long $500000 ' save registers
 ...
 cmps r22,  #0 wz
 jmp #BRNZ
 long @C_sgos8_664d6e73_finishrawget_L000278_280 ' NEI4
 mov r22, r3
 adds r22, #12 ' ADDP4 coni
 mov RI, r22
 jmp #RLNG
 ...
 jmp #WBYT ' ASGNU1 reg reg
 jmp #JMPA
 long @C_sgos8_664d6e73_finishrawget_L000278_281 ' JUMPV addrg
C_sgos8_664d6e73_finishrawget_L000278_280
 mov r22, r3
 adds r22, #12 ' ADDP4 coni
 mov RI, r22
 jmp #RLNG
 ...
 mov BC, r20
 jmp #WBYT ' ASGNU1 reg reg
C_sgos8_664d6e73_finishrawget_L000278_281
 mov r22, r3
 adds r22, #12 ' ADDP4 coni
 mov RI, r22
 jmp #RLNG
 ...
 mov r0, r22
 and r0, #15 ' BANDI4 coni
' C_sgos8_664d6e73_finishrawget_L000278_279 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 add SP, #8 ' framesize
 jmp #RETF
 ...
 alignl ' align long
C_sgos9_664d6e73_gettable_L000282 ' <symbol:gettable>
 jmp #NEWF
 sub SP, #4
 jmp #PSHM
 long $e00000 ' save registers
 ...
 jmp #RLNG
 mov r0, BC ' reg <- INDIRP4 reg
' C_sgos9_664d6e73_gettable_L000282_283 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 add SP, #4 ' framesize
 jmp #RETF
...
C_lua_rawget ' <symbol:lua_rawget>
 ...
 sub SP, #4 ' stack space for reg ARGs
 jmp #CALA
 long @C_sgos9_664d6e73_gettable_L000282
 add SP, #4 ' CALL addrg
 mov RI, FP
 sub RI, #-(-8)
 wrlong r0, RI ' ASGNP4 addrli reg
 ...
 sub SP, #4 ' stack space for reg ARGs
 jmp #CALA
 long @C_sgos8_664d6e73_finishrawget_L000278
 add SP, #4 ' CALL addrg
 mov r22, r0 ' CVI, CVU or LOAD
...
' C_lua_getiuservalue_301 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_sgosa_664d6e73_auxsetstr_L000305 ' <symbol:auxsetstr>
 jmp #NEWF
 sub SP, #12
 jmp #PSHM
 long $fea000 ' save registers
 ...
 cmps r22,  #69 wz
 jmp #BR_Z
 long @C_sgosa_664d6e73_auxsetstr_L000305_311 ' EQI4
 jmp #LODL
 long 0
 mov r17, RI ' reg <- con
 mov r15, #0 ' reg <- coni
 jmp #JMPA
 long @C_sgosa_664d6e73_auxsetstr_L000305_312 ' JUMPV addrg
C_sgosa_664d6e73_auxsetstr_L000305_311
 mov RI, FP
 sub RI, #-(-8)
 rdlong r2, RI ' reg ARG INDIR ADDRLi
 mov RI, r21
 ...
 cmps r22,  #0 wz
 jmp #BR_Z
 long @C_sgosa_664d6e73_auxsetstr_L000305_313 ' EQI4
 mov r13, #1 ' reg <- coni
 jmp #JMPA
 long @C_sgosa_664d6e73_auxsetstr_L000305_314 ' JUMPV addrg
C_sgosa_664d6e73_auxsetstr_L000305_313
 mov r13, #0 ' reg <- coni
C_sgosa_664d6e73_auxsetstr_L000305_314
 mov r15, r13 ' CVI, CVU or LOAD
C_sgosa_664d6e73_auxsetstr_L000305_312
 cmps r15,  #0 wz
 jmp #BR_Z
 long @C_sgosa_664d6e73_auxsetstr_L000305_307 ' EQI4
 mov RI, FP
 sub RI, #-(-12)
 wrlong r17, RI ' ASGNP4 addrli reg
 mov r22, r23
 ...
 cmps r18, r20 wz
 jmp #BR_Z
 long @C_sgosa_664d6e73_auxsetstr_L000305_316 ' EQI4
 mov RI, r21
 jmp #RLNG
 mov r18, BC ' reg <- INDIRP4 reg
 ...
 add SP, #4 ' CALL addrg
 jmp #JMPA
 long @C_sgosa_664d6e73_auxsetstr_L000305_316 ' JUMPV addrg
C_sgosa_664d6e73_auxsetstr_L000305_316
 mov r22, r23
 adds r22, #12 ' ADDP4 coni
 mov RI, r22
 jmp #RLNG
 ...
 jmp #WLNG ' ASGNP4 reg reg
 jmp #JMPA
 long @C_sgosa_664d6e73_auxsetstr_L000305_308 ' JUMPV addrg
C_sgosa_664d6e73_auxsetstr_L000305_307
 mov r22, r23
 adds r22, #12 ' ADDP4 coni
 mov RI, r22
 jmp #RLNG
 ...
 mov BC, r20
 jmp #WLNG ' ASGNP4 reg reg
C_sgosa_664d6e73_auxsetstr_L000305_308
' C_sgosa_664d6e73_auxsetstr_L000305_306 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 add SP, #12 ' framesize
 jmp #RETF
...
C_lua_setglobal ' <symbol:lua_setglobal>
 ...
 sub SP, #8 ' stack space for reg ARGs
 jmp #CALA
 long @C_sgosa_664d6e73_auxsetstr_L000305
 add SP, #8 ' CALL addrg
...
' C_lua_seti_330 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_sgosb_664d6e73_aux_rawset_L000344 ' <symbol:aux_rawset>
 jmp #NEWF
 jmp #PSHM
 ...
 cmps r18, r20 wz
 jmp #BR_Z
 long @C_sgosb_664d6e73_aux_rawset_L000344_347 ' EQI4
 mov r18, r15
 adds r18, #5 ' ADDP4 coni
 mov RI, r18
 jmp #RBYT
 ...
 add SP, #4 ' CALL addrg
 jmp #JMPA
 long @C_sgosb_664d6e73_aux_rawset_L000344_347 ' JUMPV addrg
C_sgosb_664d6e73_aux_rawset_L000344_347
 mov r22, r23
 adds r22, #12 ' ADDP4 coni
 mov RI, r22
 jmp #RLNG
 ...
 mov BC, r20
 jmp #WLNG ' ASGNP4 reg reg
' C_sgosb_664d6e73_aux_rawset_L000344_345 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 jmp #RETF
...
C_lua_rawset ' <symbol:lua_rawset>
 ...
 sub SP, #12 ' stack space for reg ARGs
 jmp #CALA
 long @C_sgosb_664d6e73_aux_rawset_L000344
 add SP, #12 ' CALL addrg
...
' C_lua_callk_374 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_sgosc_664d6e73_f_call_L000379 ' <symbol:f_call>
 jmp #NEWF
 jmp #PSHM
 long $e80000 ' save registers
 mov r23, r3 ' reg var <- reg arg
 ...
 long @C_luaD__callnoyield
 add SP, #8 ' CALL addrg
' C_sgosc_664d6e73_f_call_L000379_380 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 jmp #RETF
...
C_lua_pcallk_386
 ...
 sub r4, #-(-12) ' reg ARG ADDRLi
 jmp #LODL
 long @C_sgosc_664d6e73_f_call_L000379
...
' C_lua_newuserdatauv_473 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_sgosg_664d6e73_aux_upvalue_L000479 ' <symbol:aux_upvalue>
 jmp #NEWF
 sub SP, #12
 jmp #PSHM
 long $f00000 ' save registers
 ...
 cmps r23, r22 wz
 jmp #BR_Z
 long @C_sgosg_664d6e73_aux_upvalue_L000479_489 ' EQI4
 cmps r23, r22 wz,wc
 jmp #BR_B
 long @C_sgosg_664d6e73_aux_upvalue_L000479_481 ' LTI4
' C_sgosg_664d6e73_aux_upvalue_L000479_499 ' (symbol refcount = 0)
 cmps r23,  #38 wz
 jmp #BR_Z
 long @C_sgosg_664d6e73_aux_upvalue_L000479_484 ' EQI4
 jmp #JMPA
 long @C_sgosg_664d6e73_aux_upvalue_L000479_481 ' JUMPV addrg
C_sgosg_664d6e73_aux_upvalue_L000479_484
 mov RI, r5
 jmp #RLNG
 mov r22, BC ' reg <- INDIRP4 reg
 mov RI, FP
 ...
 cmp r22, r20 wz,wc 
 jmp #BR_B
 long @C_sgosg_664d6e73_aux_upvalue_L000479_485' LTU4
 jmp #LODL
 long 0
 mov r0, RI ' reg <- con
 jmp #JMPA
 long @C_sgosg_664d6e73_aux_upvalue_L000479_480 ' JUMPV addrg
C_sgosg_664d6e73_aux_upvalue_L000479_485
 mov r22, r4
 shl r22, #3 ' LSHI4 coni
 subs r22, #8 ' SUBI4 coni
 mov r20, FP
 ...
 cmp r22,  #0 wz
 jmp #BR_Z
 long @C_sgosg_664d6e73_aux_upvalue_L000479_487 ' EQU4
 mov r22, FP
 sub r22, #-(-8) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRP4 regl
 mov RI, r2
 mov BC, r22
 jmp #WLNG ' ASGNP4 reg reg
C_sgosg_664d6e73_aux_upvalue_L000479_487
 jmp #LODL
 long @C_lua_pushlstring_210_L000211
 mov r0, RI ' reg <- addrg
 jmp #JMPA
 long @C_sgosg_664d6e73_aux_upvalue_L000479_480 ' JUMPV addrg
C_sgosg_664d6e73_aux_upvalue_L000479_489
 mov RI, r5
 jmp #RLNG
 mov r22, BC ' reg <- INDIRP4 reg
 mov RI, FP
 ...
 cmp r22, r20 wz,wc 
 jmp #BR_B
 long @C_sgosg_664d6e73_aux_upvalue_L000479_490' LTU4
 jmp #LODL
 long 0
 mov r0, RI ' reg <- con
 jmp #JMPA
 long @C_sgosg_664d6e73_aux_upvalue_L000479_480 ' JUMPV addrg
C_sgosg_664d6e73_aux_upvalue_L000479_490
 mov r22, r4
 shl r22, #2 ' LSHI4 coni
 ...
 cmp r22,  #0 wz
 jmp #BR_Z
 long @C_sgosg_664d6e73_aux_upvalue_L000479_492 ' EQU4
 mov r22, r4
 shl r22, #2 ' LSHI4 coni
 subs r22, #4 ' SUBI4 coni
 mov r20, FP
 ...
 mov BC, r22
 jmp #WLNG ' ASGNP4 reg reg
C_sgosg_664d6e73_aux_upvalue_L000479_492
 mov r22, r4
 shl r22, #3 ' LSHI4 coni
 subs r22, #8 ' SUBI4 coni
 mov r20, FP
 ...
 cmp r22,  #0 wz
 jmp #BRNZ
 long @C_sgosg_664d6e73_aux_upvalue_L000479_497 ' NEU4
 jmp #LODL
 long @C_sgosg_664d6e73_aux_upvalue_L000479_494_L000495
 mov r21, RI ' reg <- addrg
 jmp #JMPA
 long @C_sgosg_664d6e73_aux_upvalue_L000479_498 ' JUMPV addrg
C_sgosg_664d6e73_aux_upvalue_L000479_497
 mov r22, FP
 sub r22, #-(-16) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRP4 regl
 mov r21, r22
 adds r21, #16 ' ADDP4 coni
C_sgosg_664d6e73_aux_upvalue_L000479_498
 mov r0, r21 ' CVI, CVU or LOAD
 jmp #JMPA
 long @C_sgosg_664d6e73_aux_upvalue_L000479_480 ' JUMPV addrg
C_sgosg_664d6e73_aux_upvalue_L000479_481
 jmp #LODL
 long 0
 mov r0, RI ' reg <- con
C_sgosg_664d6e73_aux_upvalue_L000479_480
 jmp #POPM ' restore registers
 add SP, #12 ' framesize
 jmp #RETF
...
C_lua_getupvalue ' <symbol:lua_getupvalue>
 ...
 sub SP, #12 ' stack space for reg ARGs
 jmp #CALA
 long @C_sgosg_664d6e73_aux_upvalue_L000479
 add SP, #12 ' CALL addrg
 mov r17, r0 ' CVI, CVU or LOAD
 mov r22, r17 ' CVI, CVU or LOAD
 cmp r22,  #0 wz
...
DAT ' const data segment
 ...
 alignl ' align long
C_sgosi_664d6e73_getupvalref_L000508_nullup_L000511 ' <symbol:nullup>
 long $0
...
DAT ' code segment
 ...
 alignl ' align long
C_sgosi_664d6e73_getupvalref_L000508 ' <symbol:getupvalref>
 jmp #NEWF
 sub SP, #4
 jmp #PSHM
 long $fa8000 ' save registers
 ...
 cmp r22,  #0 wz
 jmp #BR_Z
 long @C_sgosi_664d6e73_getupvalref_L000508_512 ' EQU4
 mov RI, r17
 mov BC, r15
 jmp #WLNG ' ASGNP4 reg reg
C_sgosi_664d6e73_getupvalref_L000508_512
 mov r22, #1 ' reg <- coni
 cmps r22, r19 wz,wc
 jmp #BR_A
 long @C_sgosi_664d6e73_getupvalref_L000508_514 ' GTI4
 mov r22, r15
 adds r22, #12 ' ADDP4 coni
 mov RI, r22
 jmp #RLNG
 ...
 adds r0, r20 ' ADDI/P (3)
 jmp #JMPA
 long @C_sgosi_664d6e73_getupvalref_L000508_509 ' JUMPV addrg
C_sgosi_664d6e73_getupvalref_L000508_514
 jmp #LODL
 long @C_sgosi_664d6e73_getupvalref_L000508_nullup_L000511
 mov r0, RI ' reg <- addrg
C_sgosi_664d6e73_getupvalref_L000508_509
 jmp #POPM ' restore registers
 add SP, #4 ' framesize
 jmp #RETF
...
C_lua_upvalueid_520
 ...
 sub SP, #12 ' stack space for reg ARGs
 jmp #CALA
 long @C_sgosi_664d6e73_getupvalref_L000508
 add SP, #12 ' CALL addrg
 mov r22, r0 ' CVI, CVU or LOAD
 mov RI, r22
 jmp #RLNG
...
DAT ' const data segment
 ...
 alignl ' align long
C_sgosg_664d6e73_aux_upvalue_L000479_494_L000495 ' <symbol:494>
 byte 40
 byte 110
 byte 111
 byte 32
