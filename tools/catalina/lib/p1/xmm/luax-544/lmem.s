...
' C_luaM__free__27 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_sdf42_664d6dda_tryagain_L000028 ' <symbol:tryagain>
 jmp #NEWF
 jmp #PSHM
 long $fa8000 ' save registers
 mov r23, r5 ' reg var <- reg arg
 ...
 cmps r20, r22 wz
 jmp #BRNZ
 long @C_sdf42_664d6dda_tryagain_L000028_30 ' NEI4
 mov r20, r15
 ...
 mov r22, r0 ' CVI, CVU or LOAD
 jmp #JMPA
 long @C_sdf42_664d6dda_tryagain_L000028_29 ' JUMPV addrg
C_sdf42_664d6dda_tryagain_L000028_30
 jmp #LODL
 long 0
 mov r0, RI ' reg <- con
C_sdf42_664d6dda_tryagain_L000028_29
 jmp #POPM ' restore registers
 jmp #RETF
...
C_luaM__realloc_ ' <symbol:luaM_realloc_>
 ...
 sub SP, #12 ' stack space for reg ARGs
 jmp #CALA
 long @C_sdf42_664d6dda_tryagain_L000028
 add SP, #12 ' CALL addrg
 mov r13, r0 ' CVI, CVU or LOAD
