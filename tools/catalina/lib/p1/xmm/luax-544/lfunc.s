...
' C_luaF__initupvals_17 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_s2vg_664d6dda_newupval_L000024 ' <symbol:newupval>
 jmp #NEWF
 sub SP, #4
 jmp #PSHM
 ...
 cmp r22,  #0 wz
 jmp #BR_Z
 long @C_s2vg_664d6dda_newupval_L000024_26 ' EQU4
 mov r22, r13
 adds r22, #16 ' ADDP4 coni
 mov r20, r15
 adds r20, #12 ' ADDP4 coni
 ...
 mov BC, r20
 jmp #WLNG ' ASGNP4 reg reg
C_s2vg_664d6dda_newupval_L000024_26
 mov RI, r17
 mov BC, r15
 jmp #WLNG ' ASGNP4 reg reg
 mov r22, r23
 ...
 cmp r22, r20 wz
 jmp #BRNZ
 long @C_s2vg_664d6dda_newupval_L000024_28 ' NEU4
 mov r22, r23
 adds r22, #44 ' ADDP4 coni
 mov r20, r23
 adds r20, #16 ' ADDP4 coni
 ...
 mov BC, r23
 jmp #WLNG ' ASGNP4 reg reg
C_s2vg_664d6dda_newupval_L000024_28
 mov r0, r15 ' CVI, CVU or LOAD
' C_s2vg_664d6dda_newupval_L000024_25 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 add SP, #4 ' framesize
 jmp #RETF
...
C_luaF__findupval_36
 ...
 jmp #CALA
 long @C_s2vg_664d6dda_newupval_L000024
...
C_luaF__findupval_30
 ...
 alignl ' align long
C_s2vg1_664d6dda_callclosemethod_L000037 ' <symbol:callclosemethod>
 jmp #NEWF
 sub SP, #4
 jmp #PSHM
 ...
 cmps r17,  #0 wz
 jmp #BR_Z
 long @C_s2vg1_664d6dda_callclosemethod_L000037_39 ' EQI4
 ...
 add SP, #8 ' CALL addrg
 jmp #JMPA
 long @C_s2vg1_664d6dda_callclosemethod_L000037_40 ' JUMPV addrg
C_s2vg1_664d6dda_callclosemethod_L000037_39
 mov r2, #0 ' reg ARG coni
 mov r3, r15 ' CVI, CVU or LOAD
 mov r4, r23 ' CVI, CVU or LOAD
 mov BC, #12 ' arg size, rpsize = 12, spsize = 12
 ...
 add SP, #8 ' CALL addrg
C_s2vg1_664d6dda_callclosemethod_L000037_40
' C_s2vg1_664d6dda_callclosemethod_L000037_38 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 add SP, #4 ' framesize
 jmp #RETF
 ...
 alignl ' align long
C_s2vg2_664d6dda_checkclosemth_L000041 ' <symbol:checkclosemth>
 jmp #NEWF
 sub SP, #12
 jmp #PSHM
 ...
 cmps r22,  #0 wz
 jmp #BRNZ
 long @C_s2vg2_664d6dda_checkclosemth_L000041_43 ' NEI4
 mov r22, r21 ' CVI, CVU or LOAD
 mov r20, r23
 ...
 cmp r22,  #0 wz
 jmp #BRNZ
 long @C_s2vg2_664d6dda_checkclosemth_L000041_45 ' NEU4
 jmp #LODL
 long @C_s2vg2_664d6dda_checkclosemth_L000041_47_L000048
 mov r22, RI ' reg <- addrg
 mov RI, FP
 sub RI, #-(-12)
 wrlong r22 , RI ' ASGNP4 addrli reg
C_s2vg2_664d6dda_checkclosemth_L000041_45
 mov RI, FP
 sub RI, #-(-12)
 rdlong r2, RI ' reg ARG INDIR ADDRLi
 jmp #LODL
 long @C_s2vg2_664d6dda_checkclosemth_L000041_49_L000050
 ...
 add SP, #8 ' CALL addrg
C_s2vg2_664d6dda_checkclosemth_L000041_43
' C_s2vg2_664d6dda_checkclosemth_L000041_42 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 add SP, #12 ' framesize
 jmp #RETF
 ...
 alignl ' align long
C_s2vg5_664d6dda_prepcallclosemth_L000051 ' <symbol:prepcallclosemth>
 jmp #NEWF
 sub SP, #8
 jmp #PSHM
 ...
 cmps r19, r22 wz
 jmp #BRNZ
 long @C_s2vg5_664d6dda_prepcallclosemth_L000051_53 ' NEI4
 mov r22, r23
 adds r22, #16 ' ADDP4 coni
 mov RI, r22
 jmp #RLNG
 ...
 wrlong r22, RI ' ASGNP4 addrli reg
 jmp #JMPA
 long @C_s2vg5_664d6dda_prepcallclosemth_L000051_54 ' JUMPV addrg
C_s2vg5_664d6dda_prepcallclosemth_L000051_53
 mov r22, r21
 adds r22, #8 ' ADDP4 coni
 mov RI, FP
 sub RI, #-(-12)
 ...
 add SP, #8 ' CALL addrg
C_s2vg5_664d6dda_prepcallclosemth_L000051_54
 mov r2, r17 ' CVI, CVU or LOAD
 mov RI, FP
 sub RI, #-(-12)
 rdlong r3, RI ' reg ARG INDIR ADDRLi
 ...
 sub SP, #12 ' stack space for reg ARGs
 jmp #CALA
 long @C_s2vg1_664d6dda_callclosemethod_L000037
 add SP, #12 ' CALL addrg
' C_s2vg5_664d6dda_prepcallclosemth_L000051_52 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 add SP, #8 ' framesize
 jmp #RETF
...
C_luaF__newtbcupval_56
 ...
 jmp #CALA
 long @C_s2vg2_664d6dda_checkclosemth_L000041
 add SP, #4 ' CALL addrg
 jmp #JMPA
...
' C_luaF__closeupval_65 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_s2vg6_664d6dda_poptbclist_L000074 ' <symbol:poptbclist>
 jmp #PSHM
 ...
 jmp #JMPA
 long @C_s2vg6_664d6dda_poptbclist_L000074_77 ' JUMPV addrg
C_s2vg6_664d6dda_poptbclist_L000074_76
 jmp #LODL
 long -524280
 mov r22, RI ' reg <- con
 adds r23, r22 ' ADDI/P (1)
C_s2vg6_664d6dda_poptbclist_L000074_77
 ...
 cmp r22, r20 wz,wc 
 jmp #BRBE
 long @C_s2vg6_664d6dda_poptbclist_L000074_79 ' LEU4
 mov r22, r23
 adds r22, #6 ' ADDP4 coni
 mov RI, r22
 jmp #RWRD
 ...
 cmps r22,  #0 wz
 jmp #BR_Z
 long @C_s2vg6_664d6dda_poptbclist_L000074_76 ' EQI4
C_s2vg6_664d6dda_poptbclist_L000074_79
 mov r22, r2
 adds r22, #36 ' ADDP4 coni
 mov RI, r22
 mov BC, r23
 jmp #WLNG ' ASGNP4 reg reg
' C_s2vg6_664d6dda_poptbclist_L000074_75 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 jmp #RETN
...
C_luaF__close_81
 ...
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 jmp #CALA
 long @C_s2vg6_664d6dda_poptbclist_L000074 ' CALL addrg
 mov r2, r17 ' CVI, CVU or LOAD
 mov r3, r19 ' CVI, CVU or LOAD
 ...
 sub SP, #12 ' stack space for reg ARGs
 jmp #CALA
 long @C_s2vg5_664d6dda_prepcallclosemth_L000051
 add SP, #12 ' CALL addrg
 mov r22, r23
...
DAT ' const data segment
 ...
 alignl ' align long
C_s2vg2_664d6dda_checkclosemth_L000041_49_L000050 ' <symbol:49>
 byte 118
 byte 97
 byte 114
 byte 105
 ...
 alignl ' align long
C_s2vg2_664d6dda_checkclosemth_L000041_47_L000048 ' <symbol:47>
 byte 63
 byte 0
