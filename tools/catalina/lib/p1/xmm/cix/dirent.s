...
C_opendir ' <symbol:opendir>
 ...
 cmp r22,  #0 wz
 jmp #BRNZ
 long @C_opendir_14 ' NEU4
 jmp #LODL
 long 0
 mov r0, RI ' reg <- con
 jmp #JMPA
 long @C_opendir_13 ' JUMPV addrg
C_opendir_14
 mov r2, FP
...
C_readdir_33
 ...
 cmps r22,  #0 wz
 jmp #BR_Z
 long @C_readdir_39 ' EQI4
 cmps r22,  #32 wz
 jmp #BRNZ
 long @C_readdir_37 ' NEI4
C_readdir_39
 jmp #JMPA
 long @C_readdir_35 ' JUMPV addrg
C_readdir_37
...
C_readdir_40
 ...
 cmps r22,  #0 wz
 jmp #BR_Z
 long @C_readdir_46 ' EQI4
 cmps r22,  #32 wz
 jmp #BRNZ
 long @C_readdir_44 ' NEI4
C_readdir_46
 jmp #JMPA
 long @C_readdir_42 ' JUMPV addrg
C_readdir_44
 cmps r21,  #8 wz
 jmp #BRNZ
 long @C_readdir_47 ' NEI4
 mov r22, r19 ' CVI, CVU or LOAD
 mov r19, r22
 adds r19, #1 ' ADDI4 coni
 jmp #LODL
