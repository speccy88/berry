...
'
 ...
 alignl ' align long
C_su30_69c22bb9_two_digits_L000001 ' <symbol:two_digits>
 jmp #PSHM
 ...
 cmps r2,  #0 wz
 jmp #BRNZ
 long @C_su30_69c22bb9_two_digits_L000001_3 ' NEI4
 mov RI, r4
 jmp #RBYT
 ...
 mov BC, r22
 jmp #WBYT ' ASGNU1 reg reg
C_su30_69c22bb9_two_digits_L000001_3
...
' C_su30_69c22bb9_two_digits_L000001_2 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 jmp #RETN


 alignl ' align long
C_su301_69c22bb9_four_digits_L000005 ' <symbol:four_digits>
 jmp #PSHM
 long $500000 ' save registers
 jmp #LODL
 long 10000
 ...
 mov r0, r22 ' CVI, CVU or LOAD
' C_su301_69c22bb9_four_digits_L000005_6 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 jmp #RETN
...
C_asctime_16
 ...
 jmp #CALA
 long @C_su30_69c22bb9_two_digits_L000001
 add SP, #8 ' CALL addrg
 ...
 sub SP, #4 ' stack space for reg ARGs
 jmp #CALA
 long @C_su301_69c22bb9_four_digits_L000005
 add SP, #4 ' CALL addrg
 jmp #LODL
 long @C_asctime_buf_L000009
 mov r0, RI ' reg <- addrg
