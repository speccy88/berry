...
C_gm_bound_limits ' <symbol:gm_bound_limits>
 ...
 jmp #LODL
 long @C_s108k_69c22bcc_m_min_L000001
 mov BC, r22
 jmp #WLNG ' ASGNI4 addrg reg
 jmp #LODL
 long @C_s108k1_69c22bcc_m_max_L000002
 mov BC, r4
 jmp #WLNG ' ASGNI4 addrg reg
 mov r22, FP
 ...
 rdlong r22, r22 ' reg <- INDIRI4 regl
 jmp #LODL
 long @C_s108k_69c22bcc_m_min_L000001+4
 mov BC, r22
 jmp #WLNG ' ASGNI4 addrg reg
 jmp #LODL
 long @C_s108k1_69c22bcc_m_max_L000002+4
 mov BC, r3
 jmp #WLNG ' ASGNI4 addrg reg
 jmp #LODL
 long @C_s108k_69c22bcc_m_min_L000001+8
 mov BC, r5
 jmp #WLNG ' ASGNI4 addrg reg
 jmp #LODL
 long @C_s108k1_69c22bcc_m_max_L000002+8
 mov BC, r2
 jmp #WLNG ' ASGNI4 addrg reg
...
C_gm_bound_scales ' <symbol:gm_bound_scales>
 jmp #LODL
 long @C_s108k2_69c22bcc_m_div_L000003
 mov BC, r4
 jmp #WLNG ' ASGNI4 addrg reg
 jmp #LODL
 long @C_s108k2_69c22bcc_m_div_L000003+4
 mov BC, r3
 jmp #WLNG ' ASGNI4 addrg reg
 jmp #LODL
 long @C_s108k2_69c22bcc_m_div_L000003+8
 mov BC, r2
 jmp #WLNG ' ASGNI4 addrg reg
...
C_gm_bound_preset_19
 ...
 shl r22, #2 ' LSHI4 coni
 jmp #LODL
 long @C_s108k3_69c22bcc_m_acc_L000004
 mov r20, RI ' reg <- addrg
...
DAT ' uninitialized data segment
 ...
 alignl ' align long
C_s108k3_69c22bcc_m_acc_L000004 ' <symbol:m_acc>
 byte 0[12]

 alignl ' align long
C_s108k2_69c22bcc_m_div_L000003 ' <symbol:m_div>
 byte 0[12]

 alignl ' align long
C_s108k1_69c22bcc_m_max_L000002 ' <symbol:m_max>
 byte 0[12]

 alignl ' align long
C_s108k_69c22bcc_m_min_L000001 ' <symbol:m_min>
 byte 0[12]
