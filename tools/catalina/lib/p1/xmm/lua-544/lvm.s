...
'
 ...
 alignl ' align long
C_s2go_664d6ddb_l_strton_L000016 ' <symbol:l_strton>
 jmp #NEWF
 jmp #PSHM
 ...
 cmps r20, r22 wz
 jmp #BR_Z
 long @C_s2go_664d6ddb_l_strton_L000016_18 ' EQI4
 mov r0, #0 ' reg <- coni
 jmp #JMPA
 long @C_s2go_664d6ddb_l_strton_L000016_17 ' JUMPV addrg
C_s2go_664d6ddb_l_strton_L000016_18
 ...
 cmps r18, r20 wz
 jmp #BRNZ
 long @C_s2go_664d6ddb_l_strton_L000016_24 ' NEI4
 mov RI, r23
 jmp #RLNG
 ...
 jmp #JMPA
 long @C_s2go_664d6ddb_l_strton_L000016_25 ' JUMPV addrg
C_s2go_664d6ddb_l_strton_L000016_24
 mov RI, r23
 jmp #RLNG
 mov r20, BC ' reg <- INDIRP4 reg
...
C_s2go_664d6ddb_l_strton_L000016_25
 mov r20, r17
 add r20, #1 ' ADDU4 coni
 cmp r22, r20 wz
 jmp #BRNZ
 long @C_s2go_664d6ddb_l_strton_L000016_22 ' NEU4
 mov r19, #1 ' reg <- coni
 jmp #JMPA
 long @C_s2go_664d6ddb_l_strton_L000016_23 ' JUMPV addrg
C_s2go_664d6ddb_l_strton_L000016_22
 mov r19, #0 ' reg <- coni
C_s2go_664d6ddb_l_strton_L000016_23
 mov r0, r19 ' CVI, CVU or LOAD
C_s2go_664d6ddb_l_strton_L000016_17
...
C_luaV__tonumber__27
 ...
 sub SP, #4 ' stack space for reg ARGs
 jmp #CALA
 long @C_s2go_664d6ddb_l_strton_L000016
 add SP, #4 ' CALL addrg
 cmps r0,  #0 wz
 jmp #BR_Z
...
' C_luaV__tointeger_56 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_s2go4_664d6ddb_forlimit_L000059 ' <symbol:forlimit>
 jmp #NEWF
 sub SP, #4
 jmp #PSHM
 ...
 cmps r17,  #0 wz,wc
 jmp #BRAE
 long @C_s2go4_664d6ddb_forlimit_L000059_64 ' GEI4
 mov r15, #2 ' reg <- coni
 jmp #JMPA
 long @C_s2go4_664d6ddb_forlimit_L000059_65 ' JUMPV addrg
C_s2go4_664d6ddb_forlimit_L000059_64
 mov r15, #1 ' reg <- coni
C_s2go4_664d6ddb_forlimit_L000059_65
 ...
 cmps r0,  #0 wz
 jmp #BRNZ
 long @C_s2go4_664d6ddb_forlimit_L000059_61 ' NEI4
 mov r22, r21
 adds r22, #4 ' ADDP4 coni
 mov RI, r22
 jmp #RBYT
 ...
 cmps r22,  #19 wz
 jmp #BRNZ
 long @C_s2go4_664d6ddb_forlimit_L000059_69 ' NEI4
 mov RI, r21
 jmp #RLNG
 ...
 mov r13, #1 ' reg <- coni
 jmp #JMPA
 long @C_s2go4_664d6ddb_forlimit_L000059_70 ' JUMPV addrg
C_s2go4_664d6ddb_forlimit_L000059_69
 mov r2, FP
...
C_s2go4_664d6ddb_forlimit_L000059_70
 cmps r13,  #0 wz
 jmp #BRNZ
 long @C_s2go4_664d6ddb_forlimit_L000059_66 ' NEI4
 jmp #LODL
 long @C_s2go4_664d6ddb_forlimit_L000059_71_L000072
 ...
 add SP, #8 ' CALL addrg
C_s2go4_664d6ddb_forlimit_L000059_66
 jmp #LODI
 long @C_s2go4_664d6ddb_forlimit_L000059_75_L000076
 mov r22, RI ' reg <- INDIRF4 addrg
 mov r20, FP
 ...
 jmp #FCMP
 jmp #BRAE
 long @C_s2go4_664d6ddb_forlimit_L000059_73 ' GEF4
 cmps r17,  #0 wz,wc
 jmp #BRAE
 long @C_s2go4_664d6ddb_forlimit_L000059_77 ' GEI4
 mov r0, #1 ' reg <- coni
 jmp #JMPA
 long @C_s2go4_664d6ddb_forlimit_L000059_60 ' JUMPV addrg
C_s2go4_664d6ddb_forlimit_L000059_77
 jmp #LODL
 long 2147483647
 mov r22, RI ' reg <- con
 mov RI, r19
 ...
 jmp #WLNG ' ASGNI4 reg reg
 jmp #JMPA
 long @C_s2go4_664d6ddb_forlimit_L000059_74 ' JUMPV addrg
C_s2go4_664d6ddb_forlimit_L000059_73
 cmps r17,  #0 wz,wc
 jmp #BRBE
 long @C_s2go4_664d6ddb_forlimit_L000059_79 ' LEI4
 mov r0, #1 ' reg <- coni
 jmp #JMPA
 long @C_s2go4_664d6ddb_forlimit_L000059_60 ' JUMPV addrg
C_s2go4_664d6ddb_forlimit_L000059_79
 jmp #LODL
 long -2147483648
 mov r22, RI ' reg <- con
 mov RI, r19
 mov BC, r22
 jmp #WLNG ' ASGNI4 reg reg
C_s2go4_664d6ddb_forlimit_L000059_74
C_s2go4_664d6ddb_forlimit_L000059_61
 cmps r17,  #0 wz,wc
 jmp #BRBE
 long @C_s2go4_664d6ddb_forlimit_L000059_84 ' LEI4
 mov RI, r19
 jmp #RLNG
 mov r22, BC ' reg <- INDIRI4 reg
 cmps r23, r22 wz,wc
 jmp #BRBE
 long @C_s2go4_664d6ddb_forlimit_L000059_86 ' LEI4
 mov r11, #1 ' reg <- coni
 jmp #JMPA
 long @C_s2go4_664d6ddb_forlimit_L000059_87 ' JUMPV addrg
C_s2go4_664d6ddb_forlimit_L000059_86
 mov r11, #0 ' reg <- coni
C_s2go4_664d6ddb_forlimit_L000059_87
 mov r13, r11 ' CVI, CVU or LOAD
 jmp #JMPA
 long @C_s2go4_664d6ddb_forlimit_L000059_85 ' JUMPV addrg
C_s2go4_664d6ddb_forlimit_L000059_84
 mov RI, r19
 jmp #RLNG
 mov r22, BC ' reg <- INDIRI4 reg
 cmps r23, r22 wz,wc
 jmp #BRAE
 long @C_s2go4_664d6ddb_forlimit_L000059_88 ' GEI4
 mov r9, #1 ' reg <- coni
 jmp #JMPA
 long @C_s2go4_664d6ddb_forlimit_L000059_89 ' JUMPV addrg
C_s2go4_664d6ddb_forlimit_L000059_88
 mov r9, #0 ' reg <- coni
C_s2go4_664d6ddb_forlimit_L000059_89
 mov r13, r9 ' CVI, CVU or LOAD
C_s2go4_664d6ddb_forlimit_L000059_85
 mov r0, r13 ' CVI, CVU or LOAD
C_s2go4_664d6ddb_forlimit_L000059_60
 jmp #POPM ' restore registers
 add SP, #4 ' framesize
 jmp #RETF
 ...
 alignl ' align long
C_s2go7_664d6ddb_forprep_L000090 ' <symbol:forprep>
 jmp #NEWF
 sub SP, #24
 jmp #PSHM
 ...
 cmps r20, r22 wz
 jmp #BRNZ
 long @C_s2go7_664d6ddb_forprep_L000090_92 ' NEI4
 mov r20, r19
 adds r20, #4 ' ADDP4 coni
 mov RI, r20
 jmp #RBYT
 ...
 cmps r22,  #0 wz
 jmp #BRNZ
 long @C_s2go7_664d6ddb_forprep_L000090_94 ' NEI4
 jmp #LODL
 long @C_s2go7_664d6ddb_forprep_L000090_96_L000097
 mov r2, RI ' reg ARG ADDRG
 mov r3, r23 ' CVI, CVU or LOAD
 mov BC, #8 ' arg size, rpsize = 8, spsize = 8
 sub SP, #4 ' stack space for reg ARGs
 ...
 add SP, #4 ' CALL addrg
C_s2go7_664d6ddb_forprep_L000090_94
 mov r22, r21
 ...
 jmp #CALA
 long @C_s2go4_664d6ddb_forlimit_L000059
 add SP, #16 ' CALL addrg
 cmps r0,  #0 wz
 jmp #BR_Z
 long @C_s2go7_664d6ddb_forprep_L000090_98 ' EQI4
 mov r0, #1 ' reg <- coni
 jmp #JMPA
 long @C_s2go7_664d6ddb_forprep_L000090_91 ' JUMPV addrg
C_s2go7_664d6ddb_forprep_L000090_98
 mov r22, FP
 sub r22, #-(-8) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRI4 regl
 cmps r22,  #0 wz,wc
 jmp #BRBE
 long @C_s2go7_664d6ddb_forprep_L000090_100 ' LEI4
 mov r22, FP
 ...
 cmps r22,  #1 wz
 jmp #BR_Z
 long @C_s2go7_664d6ddb_forprep_L000090_101 ' EQI4
 mov r22, FP
 sub r22, #-(-20) ' reg <- addrli
 ...
 jmp #JMPA
 long @C_s2go7_664d6ddb_forprep_L000090_101 ' JUMPV addrg
C_s2go7_664d6ddb_forprep_L000090_100
 mov r22, FP
 sub r22, #-(-12) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRI4 regl
 mov r20, FP
 ...
 sub RI, #-(-20)
 wrlong r0, RI ' ASGNU4 addrli reg
C_s2go7_664d6ddb_forprep_L000090_101
 mov RI, FP
 sub RI, #-(-24)
 ...
 jmp #WBYT ' ASGNU1 reg reg
 jmp #JMPA
 long @C_s2go7_664d6ddb_forprep_L000090_93 ' JUMPV addrg
C_s2go7_664d6ddb_forprep_L000090_92
 mov r22, r15
 adds r22, #4 ' ADDP4 coni
 mov RI, r22
 jmp #RBYT
 ...
 cmps r22,  #19 wz
 jmp #BRNZ
 long @C_s2go7_664d6ddb_forprep_L000090_107 ' NEI4
 mov RI, r15
 jmp #RLNG
 mov r22, BC ' reg <- INDIRF4 reg
 mov RI, FP
 ...
 mov r13, #1 ' reg <- coni
 jmp #JMPA
 long @C_s2go7_664d6ddb_forprep_L000090_108 ' JUMPV addrg
C_s2go7_664d6ddb_forprep_L000090_107
 mov r2, FP
 sub r2, #-(-12) ' reg ARG ADDRLi
 ...
 mov r22, r0 ' CVI, CVU or LOAD
 mov r13, r22 ' CVI, CVU or LOAD
C_s2go7_664d6ddb_forprep_L000090_108
 cmps r13,  #0 wz
 jmp #BRNZ
 long @C_s2go7_664d6ddb_forprep_L000090_104 ' NEI4
 jmp #LODL
 long @C_s2go4_664d6ddb_forlimit_L000059_71_L000072
 mov r2, RI ' reg ARG ADDRG
 mov r3, r15 ' CVI, CVU or LOAD
 ...
 long @C_luaG__forerror
 add SP, #8 ' CALL addrg
C_s2go7_664d6ddb_forprep_L000090_104
 mov r22, r19
 adds r22, #4 ' ADDP4 coni
 mov RI, r22
 jmp #RBYT
 ...
 cmps r22,  #19 wz
 jmp #BRNZ
 long @C_s2go7_664d6ddb_forprep_L000090_112 ' NEI4
 mov RI, r19
 jmp #RLNG
 mov r22, BC ' reg <- INDIRF4 reg
 mov RI, FP
 ...
 mov r11, #1 ' reg <- coni
 jmp #JMPA
 long @C_s2go7_664d6ddb_forprep_L000090_113 ' JUMPV addrg
C_s2go7_664d6ddb_forprep_L000090_112
 mov r2, FP
...
C_s2go7_664d6ddb_forprep_L000090_113
 cmps r11,  #0 wz
 jmp #BRNZ
 long @C_s2go7_664d6ddb_forprep_L000090_109 ' NEI4
 jmp #LODL
 long @C_s2go7_664d6ddb_forprep_L000090_114_L000115
 mov r2, RI ' reg ARG ADDRG
 mov r3, r19 ' CVI, CVU or LOAD
 mov r4, r23 ' CVI, CVU or LOAD
 mov BC, #12 ' arg size, rpsize = 12, spsize = 12
 ...
 long @C_luaG__forerror
 add SP, #8 ' CALL addrg
C_s2go7_664d6ddb_forprep_L000090_109
 mov r22, r17
 adds r22, #4 ' ADDP4 coni
 mov RI, r22
 jmp #RBYT
 ...
 cmps r22,  #19 wz
 jmp #BRNZ
 long @C_s2go7_664d6ddb_forprep_L000090_119 ' NEI4
 mov RI, r17
 jmp #RLNG
 mov r22, BC ' reg <- INDIRF4 reg
 mov RI, FP
 ...
 mov r9, #1 ' reg <- coni
 jmp #JMPA
 long @C_s2go7_664d6ddb_forprep_L000090_120 ' JUMPV addrg
C_s2go7_664d6ddb_forprep_L000090_119
 mov r2, FP
 sub r2, #-(-8) ' reg ARG ADDRLi
...
C_s2go7_664d6ddb_forprep_L000090_120
 cmps r9,  #0 wz
 jmp #BRNZ
 long @C_s2go7_664d6ddb_forprep_L000090_116 ' NEI4
 jmp #LODL
 long @C_s2go7_664d6ddb_forprep_L000090_121_L000122
 mov r2, RI ' reg ARG ADDRG
 mov r3, r17 ' CVI, CVU or LOAD
 mov r4, r23 ' CVI, CVU or LOAD
 mov BC, #12 ' arg size, rpsize = 12, spsize = 12
 ...
 long @C_luaG__forerror
 add SP, #8 ' CALL addrg
C_s2go7_664d6ddb_forprep_L000090_116
 mov r22, FP
 sub r22, #-(-16) ' reg <- addrli
 ...
 jmp #FCMP
 jmp #BRNZ
 long @C_s2go7_664d6ddb_forprep_L000090_123 ' NEF4
 jmp #LODL
 long @C_s2go7_664d6ddb_forprep_L000090_96_L000097
 mov r2, RI ' reg ARG ADDRG
 mov r3, r23 ' CVI, CVU or LOAD
 ...
 long @C_luaG__runerror
 add SP, #4 ' CALL addrg
C_s2go7_664d6ddb_forprep_L000090_123
 jmp #LODI
 long @C_s2go4_664d6ddb_forlimit_L000059_75_L000076
 mov r22, RI ' reg <- INDIRF4 addrg
 mov r20, FP
 ...
 jmp #FCMP
 jmp #BRAE
 long @C_s2go7_664d6ddb_forprep_L000090_130 ' GEF4
 mov r22, FP
 sub r22, #-(-12) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRF4 regl
 mov r20, FP
 ...
 jmp #FCMP
 jmp #BRAE
 long @C_s2go7_664d6ddb_forprep_L000090_132 ' GEF4
 mov r22, #1 ' reg <- coni
 mov RI, FP
 sub RI, #-(-20)
 wrlong r22, RI ' ASGNI4 addrli reg
 jmp #JMPA
 long @C_s2go7_664d6ddb_forprep_L000090_133 ' JUMPV addrg
C_s2go7_664d6ddb_forprep_L000090_132
 mov r22, #0 ' reg <- coni
 mov RI, FP
 sub RI, #-(-20)
 wrlong r22, RI ' ASGNI4 addrli reg
C_s2go7_664d6ddb_forprep_L000090_133
 mov r22, FP
 sub r22, #-(-20) ' reg <- addrli
 rdlong r7, r22 ' reg <- INDIRI4 regl
 jmp #JMPA
 long @C_s2go7_664d6ddb_forprep_L000090_131 ' JUMPV addrg
C_s2go7_664d6ddb_forprep_L000090_130
 mov r22, FP
 sub r22, #-(-8) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRF4 regl
 mov r20, FP
 ...
 jmp #FCMP
 jmp #BRAE
 long @C_s2go7_664d6ddb_forprep_L000090_134 ' GEF4
 mov r22, #1 ' reg <- coni
 mov RI, FP
 sub RI, #-(-24)
 wrlong r22, RI ' ASGNI4 addrli reg
 jmp #JMPA
 long @C_s2go7_664d6ddb_forprep_L000090_135 ' JUMPV addrg
C_s2go7_664d6ddb_forprep_L000090_134
 mov r22, #0 ' reg <- coni
 mov RI, FP
 sub RI, #-(-24)
 wrlong r22, RI ' ASGNI4 addrli reg
C_s2go7_664d6ddb_forprep_L000090_135
 mov r22, FP
 sub r22, #-(-24) ' reg <- addrli
 rdlong r7, r22 ' reg <- INDIRI4 regl
C_s2go7_664d6ddb_forprep_L000090_131
 cmps r7,  #0 wz
 jmp #BR_Z
 long @C_s2go7_664d6ddb_forprep_L000090_125 ' EQI4
 mov r0, #1 ' reg <- coni
 jmp #JMPA
 long @C_s2go7_664d6ddb_forprep_L000090_91 ' JUMPV addrg
C_s2go7_664d6ddb_forprep_L000090_125
 mov RI, FP
 sub RI, #-(-28)
 wrlong r15, RI ' ASGNP4 addrli reg
 mov r22, FP
 ...
 mov BC, r20
 jmp #WBYT ' ASGNU1 reg reg
C_s2go7_664d6ddb_forprep_L000090_93
 mov r0, #0 ' reg <- coni
C_s2go7_664d6ddb_forprep_L000090_91
 jmp #POPM ' restore registers
 add SP, #24 ' framesize
 jmp #RETF
 ...
 alignl ' align long
C_s2gob_664d6ddb_floatforloop_L000136 ' <symbol:floatforloop>
 jmp #NEWF
 sub SP, #4
 jmp #PSHM
 ...
 jmp #FCMP
 jmp #BRAE
 long @C_s2gob_664d6ddb_floatforloop_L000136_143 ' GEF4
 mov r0, r23 ' setup r0/r1 (2)
 mov r1, r19 ' setup r0/r1 (2)
 jmp #FCMP
 jmp #BR_A
 long @C_s2gob_664d6ddb_floatforloop_L000136_145 ' GTF4
 mov r15, #1 ' reg <- coni
 jmp #JMPA
 long @C_s2gob_664d6ddb_floatforloop_L000136_146 ' JUMPV addrg
C_s2gob_664d6ddb_floatforloop_L000136_145
 mov r15, #0 ' reg <- coni
C_s2gob_664d6ddb_floatforloop_L000136_146
 mov r17, r15 ' CVI, CVU or LOAD
 jmp #JMPA
 long @C_s2gob_664d6ddb_floatforloop_L000136_144 ' JUMPV addrg
C_s2gob_664d6ddb_floatforloop_L000136_143
 mov r0, r19 ' setup r0/r1 (2)
 mov r1, r23 ' setup r0/r1 (2)
 jmp #FCMP
 jmp #BR_A
 long @C_s2gob_664d6ddb_floatforloop_L000136_147 ' GTF4
 mov r13, #1 ' reg <- coni
 jmp #JMPA
 long @C_s2gob_664d6ddb_floatforloop_L000136_148 ' JUMPV addrg
C_s2gob_664d6ddb_floatforloop_L000136_147
 mov r13, #0 ' reg <- coni
C_s2gob_664d6ddb_floatforloop_L000136_148
 mov r17, r13 ' CVI, CVU or LOAD
C_s2gob_664d6ddb_floatforloop_L000136_144
 cmps r17,  #0 wz
 jmp #BR_Z
 long @C_s2gob_664d6ddb_floatforloop_L000136_138 ' EQI4
 mov RI, FP
 sub RI, #-(-8)
 ...
 mov r0, #1 ' reg <- coni
 jmp #JMPA
 long @C_s2gob_664d6ddb_floatforloop_L000136_137 ' JUMPV addrg
C_s2gob_664d6ddb_floatforloop_L000136_138
 mov r0, #0 ' reg <- coni
C_s2gob_664d6ddb_floatforloop_L000136_137
 jmp #POPM ' restore registers
 add SP, #4 ' framesize
 jmp #RETF
...
C_luaV__finishset_180
 ...
 alignl ' align long
C_s2gof_664d6ddb_l_strcmp_L000213 ' <symbol:l_strcmp>
 jmp #NEWF
 sub SP, #8
 jmp #PSHM
 long $faaa80 ' save registers
 ...
 cmps r20, r22 wz
 jmp #BRNZ
 long @C_s2gof_664d6ddb_l_strcmp_L000213_216 ' NEI4
 mov r22, r23
 ...
 mov r11, r22 ' CVI, CVU or LOAD
 jmp #JMPA
 long @C_s2gof_664d6ddb_l_strcmp_L000213_217 ' JUMPV addrg
C_s2gof_664d6ddb_l_strcmp_L000213_216
 mov r22, r23
 adds r22, #12 ' ADDP4 coni
 mov RI, r22
 jmp #RLNG
 mov r11, BC ' reg <- INDIRU4 reg
C_s2gof_664d6ddb_l_strcmp_L000213_217
 mov r15, r11 ' CVI, CVU or LOAD
 mov r17, r21
 ...
 cmps r20, r22 wz
 jmp #BRNZ
 long @C_s2gof_664d6ddb_l_strcmp_L000213_219 ' NEI4
 mov r22, r21
 adds r22, #7 ' ADDP4 coni
 mov RI, r22
 jmp #RBYT
 ...
 mov r9, r22 ' CVI, CVU or LOAD
 jmp #JMPA
 long @C_s2gof_664d6ddb_l_strcmp_L000213_220 ' JUMPV addrg
C_s2gof_664d6ddb_l_strcmp_L000213_219
 mov r22, r21
 adds r22, #12 ' ADDP4 coni
 mov RI, r22
 jmp #RLNG
 mov r9, BC ' reg <- INDIRU4 reg
C_s2gof_664d6ddb_l_strcmp_L000213_220
 mov r13, r9 ' CVI, CVU or LOAD
C_s2gof_664d6ddb_l_strcmp_L000213_221
 ...
 cmps r7,  #0 wz
 jmp #BR_Z
 long @C_s2gof_664d6ddb_l_strcmp_L000213_225 ' EQI4
 mov r0, r7 ' CVI, CVU or LOAD
 jmp #JMPA
 long @C_s2gof_664d6ddb_l_strcmp_L000213_214 ' JUMPV addrg
C_s2gof_664d6ddb_l_strcmp_L000213_225
 mov r2, r19 ' CVI, CVU or LOAD
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 jmp #CALA
 ...
 cmp r22, r13 wz
 jmp #BRNZ
 long @C_s2gof_664d6ddb_l_strcmp_L000213_227 ' NEU4
 mov r22, FP
 sub r22, #-(-8) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRU4 regl
 cmp r22, r15 wz
 jmp #BRNZ
 long @C_s2gof_664d6ddb_l_strcmp_L000213_230 ' NEU4
 mov r22, #0 ' reg <- coni
 mov RI, FP
 sub RI, #-(-12)
 wrlong r22, RI ' ASGNI4 addrli reg
 jmp #JMPA
 long @C_s2gof_664d6ddb_l_strcmp_L000213_231 ' JUMPV addrg
C_s2gof_664d6ddb_l_strcmp_L000213_230
 mov r22, #1 ' reg <- coni
 mov RI, FP
 sub RI, #-(-12)
 wrlong r22, RI ' ASGNI4 addrli reg
C_s2gof_664d6ddb_l_strcmp_L000213_231
 mov r22, FP
 sub r22, #-(-12) ' reg <- addrli
 rdlong r0, r22 ' reg <- INDIRI4 regl
 jmp #JMPA
 long @C_s2gof_664d6ddb_l_strcmp_L000213_214 ' JUMPV addrg
C_s2gof_664d6ddb_l_strcmp_L000213_227
 mov r22, FP
 sub r22, #-(-8) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRU4 regl
 cmp r22, r15 wz
 jmp #BRNZ
 long @C_s2gof_664d6ddb_l_strcmp_L000213_232 ' NEU4
 jmp #LODL
 long -1
 mov r0, RI ' reg <- con
 jmp #JMPA
 long @C_s2gof_664d6ddb_l_strcmp_L000213_214 ' JUMPV addrg
C_s2gof_664d6ddb_l_strcmp_L000213_232
 mov r22, FP
 sub r22, #-(-8) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRU4 regl
 ...
 sub r13, r22 ' SUBU (1)
 jmp #JMPA
 long @C_s2gof_664d6ddb_l_strcmp_L000213_221 ' JUMPV addrg
C_s2gof_664d6ddb_l_strcmp_L000213_214
 jmp #POPM ' restore registers
 add SP, #8 ' framesize
 jmp #RETF
 ...
 alignl ' align long
C_s2gog_664d6ddb_L_T_intfloat_L000234 ' <symbol:LTintfloat>
 jmp #NEWF
 sub SP, #4
 jmp #PSHM
 ...
 cmp r22, r20 wz,wc 
 jmp #BR_A
 long @C_s2gog_664d6ddb_L_T_intfloat_L000234_236 ' GTU4
 mov r0, r23 ' CVI, CVU or LOAD
 jmp #FLIN ' CVIF4
 mov r1, r21 ' setup r0/r1 (2)
 jmp #FCMP
 jmp #BRAE
 long @C_s2gog_664d6ddb_L_T_intfloat_L000234_239 ' GEF4
 mov r19, #1 ' reg <- coni
 jmp #JMPA
 long @C_s2gog_664d6ddb_L_T_intfloat_L000234_240 ' JUMPV addrg
C_s2gog_664d6ddb_L_T_intfloat_L000234_239
 mov r19, #0 ' reg <- coni
C_s2gog_664d6ddb_L_T_intfloat_L000234_240
 mov r0, r19 ' CVI, CVU or LOAD
 jmp #JMPA
 long @C_s2gog_664d6ddb_L_T_intfloat_L000234_235 ' JUMPV addrg
C_s2gog_664d6ddb_L_T_intfloat_L000234_236
 ...
 cmps r0,  #0 wz
 jmp #BR_Z
 long @C_s2gog_664d6ddb_L_T_intfloat_L000234_241 ' EQI4
 mov r22, FP
 sub r22, #-(-8) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRI4 regl
 cmps r23, r22 wz,wc
 jmp #BRAE
 long @C_s2gog_664d6ddb_L_T_intfloat_L000234_244 ' GEI4
 mov r17, #1 ' reg <- coni
 jmp #JMPA
 long @C_s2gog_664d6ddb_L_T_intfloat_L000234_245 ' JUMPV addrg
C_s2gog_664d6ddb_L_T_intfloat_L000234_244
 mov r17, #0 ' reg <- coni
C_s2gog_664d6ddb_L_T_intfloat_L000234_245
 mov r0, r17 ' CVI, CVU or LOAD
 jmp #JMPA
 long @C_s2gog_664d6ddb_L_T_intfloat_L000234_235 ' JUMPV addrg
C_s2gog_664d6ddb_L_T_intfloat_L000234_241
 jmp #LODI
 long @C_s2go4_664d6ddb_forlimit_L000059_75_L000076
 mov r22, RI ' reg <- INDIRF4 addrg
 ...
 jmp #FCMP
 jmp #BRBE
 long @C_s2gog_664d6ddb_L_T_intfloat_L000234_247 ' LEF4
 mov r15, #1 ' reg <- coni
 jmp #JMPA
 long @C_s2gog_664d6ddb_L_T_intfloat_L000234_248 ' JUMPV addrg
C_s2gog_664d6ddb_L_T_intfloat_L000234_247
 mov r15, #0 ' reg <- coni
C_s2gog_664d6ddb_L_T_intfloat_L000234_248
 mov r0, r15 ' CVI, CVU or LOAD
C_s2gog_664d6ddb_L_T_intfloat_L000234_235
 jmp #POPM ' restore registers
 add SP, #4 ' framesize
 jmp #RETF
 ...
 alignl ' align long
C_s2goh_664d6ddb_L_E_intfloat_L000249 ' <symbol:LEintfloat>
 jmp #NEWF
 sub SP, #4
 jmp #PSHM
 long $fa8000 ' save registers
 ...
 cmp r22, r20 wz,wc 
 jmp #BR_A
 long @C_s2goh_664d6ddb_L_E_intfloat_L000249_251 ' GTU4
 mov r0, r23 ' CVI, CVU or LOAD
 jmp #FLIN ' CVIF4
 mov r1, r21 ' setup r0/r1 (2)
 jmp #FCMP
 jmp #BR_A
 long @C_s2goh_664d6ddb_L_E_intfloat_L000249_254 ' GTF4
 mov r19, #1 ' reg <- coni
 jmp #JMPA
 long @C_s2goh_664d6ddb_L_E_intfloat_L000249_255 ' JUMPV addrg
C_s2goh_664d6ddb_L_E_intfloat_L000249_254
 mov r19, #0 ' reg <- coni
C_s2goh_664d6ddb_L_E_intfloat_L000249_255
 mov r0, r19 ' CVI, CVU or LOAD
 jmp #JMPA
 long @C_s2goh_664d6ddb_L_E_intfloat_L000249_250 ' JUMPV addrg
C_s2goh_664d6ddb_L_E_intfloat_L000249_251
 mov r2, #1 ' reg ARG coni
 mov r3, FP
 sub r3, #-(-8) ' reg ARG ADDRLi
 mov r4, r21 ' CVI, CVU or LOAD
 ...
 cmps r0,  #0 wz
 jmp #BR_Z
 long @C_s2goh_664d6ddb_L_E_intfloat_L000249_256 ' EQI4
 mov r22, FP
 sub r22, #-(-8) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRI4 regl
 cmps r23, r22 wz,wc
 jmp #BR_A
 long @C_s2goh_664d6ddb_L_E_intfloat_L000249_259 ' GTI4
 mov r17, #1 ' reg <- coni
 jmp #JMPA
 long @C_s2goh_664d6ddb_L_E_intfloat_L000249_260 ' JUMPV addrg
C_s2goh_664d6ddb_L_E_intfloat_L000249_259
 mov r17, #0 ' reg <- coni
C_s2goh_664d6ddb_L_E_intfloat_L000249_260
 mov r0, r17 ' CVI, CVU or LOAD
 jmp #JMPA
 long @C_s2goh_664d6ddb_L_E_intfloat_L000249_250 ' JUMPV addrg
C_s2goh_664d6ddb_L_E_intfloat_L000249_256
 jmp #LODI
 long @C_s2go4_664d6ddb_forlimit_L000059_75_L000076
 mov r22, RI ' reg <- INDIRF4 addrg
 mov r0, r21 ' setup r0/r1 (2)
 ...
 jmp #FCMP
 jmp #BRBE
 long @C_s2goh_664d6ddb_L_E_intfloat_L000249_262 ' LEF4
 mov r15, #1 ' reg <- coni
 jmp #JMPA
 long @C_s2goh_664d6ddb_L_E_intfloat_L000249_263 ' JUMPV addrg
C_s2goh_664d6ddb_L_E_intfloat_L000249_262
 mov r15, #0 ' reg <- coni
C_s2goh_664d6ddb_L_E_intfloat_L000249_263
 mov r0, r15 ' CVI, CVU or LOAD
C_s2goh_664d6ddb_L_E_intfloat_L000249_250
 jmp #POPM ' restore registers
 add SP, #4 ' framesize
 jmp #RETF
 ...
 alignl ' align long
C_s2goi_664d6ddb_L_T_floatint_L000264 ' <symbol:LTfloatint>
 jmp #NEWF
 sub SP, #4
 jmp #PSHM
 long $fa8000 ' save registers
 ...
 cmp r22, r20 wz,wc 
 jmp #BR_A
 long @C_s2goi_664d6ddb_L_T_floatint_L000264_266 ' GTU4
 ...
 jmp #FCMP
 jmp #BRAE
 long @C_s2goi_664d6ddb_L_T_floatint_L000264_269 ' GEF4
 mov r19, #1 ' reg <- coni
 jmp #JMPA
 long @C_s2goi_664d6ddb_L_T_floatint_L000264_270 ' JUMPV addrg
C_s2goi_664d6ddb_L_T_floatint_L000264_269
 mov r19, #0 ' reg <- coni
C_s2goi_664d6ddb_L_T_floatint_L000264_270
 mov r0, r19 ' CVI, CVU or LOAD
 jmp #JMPA
 long @C_s2goi_664d6ddb_L_T_floatint_L000264_265 ' JUMPV addrg
C_s2goi_664d6ddb_L_T_floatint_L000264_266
 mov r2, #1 ' reg ARG coni
 mov r3, FP
 sub r3, #-(-8) ' reg ARG ADDRLi
 mov r4, r23 ' CVI, CVU or LOAD
 ...
 cmps r0,  #0 wz
 jmp #BR_Z
 long @C_s2goi_664d6ddb_L_T_floatint_L000264_271 ' EQI4
 mov r22, FP
 sub r22, #-(-8) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRI4 regl
 cmps r22, r21 wz,wc
 jmp #BRAE
 long @C_s2goi_664d6ddb_L_T_floatint_L000264_274 ' GEI4
 mov r17, #1 ' reg <- coni
 jmp #JMPA
 long @C_s2goi_664d6ddb_L_T_floatint_L000264_275 ' JUMPV addrg
C_s2goi_664d6ddb_L_T_floatint_L000264_274
 mov r17, #0 ' reg <- coni
C_s2goi_664d6ddb_L_T_floatint_L000264_275
 mov r0, r17 ' CVI, CVU or LOAD
 jmp #JMPA
 long @C_s2goi_664d6ddb_L_T_floatint_L000264_265 ' JUMPV addrg
C_s2goi_664d6ddb_L_T_floatint_L000264_271
 jmp #LODI
 long @C_s2go4_664d6ddb_forlimit_L000059_75_L000076
 mov r22, RI ' reg <- INDIRF4 addrg
 mov r0, r23 ' setup r0/r1 (2)
 ...
 jmp #FCMP
 jmp #BRAE
 long @C_s2goi_664d6ddb_L_T_floatint_L000264_277 ' GEF4
 mov r15, #1 ' reg <- coni
 jmp #JMPA
 long @C_s2goi_664d6ddb_L_T_floatint_L000264_278 ' JUMPV addrg
C_s2goi_664d6ddb_L_T_floatint_L000264_277
 mov r15, #0 ' reg <- coni
C_s2goi_664d6ddb_L_T_floatint_L000264_278
 mov r0, r15 ' CVI, CVU or LOAD
C_s2goi_664d6ddb_L_T_floatint_L000264_265
 jmp #POPM ' restore registers
 add SP, #4 ' framesize
 jmp #RETF
 ...
 alignl ' align long
C_s2goj_664d6ddb_L_E_floatint_L000279 ' <symbol:LEfloatint>
 jmp #NEWF
 sub SP, #4
 jmp #PSHM
 long $fa8000 ' save registers
 ...
 cmp r22, r20 wz,wc 
 jmp #BR_A
 long @C_s2goj_664d6ddb_L_E_floatint_L000279_281 ' GTU4
 mov r0, r21 ' CVI, CVU or LOAD
 jmp #FLIN ' CVIF4
 mov r1, r0 ' setup r0/r1 (1)
 mov r0, r23 ' setup r0/r1 (1)
 jmp #FCMP
 jmp #BR_A
 long @C_s2goj_664d6ddb_L_E_floatint_L000279_284 ' GTF4
 mov r19, #1 ' reg <- coni
 jmp #JMPA
 long @C_s2goj_664d6ddb_L_E_floatint_L000279_285 ' JUMPV addrg
C_s2goj_664d6ddb_L_E_floatint_L000279_284
 mov r19, #0 ' reg <- coni
C_s2goj_664d6ddb_L_E_floatint_L000279_285
 mov r0, r19 ' CVI, CVU or LOAD
 jmp #JMPA
 long @C_s2goj_664d6ddb_L_E_floatint_L000279_280 ' JUMPV addrg
C_s2goj_664d6ddb_L_E_floatint_L000279_281
 mov r2, #2 ' reg ARG coni
 mov r3, FP
 sub r3, #-(-8) ' reg ARG ADDRLi
 mov r4, r23 ' CVI, CVU or LOAD
 ...
 cmps r0,  #0 wz
 jmp #BR_Z
 long @C_s2goj_664d6ddb_L_E_floatint_L000279_286 ' EQI4
 mov r22, FP
 sub r22, #-(-8) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRI4 regl
 cmps r22, r21 wz,wc
 jmp #BR_A
 long @C_s2goj_664d6ddb_L_E_floatint_L000279_289 ' GTI4
 mov r17, #1 ' reg <- coni
 jmp #JMPA
 long @C_s2goj_664d6ddb_L_E_floatint_L000279_290 ' JUMPV addrg
C_s2goj_664d6ddb_L_E_floatint_L000279_289
 mov r17, #0 ' reg <- coni
C_s2goj_664d6ddb_L_E_floatint_L000279_290
 mov r0, r17 ' CVI, CVU or LOAD
 jmp #JMPA
 long @C_s2goj_664d6ddb_L_E_floatint_L000279_280 ' JUMPV addrg
C_s2goj_664d6ddb_L_E_floatint_L000279_286
 jmp #LODI
 long @C_s2go4_664d6ddb_forlimit_L000059_75_L000076
 mov r22, RI ' reg <- INDIRF4 addrg
 mov r0, r23 ' setup r0/r1 (2)
 ...
 jmp #FCMP
 jmp #BRAE
 long @C_s2goj_664d6ddb_L_E_floatint_L000279_292 ' GEF4
 mov r15, #1 ' reg <- coni
 jmp #JMPA
 long @C_s2goj_664d6ddb_L_E_floatint_L000279_293 ' JUMPV addrg
C_s2goj_664d6ddb_L_E_floatint_L000279_292
 mov r15, #0 ' reg <- coni
C_s2goj_664d6ddb_L_E_floatint_L000279_293
 mov r0, r15 ' CVI, CVU or LOAD
C_s2goj_664d6ddb_L_E_floatint_L000279_280
 jmp #POPM ' restore registers
 add SP, #4 ' framesize
 jmp #RETF
 ...
 alignl ' align long
C_s2gok_664d6ddb_L_T_num_L000294 ' <symbol:LTnum>
 jmp #NEWF
 sub SP, #4
 jmp #PSHM
 ...
 cmps r22,  #3 wz
 jmp #BRNZ
 long @C_s2gok_664d6ddb_L_T_num_L000294_296 ' NEI4
 mov RI, r23
 jmp #RLNG
 mov r22, BC ' reg <- INDIRI4 reg
 mov RI, FP
 ...
 cmps r22,  #3 wz
 jmp #BRNZ
 long @C_s2gok_664d6ddb_L_T_num_L000294_298 ' NEI4
 mov r22, FP
 sub r22, #-(-8) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRI4 regl
 mov RI, r21
 ...
 cmps r22, r20 wz,wc
 jmp #BRAE
 long @C_s2gok_664d6ddb_L_T_num_L000294_301 ' GEI4
 mov r19, #1 ' reg <- coni
 jmp #JMPA
 long @C_s2gok_664d6ddb_L_T_num_L000294_302 ' JUMPV addrg
C_s2gok_664d6ddb_L_T_num_L000294_301
 mov r19, #0 ' reg <- coni
C_s2gok_664d6ddb_L_T_num_L000294_302
 mov r0, r19 ' CVI, CVU or LOAD
 jmp #JMPA
 long @C_s2gok_664d6ddb_L_T_num_L000294_295 ' JUMPV addrg
C_s2gok_664d6ddb_L_T_num_L000294_298
 mov RI, r21
 jmp #RLNG
 ...
 sub SP, #4 ' stack space for reg ARGs
 jmp #CALA
 long @C_s2gog_664d6ddb_L_T_intfloat_L000234
 add SP, #4 ' CALL addrg
 mov r22, r0 ' CVI, CVU or LOAD
 jmp #JMPA
 long @C_s2gok_664d6ddb_L_T_num_L000294_295 ' JUMPV addrg
C_s2gok_664d6ddb_L_T_num_L000294_296
 mov RI, r23
 jmp #RLNG
 mov r22, BC ' reg <- INDIRF4 reg
 mov RI, FP
 ...
 cmps r22,  #19 wz
 jmp #BRNZ
 long @C_s2gok_664d6ddb_L_T_num_L000294_303 ' NEI4
 mov r22, FP
 sub r22, #-(-8) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRF4 regl
 mov RI, r21
 ...
 jmp #FCMP
 jmp #BRAE
 long @C_s2gok_664d6ddb_L_T_num_L000294_306 ' GEF4
 mov r19, #1 ' reg <- coni
 jmp #JMPA
 long @C_s2gok_664d6ddb_L_T_num_L000294_307 ' JUMPV addrg
C_s2gok_664d6ddb_L_T_num_L000294_306
 mov r19, #0 ' reg <- coni
C_s2gok_664d6ddb_L_T_num_L000294_307
 mov r0, r19 ' CVI, CVU or LOAD
 jmp #JMPA
 long @C_s2gok_664d6ddb_L_T_num_L000294_295 ' JUMPV addrg
C_s2gok_664d6ddb_L_T_num_L000294_303
 mov RI, r21
 jmp #RLNG
 ...
 sub SP, #4 ' stack space for reg ARGs
 jmp #CALA
 long @C_s2goi_664d6ddb_L_T_floatint_L000264
 add SP, #4 ' CALL addrg
 mov r22, r0 ' CVI, CVU or LOAD
C_s2gok_664d6ddb_L_T_num_L000294_295
 jmp #POPM ' restore registers
 add SP, #4 ' framesize
 jmp #RETF
 ...
 alignl ' align long
C_s2gol_664d6ddb_L_E_num_L000308 ' <symbol:LEnum>
 jmp #NEWF
 sub SP, #4
 jmp #PSHM
 long $f80000 ' save registers
 ...
 cmps r22,  #3 wz
 jmp #BRNZ
 long @C_s2gol_664d6ddb_L_E_num_L000308_310 ' NEI4
 mov RI, r23
 jmp #RLNG
 mov r22, BC ' reg <- INDIRI4 reg
 mov RI, FP
 ...
 cmps r22,  #3 wz
 jmp #BRNZ
 long @C_s2gol_664d6ddb_L_E_num_L000308_312 ' NEI4
 mov r22, FP
 sub r22, #-(-8) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRI4 regl
 mov RI, r21
 ...
 cmps r22, r20 wz,wc
 jmp #BR_A
 long @C_s2gol_664d6ddb_L_E_num_L000308_315 ' GTI4
 mov r19, #1 ' reg <- coni
 jmp #JMPA
 long @C_s2gol_664d6ddb_L_E_num_L000308_316 ' JUMPV addrg
C_s2gol_664d6ddb_L_E_num_L000308_315
 mov r19, #0 ' reg <- coni
C_s2gol_664d6ddb_L_E_num_L000308_316
 mov r0, r19 ' CVI, CVU or LOAD
 jmp #JMPA
 long @C_s2gol_664d6ddb_L_E_num_L000308_309 ' JUMPV addrg
C_s2gol_664d6ddb_L_E_num_L000308_312
 mov RI, r21
 jmp #RLNG
 mov r2, BC ' reg <- INDIRF4 reg
 mov RI, FP
 ...
 sub SP, #4 ' stack space for reg ARGs
 jmp #CALA
 long @C_s2goh_664d6ddb_L_E_intfloat_L000249
 add SP, #4 ' CALL addrg
 mov r22, r0 ' CVI, CVU or LOAD
 jmp #JMPA
 long @C_s2gol_664d6ddb_L_E_num_L000308_309 ' JUMPV addrg
C_s2gol_664d6ddb_L_E_num_L000308_310
 mov RI, r23
 jmp #RLNG
 mov r22, BC ' reg <- INDIRF4 reg
 mov RI, FP
 ...
 cmps r22,  #19 wz
 jmp #BRNZ
 long @C_s2gol_664d6ddb_L_E_num_L000308_317 ' NEI4
 mov r22, FP
 sub r22, #-(-8) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRF4 regl
 mov RI, r21
 ...
 jmp #FCMP
 jmp #BR_A
 long @C_s2gol_664d6ddb_L_E_num_L000308_320 ' GTF4
 mov r19, #1 ' reg <- coni
 jmp #JMPA
 long @C_s2gol_664d6ddb_L_E_num_L000308_321 ' JUMPV addrg
C_s2gol_664d6ddb_L_E_num_L000308_320
 mov r19, #0 ' reg <- coni
C_s2gol_664d6ddb_L_E_num_L000308_321
 mov r0, r19 ' CVI, CVU or LOAD
 jmp #JMPA
 long @C_s2gol_664d6ddb_L_E_num_L000308_309 ' JUMPV addrg
C_s2gol_664d6ddb_L_E_num_L000308_317
 mov RI, r21
 jmp #RLNG
 mov r2, BC ' reg <- INDIRI4 reg
 mov RI, FP
 ...
 sub SP, #4 ' stack space for reg ARGs
 jmp #CALA
 long @C_s2goj_664d6ddb_L_E_floatint_L000279
 add SP, #4 ' CALL addrg
 mov r22, r0 ' CVI, CVU or LOAD
C_s2gol_664d6ddb_L_E_num_L000308_309
 jmp #POPM ' restore registers
 add SP, #4 ' framesize
 jmp #RETF
 ...
 alignl ' align long
C_s2gom_664d6ddb_lessthanothers_L000322 ' <symbol:lessthanothers>
 jmp #NEWF
 jmp #PSHM
 ...
 cmps r20, r22 wz
 jmp #BRNZ
 long @C_s2gom_664d6ddb_lessthanothers_L000322_324 ' NEI4
 mov r20, r19
 adds r20, #4 ' ADDP4 coni
 mov RI, r20
 jmp #RBYT
 ...
 sub SP, #4 ' stack space for reg ARGs
 jmp #CALA
 long @C_s2gof_664d6ddb_l_strcmp_L000213
 add SP, #4 ' CALL addrg
 mov r22, r0 ' CVI, CVU or LOAD
 cmps r22,  #0 wz,wc
 jmp #BRAE
 long @C_s2gom_664d6ddb_lessthanothers_L000322_327 ' GEI4
 mov r17, #1 ' reg <- coni
 jmp #JMPA
 long @C_s2gom_664d6ddb_lessthanothers_L000322_328 ' JUMPV addrg
C_s2gom_664d6ddb_lessthanothers_L000322_327
 mov r17, #0 ' reg <- coni
C_s2gom_664d6ddb_lessthanothers_L000322_328
 mov r0, r17 ' CVI, CVU or LOAD
 jmp #JMPA
 long @C_s2gom_664d6ddb_lessthanothers_L000322_323 ' JUMPV addrg
C_s2gom_664d6ddb_lessthanothers_L000322_324
 ...
 mov r22, r0 ' CVI, CVU or LOAD
C_s2gom_664d6ddb_lessthanothers_L000322_323
 jmp #POPM ' restore registers
 jmp #RETF
...
C_luaV__lessthan ' <symbol:luaV_lessthan>
 ...
 sub SP, #4 ' stack space for reg ARGs
 jmp #CALA
 long @C_s2gok_664d6ddb_L_T_num_L000294
 add SP, #4 ' CALL addrg
 mov r22, r0 ' CVI, CVU or LOAD
 jmp #JMPA
...
C_luaV__lessthan_330
 ...
 sub SP, #8 ' stack space for reg ARGs
 jmp #CALA
 long @C_s2gom_664d6ddb_lessthanothers_L000322
 add SP, #8 ' CALL addrg
 mov r22, r0 ' CVI, CVU or LOAD
C_luaV__lessthan_329
 ...
 alignl ' align long
C_s2gon_664d6ddb_lessequalothers_L000332 ' <symbol:lessequalothers>
 jmp #NEWF
 jmp #PSHM
 long $fa0000 ' save registers
 mov r23, r4 ' reg var <- reg arg
 ...
 cmps r20, r22 wz
 jmp #BRNZ
 long @C_s2gon_664d6ddb_lessequalothers_L000332_334 ' NEI4
 mov r20, r19
 adds r20, #4 ' ADDP4 coni
 mov RI, r20
 jmp #RBYT
 ...
 cmps r22,  #0 wz,wc
 jmp #BR_A
 long @C_s2gon_664d6ddb_lessequalothers_L000332_337 ' GTI4
 mov r17, #1 ' reg <- coni
 jmp #JMPA
 long @C_s2gon_664d6ddb_lessequalothers_L000332_338 ' JUMPV addrg
C_s2gon_664d6ddb_lessequalothers_L000332_337
 mov r17, #0 ' reg <- coni
C_s2gon_664d6ddb_lessequalothers_L000332_338
 mov r0, r17 ' CVI, CVU or LOAD
 jmp #JMPA
 long @C_s2gon_664d6ddb_lessequalothers_L000332_333 ' JUMPV addrg
C_s2gon_664d6ddb_lessequalothers_L000332_334
 ...
 add SP, #12 ' CALL addrg
 mov r22, r0 ' CVI, CVU or LOAD
C_s2gon_664d6ddb_lessequalothers_L000332_333
 jmp #POPM ' restore registers
 jmp #RETF
...
C_luaV__lessequal ' <symbol:luaV_lessequal>
 ...
 sub SP, #4 ' stack space for reg ARGs
 jmp #CALA
 long @C_s2gol_664d6ddb_L_E_num_L000308
 add SP, #4 ' CALL addrg
 mov r22, r0 ' CVI, CVU or LOAD
 jmp #JMPA
...
C_luaV__lessequal_340
 ...
 sub SP, #8 ' stack space for reg ARGs
 jmp #CALA
 long @C_s2gon_664d6ddb_lessequalothers_L000332
 add SP, #8 ' CALL addrg
 mov r22, r0 ' CVI, CVU or LOAD
...
C_luaV__equalobj_342
 ...
 alignl ' align long
C_s2gos_664d6ddb_copy2buff_L000430 ' <symbol:copy2buff>
 jmp #NEWF
 jmp #PSHM
 long $faa000 ' save registers
 mov r23, r4 ' reg var <- reg arg
 ...
 mov r19, r2 ' reg var <- reg arg
 mov r17, #0 ' reg <- coni
C_s2gos_664d6ddb_copy2buff_L000430_432
 mov r22, #4 ' reg <- coni
 mov r20, r21
 ...
 cmps r20, r22 wz
 jmp #BRNZ
 long @C_s2gos_664d6ddb_copy2buff_L000430_436 ' NEI4
 mov r22, r21
 ...
 mov r13, r22 ' CVI, CVU or LOAD
 jmp #JMPA
 long @C_s2gos_664d6ddb_copy2buff_L000430_437 ' JUMPV addrg
C_s2gos_664d6ddb_copy2buff_L000430_436
 mov r22, r21
 shl r22, #3 ' LSHI4 coni
 subs r22, r23
 neg r22, r22 ' SUBI/P (2)
...
C_s2gos_664d6ddb_copy2buff_L000430_437
 ...
 add SP, #8 ' CALL addrg
 add r17, r15 ' ADDU (1)
' C_s2gos_664d6ddb_copy2buff_L000430_433 ' (symbol refcount = 0)
 mov r22, r21
 subs r22, #1 ' SUBI4 coni
 mov r21, r22 ' CVI, CVU or LOAD
 cmps r22,  #0 wz,wc
 jmp #BR_A
 long @C_s2gos_664d6ddb_copy2buff_L000430_432 ' GTI4
' C_s2gos_664d6ddb_copy2buff_L000430_431 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 jmp #RETF
...
C_luaV__concat_470
 ...
 sub SP, #8 ' stack space for reg ARGs
 jmp #CALA
 long @C_s2gos_664d6ddb_copy2buff_L000430
 add SP, #8 ' CALL addrg
 mov r2, r15 ' CVI, CVU or LOAD
 mov r3, FP
...
C_luaV__shiftl_523
 ...
 alignl ' align long
C_s2go11_664d6ddb_pushclosure_L000530 ' <symbol:pushclosure>
 jmp #NEWF
 sub SP, #4
 jmp #PSHM
 long $feaa80 ' save registers
 ...
 mov r15, #0 ' reg <- coni
 jmp #JMPA
 long @C_s2go11_664d6ddb_pushclosure_L000530_535 ' JUMPV addrg
C_s2go11_664d6ddb_pushclosure_L000530_532
 mov r22, r15
 shl r22, #3 ' LSHI4 coni
 ...
 cmps r22,  #0 wz
 jmp #BR_Z
 long @C_s2go11_664d6ddb_pushclosure_L000530_536 ' EQI4
 mov r22, r15
 shl r22, #3 ' LSHI4 coni
 adds r22, r11 ' ADDI/P (1)
 ...
 jmp #WLNG ' ASGNP4 reg reg
 jmp #JMPA
 long @C_s2go11_664d6ddb_pushclosure_L000530_537 ' JUMPV addrg
C_s2go11_664d6ddb_pushclosure_L000530_536
 mov r22, r15
 shl r22, #2 ' LSHI4 coni
 mov r20, r13
 ...
 mov BC, r20
 jmp #WLNG ' ASGNP4 reg reg
C_s2go11_664d6ddb_pushclosure_L000530_537
 mov r22, #0 ' reg <- coni
 mov r20, r13
 adds r20, #5 ' ADDP4 coni
 mov RI, r20
 ...
 cmps r20, r22 wz
 jmp #BR_Z
 long @C_s2go11_664d6ddb_pushclosure_L000530_539 ' EQI4
 mov r20, r15
 shl r20, #2 ' LSHI4 coni
 mov r18, r13
 adds r18, #16 ' ADDP4 coni
 ...
 add SP, #8 ' CALL addrg
 jmp #JMPA
 long @C_s2go11_664d6ddb_pushclosure_L000530_539 ' JUMPV addrg
C_s2go11_664d6ddb_pushclosure_L000530_539
' C_s2go11_664d6ddb_pushclosure_L000530_533 ' (symbol refcount = 0)
 adds r15, #1 ' ADDI4 coni
C_s2go11_664d6ddb_pushclosure_L000530_535
 cmps r15, r9 wz,wc
 jmp #BR_B
 long @C_s2go11_664d6ddb_pushclosure_L000530_532 ' LTI4
' C_s2go11_664d6ddb_pushclosure_L000530_531 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 add SP, #4 ' framesize
 jmp #RETF
...
C_luaV__execute_1241
 ...
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 jmp #CALA
 long @C_s2gob_664d6ddb_floatforloop_L000136 ' CALL addrg
 cmps r0,  #0 wz
 jmp #BR_Z
...
C_luaV__execute_1247
 ...
 sub SP, #4 ' stack space for reg ARGs
 jmp #CALA
 long @C_s2go7_664d6ddb_forprep_L000090
 add SP, #4 ' CALL addrg
 cmps r0,  #0 wz
 jmp #BR_Z
 long @C_luaV__execute_573 ' EQI4
...
C_luaV__execute_1272
 ...
 add SP, #4 ' correct for new kernel !!! 
 jmp #CALA
 long @C_s2go11_664d6ddb_pushclosure_L000530
 add SP, #16 ' CALL addrg
 mov r22, r23
 adds r22, #16 ' ADDP4 coni
 mov RI, r22
...
C_luaV__finishget_158_L000159 ' <symbol:158>
 ...
 alignl ' align long
C_s2go7_664d6ddb_forprep_L000090_121_L000122 ' <symbol:121>
 byte 105
 byte 110
 byte 105
 byte 116
 ...
 alignl ' align long
C_s2go7_664d6ddb_forprep_L000090_114_L000115 ' <symbol:114>
 byte 115
 byte 116
 byte 101
 byte 112
 ...
 alignl ' align long
C_s2go7_664d6ddb_forprep_L000090_96_L000097 ' <symbol:96>
 byte 39
 byte 102
 byte 111
 byte 114
 ...
 alignl ' align long
C_s2go4_664d6ddb_forlimit_L000059_75_L000076 ' <symbol:75>
 long $0 ' float

 alignl ' align long
C_s2go4_664d6ddb_forlimit_L000059_71_L000072 ' <symbol:71>
 byte 108
 byte 105
 byte 109
 byte 105
