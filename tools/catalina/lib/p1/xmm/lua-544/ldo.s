...
' C_luaD__rawrunprotected_38 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_sic01_664d6dda_correctstack_L000044 ' <symbol:correctstack>
 jmp #PSHM
 long $f40000 ' save registers
 mov r22, r4
 adds r22, #12 ' ADDP4 coni
 ...
 jmp #JMPA
 long @C_sic01_664d6dda_correctstack_L000044_49 ' JUMPV addrg
C_sic01_664d6dda_correctstack_L000044_46
 mov r22, r21
 ...
 mov BC, r20
 jmp #WLNG ' ASGNP4 reg reg
' C_sic01_664d6dda_correctstack_L000044_47 ' (symbol refcount = 0)
 mov r22, r21
 adds r22, #12 ' ADDP4 coni
 mov RI, r22
 jmp #RLNG
 mov r21, BC ' reg <- INDIRP4 reg
C_sic01_664d6dda_correctstack_L000044_49
 mov r22, r21 ' CVI, CVU or LOAD
 cmp r22,  #0 wz
 jmp #BRNZ
 long @C_sic01_664d6dda_correctstack_L000044_46 ' NEU4
 mov r22, r4
 ...
 jmp #JMPA
 long @C_sic01_664d6dda_correctstack_L000044_53 ' JUMPV addrg
C_sic01_664d6dda_correctstack_L000044_50
 mov r22, r23
 adds r22, #4 ' ADDP4 coni
 mov RI, r22
 jmp #RLNG
 ...
 cmps r22,  #0 wz
 jmp #BRNZ
 long @C_sic01_664d6dda_correctstack_L000044_54 ' NEI4
 mov r22, r23
 adds r22, #20 ' ADDP4 coni
 mov r20, #1 ' reg <- coni
 mov RI, r22
 mov BC, r20
 jmp #WLNG ' ASGNI4 reg reg
C_sic01_664d6dda_correctstack_L000044_54
' C_sic01_664d6dda_correctstack_L000044_51 ' (symbol refcount = 0)
 mov r22, r23
 adds r22, #8 ' ADDP4 coni
 mov RI, r22
 jmp #RLNG
 mov r23, BC ' reg <- INDIRP4 reg
C_sic01_664d6dda_correctstack_L000044_53
 mov r22, r23 ' CVI, CVU or LOAD
 cmp r22,  #0 wz
 jmp #BRNZ
 long @C_sic01_664d6dda_correctstack_L000044_50 ' NEU4
' C_sic01_664d6dda_correctstack_L000044_45 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 jmp #RETN
...
C_luaD__reallocstack_67
 ...
 sub SP, #8 ' stack space for reg ARGs
 jmp #CALA
 long @C_sic01_664d6dda_correctstack_L000044
 add SP, #8 ' CALL addrg
 mov r22, r13
 adds r22, #5 ' ADDI4 coni
 mov r2, r22
...
C_luaD__growstack_68
 ...
 alignl ' align long
C_sic03_664d6dda_stackinuse_L000083 ' <symbol:stackinuse>
 jmp #PSHM
 long $f80000 ' save registers
 mov r22, r2
 adds r22, #12 ' ADDP4 coni
 ...
 mov r23, BC ' reg <- INDIRP4 reg
 jmp #JMPA
 long @C_sic03_664d6dda_stackinuse_L000083_88 ' JUMPV addrg
C_sic03_664d6dda_stackinuse_L000083_85
 mov r22, r21 ' CVI, CVU or LOAD
 mov r20, r23
 adds r20, #4 ' ADDP4 coni
 mov RI, r20
 ...
 cmp r22, r20 wz,wc 
 jmp #BRAE
 long @C_sic03_664d6dda_stackinuse_L000083_89 ' GEU4
 mov r22, r23
 adds r22, #4 ' ADDP4 coni
 mov RI, r22
 jmp #RLNG
 mov r21, BC ' reg <- INDIRP4 reg
C_sic03_664d6dda_stackinuse_L000083_89
' C_sic03_664d6dda_stackinuse_L000083_86 ' (symbol refcount = 0)
 mov r22, r23
 adds r22, #8 ' ADDP4 coni
 mov RI, r22
 jmp #RLNG
 mov r23, BC ' reg <- INDIRP4 reg
C_sic03_664d6dda_stackinuse_L000083_88
 mov r22, r23 ' CVI, CVU or LOAD
 cmp r22,  #0 wz
 jmp #BRNZ
 long @C_sic03_664d6dda_stackinuse_L000083_85 ' NEU4
 mov r22, r21 ' CVI, CVU or LOAD
 mov r20, r2
 adds r20, #28 ' ADDP4 coni
 mov RI, r20
 ...
 cmps r19,  #20 wz,wc
 jmp #BRAE
 long @C_sic03_664d6dda_stackinuse_L000083_91 ' GEI4
 mov r19, #20 ' reg <- coni
C_sic03_664d6dda_stackinuse_L000083_91
 mov r0, r19 ' CVI, CVU or LOAD
' C_sic03_664d6dda_stackinuse_L000083_84 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 jmp #RETN
...
C_luaD__shrinkstack ' <symbol:luaD_shrinkstack>
 ...
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 jmp #CALA
 long @C_sic03_664d6dda_stackinuse_L000083 ' CALL addrg
 mov r21, r0 ' CVI, CVU or LOAD
 mov r22, r21
...
' C_luaD__hookcall_116 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_sic04_664d6dda_rethook_L000122 ' <symbol:rethook>
 jmp #NEWF
 sub SP, #16
 jmp #PSHM
 long $fc0000 ' save registers
 ...
 cmps r22,  #0 wz
 jmp #BR_Z
 long @C_sic04_664d6dda_rethook_L000122_124 ' EQI4
 mov r22, r23
 adds r22, #12 ' ADDP4 coni
 mov RI, r22
 jmp #RLNG
 ...
 cmps r22,  #0 wz
 jmp #BRNZ
 long @C_sic04_664d6dda_rethook_L000122_126 ' NEI4
 mov RI, r21
 jmp #RLNG
 mov r22, BC ' reg <- INDIRP4 reg
 mov RI, r22
 ...
 cmps r22,  #0 wz
 jmp #BR_Z
 long @C_sic04_664d6dda_rethook_L000122_128 ' EQI4
 mov r22, r21
 adds r22, #24 ' ADDP4 coni
 mov RI, r22
 jmp #RLNG
 ...
 sub RI, #-(-8)
 wrlong r22, RI ' ASGNI4 addrli reg
C_sic04_664d6dda_rethook_L000122_128
C_sic04_664d6dda_rethook_L000122_126
 mov r22, FP
 sub r22, #-(-8) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRI4 regl
 shl r22, #3 ' LSHI4 coni
 ...
 mov BC, r22
 jmp #WLNG ' ASGNP4 reg reg
C_sic04_664d6dda_rethook_L000122_124
 mov r22, r21
 adds r22, #8 ' ADDP4 coni
 mov RI, r22
 jmp #RLNG
 ...
 cmps r22,  #0 wz
 jmp #BRNZ
 long @C_sic04_664d6dda_rethook_L000122_130 ' NEI4
 mov r22, r23
 adds r22, #100 ' ADDP4 coni
 mov r20, r21
 ...
 mov BC, r20
 jmp #WLNG ' ASGNI4 reg reg
C_sic04_664d6dda_rethook_L000122_130
' C_sic04_664d6dda_rethook_L000122_123 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 add SP, #16 ' framesize
 jmp #RETF
...
' C_luaD__tryfuncT_M__132 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_sic05_664d6dda_moveresults_L000143 ' <symbol:moveresults>
 jmp #NEWF
 sub SP, #8
 jmp #PSHM
 ...
 cmps r17, r22 wz
 jmp #BR_Z
 long @C_sic05_664d6dda_moveresults_L000143_151 ' EQI4
 cmps r17,  #0 wz
 jmp #BR_Z
 long @C_sic05_664d6dda_moveresults_L000143_147 ' EQI4
 cmps r17,  #1 wz
 jmp #BR_Z
 long @C_sic05_664d6dda_moveresults_L000143_148 ' EQI4
 jmp #JMPA
 long @C_sic05_664d6dda_moveresults_L000143_145 ' JUMPV addrg
C_sic05_664d6dda_moveresults_L000143_147
 mov r22, r23
 adds r22, #12 ' ADDP4 coni
 mov RI, r22
 mov BC, r21
 jmp #WLNG ' ASGNP4 reg reg
 jmp #JMPA
 long @C_sic05_664d6dda_moveresults_L000143_144 ' JUMPV addrg
C_sic05_664d6dda_moveresults_L000143_148
 cmps r19,  #0 wz
 jmp #BRNZ
 long @C_sic05_664d6dda_moveresults_L000143_149 ' NEI4
 mov r22, r21
 adds r22, #4 ' ADDP4 coni
 mov r20, #0 ' reg <- coni
 mov RI, r22
 ...
 jmp #WBYT ' ASGNU1 reg reg
 jmp #JMPA
 long @C_sic05_664d6dda_moveresults_L000143_150 ' JUMPV addrg
C_sic05_664d6dda_moveresults_L000143_149
 mov RI, FP
 sub RI, #-(-8)
 ...
 mov BC, r20
 jmp #WBYT ' ASGNU1 reg reg
C_sic05_664d6dda_moveresults_L000143_150
 mov r22, r23
 adds r22, #12 ' ADDP4 coni
 mov r20, r21
 adds r20, #8 ' ADDP4 coni
 ...
 jmp #JMPA
 long @C_sic05_664d6dda_moveresults_L000143_144 ' JUMPV addrg
C_sic05_664d6dda_moveresults_L000143_151
 mov r17, r19 ' CVI, CVU or LOAD
 jmp #JMPA
 long @C_sic05_664d6dda_moveresults_L000143_146 ' JUMPV addrg
C_sic05_664d6dda_moveresults_L000143_145
 jmp #LODL
 long -1
 mov r22, RI ' reg <- con
 cmps r17, r22 wz,wc
 jmp #BRAE
 long @C_sic05_664d6dda_moveresults_L000143_146 ' GEI4
 mov r22, r21 ' CVI, CVU or LOAD
 mov r20, r23
 adds r20, #28 ' ADDP4 coni
 mov RI, r20
 ...
 cmps r22,  #0 wz
 jmp #BR_Z
 long @C_sic05_664d6dda_moveresults_L000143_154 ' EQI4
 mov r2, r19 ' CVI, CVU or LOAD
 mov r22, r23
 adds r22, #20 ' ADDP4 coni
 mov RI, r22
 ...
 sub SP, #8 ' stack space for reg ARGs
 jmp #CALA
 long @C_sic04_664d6dda_rethook_L000122
 add SP, #8 ' CALL addrg
C_sic05_664d6dda_moveresults_L000143_154
 mov r22, FP
 sub r22, #-(-8) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRI4 regl
 mov r20, r23
 ...
 cmps r17, r22 wz
 jmp #BRNZ
 long @C_sic05_664d6dda_moveresults_L000143_146 ' NEI4
 mov r17, r19 ' CVI, CVU or LOAD
C_sic05_664d6dda_moveresults_L000143_146
 mov r22, r23
 adds r22, #12 ' ADDP4 coni
 mov RI, r22
 jmp #RLNG
 ...
 cmps r19, r17 wz,wc
 jmp #BRBE
 long @C_sic05_664d6dda_moveresults_L000143_158 ' LEI4
 mov r19, r17 ' CVI, CVU or LOAD
C_sic05_664d6dda_moveresults_L000143_158
 mov r15, #0 ' reg <- coni
 jmp #JMPA
 long @C_sic05_664d6dda_moveresults_L000143_163 ' JUMPV addrg
C_sic05_664d6dda_moveresults_L000143_160
 mov r22, r15
 shl r22, #3 ' LSHI4 coni
 mov r11, r22 ' ADDI/P
 ...
 mov BC, r20
 jmp #WBYT ' ASGNU1 reg reg
' C_sic05_664d6dda_moveresults_L000143_161 ' (symbol refcount = 0)
 adds r15, #1 ' ADDI4 coni
C_sic05_664d6dda_moveresults_L000143_163
 cmps r15, r19 wz,wc
 jmp #BR_B
 long @C_sic05_664d6dda_moveresults_L000143_160 ' LTI4
 jmp #JMPA
 long @C_sic05_664d6dda_moveresults_L000143_167 ' JUMPV addrg
C_sic05_664d6dda_moveresults_L000143_164
 mov r22, r15
 shl r22, #3 ' LSHI4 coni
 ...
 mov BC, r20
 jmp #WBYT ' ASGNU1 reg reg
' C_sic05_664d6dda_moveresults_L000143_165 ' (symbol refcount = 0)
 adds r15, #1 ' ADDI4 coni
C_sic05_664d6dda_moveresults_L000143_167
 cmps r15, r17 wz,wc
 jmp #BR_B
 long @C_sic05_664d6dda_moveresults_L000143_164 ' LTI4
 mov r22, r23
 adds r22, #12 ' ADDP4 coni
 mov r20, r17
 shl r20, #3 ' LSHI4 coni
 ...
 mov BC, r20
 jmp #WLNG ' ASGNP4 reg reg
C_sic05_664d6dda_moveresults_L000143_144
 jmp #POPM ' restore registers
 add SP, #8 ' framesize
 jmp #RETF
...
C_luaD__poscall_169
 ...
 sub SP, #12 ' stack space for reg ARGs
 jmp #CALA
 long @C_sic05_664d6dda_moveresults_L000143
 add SP, #12 ' CALL addrg
 mov r22, r23
 adds r22, #20 ' ADDP4 coni
 mov r20, r21
...
' C_luaD__poscall_168 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_sic06_664d6dda_prepC_allI_nfo_L000171 ' <symbol:prepCallInfo>
 jmp #NEWF
 jmp #PSHM
 long $faa000 ' save registers
 mov r23, r5 ' reg var <- reg arg
 ...
 cmp r20,  #0 wz
 jmp #BR_Z
 long @C_sic06_664d6dda_prepC_allI_nfo_L000171_174 ' EQU4
 mov r20, FP
 add r20, #8 ' reg <- addrfi
 rdlong r20, r20 ' reg <- INDIRP4 regl
 ...
 jmp #JMPA
 long @C_sic06_664d6dda_prepC_allI_nfo_L000171_175 ' JUMPV addrg
C_sic06_664d6dda_prepC_allI_nfo_L000171_174
 mov RI, FP
 add RI, #8
...
C_sic06_664d6dda_prepC_allI_nfo_L000171_175
 mov RI, r22
 mov BC, r13
 jmp #WLNG ' ASGNP4 reg reg
 ...
 jmp #WLNG ' ASGNP4 reg reg
 mov r0, r15 ' CVI, CVU or LOAD
' C_sic06_664d6dda_prepC_allI_nfo_L000171_172 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 jmp #RETF


 alignl ' align long
C_sic07_664d6dda_precallC__L000176 ' <symbol:precallC>
 jmp #NEWF
 sub SP, #8
 jmp #PSHM
 ...
 cmps r0,  #20 wz,wc
 jmp #BR_A
 long @C_sic07_664d6dda_precallC__L000176_178 ' GTI4
 mov r22, r21 ' CVI, CVU or LOAD
 mov r20, r23
 adds r20, #28 ' ADDP4 coni
 mov RI, r20
 ...
 cmps r22,  #0 wz,wc
 jmp #BRBE
 long @C_sic07_664d6dda_precallC__L000176_180 ' LEI4
 mov r2, r23 ' CVI, CVU or LOAD
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 jmp #CALA
 long @C_luaC__step ' CALL addrg
C_sic07_664d6dda_precallC__L000176_180
 mov r2, #1 ' reg ARG coni
 mov r3, #20 ' reg ARG coni
 mov r4, r23 ' CVI, CVU or LOAD
 mov BC, #12 ' arg size, rpsize = 12, spsize = 12
 ...
 mov r21, r22 ' ADDI/P
 adds r21, r20 ' ADDI/P (3)
C_sic07_664d6dda_precallC__L000176_178
' C_sic07_664d6dda_precallC__L000176_179 ' (symbol refcount = 0)
 mov r22, r23
 adds r22, #12 ' ADDP4 coni
 mov RI, r22
 jmp #RLNG
 ...
 add SP, #4 ' correct for new kernel !!! 
 jmp #CALA
 long @C_sic06_664d6dda_prepC_allI_nfo_L000171
 add SP, #16 ' CALL addrg
 mov RI, FP
 sub RI, #-(-8)
 wrlong r0, RI ' ASGNP4 addrli reg
 ...
 cmps r22,  #0 wz
 jmp #BR_Z
 long @C_sic07_664d6dda_precallC__L000176_182 ' EQI4
 mov r22, r23
 adds r22, #12 ' ADDP4 coni
 mov RI, r22
 jmp #RLNG
 ...
 long @C_luaD__hook
 add SP, #16 ' CALL addrg
C_sic07_664d6dda_precallC__L000176_182
 mov r2, r23 ' CVI, CVU or LOAD
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 mov RI, r17
 jmp #CALI ' CALL indirect
 ...
 add SP, #8 ' CALL addrg
 mov r0, r15 ' CVI, CVU or LOAD
' C_sic07_664d6dda_precallC__L000176_177 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 add SP, #8 ' framesize
 jmp #RETF
...
C_luaD__pretailcall_189
 ...
 sub SP, #12 ' stack space for reg ARGs
 jmp #CALA
 long @C_sic07_664d6dda_precallC__L000176
 add SP, #12 ' CALL addrg
 mov r22, r0 ' CVI, CVU or LOAD
 jmp #JMPA
...
C_luaD__precall_206
 ...
 alignl ' align long
C_sic08_664d6dda_ccall_L000224 ' <symbol:ccall>
 jmp #NEWF
 sub SP, #4
 jmp #PSHM
 ...
 cmp r22,  #200 wz,wc 
 jmp #BR_B
 long @C_sic08_664d6dda_ccall_L000224_226' LTU4
 mov r2, r23 ' CVI, CVU or LOAD
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 jmp #CALA
 long @C_luaE__checkcstack ' CALL addrg
C_sic08_664d6dda_ccall_L000224_226
 mov r2, r19 ' CVI, CVU or LOAD
 mov r3, r21 ' CVI, CVU or LOAD
 mov r4, r23 ' CVI, CVU or LOAD
 mov BC, #12 ' arg size, rpsize = 12, spsize = 12
 ...
 cmp r22,  #0 wz
 jmp #BR_Z
 long @C_sic08_664d6dda_ccall_L000224_228 ' EQU4
 mov r22, FP
 sub r22, #-(-8) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRP4 regl
 adds r22, #34 ' ADDP4 coni
 ...
 add SP, #4 ' CALL addrg
C_sic08_664d6dda_ccall_L000224_228
 mov r22, r23
 adds r22, #96 ' ADDP4 coni
 mov RI, r22
 jmp #RLNG
 ...
 mov BC, r20
 jmp #WLNG ' ASGNU4 reg reg
' C_sic08_664d6dda_ccall_L000224_225 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 add SP, #4 ' framesize
 jmp #RETF
...
C_luaD__call ' <symbol:luaD_call>
 ...
 sub SP, #12 ' stack space for reg ARGs
 jmp #CALA
 long @C_sic08_664d6dda_ccall_L000224
 add SP, #12 ' CALL addrg
...
' C_luaD__callnoyield_231 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_sic09_664d6dda_finishpcallk_L000232 ' <symbol:finishpcallk>
 jmp #NEWF
 sub SP, #4
 jmp #PSHM
 long $fc0000 ' save registers
 ...
 cmps r19,  #0 wz
 jmp #BRNZ
 long @C_sic09_664d6dda_finishpcallk_L000232_234 ' NEI4
 mov r19, #1 ' reg <- coni
 jmp #JMPA
 long @C_sic09_664d6dda_finishpcallk_L000232_235 ' JUMPV addrg
C_sic09_664d6dda_finishpcallk_L000232_234
 mov r22, r21
 adds r22, #28 ' ADDP4 coni
 mov RI, r22
 jmp #RLNG
 ...
 mov BC, r20
 jmp #WWRD ' ASGNU2 reg reg
C_sic09_664d6dda_finishpcallk_L000232_235
 mov r22, r21
 adds r22, #34 ' ADDP4 coni
 mov RI, r22
 jmp #RWRD
 ...
 jmp #WLNG ' ASGNI4 reg reg
 mov r0, r19 ' CVI, CVU or LOAD
' C_sic09_664d6dda_finishpcallk_L000232_233 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 add SP, #4 ' framesize
 jmp #RETF
 ...
 alignl ' align long
C_sic0a_664d6dda_finishC_call_L000236 ' <symbol:finishCcall>
 jmp #NEWF
 sub SP, #8
 jmp #PSHM
 ...
 cmps r22,  #0 wz
 jmp #BR_Z
 long @C_sic0a_664d6dda_finishC_call_L000236_238 ' EQI4
 mov r22, r21
 adds r22, #28 ' ADDP4 coni
 mov RI, r22
 jmp #RLNG
 ...
 wrlong r22, RI ' ASGNI4 addrli reg
 jmp #JMPA
 long @C_sic0a_664d6dda_finishC_call_L000236_239 ' JUMPV addrg
C_sic0a_664d6dda_finishC_call_L000236_238
 mov r22, #1 ' reg <- coni
 mov RI, FP
 sub RI, #-(-12)
 wrlong r22, RI ' ASGNI4 addrli reg
 ...
 cmps r22,  #0 wz
 jmp #BR_Z
 long @C_sic0a_664d6dda_finishC_call_L000236_240 ' EQI4
 mov r2, r21 ' CVI, CVU or LOAD
 mov r3, r23 ' CVI, CVU or LOAD
 mov BC, #8 ' arg size, rpsize = 8, spsize = 8
 sub SP, #4 ' stack space for reg ARGs
 jmp #CALA
 long @C_sic09_664d6dda_finishpcallk_L000232
 add SP, #4 ' CALL addrg
 mov RI, FP
 sub RI, #-(-12)
 wrlong r0, RI ' ASGNI4 addrli reg
C_sic0a_664d6dda_finishC_call_L000236_240
 mov r22, r23
 adds r22, #20 ' ADDP4 coni
 mov RI, r22
 jmp #RLNG
 ...
 cmp r22, r20 wz,wc 
 jmp #BRAE
 long @C_sic0a_664d6dda_finishC_call_L000236_242 ' GEU4
 mov r22, r23
 adds r22, #20 ' ADDP4 coni
 mov RI, r22
 jmp #RLNG
 ...
 mov BC, r20
 jmp #WLNG ' ASGNP4 reg reg
C_sic0a_664d6dda_finishC_call_L000236_242
 mov r22, r21
 adds r22, #24 ' ADDP4 coni
 mov RI, r22
 jmp #RLNG
 ...
 sub RI, #-(-8)
 wrlong r0, RI ' ASGNI4 addrli reg
C_sic0a_664d6dda_finishC_call_L000236_239
 mov RI, FP
 sub RI, #-(-8)
 rdlong r2, RI ' reg ARG INDIR ADDRLi
 mov r3, r21 ' CVI, CVU or LOAD
 ...
 long @C_luaD__poscall
 add SP, #8 ' CALL addrg
' C_sic0a_664d6dda_finishC_call_L000236_237 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 add SP, #8 ' framesize
 jmp #RETF
 ...
 alignl ' align long
C_sic0b_664d6dda_unroll_L000244 ' <symbol:unroll>
 jmp #NEWF
 jmp #PSHM
 long $f80000 ' save registers
 mov r23, r3 ' reg var <- reg arg
 mov r21, r2 ' reg var <- reg arg
 jmp #JMPA
 long @C_sic0b_664d6dda_unroll_L000244_247 ' JUMPV addrg
C_sic0b_664d6dda_unroll_L000244_246
 mov r22, r19
 adds r22, #34 ' ADDP4 coni
 mov RI, r22
 jmp #RWRD
 ...
 cmps r22,  #0 wz
 jmp #BR_Z
 long @C_sic0b_664d6dda_unroll_L000244_249 ' EQI4
 mov r2, r19 ' CVI, CVU or LOAD
 mov r3, r23 ' CVI, CVU or LOAD
 mov BC, #8 ' arg size, rpsize = 8, spsize = 8
 sub SP, #4 ' stack space for reg ARGs
 jmp #CALA
 long @C_sic0a_664d6dda_finishC_call_L000236
 add SP, #4 ' CALL addrg
 jmp #JMPA
 long @C_sic0b_664d6dda_unroll_L000244_250 ' JUMPV addrg
C_sic0b_664d6dda_unroll_L000244_249
 mov r2, r23 ' CVI, CVU or LOAD
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 jmp #CALA
 ...
 long @C_luaV__execute
 add SP, #4 ' CALL addrg
C_sic0b_664d6dda_unroll_L000244_250
C_sic0b_664d6dda_unroll_L000244_247
 mov r22, r23
 adds r22, #20 ' ADDP4 coni
 mov RI, r22
 jmp #RLNG
 ...
 cmp r22, r20 wz
 jmp #BRNZ
 long @C_sic0b_664d6dda_unroll_L000244_246 ' NEU4
' C_sic0b_664d6dda_unroll_L000244_245 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 jmp #RETF


 alignl ' align long
C_sic0c_664d6dda_findpcall_L000251 ' <symbol:findpcall>
 jmp #PSHM
 ...
 mov r23, BC ' reg <- INDIRP4 reg
 jmp #JMPA
 long @C_sic0c_664d6dda_findpcall_L000251_256 ' JUMPV addrg
C_sic0c_664d6dda_findpcall_L000251_253
 mov r22, r23
 adds r22, #34 ' ADDP4 coni
 mov RI, r22
 jmp #RWRD
 ...
 cmps r22,  #0 wz
 jmp #BR_Z
 long @C_sic0c_664d6dda_findpcall_L000251_257 ' EQI4
 mov r0, r23 ' CVI, CVU or LOAD
 jmp #JMPA
 long @C_sic0c_664d6dda_findpcall_L000251_252 ' JUMPV addrg
C_sic0c_664d6dda_findpcall_L000251_257
' C_sic0c_664d6dda_findpcall_L000251_254 ' (symbol refcount = 0)
 mov r22, r23
 adds r22, #8 ' ADDP4 coni
 mov RI, r22
 jmp #RLNG
 mov r23, BC ' reg <- INDIRP4 reg
C_sic0c_664d6dda_findpcall_L000251_256
 mov r22, r23 ' CVI, CVU or LOAD
 cmp r22,  #0 wz
 jmp #BRNZ
 long @C_sic0c_664d6dda_findpcall_L000251_253 ' NEU4
 jmp #LODL
 long 0
 mov r0, RI ' reg <- con
C_sic0c_664d6dda_findpcall_L000251_252
 jmp #POPM ' restore registers
 jmp #RETN


 alignl ' align long
C_sic0d_664d6dda_resume_error_L000259 ' <symbol:resume_error>
 jmp #NEWF
 jmp #PSHM
 long $fe8000 ' save registers
 mov r23, r4 ' reg var <- reg arg
 ...
 jmp #WLNG ' ASGNP4 reg reg
 mov r0, #2 ' reg <- coni
' C_sic0d_664d6dda_resume_error_L000259_260 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 jmp #RETF


 alignl ' align long
C_sic0e_664d6dda_resume_L000261 ' <symbol:resume>
 jmp #NEWF
 sub SP, #12
 jmp #PSHM
 long $f00000 ' save registers
 ...
 cmps r22,  #0 wz
 jmp #BRNZ
 long @C_sic0e_664d6dda_resume_L000261_263 ' NEI4
 mov r2, #0 ' reg ARG coni
 jmp #LODL
 long -1
 mov r3, RI ' reg ARG con
 ...
 add SP, #12 ' CALL addrg
 jmp #JMPA
 long @C_sic0e_664d6dda_resume_L000261_264 ' JUMPV addrg
C_sic0e_664d6dda_resume_L000261_263
 mov r22, r23
 adds r22, #6 ' ADDP4 coni
 mov r20, #0 ' reg <- coni
 mov RI, r22
 ...
 cmps r22,  #0 wz
 jmp #BRNZ
 long @C_sic0e_664d6dda_resume_L000261_265 ' NEI4
 mov r22, r23
 adds r22, #12 ' ADDP4 coni
 mov r20, FP
 sub r20, #-(-16) ' reg <- addrli
 ...
 add SP, #4 ' CALL addrg
 jmp #JMPA
 long @C_sic0e_664d6dda_resume_L000261_266 ' JUMPV addrg
C_sic0e_664d6dda_resume_L000261_265
 mov r22, FP
 sub r22, #-(-8) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRP4 regl
 adds r22, #16 ' ADDP4 coni
 ...
 cmp r22,  #0 wz
 jmp #BR_Z
 long @C_sic0e_664d6dda_resume_L000261_267 ' EQU4
 mov r22, FP
 sub r22, #-(-8) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRP4 regl
 mov r20, r22
 ...
 sub RI, #-(-12)
 wrlong r0, RI ' ASGNI4 addrli reg
C_sic0e_664d6dda_resume_L000261_267
 mov RI, FP
 sub RI, #-(-12)
 rdlong r2, RI ' reg ARG INDIR ADDRLi
 mov RI, FP
 ...
 long @C_luaD__poscall
 add SP, #8 ' CALL addrg
C_sic0e_664d6dda_resume_L000261_266
 jmp #LODL
 long 0
 mov r2, RI ' reg ARG con
 mov r3, r23 ' CVI, CVU or LOAD
 ...
 sub SP, #4 ' stack space for reg ARGs
 jmp #CALA
 long @C_sic0b_664d6dda_unroll_L000244
 add SP, #4 ' CALL addrg
C_sic0e_664d6dda_resume_L000261_264
' C_sic0e_664d6dda_resume_L000261_262 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 add SP, #12 ' framesize
 jmp #RETF
 ...
 alignl ' align long
C_sic0f_664d6dda_precover_L000269 ' <symbol:precover>
 jmp #NEWF
 jmp #PSHM
 long $fc0000 ' save registers
 mov r23, r3 ' reg var <- reg arg
 mov r21, r2 ' reg var <- reg arg
 jmp #JMPA
 long @C_sic0f_664d6dda_precover_L000269_272 ' JUMPV addrg
C_sic0f_664d6dda_precover_L000269_271
 mov r22, r23
 adds r22, #20 ' ADDP4 coni
 mov RI, r22
 mov BC, r19
 ...
 add SP, #8 ' CALL addrg
 mov r21, r0 ' CVI, CVU or LOAD
C_sic0f_664d6dda_precover_L000269_272
 cmps r21,  #1 wz,wc
 jmp #BRBE
 long @C_sic0f_664d6dda_precover_L000269_274 ' LEI4
 mov r2, r23 ' CVI, CVU or LOAD
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 jmp #CALA
 long @C_sic0c_664d6dda_findpcall_L000251 ' CALL addrg
 mov r19, r0 ' CVI, CVU or LOAD
 mov r22, r0 ' CVI, CVU or LOAD
 cmp r22,  #0 wz
 jmp #BRNZ
 long @C_sic0f_664d6dda_precover_L000269_271 ' NEU4
C_sic0f_664d6dda_precover_L000269_274
 mov r0, r21 ' CVI, CVU or LOAD
' C_sic0f_664d6dda_precover_L000269_270 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 jmp #RETF
...
C_lua_resume ' <symbol:lua_resume>
 ...
 sub SP, #8 ' stack space for reg ARGs
 jmp #CALA
 long @C_sic0d_664d6dda_resume_error_L000259
 add SP, #8 ' CALL addrg
 mov r22, r0 ' CVI, CVU or LOAD
 jmp #JMPA
...
C_lua_resume_291
 ...
 jmp #LODL
 long @C_sic0e_664d6dda_resume_L000261
 mov r3, RI ' reg ARG ADDRG
 mov r4, r23 ' CVI, CVU or LOAD
 mov BC, #12 ' arg size, rpsize = 12, spsize = 12
 sub SP, #8 ' stack space for reg ARGs
 ...
 sub SP, #4 ' stack space for reg ARGs
 jmp #CALA
 long @C_sic0f_664d6dda_precover_L000269
 add SP, #4 ' CALL addrg
 mov r17, r0 ' CVI, CVU or LOAD
 cmps r17,  #1 wz,wc
 jmp #BR_A
...
' C_lua_yieldk_304 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_sic0l_664d6dda_closepaux_L000317 ' <symbol:closepaux>
 jmp #NEWF
 jmp #PSHM
 ...
 long @C_luaF__close
 add SP, #12 ' CALL addrg
' C_sic0l_664d6dda_closepaux_L000317_318 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 jmp #RETF
...
C_luaD__closeprotected_320
 ...
 jmp #LODL
 long @C_sic0l_664d6dda_closepaux_L000317
 mov r3, RI ' reg ARG ADDRG
 mov r4, r23 ' CVI, CVU or LOAD
 mov BC, #12 ' arg size, rpsize = 12, spsize = 12
 sub SP, #8 ' stack space for reg ARGs
...
' C_luaD__pcall_328 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_sic0m_664d6dda_checkmode_L000331 ' <symbol:checkmode>
 jmp #NEWF
 jmp #PSHM
 long $e80000 ' save registers
 mov r23, r4 ' reg var <- reg arg
 ...
 cmp r22,  #0 wz
 jmp #BR_Z
 long @C_sic0m_664d6dda_checkmode_L000331_333 ' EQU4
 mov RI, r19
 jmp #RBYT
 mov r22, BC ' reg <- INDIRU1 reg
 mov r2, r22 ' CVUI
 ...
 cmp r22,  #0 wz
 jmp #BRNZ
 long @C_sic0m_664d6dda_checkmode_L000331_333 ' NEU4
 mov r2, r21 ' CVI, CVU or LOAD
 mov r3, r19 ' CVI, CVU or LOAD
 jmp #LODL
 long @C_sic0m_664d6dda_checkmode_L000331_335_L000336
 ...
 long @C_luaD__throw
 add SP, #4 ' CALL addrg
C_sic0m_664d6dda_checkmode_L000331_333
' C_sic0m_664d6dda_checkmode_L000331_332 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 jmp #RETF


 alignl ' align long
C_sic0o_664d6dda_f_parser_L000337 ' <symbol:f_parser>
 jmp #NEWF
 sub SP, #8
 jmp #PSHM
 long $fe0000 ' save registers
 ...
 cmp r20,  #0 wz
 jmp #BR_Z
 long @C_sic0o_664d6dda_f_parser_L000337_340 ' EQU4
 mov RI, r19
 jmp #RLNG
 mov r22, BC ' reg <- INDIRP4 reg
 adds r22, #4 ' ADDP4 coni
 ...
 jmp #JMPA
 long @C_sic0o_664d6dda_f_parser_L000337_341 ' JUMPV addrg
C_sic0o_664d6dda_f_parser_L000337_340
 mov RI, r19
 jmp #RLNG
 mov r2, BC ' reg <- INDIRP4 reg
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
...
C_sic0o_664d6dda_f_parser_L000337_341
 mov RI, FP
 sub RI, #-(-8)
 ...
 rdlong r22, r22 ' reg <- INDIRI4 regl
 jmp #LODL
 long @C_sic0o_664d6dda_f_parser_L000337_344_L000345
 jmp #RBYT
 mov r20, BC ' reg <- INDIRU1 addrg
 and r20, cviu_m1 ' zero extend
 cmps r22, r20 wz
 jmp #BRNZ
 long @C_sic0o_664d6dda_f_parser_L000337_342 ' NEI4
 jmp #LODL
 long @C_sic0o_664d6dda_f_parser_L000337_346_L000347
 mov r2, RI ' reg ARG ADDRG
 mov r22, r19
 ...
 sub SP, #8 ' stack space for reg ARGs
 jmp #CALA
 long @C_sic0m_664d6dda_checkmode_L000331
 add SP, #8 ' CALL addrg
 mov r22, r19
 ...
 wrlong r0, RI ' ASGNP4 addrli reg
 jmp #JMPA
 long @C_sic0o_664d6dda_f_parser_L000337_343 ' JUMPV addrg
C_sic0o_664d6dda_f_parser_L000337_342
 jmp #LODL
 long @C_sic0o_664d6dda_f_parser_L000337_348_L000349
 mov r2, RI ' reg ARG ADDRG
 mov r22, r19
 adds r22, #52 ' ADDP4 coni
 mov RI, r22
 ...
 sub RI, #-(-12)
 wrlong r0, RI ' ASGNP4 addrli reg
C_sic0o_664d6dda_f_parser_L000337_343
 mov RI, FP
 sub RI, #-(-12)
 rdlong r2, RI ' reg ARG INDIR ADDRLi
 mov r3, r23 ' CVI, CVU or LOAD
 ...
 add SP, #4 ' CALL addrg
' C_sic0o_664d6dda_f_parser_L000337_338 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 add SP, #8 ' framesize
 jmp #RETF
...
C_luaD__protectedparser ' <symbol:luaD_protectedparser>
 ...
 jmp #LODL
 long @C_sic0o_664d6dda_f_parser_L000337
...
DAT ' const data segment
 ...
 alignl ' align long
C_sic0o_664d6dda_f_parser_L000337_348_L000349 ' <symbol:348>
 byte 116
 byte 101
 byte 120
 byte 116
 ...
 alignl ' align long
C_sic0o_664d6dda_f_parser_L000337_346_L000347 ' <symbol:346>
 byte 98
 byte 105
 byte 110
 byte 97
 ...
 alignl ' align long
C_sic0o_664d6dda_f_parser_L000337_344_L000345 ' <symbol:344>
 byte 27
 byte 76
 byte 117
 byte 97
 ...
 alignl ' align long
C_sic0m_664d6dda_checkmode_L000331_335_L000336 ' <symbol:335>
 byte 97
 byte 116
 byte 116
 byte 101
