...
'
 ...
 alignl ' align long
C_sj6k_664d6dda_luai_makeseed_L000013 ' <symbol:luai_makeseed>
 jmp #NEWF
 sub SP, #20
 jmp #PSHM
...
' C_sj6k_664d6dda_luai_makeseed_L000013_14 ' (symbol refcount = 0)
...
' C_luaE__incC_stack_39 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_sj6k2_664d6dda_stack_init_L000042 ' <symbol:stack_init>
 jmp #NEWF
 jmp #PSHM
 long $fa0000 ' save registers
 ...
 jmp #WLNG ' ASGNP4 reg reg
 mov r19, #0 ' reg <- coni
C_sj6k2_664d6dda_stack_init_L000042_44
 mov r22, r19
...
' C_sj6k2_664d6dda_stack_init_L000042_45 ' (symbol refcount = 0)
 adds r19, #1 ' ADDI4 coni
 cmps r19,  #45 wz,wc
 jmp #BR_B
 long @C_sj6k2_664d6dda_stack_init_L000042_44 ' LTI4
 mov r22, r23
 adds r22, #12 ' ADDP4 coni
 mov r20, r23
 adds r20, #28 ' ADDP4 coni
 ...
 mov BC, r17
 jmp #WLNG ' ASGNP4 reg reg
' C_sj6k2_664d6dda_stack_init_L000042_43 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 jmp #RETF


 alignl ' align long
C_sj6k3_664d6dda_freestack_L000048 ' <symbol:freestack>
 jmp #NEWF
 jmp #PSHM
 ...
 cmp r22,  #0 wz
 jmp #BRNZ
 long @C_sj6k3_664d6dda_freestack_L000048_50 ' NEU4
 jmp #JMPA
 long @C_sj6k3_664d6dda_freestack_L000048_49 ' JUMPV addrg
C_sj6k3_664d6dda_freestack_L000048_50
 mov r22, r23
 adds r22, #20 ' ADDP4 coni
 mov r20, r23
 ...
 long @C_luaM__free_
 add SP, #8 ' CALL addrg
C_sj6k3_664d6dda_freestack_L000048_49
 jmp #POPM ' restore registers
 jmp #RETF


 alignl ' align long
C_sj6k4_664d6dda_init_registry_L000052 ' <symbol:init_registry>
 jmp #NEWF
 sub SP, #4
 jmp #PSHM
 long $fa0000 ' save registers
 ...
 mov BC, r20
 jmp #WBYT ' ASGNU1 reg reg
' C_sj6k4_664d6dda_init_registry_L000052_53 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 add SP, #4 ' framesize
 jmp #RETF
 ...
 alignl ' align long
C_sj6k5_664d6dda_f_luaopen_L000054 ' <symbol:f_luaopen>
 jmp #NEWF
 jmp #PSHM
 long $f80000 ' save registers
 mov r23, r3 ' reg var <- reg arg
 ...
 sub SP, #4 ' stack space for reg ARGs
 jmp #CALA
 long @C_sj6k2_664d6dda_stack_init_L000042
 add SP, #4 ' CALL addrg
 ...
 sub SP, #4 ' stack space for reg ARGs
 jmp #CALA
 long @C_sj6k4_664d6dda_init_registry_L000052
 add SP, #4 ' CALL addrg
 mov r2, r23 ' CVI, CVU or LOAD
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 jmp #CALA
 ...
 mov BC, r20
 jmp #WBYT ' ASGNU1 reg reg
' C_sj6k5_664d6dda_f_luaopen_L000054_55 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 jmp #RETF


 alignl ' align long
C_sj6k6_664d6dda_preinit_thread_L000056 ' <symbol:preinit_thread>
 jmp #PSHM
 ...
 mov BC, r20
 jmp #WLNG ' ASGNI4 reg reg
' C_sj6k6_664d6dda_preinit_thread_L000056_57 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 jmp #RETN


 alignl ' align long
C_sj6k7_664d6dda_close_state_L000058 ' <symbol:close_state>
 jmp #NEWF
 jmp #PSHM
 long $f00000 ' save registers
 mov r23, r2 ' reg var <- reg arg
 ...
 cmps r22,  #0 wz
 jmp #BR_Z
 long @C_sj6k7_664d6dda_close_state_L000058_60 ' EQI4
 mov r2, r23 ' CVI, CVU or LOAD
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 jmp #CALA
 long @C_luaC__freeallobjects ' CALL addrg
 jmp #JMPA
 long @C_sj6k7_664d6dda_close_state_L000058_61 ' JUMPV addrg
C_sj6k7_664d6dda_close_state_L000058_60
 mov r22, r23
 adds r22, #20 ' ADDP4 coni
 mov r20, r23
 adds r20, #52 ' ADDP4 coni
 ...
 jmp #CALA
 long @C_luaC__freeallobjects ' CALL addrg
C_sj6k7_664d6dda_close_state_L000058_61
 mov r22, r23
 adds r22, #16 ' ADDP4 coni
 mov RI, r22
 jmp #RLNG
 ...
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 jmp #CALA
 long @C_sj6k3_664d6dda_freestack_L000048 ' CALL addrg
 mov r2, #0 ' reg ARG coni
 jmp #LODL
 long 840
...
' C_sj6k7_664d6dda_close_state_L000058_59 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 jmp #RETF
...
C_lua_newthread_63
 ...
 sub SP, #4 ' stack space for reg ARGs
 jmp #CALA
 long @C_sj6k6_664d6dda_preinit_thread_L000056
 add SP, #4 ' CALL addrg
 mov r22, r21
 adds r22, #112 ' ADDP4 coni
 mov r20, r23
...
C_lua_newstate_73
 ...
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 jmp #CALA
 long @C_sj6k_664d6dda_luai_makeseed_L000013 ' CALL addrg
 mov r20, r19
 adds r20, #52 ' ADDP4 coni
 mov RI, r20
 mov BC, r0
...
' C_lua_newstate_76 ' (symbol refcount = 0)
 ...
 mov r2, RI ' reg ARG con
 jmp #LODL
 long @C_sj6k5_664d6dda_f_luaopen_L000054
 ...
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 jmp #CALA
 long @C_sj6k7_664d6dda_close_state_L000058 ' CALL addrg
 jmp #LODL
 long 0
 mov r15, RI ' reg <- con
C_lua_newstate_79
