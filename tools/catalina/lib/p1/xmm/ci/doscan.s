...
'
 ...
 alignl ' align long
C_so9c_69c22be6_o_collect_L000003 ' <symbol:o_collect>
 jmp #NEWF
 jmp #PSHM
 ...
 cmps r11, r22 wz
 jmp #BR_Z
 long @C_so9c_69c22be6_o_collect_L000003_8 ' EQI4
 cmps r11, r22 wz,wc
 jmp #BR_A
 long @C_so9c_69c22be6_o_collect_L000003_13 ' GTI4
' C_so9c_69c22be6_o_collect_L000003_12 ' (symbol refcount = 0)
 mov r22, #88 ' reg <- coni
 cmps r11, r22 wz
 jmp #BR_Z
 long @C_so9c_69c22be6_o_collect_L000003_8 ' EQI4
 cmps r11, r22 wz,wc
 jmp #BR_B
 long @C_so9c_69c22be6_o_collect_L000003_5 ' LTI4
' C_so9c_69c22be6_o_collect_L000003_14 ' (symbol refcount = 0)
 cmps r11,  #98 wz
 jmp #BR_Z
 long @C_so9c_69c22be6_o_collect_L000003_11 ' EQI4
 cmps r11,  #100 wz
 jmp #BR_Z
 long @C_so9c_69c22be6_o_collect_L000003_9 ' EQI4
 jmp #JMPA
 long @C_so9c_69c22be6_o_collect_L000003_5 ' JUMPV addrg
C_so9c_69c22be6_o_collect_L000003_13
 mov r22, #111 ' reg <- coni
 cmps r11, r22 wz
 jmp #BR_Z
 long @C_so9c_69c22be6_o_collect_L000003_10 ' EQI4
 cmps r11,  #112 wz
 jmp #BR_Z
 long @C_so9c_69c22be6_o_collect_L000003_8 ' EQI4
 cmps r11, r22 wz,wc
 jmp #BR_B
 long @C_so9c_69c22be6_o_collect_L000003_5 ' LTI4
' C_so9c_69c22be6_o_collect_L000003_15 ' (symbol refcount = 0)
 cmps r11,  #117 wz
 jmp #BR_Z
 long @C_so9c_69c22be6_o_collect_L000003_9 ' EQI4
 cmps r11,  #120 wz
 ...
 jmp #JMPA
 long @C_so9c_69c22be6_o_collect_L000003_5 ' JUMPV addrg
C_so9c_69c22be6_o_collect_L000003_8
 mov r13, #16 ' reg <- coni
 jmp #JMPA
 long @C_so9c_69c22be6_o_collect_L000003_6 ' JUMPV addrg
C_so9c_69c22be6_o_collect_L000003_9
 mov r13, #10 ' reg <- coni
 jmp #JMPA
 long @C_so9c_69c22be6_o_collect_L000003_6 ' JUMPV addrg
C_so9c_69c22be6_o_collect_L000003_10
 mov r13, #8 ' reg <- coni
 jmp #JMPA
 long @C_so9c_69c22be6_o_collect_L000003_6 ' JUMPV addrg
C_so9c_69c22be6_o_collect_L000003_11
 mov r13, #2 ' reg <- coni
C_so9c_69c22be6_o_collect_L000003_5
C_so9c_69c22be6_o_collect_L000003_6
 mov r22, FP
 add r22, #8 ' reg <- addrfi
 rdlong r22, r22 ' reg <- INDIRI4 regl
 cmps r22,  #45 wz
 jmp #BR_Z
 long @C_so9c_69c22be6_o_collect_L000003_18 ' EQI4
 cmps r22,  #43 wz
 jmp #BRNZ
 long @C_so9c_69c22be6_o_collect_L000003_16 ' NEI4
C_so9c_69c22be6_o_collect_L000003_18
 ...
 cmps r22,  #0 wz
 jmp #BR_Z
 long @C_so9c_69c22be6_o_collect_L000003_19 ' EQI4
 mov RI, FP
 add RI, #12
...
C_so9c_69c22be6_o_collect_L000003_19
C_so9c_69c22be6_o_collect_L000003_16
 cmps r21,  #0 wz
 jmp #BR_Z
 long @C_so9c_69c22be6_o_collect_L000003_21 ' EQI4
 mov r22, FP
 add r22, #8 ' reg <- addrfi
 rdlong r22, r22 ' reg <- INDIRI4 regl
 cmps r22,  #48 wz
 jmp #BRNZ
 long @C_so9c_69c22be6_o_collect_L000003_21 ' NEI4
 cmps r13,  #16 wz
 jmp #BRNZ
 long @C_so9c_69c22be6_o_collect_L000003_21 ' NEI4
 mov r22, r15 ' CVI, CVU or LOAD
 ...
 cmps r22,  #0 wz
 jmp #BR_Z
 long @C_so9c_69c22be6_o_collect_L000003_23 ' EQI4
 mov RI, FP
 add RI, #12
 rdlong r2, RI ' reg ARG INDIR ADDRFi
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 ...
 add RI, #8
 wrlong r0, RI ' ASGNI4 addrfi reg
C_so9c_69c22be6_o_collect_L000003_23
 mov r22, FP
 add r22, #8 ' reg <- addrfi
 rdlong r22, r22 ' reg <- INDIRI4 regl
 cmps r22,  #120 wz
 jmp #BR_Z
 long @C_so9c_69c22be6_o_collect_L000003_25 ' EQI4
 cmps r22,  #88 wz
 jmp #BR_Z
 long @C_so9c_69c22be6_o_collect_L000003_25 ' EQI4
 mov r22, r23 ' CVUI
 ...
 cmps r22,  #105 wz
 jmp #BRNZ
 long @C_so9c_69c22be6_o_collect_L000003_36 ' NEI4
 mov r13, #8 ' reg <- coni
 jmp #JMPA
 long @C_so9c_69c22be6_o_collect_L000003_36 ' JUMPV addrg
C_so9c_69c22be6_o_collect_L000003_25
 cmps r21,  #0 wz
 jmp #BR_Z
 long @C_so9c_69c22be6_o_collect_L000003_36 ' EQI4
 mov r22, r15 ' CVI, CVU or LOAD
 mov r15, r22
 adds r15, #1 ' ADDP4 coni
 mov r20, FP
 ...
 jmp #JMPA
 long @C_so9c_69c22be6_o_collect_L000003_36 ' JUMPV addrg
C_so9c_69c22be6_o_collect_L000003_21
 mov r22, r23 ' CVUI
 and r22, cviu_m1 ' zero extend
 cmps r22,  #105 wz
 jmp #BRNZ
 ...
 jmp #JMPA
 long @C_so9c_69c22be6_o_collect_L000003_36 ' JUMPV addrg
C_so9c_69c22be6_o_collect_L000003_35
 cmps r13,  #10 wz
 jmp #BRNZ
 long @C_so9c_69c22be6_o_collect_L000003_42 ' NEI4
 mov r22, FP
 add r22, #8 ' reg <- addrfi
 rdlong r22, r22 ' reg <- INDIRI4 regl
 ...
 cmp r22,  #10 wz,wc 
 jmp #BR_B
 long @C_so9c_69c22be6_o_collect_L000003_45' LTU4
C_so9c_69c22be6_o_collect_L000003_42
 cmps r13,  #16 wz
 jmp #BRNZ
 long @C_so9c_69c22be6_o_collect_L000003_44 ' NEI4
 mov r22, FP
 add r22, #8 ' reg <- addrfi
 rdlong r22, r22 ' reg <- INDIRI4 regl
 jmp #LODL
 ...
 cmps r22,  #0 wz
 jmp #BRNZ
 long @C_so9c_69c22be6_o_collect_L000003_45 ' NEI4
C_so9c_69c22be6_o_collect_L000003_44
 cmps r13,  #8 wz
 jmp #BRNZ
 long @C_so9c_69c22be6_o_collect_L000003_47 ' NEI4
 mov r22, FP
 add r22, #8 ' reg <- addrfi
 rdlong r22, r22 ' reg <- INDIRI4 regl
 mov r20, r22
 ...
 cmp r20,  #10 wz,wc 
 jmp #BRAE
 long @C_so9c_69c22be6_o_collect_L000003_47 ' GEU4
 cmps r22,  #56 wz,wc
 jmp #BR_B
 long @C_so9c_69c22be6_o_collect_L000003_45 ' LTI4
C_so9c_69c22be6_o_collect_L000003_47
 cmps r13,  #2 wz
 jmp #BRNZ
 long @C_so9c_69c22be6_o_collect_L000003_37 ' NEI4
 mov r22, FP
 add r22, #8 ' reg <- addrfi
 rdlong r22, r22 ' reg <- INDIRI4 regl
 mov r20, r22
 ...
 cmp r20,  #10 wz,wc 
 jmp #BRAE
 long @C_so9c_69c22be6_o_collect_L000003_37 ' GEU4
 cmps r22,  #50 wz,wc
 jmp #BRAE
 long @C_so9c_69c22be6_o_collect_L000003_37 ' GEI4
C_so9c_69c22be6_o_collect_L000003_45
 mov r22, r15 ' CVI, CVU or LOAD
 mov r15, r22
 adds r15, #1 ' ADDP4 coni
 mov r20, FP
 ...
 cmps r22,  #0 wz
 jmp #BR_Z
 long @C_so9c_69c22be6_o_collect_L000003_39 ' EQI4
 mov RI, FP
 add RI, #12
 rdlong r2, RI ' reg ARG INDIR ADDRFi
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 ...
 add RI, #8
 wrlong r0, RI ' ASGNI4 addrfi reg
C_so9c_69c22be6_o_collect_L000003_39
C_so9c_69c22be6_o_collect_L000003_36
 cmps r21,  #0 wz
 jmp #BRNZ
 long @C_so9c_69c22be6_o_collect_L000003_35 ' NEI4
C_so9c_69c22be6_o_collect_L000003_37
 cmps r21,  #0 wz
 jmp #BR_Z
 long @C_so9c_69c22be6_o_collect_L000003_50 ' EQI4
 mov r22, FP
 add r22, #8 ' reg <- addrfi
 rdlong r22, r22 ' reg <- INDIRI4 regl
 jmp #LODL
 ...
 long @C_ungetc
 add SP, #4 ' CALL addrg
C_so9c_69c22be6_o_collect_L000003_50
 mov r22, r23 ' CVUI
 and r22, cviu_m1 ' zero extend
 cmps r22,  #105 wz
 jmp #BRNZ
 long @C_so9c_69c22be6_o_collect_L000003_52 ' NEI4
 mov r13, #0 ' reg <- coni
C_so9c_69c22be6_o_collect_L000003_52
 mov RI, r19
 mov BC, r13
...
' C_so9c_69c22be6_o_collect_L000003_4 ' (symbol refcount = 0)
...
C__doscan_135
 ...
 jmp #CALA
 long @C_so9c_69c22be6_o_collect_L000003
