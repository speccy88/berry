...
DAT ' const data segment
 ...
 alignl ' align long
C_srv8_69c22bc8_udatatypename_L000015 ' <symbol:udatatypename>
 byte 117
 byte 115
 byte 101
 byte 114
...
C_luaT__typenames_ ' <symbol:luaT_typenames_>
 long @C_srv81_69c22bc8_16_L000017
 long @C_srv82_69c22bc8_18_L000019
 long @C_srv83_69c22bc8_20_L000021
 long @C_srv8_69c22bc8_udatatypename_L000015
 long @C_srv84_69c22bc8_22_L000023
 long @C_srv85_69c22bc8_24_L000025
 long @C_srv86_69c22bc8_26_L000027
 long @C_srv87_69c22bc8_28_L000029
 long @C_srv8_69c22bc8_udatatypename_L000015
 long @C_srv88_69c22bc8_30_L000031
 long @C_srv89_69c22bc8_32_L000033
 long @C_srv8a_69c22bc8_34_L000035
...
' C_luaT__callT_M_res_118 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_srv816_69c22bc8_callbinT_M__L000121 ' <symbol:callbinTM>
 jmp #NEWF
 jmp #PSHM
 ...
 cmps r22,  #0 wz
 jmp #BRNZ
 long @C_srv816_69c22bc8_callbinT_M__L000121_123 ' NEI4
 mov r2, r17 ' CVI, CVU or LOAD
 ...
 add SP, #8 ' CALL addrg
 mov r15, r0 ' CVI, CVU or LOAD
C_srv816_69c22bc8_callbinT_M__L000121_123
 mov r22, r15
 adds r22, #4 ' ADDP4 coni
 mov RI, r22
 jmp #RBYT
 ...
 cmps r22,  #0 wz
 jmp #BRNZ
 long @C_srv816_69c22bc8_callbinT_M__L000121_125 ' NEI4
 mov r0, #0 ' reg <- coni
 jmp #JMPA
 long @C_srv816_69c22bc8_callbinT_M__L000121_122 ' JUMPV addrg
C_srv816_69c22bc8_callbinT_M__L000121_125
 mov r2, r19 ' CVI, CVU or LOAD
 mov r3, r21 ' CVI, CVU or LOAD
 ...
 mov r0, #1 ' reg <- coni
C_srv816_69c22bc8_callbinT_M__L000121_122
 jmp #POPM ' restore registers
 jmp #RETF
...
C_luaT__trybinT_M_ ' <symbol:luaT_trybinTM>
 ...
 add SP, #4 ' correct for new kernel !!! 
 jmp #CALA
 long @C_srv816_69c22bc8_callbinT_M__L000121
 add SP, #16 ' CALL addrg
 cmps r0,  #0 wz
 jmp #BRNZ
...
C_luaT__init_39_L000040 ' <symbol:39>
 ...
 alignl ' align long
C_srv8a_69c22bc8_34_L000035 ' <symbol:34>
 byte 112
 byte 114
 byte 111
 byte 116
 ...
 alignl ' align long
C_srv89_69c22bc8_32_L000033 ' <symbol:32>
 byte 117
 byte 112
 byte 118
 byte 97
 ...
 alignl ' align long
C_srv88_69c22bc8_30_L000031 ' <symbol:30>
 byte 116
 byte 104
 byte 114
 byte 101
 ...
 alignl ' align long
C_srv87_69c22bc8_28_L000029 ' <symbol:28>
 byte 102
 byte 117
 byte 110
 byte 99
 ...
 alignl ' align long
C_srv86_69c22bc8_26_L000027 ' <symbol:26>
 byte 116
 byte 97
 byte 98
 byte 108
 ...
 alignl ' align long
C_srv85_69c22bc8_24_L000025 ' <symbol:24>
 byte 115
 byte 116
 byte 114
 byte 105
 ...
 alignl ' align long
C_srv84_69c22bc8_22_L000023 ' <symbol:22>
 byte 110
 byte 117
 byte 109
 byte 98
 ...
 alignl ' align long
C_srv83_69c22bc8_20_L000021 ' <symbol:20>
 byte 98
 byte 111
 byte 111
 byte 108
 ...
 alignl ' align long
C_srv82_69c22bc8_18_L000019 ' <symbol:18>
 byte 110
 byte 105
 byte 108
 byte 0
 ...
 alignl ' align long
C_srv81_69c22bc8_16_L000017 ' <symbol:16>
 byte 110
 byte 111
 byte 32
 byte 118
