...
'
 ...
 alignl ' align long
C_squo_69c22bf9_itoa_L000001 ' <symbol:itoa>
 jmp #NEWF
 sub SP, #4
 jmp #PSHM
 ...
 cmps r3,  #0 wz,wc
 jmp #BRAE
 long @C_squo_69c22bf9_itoa_L000001_3 ' GEI4
 mov r22, #1 ' reg <- coni
 mov RI, FP
 sub RI, #-(-8)
 wrlong r22, RI ' ASGNI4 addrli reg
 ...
 jmp #JMPA
 long @C_squo_69c22bf9_itoa_L000001_4 ' JUMPV addrg
C_squo_69c22bf9_itoa_L000001_3
 mov r23, r3 ' CVI, CVU or LOAD
C_squo_69c22bf9_itoa_L000001_4
 mov r22, #0 ' reg <- coni
 mov RI, r21
 mov BC, r22
 jmp #WBYT ' ASGNU1 reg reg
C_squo_69c22bf9_itoa_L000001_5
 jmp #LODL
 long -1
 mov r22, RI ' reg <- con
...
' C_squo_69c22bf9_itoa_L000001_6 ' (symbol refcount = 0)
 cmp r23,  #0 wz
 jmp #BRNZ
 long @C_squo_69c22bf9_itoa_L000001_5 ' NEU4
 mov r22, FP
 sub r22, #-(-8) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRI4 regl
 cmps r22,  #0 wz
 jmp #BR_Z
 long @C_squo_69c22bf9_itoa_L000001_8 ' EQI4
 jmp #LODL
 long -1
 mov r22, RI ' reg <- con
 adds r22, r21 ' ADDI/P (2)
 ...
 mov BC, r20
 jmp #WBYT ' ASGNU1 reg reg
C_squo_69c22bf9_itoa_L000001_8
 mov r0, r21 ' CVI, CVU or LOAD
' C_squo_69c22bf9_itoa_L000001_2 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_squo1_69c22bf9_N_anO_rI_nf_L000010 ' <symbol:NanOrInf>
 jmp #NEWF
 sub SP, #4
 jmp #PSHM
 long $f00000 ' save registers
 ...
 cmp r20, r22 wz
 jmp #BRNZ
 long @C_squo1_69c22bf9_N_anO_rI_nf_L000010_12 ' NEU4
 mov r22, FP
 sub r22, #-(-8) ' reg <- addrli
 ...
 cmp r22,  #0 wz
 jmp #BRNZ
 long @C_squo1_69c22bf9_N_anO_rI_nf_L000010_14 ' NEU4
 mov r22, FP
 sub r22, #-(-8) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRU4 regl
 jmp #LODL
 ...
 cmp r22,  #0 wz
 jmp #BR_Z
 long @C_squo1_69c22bf9_N_anO_rI_nf_L000010_16 ' EQU4
 ...
 mov BC, r20
 jmp #WBYT ' ASGNU1 reg reg
C_squo1_69c22bf9_N_anO_rI_nf_L000010_16
 jmp #LODL
 long @C_squo1_69c22bf9_N_anO_rI_nf_L000010_18_L000019
 ...
 jmp #JMPA
 long @C_squo1_69c22bf9_N_anO_rI_nf_L000010_11 ' JUMPV addrg
C_squo1_69c22bf9_N_anO_rI_nf_L000010_14
 mov r22, FP
 sub r22, #-(-8) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRU4 regl
 jmp #LODL
 ...
 cmp r22,  #0 wz
 jmp #BR_Z
 long @C_squo1_69c22bf9_N_anO_rI_nf_L000010_20 ' EQU4
 mov r22, r21 ' CVI, CVU or LOAD
 mov r21, r22
 adds r21, #1 ' ADDP4 coni
 mov r20, #45 ' reg <- coni
 ...
 mov BC, r20
 jmp #WBYT ' ASGNU1 reg reg
C_squo1_69c22bf9_N_anO_rI_nf_L000010_20
 jmp #LODL
 long @C_squo1_69c22bf9_N_anO_rI_nf_L000010_22_L000023
 mov r2, RI ' reg ARG ADDRG
 mov r3, r21 ' CVI, CVU or LOAD
 mov BC, #8 ' arg size, rpsize = 8, spsize = 8
 sub SP, #4 ' stack space for reg ARGs
 ...
 jmp #JMPA
 long @C_squo1_69c22bf9_N_anO_rI_nf_L000010_11 ' JUMPV addrg
C_squo1_69c22bf9_N_anO_rI_nf_L000010_12
 jmp #LODL
 long 0
 mov r0, RI ' reg <- con
C_squo1_69c22bf9_N_anO_rI_nf_L000010_11
 jmp #POPM ' restore registers
 add SP, #4 ' framesize
 jmp #RETF
...
C_t_float_25
 ...
 sub SP, #4 ' stack space for reg ARGs
 jmp #CALA
 long @C_squo1_69c22bf9_N_anO_rI_nf_L000010
 add SP, #4 ' CALL addrg
...
C_t_float_39
 ...
 sub SP, #4 ' stack space for reg ARGs
 jmp #CALA
 long @C_squo_69c22bf9_itoa_L000001
 add SP, #4 ' CALL addrg
 mov r22, r0 ' CVI, CVU or LOAD
...
C_t_float_31_L000032 ' <symbol:31>
 ...
 alignl ' align long
C_squo1_69c22bf9_N_anO_rI_nf_L000010_22_L000023 ' <symbol:22>
 byte 110
 byte 97
 byte 110
 byte 0
 ...
 alignl ' align long
C_squo1_69c22bf9_N_anO_rI_nf_L000010_18_L000019 ' <symbol:18>
 byte 105
 byte 110
 byte 102
 byte 0
