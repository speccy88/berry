...
DAT ' initialized data segment
 ...
 alignl ' align long
C_smlk_69c22bc2_K_ernel_lock_L000004 ' <symbol:Kernel_lock>
 long -1

 alignl ' align long
C_smlk1_69c22bc2_P_thread_L_ock_L000005 ' <symbol:Pthread_Lock>
 long -1

 alignl ' align long
C_smlk2_69c22bc2_P_rintf_L_ock_L000006 ' <symbol:Printf_Lock>
 long -1

 alignl ' align long
C_smlk3_69c22bc2_O_nce_L_ock_L000007 ' <symbol:Once_Lock>
 long -1

 alignl ' align long
C_smlk4_69c22bc2_concurrency_L000008 ' <symbol:concurrency>
 long 0
...
DAT ' code segment
 ...
 alignl ' align long
C_smlk5_69c22bc2__ensure_lock_L000009 ' <symbol:_ensure_lock>
 jmp #NEWF
 jmp #PSHM
 ...
 cmps r22,  #0 wz,wc
 jmp #BR_A
 long @C_smlk5_69c22bc2__ensure_lock_L000009_11 ' GTI4
 jmp #LODL
...
C_smlk5_69c22bc2__ensure_lock_L000009_11
' C_smlk5_69c22bc2__ensure_lock_L000009_10 ' (symbol refcount = 0)
...
C__pthread_init_lock_pool ' <symbol:_pthread_init_lock_pool>
 ...
 mov r23, r2 ' reg var <- reg arg
 jmp #LODI
 long @C_smlk_69c22bc2_K_ernel_lock_L000004
...
C__pthread_init_lock_pool_14
 ...
 jmp #LODI
 long @C_smlk1_69c22bc2_P_thread_L_ock_L000005
 mov r22, RI ' reg <- INDIRI4 addrg
 jmp #LODL
 long -1
 mov r20, RI ' reg <- con
...
C__pthread_init_lock_pool_16
 jmp #LODL
 long @C_smlk2_69c22bc2_P_rintf_L_ock_L000006
 mov r2, RI ' reg ARG ADDRG
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 jmp #CALA
 long @C_smlk5_69c22bc2__ensure_lock_L000009 ' CALL addrg
 jmp #LODL
 long @C_smlk3_69c22bc2_O_nce_L_ock_L000007
 mov r2, RI ' reg ARG ADDRG
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 jmp #CALA
 long @C_smlk5_69c22bc2__ensure_lock_L000009 ' CALL addrg
...
' C_pthread_equal_56 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_smlkd_69c22bc2_dummy_function_L000060 ' <symbol:dummy_function>
 jmp #NEWF
 sub SP, #12
 jmp #PSHM
 ...
 cmps r22,  #0 wz
 jmp #BRNZ
 long @C_smlkd_69c22bc2_dummy_function_L000060_62 ' NEI4
 mov r22, FP
...
C_smlkd_69c22bc2_dummy_function_L000060_62
 mov r22, FP
 sub r22, #-(-8) ' reg <- addrli
 rdlong r0, r22 ' reg <- INDIRI4 regl
' C_smlkd_69c22bc2_dummy_function_L000060_61 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 add SP, #12 ' framesize
 jmp #RETF
...
C_pthread_create_70
 ...
 jmp #LODL
 long @C_smlkd_69c22bc2_dummy_function_L000060
...
C_pthread_create_64
 ...
 alignl ' align long
C_smlke_69c22bc2_foreman_L000075 ' <symbol:foreman>
 jmp #NEWF
 jmp #PSHM
 ...
 long @C__thread_set_lock ' CALL addrg
 jmp #JMPA
 long @C_smlke_69c22bc2_foreman_L000075_78 ' JUMPV addrg
C_smlke_69c22bc2_foreman_L000075_77
 mov r2, #100 ' reg ARG coni
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 jmp #CALA
 long @C__thread_wait ' CALL addrg
C_smlke_69c22bc2_foreman_L000075_78
 jmp #JMPA
 long @C_smlke_69c22bc2_foreman_L000075_77 ' JUMPV addrg
 mov r0, #0 ' reg <- coni
' C_smlke_69c22bc2_foreman_L000075_76 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 jmp #RETF
...
C_pthread_createaffinity_81
 ...
 jmp #LODL
 long @C_smlke_69c22bc2_foreman_L000075
 mov r5, RI ' reg ARG ADDRG
 mov BC, #16 ' arg size, rpsize = 16, spsize = 16
 sub SP, #12 ' stack space for reg ARGs
 jmp #CALA
...
C_pthread_setconcurrency ' <symbol:pthread_setconcurrency>
 jmp #LODL
 long @C_smlk4_69c22bc2_concurrency_L000008
 mov BC, r2
 jmp #WLNG ' ASGNI4 addrg reg
 mov r0, #0 ' reg <- coni
