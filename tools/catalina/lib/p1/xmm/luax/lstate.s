...
'
 ...
 alignl ' align long
C_sgnk_69c22bc8_luai_makeseed_L000015 ' <symbol:luai_makeseed>
 jmp #NEWF
 sub SP, #20
 jmp #PSHM
...
' C_sgnk_69c22bc8_luai_makeseed_L000015_16 ' (symbol refcount = 0)
...
' C_luaE__extendC_I__21 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_sgnk1_69c22bc8_freeC_I__L000022 ' <symbol:freeCI>
 jmp #NEWF
 jmp #PSHM
 ...
 jmp #WLNG ' ASGNP4 reg reg
 jmp #JMPA
 long @C_sgnk1_69c22bc8_freeC_I__L000022_25 ' JUMPV addrg
C_sgnk1_69c22bc8_freeC_I__L000022_24
 mov r22, r21
 adds r22, #12 ' ADDP4 coni
 mov RI, r22
 jmp #RLNG
 ...
 mov BC, r20
 jmp #WWRD ' ASGNU2 reg reg
C_sgnk1_69c22bc8_freeC_I__L000022_25
 mov r21, r19 ' CVI, CVU or LOAD
 mov r22, r19 ' CVI, CVU or LOAD
 cmp r22,  #0 wz
 jmp #BRNZ
 long @C_sgnk1_69c22bc8_freeC_I__L000022_24 ' NEU4
' C_sgnk1_69c22bc8_freeC_I__L000022_23 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 jmp #RETF
...
' C_luaE__incC_stack_42 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_sgnk3_69c22bc8_stack_init_L000045 ' <symbol:stack_init>
 jmp #NEWF
 jmp #PSHM
 long $fa0000 ' save registers
 ...
 jmp #WLNG ' ASGNP4 reg reg
 mov r19, #0 ' reg <- coni
C_sgnk3_69c22bc8_stack_init_L000045_47
 mov r22, r19
...
' C_sgnk3_69c22bc8_stack_init_L000045_48 ' (symbol refcount = 0)
 adds r19, #1 ' ADDI4 coni
 cmps r19,  #45 wz,wc
 jmp #BR_B
 long @C_sgnk3_69c22bc8_stack_init_L000045_47 ' LTI4
 mov r22, r23
 adds r22, #12 ' ADDP4 coni
 mov r20, r23
 adds r20, #28 ' ADDP4 coni
 ...
 mov BC, r17
 jmp #WLNG ' ASGNP4 reg reg
' C_sgnk3_69c22bc8_stack_init_L000045_46 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 jmp #RETF


 alignl ' align long
C_sgnk4_69c22bc8_freestack_L000051 ' <symbol:freestack>
 jmp #NEWF
 jmp #PSHM
 ...
 cmp r22,  #0 wz
 jmp #BRNZ
 long @C_sgnk4_69c22bc8_freestack_L000051_53 ' NEU4
 jmp #JMPA
 long @C_sgnk4_69c22bc8_freestack_L000051_52 ' JUMPV addrg
C_sgnk4_69c22bc8_freestack_L000051_53
 mov r22, r23
 adds r22, #20 ' ADDP4 coni
 mov r20, r23
 ...
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 jmp #CALA
 long @C_sgnk1_69c22bc8_freeC_I__L000022 ' CALL addrg
 mov r22, r23
 adds r22, #28 ' ADDP4 coni
 mov RI, r22
 jmp #RLNG
 ...
 long @C_luaM__free_
 add SP, #8 ' CALL addrg
C_sgnk4_69c22bc8_freestack_L000051_52
 jmp #POPM ' restore registers
 jmp #RETF


 alignl ' align long
C_sgnk5_69c22bc8_init_registry_L000055 ' <symbol:init_registry>
 jmp #NEWF
 sub SP, #4
 jmp #PSHM
 long $fa0000 ' save registers
 ...
 mov BC, r20
 jmp #WBYT ' ASGNU1 reg reg
' C_sgnk5_69c22bc8_init_registry_L000055_56 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 add SP, #4 ' framesize
 jmp #RETF
 ...
 alignl ' align long
C_sgnk6_69c22bc8_f_luaopen_L000057 ' <symbol:f_luaopen>
 jmp #NEWF
 jmp #PSHM
 long $f80000 ' save registers
 mov r23, r3 ' reg var <- reg arg
 ...
 sub SP, #4 ' stack space for reg ARGs
 jmp #CALA
 long @C_sgnk3_69c22bc8_stack_init_L000045
 add SP, #4 ' CALL addrg
 ...
 sub SP, #4 ' stack space for reg ARGs
 jmp #CALA
 long @C_sgnk5_69c22bc8_init_registry_L000055
 add SP, #4 ' CALL addrg
 mov r2, r23 ' CVI, CVU or LOAD
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 jmp #CALA
 ...
 mov BC, r20
 jmp #WBYT ' ASGNU1 reg reg
' C_sgnk6_69c22bc8_f_luaopen_L000057_58 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 jmp #RETF


 alignl ' align long
C_sgnk7_69c22bc8_preinit_thread_L000059 ' <symbol:preinit_thread>
 jmp #PSHM
 ...
 mov BC, r20
 jmp #WLNG ' ASGNI4 reg reg
' C_sgnk7_69c22bc8_preinit_thread_L000059_60 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 jmp #RETN


 alignl ' align long
C_sgnk8_69c22bc8_close_state_L000061 ' <symbol:close_state>
 jmp #NEWF
 jmp #PSHM
 long $f00000 ' save registers
 mov r23, r2 ' reg var <- reg arg
 ...
 cmps r22,  #0 wz
 jmp #BR_Z
 long @C_sgnk8_69c22bc8_close_state_L000061_63 ' EQI4
 mov r2, r23 ' CVI, CVU or LOAD
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 jmp #CALA
 long @C_luaC__freeallobjects ' CALL addrg
 jmp #JMPA
 long @C_sgnk8_69c22bc8_close_state_L000061_64 ' JUMPV addrg
C_sgnk8_69c22bc8_close_state_L000061_63
 mov r22, r23
 adds r22, #20 ' ADDP4 coni
 mov r20, r23
 adds r20, #52 ' ADDP4 coni
 ...
 jmp #CALA
 long @C_luaC__freeallobjects ' CALL addrg
C_sgnk8_69c22bc8_close_state_L000061_64
 mov r22, r23
 adds r22, #16 ' ADDP4 coni
 mov RI, r22
 jmp #RLNG
 ...
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 jmp #CALA
 long @C_sgnk4_69c22bc8_freestack_L000051 ' CALL addrg
 mov r2, #0 ' reg ARG coni
 jmp #LODL
 long 840
...
' C_sgnk8_69c22bc8_close_state_L000061_62 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 jmp #RETF
...
C_lua_newthread_66
 ...
 sub SP, #4 ' stack space for reg ARGs
 jmp #CALA
 long @C_sgnk7_69c22bc8_preinit_thread_L000059
 add SP, #4 ' CALL addrg
 mov r22, r21
 adds r22, #112 ' ADDP4 coni
 mov r20, r23
...
C_lua_newstate_80
 ...
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 jmp #CALA
 long @C_sgnk_69c22bc8_luai_makeseed_L000015 ' CALL addrg
 mov r20, r19
 adds r20, #52 ' ADDP4 coni
 mov RI, r20
 mov BC, r0
...
' C_lua_newstate_83 ' (symbol refcount = 0)
 ...
 mov r2, RI ' reg ARG con
 jmp #LODL
 long @C_sgnk6_69c22bc8_f_luaopen_L000057
 ...
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 jmp #CALA
 long @C_sgnk8_69c22bc8_close_state_L000061 ' CALL addrg
 jmp #LODL
 long 0
 mov r15, RI ' reg <- con
C_lua_newstate_86
