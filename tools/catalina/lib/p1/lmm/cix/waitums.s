...
'
 ...
 alignl ' align long
C_snh07_69c22b25_recalculate_L000008 ' <symbol:recalculate>
 jmp #NEWF
 jmp #PSHM
 long $fc0000 ' save registers
 mov r23, r2 ' reg var <- reg arg
 jmp #LODL
 long @C_snh0_69c22b25_old_freq_L000001
 ...
 jmp #DIVU ' DIVU
 jmp #LODL
 long @C_snh01_69c22b25_cnt_usec_L000002
 ...
 jmp #DIVU ' DIVU
 jmp #LODL
 long @C_snh02_69c22b25_cnt_msec_L000003
 wrlong r0, RI ' ASGNU4 addrg reg
 ...
 jmp #LODL
 long @C_snh03_69c22b25_min_tick_L000004
 wrlong r0, RI ' ASGNU4 addrg reg
 ...
 jmp #LODL
 long @C_snh06_69c22b25_overhead_L000007
 ...
 jmp #DIVU ' DIVU
 jmp #LODL
 long @C_snh04_69c22b25_min_usec_L000005
 wrlong r0, RI ' ASGNU4 addrg reg
 jmp #LODI
 long @C_snh02_69c22b25_cnt_msec_L000003
 mov r20, RI ' reg <- INDIRU4 addrg
 ...
 jmp #DIVU ' DIVU
 jmp #LODL
 long @C_snh05_69c22b25_min_msec_L000006
 wrlong r0, RI ' ASGNU4 addrg reg
' C_snh07_69c22b25_recalculate_L000008_9 ' (symbol refcount = 0)
...
C_min_waitus ' <symbol:min_waitus>
 ...
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 jmp #CALA
 long @C_snh07_69c22b25_recalculate_L000008 ' CALL addrg
C_min_waitus_11
 jmp #LODI
 long @C_snh04_69c22b25_min_usec_L000005
...
DAT ' uninitialized data segment
 ...
 alignl ' align long
C_snh06_69c22b25_overhead_L000007 ' <symbol:overhead>
 byte 0[4]

 alignl ' align long
C_snh05_69c22b25_min_msec_L000006 ' <symbol:min_msec>
 byte 0[4]

 alignl ' align long
C_snh04_69c22b25_min_usec_L000005 ' <symbol:min_usec>
 byte 0[4]

 alignl ' align long
C_snh03_69c22b25_min_tick_L000004 ' <symbol:min_tick>
 byte 0[4]

 alignl ' align long
C_snh02_69c22b25_cnt_msec_L000003 ' <symbol:cnt_msec>
 byte 0[4]

 alignl ' align long
C_snh01_69c22b25_cnt_usec_L000002 ' <symbol:cnt_usec>
 byte 0[4]

 alignl ' align long
C_snh0_69c22b25_old_freq_L000001 ' <symbol:old_freq>
 byte 0[4]
