...
DAT ' initialized data segment
 ...
 alignl ' align long
C_sa70_69c22b05_rxbase_L000002 ' <symbol:rxbase>
 long $0

 alignl ' align long
C_sa701_69c22b05_lock_L000003 ' <symbol:lock>
 long -1
...
DAT ' code segment
 ...
 alignl ' align long
C_sa702_69c22b05_initialize_L000004 ' <symbol:initialize>
 jmp #NEWF
 sub SP, #8
 jmp #PSHM
 long $540000 ' save registers
 jmp #LODI
 long @C_sa70_69c22b05_rxbase_L000002
 mov r22, RI ' reg <- INDIRP4 addrg
 cmp r22,  #0 wz
 jmp #BRNZ
 long @C_sa702_69c22b05_initialize_L000004_6 ' NEU4
 ...
 cmps r22,  #0 wz,wc
 jmp #BR_B
 long @C_sa702_69c22b05_initialize_L000004_8 ' LTI4
 ...
 jmp #LODL
 long @C_sa701_69c22b05_lock_L000003
 ...
 cmps r22,  #0 wz
 jmp #BRNZ
 long @C_sa702_69c22b05_initialize_L000004_10 ' NEI4
 mov BC, #0 ' arg size, rpsize = 0, spsize = 0
 jmp #CALA
 ...
 cmps r22,  #0 wz,wc
 jmp #BR_B
 long @C_sa702_69c22b05_initialize_L000004_11 ' LTI4
 mov r22, FP
 sub r22, #-(-12) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRU4 reg
 jmp #LODI
 ...
 jmp #JMPA
 long @C_sa702_69c22b05_initialize_L000004_11 ' JUMPV addrg
C_sa702_69c22b05_initialize_L000004_10
 jmp #LODL
 long @C_sa701_69c22b05_lock_L000003
 ...
 long @C_sa701_69c22b05_lock_L000003
 wrlong r22, RI ' ASGNI4 addrg reg
C_sa702_69c22b05_initialize_L000004_11
C_sa702_69c22b05_initialize_L000004_8
C_sa702_69c22b05_initialize_L000004_6
' C_sa702_69c22b05_initialize_L000004_5 ' (symbol refcount = 0)
...
C_s_rxflush ' <symbol:s_rxflush>
 ...
 mov BC, #0 ' arg size, rpsize = 0, spsize = 0
 jmp #CALA
 long @C_sa702_69c22b05_initialize_L000004 ' CALL addrg
C_s_rxflush_15
 cmp r23,  #3 wz,wc 
 jmp #BRBE
