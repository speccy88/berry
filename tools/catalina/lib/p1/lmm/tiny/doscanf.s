...
'
 ...
 alignl ' align long
C_s8j0_69c22afb_isspace_L000001 ' <symbol:isspace>
 jmp #PSHM
 long $800000 ' save registers
 cmps r2,  #0 wz
 jmp #BR_Z
 long @C_s8j0_69c22afb_isspace_L000001_11 ' EQI4
 cmps r2,  #32 wz
 jmp #BR_Z
 long @C_s8j0_69c22afb_isspace_L000001_11 ' EQI4
 cmps r2,  #12 wz
 ...
 cmps r2,  #10 wz
 jmp #BRNZ
 long @C_s8j0_69c22afb_isspace_L000001_4 ' NEI4
C_s8j0_69c22afb_isspace_L000001_11
 mov r23, #1 ' reg <- coni
 jmp #JMPA
 long @C_s8j0_69c22afb_isspace_L000001_5 ' JUMPV addrg
C_s8j0_69c22afb_isspace_L000001_4
 mov r23, #0 ' reg <- coni
C_s8j0_69c22afb_isspace_L000001_5
 mov r0, r23 ' CVI, CVU or LOAD
' C_s8j0_69c22afb_isspace_L000001_2 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 jmp #RETN


 alignl ' align long
C_s8j01_69c22afb_trim_L000012 ' <symbol:trim>
 jmp #NEWF
 jmp #PSHM
 long $c00000 ' save registers
 mov r23, r2 ' reg var <- reg arg
 jmp #JMPA
 long @C_s8j01_69c22afb_trim_L000012_15 ' JUMPV addrg
C_s8j01_69c22afb_trim_L000012_14
 adds r23, #1 ' ADDP4 coni
C_s8j01_69c22afb_trim_L000012_15
 rdbyte r22, r23 ' reg <- INDIRU1 reg
 mov r2, r22 ' CVUI
 and r2, cviu_m1 ' zero extend
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 jmp #CALA
 long @C_s8j0_69c22afb_isspace_L000001 ' CALL addrg
 cmps r0,  #0 wz
 jmp #BRNZ
 long @C_s8j01_69c22afb_trim_L000012_14 ' NEI4
 mov r0, r23 ' CVI, CVU or LOAD
' C_s8j01_69c22afb_trim_L000012_13 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 jmp #RETF


 alignl ' align long
C_s8j02_69c22afb__scanf_gets_L000017 ' <symbol:_scanf_gets>
 jmp #NEWF
 jmp #PSHM
 ...
 jmp #JMPA
 long @C_s8j02_69c22afb__scanf_gets_L000017_20 ' JUMPV addrg
C_s8j02_69c22afb__scanf_gets_L000017_19
...
C_s8j02_69c22afb__scanf_gets_L000017_20
 mov r22, r19 ' CVI, CVU or LOAD
 mov r19, r22
 sub r19, #1 ' SUBU4 coni
 cmp r22,  #0 wz
 jmp #BR_Z
 long @C_s8j02_69c22afb__scanf_gets_L000017_22 ' EQU4
 cmps r17,  #0 wz
 jmp #BRNZ
 long @C_s8j02_69c22afb__scanf_gets_L000017_19 ' NEI4
 rdbyte r22, r23 ' reg <- INDIRU1 reg
 mov r2, r22 ' CVUI
 and r2, cviu_m1 ' zero extend
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 ...
 cmps r0,  #0 wz
 jmp #BR_Z
 long @C_s8j02_69c22afb__scanf_gets_L000017_19 ' EQI4
C_s8j02_69c22afb__scanf_gets_L000017_22
 cmps r17,  #0 wz
 jmp #BRNZ
 long @C_s8j02_69c22afb__scanf_gets_L000017_23 ' NEI4
 mov r22, #0 ' reg <- coni
 wrbyte r22, r21 ' ASGNU1 reg reg
C_s8j02_69c22afb__scanf_gets_L000017_23
 mov r0, r23 ' CVI, CVU or LOAD
' C_s8j02_69c22afb__scanf_gets_L000017_18 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 jmp #RETF
...
C__doscanf_26
 ...
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 jmp #CALA
 long @C_s8j01_69c22afb_trim_L000012 ' CALL addrg
...
C__doscanf_49
 ...
 jmp #CALA
 long @C_s8j02_69c22afb__scanf_gets_L000017
