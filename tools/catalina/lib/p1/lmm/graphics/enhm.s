...
C_gm_bound_limits ' <symbol:gm_bound_limits>
 ...
 jmp #LODL
 long @C_sf0g_69c22b01_m_min_L000001
 wrlong r22, RI ' ASGNI4 addrg reg
 jmp #LODL
 long @C_sf0g1_69c22b01_m_max_L000002
 wrlong r4, RI ' ASGNI4 addrg reg
 mov r22, FP
 add r22, #12 ' reg <- addrfi
 rdlong r22, r22 ' reg <- INDIRI4 reg
 jmp #LODL
 long @C_sf0g_69c22b01_m_min_L000001+4
 wrlong r22, RI ' ASGNI4 addrg reg
 jmp #LODL
 long @C_sf0g1_69c22b01_m_max_L000002+4
 wrlong r3, RI ' ASGNI4 addrg reg
 jmp #LODL
 long @C_sf0g_69c22b01_m_min_L000001+8
 wrlong r5, RI ' ASGNI4 addrg reg
 jmp #LODL
 long @C_sf0g1_69c22b01_m_max_L000002+8
...
C_gm_bound_scales ' <symbol:gm_bound_scales>
 jmp #LODL
 long @C_sf0g2_69c22b01_m_div_L000003
 wrlong r4, RI ' ASGNI4 addrg reg
 jmp #LODL
 long @C_sf0g2_69c22b01_m_div_L000003+4
 wrlong r3, RI ' ASGNI4 addrg reg
 jmp #LODL
 long @C_sf0g2_69c22b01_m_div_L000003+8
 wrlong r2, RI ' ASGNI4 addrg reg
...
C_gm_bound_preset_19
 ...
 shl r22, #2 ' LSHI4 coni
 jmp #LODL
 long @C_sf0g3_69c22b01_m_acc_L000004
 mov r20, RI ' reg <- addrg
...
DAT ' uninitialized data segment
 ...
 alignl ' align long
C_sf0g3_69c22b01_m_acc_L000004 ' <symbol:m_acc>
 byte 0[12]

 alignl ' align long
C_sf0g2_69c22b01_m_div_L000003 ' <symbol:m_div>
 byte 0[12]

 alignl ' align long
C_sf0g1_69c22b01_m_max_L000002 ' <symbol:m_max>
 byte 0[12]

 alignl ' align long
C_sf0g_69c22b01_m_min_L000001 ' <symbol:m_min>
 byte 0[12]
