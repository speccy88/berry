...
C_cond_no_active_lp ' <symbol:cond_no_active_lp>
 ...
 alignl ' align long
C_sd58_69c22aff_workerls_L000005 ' <symbol:workerls>
 long $0
...
C_workermain ' <symbol:workermain>
 ...
 mov r2, RI ' reg ARG ADDRG
 jmp #LODI
 long @C_sd58_69c22aff_workerls_L000005
...
C_workermain_17
 ...
 mov BC, #0 ' arg size, rpsize = 0, spsize = 0
 jmp #CALA
 long @C_sd581_69c22aff_sched_dec_lpcount_L000006 ' CALL addrg
 jmp #JMPA
...
' C_workermain_7 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_sd581_69c22aff_sched_dec_lpcount_L000006 ' <symbol:sched_dec_lpcount>
 jmp #NEWF
 jmp #PSHM
 ...
 cmps r22,  #0 wz
 jmp #BRNZ
 long @C_sd581_69c22aff_sched_dec_lpcount_L000006_30 ' NEI4
 jmp #LODL
 ...
 jmp #CALA
 long @C_pthread_cond_signal ' CALL addrg
C_sd581_69c22aff_sched_dec_lpcount_L000006_30
 jmp #LODL
 long @C_mutex_lp_count
 mov r2, RI ' reg ARG ADDRG
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 jmp #CALA
 long @C_pthread_mutex_unlock ' CALL addrg
' C_sd581_69c22aff_sched_dec_lpcount_L000006_29 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 jmp #RETF
