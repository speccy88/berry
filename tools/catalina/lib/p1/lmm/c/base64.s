...
DAT ' const data segment
 ...
 alignl ' align long
C_snd0_69c22b0c_cb64_L000003 ' <symbol:cb64>
 byte 65
 byte 66
 byte 67
 byte 68
 ...
 alignl ' align long
C_snd01_69c22b0c_cd64_L000004 ' <symbol:cd64>
 byte 124
 byte 36
 byte 36
 byte 36
...
DAT ' code segment
 ...
 alignl ' align long
C_snd02_69c22b0c_encodeblock_L000005 ' <symbol:encodeblock>
 jmp #PSHM
 ...
 jmp #LODL
 long @C_snd0_69c22b0c_cb64_L000003
 ...
 cmps r2,  #1 wz,wc
 jmp #BRBE
 long @C_snd02_69c22b0c_encodeblock_L000005_8 ' LEI4
 mov r22, r4
 ...
 jmp #JMPA
 long @C_snd02_69c22b0c_encodeblock_L000005_9 ' JUMPV addrg
C_snd02_69c22b0c_encodeblock_L000005_8
 mov r23, #61 ' reg <- coni
C_snd02_69c22b0c_encodeblock_L000005_9
 mov r22, r3
 ...
 cmps r2,  #2 wz,wc
 jmp #BRBE
 long @C_snd02_69c22b0c_encodeblock_L000005_11 ' LEI4
 mov r22, r4
 adds r22, #2 ' ADDP4 coni
 rdbyte r22, r22 ' reg <- INDIRU1 reg
 and r22, cviu_m1 ' zero extend
 ...
 jmp #JMPA
 long @C_snd02_69c22b0c_encodeblock_L000005_12 ' JUMPV addrg
C_snd02_69c22b0c_encodeblock_L000005_11
 mov r21, #61 ' reg <- coni
C_snd02_69c22b0c_encodeblock_L000005_12
 mov r22, r3
 adds r22, #3 ' ADDP4 coni
 mov r20, r21 ' CVI, CVU or LOAD
 wrbyte r20, r22 ' ASGNU1 reg reg
' C_snd02_69c22b0c_encodeblock_L000005_6 ' (symbol refcount = 0)
...
' C_encode_buff_22 ' (symbol refcount = 0)
 ...
 jmp #CALA
 long @C_snd02_69c22b0c_encodeblock_L000005
 add SP, #8 ' CALL addrg
 mov r15, #0 ' reg <- coni
C_encode_buff_29
 cmps r11, r19 wz,wc
...
' C_encode_buff_13 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_snd03_69c22b0c_decodeblock_L000040 ' <symbol:decodeblock>
 jmp #PSHM
 ...
 or r20, r18 ' BORI/U (1)
 wrbyte r20, r22 ' ASGNU1 reg reg
' C_snd03_69c22b0c_decodeblock_L000040_41 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 jmp #RETN
...
C_decode_buff_57
 jmp #LODL
 long @C_snd01_69c22b0c_cd64_L000004-43
...
C_decode_buff_70
 ...
 jmp #CALA
 long @C_snd03_69c22b0c_decodeblock_L000040
 add SP, #4 ' CALL addrg
 mov r11, #0 ' reg <- coni
 jmp #JMPA
