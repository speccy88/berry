...
DAT ' const data segment
 ...
 alignl_label
C_sfqk_69c22cba_cb64_L000003 ' <symbol:cb64>
 byte 65
 byte 66
 byte 67
 byte 68
 ...
 alignl_label
C_sfqk1_69c22cba_cd64_L000004 ' <symbol:cd64>
 byte 124
 byte 36
 byte 36
 byte 36
...
DAT ' code segment
 ...
 alignl_label
C_sfqk2_69c22cba_encodeblock_L000005 ' <symbol:encodeblock>
 alignl_p1
 ...
 alignl_p1
 long @C_sfqk_69c22cba_cb64_L000003 ' reg <- addrg
 ...
 alignl_p1
 long I32_BRBE + (@C_sfqk2_69c22cba_encodeblock_L000005_8)<<S32 ' LEI4 reg coni
 ...
 alignl_p1
 long I32_JMPA + (@C_sfqk2_69c22cba_encodeblock_L000005_9)<<S32 ' JUMPV addrg
 alignl_label
C_sfqk2_69c22cba_encodeblock_L000005_8
 alignl_p1
 long I32_LODS + (r23)<<D32S + ((61)&$7FFFF)<<S32 ' reg <- cons
 alignl_label
C_sfqk2_69c22cba_encodeblock_L000005_9
 word I16A_MOV + (r22)<<D16A + (r3)<<S16A
 ...
 alignl_p1
 long I32_BRBE + (@C_sfqk2_69c22cba_encodeblock_L000005_11)<<S32 ' LEI4 reg coni
 word I16A_MOV + (r22)<<D16A + (r4)<<S16A
 word I16A_ADDSI + (r22)<<D16A + (2)<<S16A ' ADDP4 reg coni
 word I16A_RDBYTE + (r22)<<D16A + (r22)<<S16A ' reg <- INDIRU1 reg
 word I16B_TRN1 + (r22)<<D16B ' zero extend
 ...
 alignl_p1
 long I32_JMPA + (@C_sfqk2_69c22cba_encodeblock_L000005_12)<<S32 ' JUMPV addrg
 alignl_label
C_sfqk2_69c22cba_encodeblock_L000005_11
 alignl_p1
 long I32_LODS + (r21)<<D32S + ((61)&$7FFFF)<<S32 ' reg <- cons
 alignl_label
C_sfqk2_69c22cba_encodeblock_L000005_12
 word I16A_MOV + (r22)<<D16A + (r3)<<S16A
 word I16A_ADDSI + (r22)<<D16A + (3)<<S16A ' ADDP4 reg coni
 word I16A_MOV + (r20)<<D16A + (r21)<<S16A ' CVI, CVU or LOAD
 word I16A_WRBYTE + (r20)<<D16A + (r22)<<S16A ' ASGNU1 reg reg
' C_sfqk2_69c22cba_encodeblock_L000005_6 ' (symbol refcount = 0)
...
' C_encode_buff_22 ' (symbol refcount = 0)
 ...
 alignl_p1
 long I32_CALA + (@C_sfqk2_69c22cba_encodeblock_L000005)<<S32
...
' C_encode_buff_13 ' (symbol refcount = 0)
 ...
 alignl_label
C_sfqk3_69c22cba_decodeblock_L000040 ' <symbol:decodeblock>
 alignl_p1
 ...
 word I16A_OR + (r20)<<D16A + (r18)<<S16A ' BORI/U (1)
 word I16A_WRBYTE + (r20)<<D16A + (r22)<<S16A ' ASGNU1 reg reg
' C_sfqk3_69c22cba_decodeblock_L000040_41 ' (symbol refcount = 0)
 word I16B_POPM + $80<<S16B ' restore registers, do not pop frame, do return
 alignl_p1
...
C_decode_buff_57
 ...
 alignl_p1
 long @C_sfqk1_69c22cba_cd64_L000004-43 ' reg <- addrg
 word I16A_ADDS + (r22)<<D16A + (r15)<<S16A ' ADDI/P (2)
 word I16A_RDBYTE + (r22)<<D16A + (r22)<<S16A ' reg <- INDIRU1 reg
...
C_decode_buff_70
 ...
 alignl_p1
 long I32_CALA + (@C_sfqk3_69c22cba_decodeblock_L000040)<<S32
