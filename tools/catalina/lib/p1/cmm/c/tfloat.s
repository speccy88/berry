...
'
 ...
 alignl_label
C_squ4_69c22ca0_itoa_L000001 ' <symbol:itoa>
 alignl_p1
 long I32_NEWF + 4<<S32
 alignl_p1
 ...
 alignl_p1
 long I32_BRAE + (@C_squ4_69c22ca0_itoa_L000001_3)<<S32 ' GEI4 reg coni
 ...
 alignl_p1
 long I32_JMPA + (@C_squ4_69c22ca0_itoa_L000001_4)<<S32 ' JUMPV addrg
 alignl_label
C_squ4_69c22ca0_itoa_L000001_3
 word I16A_MOV + (r23)<<D16A + (r3)<<S16A ' CVI, CVU or LOAD
 alignl_label
C_squ4_69c22ca0_itoa_L000001_4
 word I16A_MOVI + (r22)<<D16A + (0)<<S16A ' reg <- coni
 word I16A_WRBYTE + (r22)<<D16A + (r21)<<S16A ' ASGNU1 reg reg
 alignl_label
C_squ4_69c22ca0_itoa_L000001_5
...
' C_squ4_69c22ca0_itoa_L000001_6 ' (symbol refcount = 0)
 word I16A_CMPI + (r23)<<D16A + (0)<<S16A
 alignl_p1
 long I32_BRNZ + (@C_squ4_69c22ca0_itoa_L000001_5)<<S32 ' NEU4 reg coni
 word I16B_LODF + ((-8)&$1FF)<<S16B
 word I16A_RDLONG + (r22)<<D16A + RI<<S16A ' reg <- INDIRI4 addrl16
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl_p1
 long I32_BR_Z + (@C_squ4_69c22ca0_itoa_L000001_8)<<S32 ' EQI4 reg coni
 word I16A_NEGI + (r22)<<D16A + (-(-1)&$1F)<<S16A ' reg <- conn
 word I16A_ADDS + (r22)<<D16A + (r21)<<S16A ' ADDI/P (2)
 word I16A_MOV + (r21)<<D16A + (r22)<<S16A ' CVI, CVU or LOAD
 alignl_p1
 ...
 word I16A_WRBYTE + (r20)<<D16A + (r22)<<S16A ' ASGNU1 reg reg
 alignl_label
C_squ4_69c22ca0_itoa_L000001_8
 word I16A_MOV + (r0)<<D16A + (r21)<<S16A ' CVI, CVU or LOAD
' C_squ4_69c22ca0_itoa_L000001_2 ' (symbol refcount = 0)
 word I16B_POPM + 1<<S16B ' restore registers, do pop frame, do return
 alignl_p1

 alignl_label
C_squ41_69c22ca0_N_anO_rI_nf_L000010 ' <symbol:NanOrInf>
 alignl_p1
 long I32_NEWF + 4<<S32
 alignl_p1
 long I32_PSHM + $f00000<<S32 ' save registers
 ...
 alignl_p1
 long I32_BRNZ + (@C_squ41_69c22ca0_N_anO_rI_nf_L000010_12)<<S32 ' NEU4 reg reg
 word I16B_LODF + ((-8)&$1FF)<<S16B
 ...
 alignl_p1
 long I32_BRNZ + (@C_squ41_69c22ca0_N_anO_rI_nf_L000010_14)<<S32 ' NEU4 reg coni
 word I16B_LODF + ((-8)&$1FF)<<S16B
 word I16A_RDLONG + (r22)<<D16A + RI<<S16A ' reg <- INDIRU4 addrl16
 word I16B_LODL + (r20)<<D16B
 alignl_p1
 ...
 word I16A_CMPI + (r22)<<D16A + (0)<<S16A
 alignl_p1
 long I32_BR_Z + (@C_squ41_69c22ca0_N_anO_rI_nf_L000010_16)<<S32 ' EQU4 reg coni
 ...
 word I16A_WRBYTE + (r20)<<D16A + (r22)<<S16A ' ASGNU1 reg reg
 alignl_label
C_squ41_69c22ca0_N_anO_rI_nf_L000010_16
 word I16B_LODL + (r2)<<D16B
 alignl_p1
 long @C_squ41_69c22ca0_N_anO_rI_nf_L000010_18_L000019 ' reg ARG ADDRG
 ...
 alignl_p1
 long I32_JMPA + (@C_squ41_69c22ca0_N_anO_rI_nf_L000010_11)<<S32 ' JUMPV addrg
 alignl_label
C_squ41_69c22ca0_N_anO_rI_nf_L000010_14
 word I16B_LODF + ((-8)&$1FF)<<S16B
 word I16A_RDLONG + (r22)<<D16A + RI<<S16A ' reg <- INDIRU4 addrl16
 word I16B_LODL + (r20)<<D16B
 alignl_p1
 ...
 word I16A_CMPI + (r22)<<D16A + (0)<<S16A
 alignl_p1
 long I32_BR_Z + (@C_squ41_69c22ca0_N_anO_rI_nf_L000010_20)<<S32 ' EQU4 reg coni
 word I16A_MOV + (r22)<<D16A + (r21)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r21)<<D16A + (r22)<<S16A
 word I16A_ADDSI + (r21)<<D16A + (1)<<S16A ' ADDP4 reg coni
 alignl_p1
 ...
 word I16A_WRBYTE + (r20)<<D16A + (r22)<<S16A ' ASGNU1 reg reg
 alignl_label
C_squ41_69c22ca0_N_anO_rI_nf_L000010_20
 word I16B_LODL + (r2)<<D16B
 alignl_p1
 long @C_squ41_69c22ca0_N_anO_rI_nf_L000010_22_L000023 ' reg ARG ADDRG
 word I16A_MOV + (r3)<<D16A + (r21)<<S16A ' CVI, CVU or LOAD
 word I16B_CPREP + 33<<S16B ' arg size, rpsize = 8, spsize = 8
 alignl_p1
 long I32_CALA + (@C_strcpy)<<S32
 ...
 long I32_JMPA + (@C_squ41_69c22ca0_N_anO_rI_nf_L000010_11)<<S32 ' JUMPV addrg
 alignl_label
C_squ41_69c22ca0_N_anO_rI_nf_L000010_12
 word I16B_LODL + R0<<D16B
 alignl_p1
 long 0 ' RET con
 alignl_label
C_squ41_69c22ca0_N_anO_rI_nf_L000010_11
 word I16B_POPM + 1<<S16B ' restore registers, do pop frame, do return
 alignl_p1
...
C_t_float_25
 ...
 word I16B_CPREP + 33<<S16B ' arg size, rpsize = 8, spsize = 8
 alignl_p1
 long I32_CALA + (@C_squ41_69c22ca0_N_anO_rI_nf_L000010)<<S32
 word I16A_ADDI + SP<<D16A + 4<<S16A ' CALL addrg
...
C_t_float_39
 ...
 word I16B_CPREP + 33<<S16B ' arg size, rpsize = 8, spsize = 8
 alignl_p1
 long I32_CALA + (@C_squ4_69c22ca0_itoa_L000001)<<S32
 word I16A_ADDI + SP<<D16A + 4<<S16A ' CALL addrg
 word I16A_MOV + (r22)<<D16A + (r0)<<S16A ' CVI, CVU or LOAD
...
C_t_float_31_L000032 ' <symbol:31>
 ...
 alignl_label
C_squ41_69c22ca0_N_anO_rI_nf_L000010_22_L000023 ' <symbol:22>
 byte 110
 byte 97
 byte 110
 byte 0
 ...
 alignl_label
C_squ41_69c22ca0_N_anO_rI_nf_L000010_18_L000019 ' <symbol:18>
 byte 105
 byte 110
 byte 102
 byte 0
