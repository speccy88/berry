...
C_gm_bound_limits ' <symbol:gm_bound_limits>
 ...
 alignl_p1
 long I32_LODA + (@C_smu8_69c22c96_m_min_L000001)<<S32
 word I16A_WRLONG + (r22)<<D16A + RI<<S16A ' ASGNI4 addrg reg
 alignl_p1
 long I32_LODA + (@C_smu81_69c22c96_m_max_L000002)<<S32
 word I16A_WRLONG + (r4)<<D16A + RI<<S16A ' ASGNI4 addrg reg
 word I16B_LODF + ((12)&$1FF)<<S16B
 word I16A_RDLONG + (r22)<<D16A + RI<<S16A ' reg <- INDIRI4 addrl16
 alignl_p1
 long I32_LODA + (@C_smu8_69c22c96_m_min_L000001+4)<<S32
 word I16A_WRLONG + (r22)<<D16A + RI<<S16A ' ASGNI4 addrg reg
 alignl_p1
 long I32_LODA + (@C_smu81_69c22c96_m_max_L000002+4)<<S32
 word I16A_WRLONG + (r3)<<D16A + RI<<S16A ' ASGNI4 addrg reg
 alignl_p1
 long I32_LODA + (@C_smu8_69c22c96_m_min_L000001+8)<<S32
 word I16A_WRLONG + (r5)<<D16A + RI<<S16A ' ASGNI4 addrg reg
 alignl_p1
 long I32_LODA + (@C_smu81_69c22c96_m_max_L000002+8)<<S32
...
C_gm_bound_scales ' <symbol:gm_bound_scales>
 alignl_p1
 long I32_LODA + (@C_smu82_69c22c96_m_div_L000003)<<S32
 word I16A_WRLONG + (r4)<<D16A + RI<<S16A ' ASGNI4 addrg reg
 alignl_p1
 long I32_LODA + (@C_smu82_69c22c96_m_div_L000003+4)<<S32
 word I16A_WRLONG + (r3)<<D16A + RI<<S16A ' ASGNI4 addrg reg
 alignl_p1
 long I32_LODA + (@C_smu82_69c22c96_m_div_L000003+8)<<S32
 word I16A_WRLONG + (r2)<<D16A + RI<<S16A ' ASGNI4 addrg reg
...
C_gm_bound_preset_19
 ...
 alignl_p1
 long @C_smu82_69c22c96_m_div_L000003 ' reg <- addrg
 ...
 word I16B_LODL + (r20)<<D16B
 alignl_p1
 long @C_smu83_69c22c96_m_acc_L000004 ' reg <- addrg
 ...
 alignl_p1
 long @C_smu8_69c22c96_m_min_L000001 ' reg <- addrg
...
C_gm_limit_24
 ...
 alignl_p1
 long @C_smu81_69c22c96_m_max_L000002 ' reg <- addrg
 word I16A_ADDS + (r18)<<D16A + (r22)<<S16A ' ADDI/P (2)
 word I16A_RDLONG + (r18)<<D16A + (r18)<<S16A ' reg <- INDIRI4 reg
 word I16B_LODL + (r16)<<D16B
 alignl_p1
...
DAT ' uninitialized data segment
 ...
 alignl_label
C_smu83_69c22c96_m_acc_L000004 ' <symbol:m_acc>
 byte 0[12]

 alignl_label
C_smu82_69c22c96_m_div_L000003 ' <symbol:m_div>
 byte 0[12]

 alignl_label
C_smu81_69c22c96_m_max_L000002 ' <symbol:m_max>
 byte 0[12]

 alignl_label
C_smu8_69c22c96_m_min_L000001 ' <symbol:m_min>
 byte 0[12]
