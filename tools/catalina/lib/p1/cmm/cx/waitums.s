...
'
 ...
 alignl_label
C_si587_69c22cc6_recalculate_L000008 ' <symbol:recalculate>
 alignl_p1
 long I32_NEWF + 0<<S32
 alignl_p1
 ...
 alignl_p1
 long I32_LODA + (@C_si58_69c22cc6_old_freq_L000001)<<S32
 ...
 word I16B_DIVU ' DIVU
 alignl_p1
 long I32_LODA + (@C_si581_69c22cc6_cnt_usec_L000002)<<S32
 ...
 word I16B_DIVU ' DIVU
 alignl_p1
 long I32_LODA + (@C_si582_69c22cc6_cnt_msec_L000003)<<S32
 word I16A_WRLONG + (r0)<<D16A + RI<<S16A ' ASGNU4 addrg reg
 ...
 alignl_p1
 long I32_LODA + (@C_si583_69c22cc6_min_tick_L000004)<<S32
 word I16A_WRLONG + (r0)<<D16A + RI<<S16A ' ASGNU4 addrg reg
 alignl_p1
 ...
 word I16B_DIVU ' DIVU
 alignl_p1
 long I32_LODA + (@C_si584_69c22cc6_min_usec_L000005)<<S32
 word I16A_WRLONG + (r0)<<D16A + RI<<S16A ' ASGNU4 addrg reg
 alignl_p1
 long I32_LODI + (@C_si582_69c22cc6_cnt_msec_L000003)<<S32
 word I16A_MOV + (r20)<<D16A + RI<<S16A ' reg <- INDIRU4 addrg
 ...
 word I16B_DIVU ' DIVU
 alignl_p1
 long I32_LODA + (@C_si585_69c22cc6_min_msec_L000006)<<S32
 word I16A_WRLONG + (r0)<<D16A + RI<<S16A ' ASGNU4 addrg reg
' C_si587_69c22cc6_recalculate_L000008_9 ' (symbol refcount = 0)
...
C_min_waitus ' <symbol:min_waitus>
 ...
 alignl_p1
 long I32_LODI + (@C_si58_69c22cc6_old_freq_L000001)<<S32
 ...
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
 alignl_p1
 long I32_CALA + (@C_si587_69c22cc6_recalculate_L000008)<<S32 ' CALL addrg
 alignl_label
C_min_waitus_11
 alignl_p1
 long I32_LODI + (@C_si584_69c22cc6_min_usec_L000005)<<S32
...
C_min_waitms_14
 alignl_p1
 long I32_LODI + (@C_si585_69c22cc6_min_msec_L000006)<<S32
 word I16A_MOV + (r0)<<D16A + RI<<S16A ' reg <- INDIRU4 addrg
...
C__waitus_23
 ...
 alignl_p1
 long I32_LODI + (@C_si586_69c22cc6_overhead_L000007)<<S32
 word I16A_MOV + (r20)<<D16A + RI<<S16A ' reg <- INDIRU4 addrg
...
DAT ' uninitialized data segment
 ...
 alignl_label
C_si586_69c22cc6_overhead_L000007 ' <symbol:overhead>
 byte 0[4]

 alignl_label
C_si585_69c22cc6_min_msec_L000006 ' <symbol:min_msec>
 byte 0[4]

 alignl_label
C_si584_69c22cc6_min_usec_L000005 ' <symbol:min_usec>
 byte 0[4]

 alignl_label
C_si583_69c22cc6_min_tick_L000004 ' <symbol:min_tick>
 byte 0[4]

 alignl_label
C_si582_69c22cc6_cnt_msec_L000003 ' <symbol:cnt_msec>
 byte 0[4]

 alignl_label
C_si581_69c22cc6_cnt_usec_L000002 ' <symbol:cnt_usec>
 byte 0[4]

 alignl_label
C_si58_69c22cc6_old_freq_L000001 ' <symbol:old_freq>
 byte 0[4]
