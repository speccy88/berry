...
'
 ...
 alignl ' align long
C_s8og_664d6f1a_luai_makeseed_L000013 ' <symbol:luai_makeseed>
 alignl ' align long
...
' C_s8og_664d6f1a_luai_makeseed_L000013_14 ' (symbol refcount = 0)
...
' C_luaE__incC_stack_39 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_s8og2_664d6f1a_stack_init_L000042 ' <symbol:stack_init>
 alignl ' align long
 long I32_NEWF + 0<<S32
 alignl ' align long
 ...
 alignl ' align long
C_s8og2_664d6f1a_stack_init_L000042_44
 word I16A_MOV + (r22)<<D16A + (r19)<<S16A
...
' C_s8og2_664d6f1a_stack_init_L000042_45 ' (symbol refcount = 0)
 word I16A_ADDSI + (r19)<<D16A + (1)<<S16A ' ADDI4 reg coni
 alignl ' align long
 long I32_MOVI + RI<<D32 + (45)<<S32
 word I16A_CMPS + (r19)<<D16A + RI<<S16A
 alignl ' align long
 long I32_BR_B + (@C_s8og2_664d6f1a_stack_init_L000042_44)<<S32 ' LTI4 reg coni
 word I16A_MOV + (r22)<<D16A + (r23)<<S16A
 word I16A_ADDSI + (r22)<<D16A + (12)<<S16A ' ADDP4 reg coni
 word I16A_MOV + (r20)<<D16A + (r23)<<S16A
 word I16A_ADDSI + (r20)<<D16A + (28)<<S16A ' ADDP4 reg coni
 ...
 word I16A_ADDSI + (r22)<<D16A + (20)<<S16A ' ADDP4 reg coni
 word I16A_WRLONG + (r17)<<D16A + (r22)<<S16A ' ASGNP4 reg reg
' C_s8og2_664d6f1a_stack_init_L000042_43 ' (symbol refcount = 0)
 word I16B_POPM + 0<<S16B ' restore registers, do pop frame, do return
 alignl ' align long

 alignl ' align long
C_s8og3_664d6f1a_freestack_L000048 ' <symbol:freestack>
 alignl ' align long
 long I32_NEWF + 0<<S32
 alignl ' align long
 ...
 word I16A_CMPI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_s8og3_664d6f1a_freestack_L000048_50)<<S32 ' NEU4 reg coni
 alignl ' align long
 long I32_JMPA + (@C_s8og3_664d6f1a_freestack_L000048_49)<<S32 ' JUMPV addrg
 alignl ' align long
C_s8og3_664d6f1a_freestack_L000048_50
 word I16A_MOV + (r22)<<D16A + (r23)<<S16A
 word I16A_ADDSI + (r22)<<D16A + (20)<<S16A ' ADDP4 reg coni
 alignl ' align long
 ...
 word I16A_ADDI + SP<<D16A + 8<<S16A ' CALL addrg
 alignl ' align long
C_s8og3_664d6f1a_freestack_L000048_49
 word I16B_POPM + 0<<S16B ' restore registers, do pop frame, do return
 alignl ' align long

 alignl ' align long
C_s8og4_664d6f1a_init_registry_L000052 ' <symbol:init_registry>
 alignl ' align long
 long I32_NEWF + 4<<S32
 alignl ' align long
 long I32_PSHM + $fa0000<<S32 ' save registers
 ...
 long I32_MOVI + (r20)<<D32 +(69)<<S32 ' reg <- conli
 word I16A_WRBYTE + (r20)<<D16A + (r22)<<S16A ' ASGNU1 reg reg
' C_s8og4_664d6f1a_init_registry_L000052_53 ' (symbol refcount = 0)
 word I16B_POPM + 1<<S16B ' restore registers, do pop frame, do return
 alignl ' align long

 alignl ' align long
C_s8og5_664d6f1a_f_luaopen_L000054 ' <symbol:f_luaopen>
 alignl ' align long
 long I32_NEWF + 0<<S32
 alignl ' align long
 long I32_PSHM + $f80000<<S32 ' save registers
 ...
 word I16B_CPREP + 33<<S16B ' arg size, rpsize = 8, spsize = 8
 alignl ' align long
 long I32_CALA + (@C_s8og2_664d6f1a_stack_init_L000042)<<S32
 word I16A_ADDI + SP<<D16A + 4<<S16A ' CALL addrg
 word I16A_MOV + (r2)<<D16A + (r19)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r3)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
 word I16B_CPREP + 33<<S16B ' arg size, rpsize = 8, spsize = 8
 alignl ' align long
 long I32_CALA + (@C_s8og4_664d6f1a_init_registry_L000052)<<S32
 word I16A_ADDI + SP<<D16A + 4<<S16A ' CALL addrg
 word I16A_MOV + (r2)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
 alignl ' align long
 ...
 word I16A_MOVI + (r20)<<D16A + (0)<<S16A ' reg <- coni
 word I16A_WRBYTE + (r20)<<D16A + (r22)<<S16A ' ASGNU1 reg reg
' C_s8og5_664d6f1a_f_luaopen_L000054_55 ' (symbol refcount = 0)
 word I16B_POPM + 0<<S16B ' restore registers, do pop frame, do return
 alignl ' align long

 alignl ' align long
C_s8og6_664d6f1a_preinit_thread_L000056 ' <symbol:preinit_thread>
 alignl ' align long
 ...
 word I16A_MOVI + (r20)<<D16A + (0)<<S16A ' reg <- coni
 word I16A_WRLONG + (r20)<<D16A + (r22)<<S16A ' ASGNI4 reg reg
' C_s8og6_664d6f1a_preinit_thread_L000056_57 ' (symbol refcount = 0)
 word I16B_POPM + $80<<S16B ' restore registers, do not pop frame, do return
 alignl ' align long

 alignl ' align long
C_s8og7_664d6f1a_close_state_L000058 ' <symbol:close_state>
 alignl ' align long
 long I32_NEWF + 0<<S32
 alignl ' align long
 long I32_PSHM + $f00000<<S32 ' save registers
 ...
 alignl ' align long
 long I32_BR_Z + (@C_s8og7_664d6f1a_close_state_L000058_60)<<S32 ' EQI4 reg coni
 word I16A_MOV + (r2)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
 alignl ' align long
 long I32_CALA + (@C_luaC__freeallobjects)<<S32 ' CALL addrg
 alignl ' align long
 long I32_JMPA + (@C_s8og7_664d6f1a_close_state_L000058_61)<<S32 ' JUMPV addrg
 alignl ' align long
C_s8og7_664d6f1a_close_state_L000058_60
 word I16A_MOV + (r22)<<D16A + (r23)<<S16A
 word I16A_ADDSI + (r22)<<D16A + (20)<<S16A ' ADDP4 reg coni
 alignl ' align long
 long I32_LODS + (r20)<<D32S + ((52)&$7FFFF)<<S32 ' reg <- cons
 ...
 long I32_CALA + (@C_luaC__freeallobjects)<<S32 ' CALL addrg
 alignl ' align long
C_s8og7_664d6f1a_close_state_L000058_61
 word I16A_MOV + (r22)<<D16A + (r23)<<S16A
 word I16A_ADDSI + (r22)<<D16A + (16)<<S16A ' ADDP4 reg coni
 word I16A_RDLONG + (r22)<<D16A + (r22)<<S16A ' reg <- INDIRP4 reg
 alignl ' align long
 ...
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
 alignl ' align long
 long I32_CALA + (@C_s8og3_664d6f1a_freestack_L000048)<<S32 ' CALL addrg
 word I16A_MOVI + (r2)<<D16A + (0)<<S16A ' reg ARG coni
 alignl ' align long
...
' C_s8og7_664d6f1a_close_state_L000058_59 ' (symbol refcount = 0)
 word I16B_POPM + 0<<S16B ' restore registers, do pop frame, do return
 alignl ' align long
...
C_lua_newthread_63
 ...
 word I16B_CPREP + 33<<S16B ' arg size, rpsize = 8, spsize = 8
 alignl ' align long
 long I32_CALA + (@C_s8og6_664d6f1a_preinit_thread_L000056)<<S32
 word I16A_ADDI + SP<<D16A + 4<<S16A ' CALL addrg
 alignl ' align long
 long I32_LODS + (r22)<<D32S + ((112)&$7FFFF)<<S32 ' reg <- cons
...
C_lua_newstate_73
 ...
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
 alignl ' align long
 long I32_CALA + (@C_s8og_664d6f1a_luai_makeseed_L000013)<<S32 ' CALL addrg
 alignl ' align long
 long I32_LODS + (r20)<<D32S + ((52)&$7FFFF)<<S32 ' reg <- cons
 word I16A_ADDS + (r20)<<D16A + (r19)<<S16A ' ADDI/P (2)
...
' C_lua_newstate_76 ' (symbol refcount = 0)
 ...
 alignl ' align long
 long @C_s8og5_664d6f1a_f_luaopen_L000054 ' reg ARG ADDRG
 ...
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
 alignl ' align long
 long I32_CALA + (@C_s8og7_664d6f1a_close_state_L000058)<<S32 ' CALL addrg
