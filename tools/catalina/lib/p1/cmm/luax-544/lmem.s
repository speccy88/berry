...
' C_luaM__free__27 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_seu42_664d6f1a_tryagain_L000028 ' <symbol:tryagain>
 alignl ' align long
 long I32_NEWF + 0<<S32
 alignl ' align long
 long I32_PSHM + $fa8000<<S32 ' save registers
 ...
 alignl ' align long
 long I32_BRNZ + (@C_seu42_664d6f1a_tryagain_L000028_30)<<S32 ' NEI4 reg coni
 alignl ' align long
 ...
 word I16A_MOV + (r22)<<D16A + (r0)<<S16A ' CVI, CVU or LOAD
 alignl ' align long
 long I32_JMPA + (@C_seu42_664d6f1a_tryagain_L000028_29)<<S32 ' JUMPV addrg
 alignl ' align long
C_seu42_664d6f1a_tryagain_L000028_30
 word I16B_LODL + R0<<D16B
 alignl ' align long
 long 0 ' RET con
 alignl ' align long
C_seu42_664d6f1a_tryagain_L000028_29
 word I16B_POPM + 0<<S16B ' restore registers, do pop frame, do return
 alignl ' align long
...
C_luaM__realloc_ ' <symbol:luaM_realloc_>
 ...
 word I16B_CPREP + 67<<S16B ' arg size, rpsize = 16, spsize = 16
 alignl ' align long
 long I32_CALA + (@C_seu42_664d6f1a_tryagain_L000028)<<S32
 word I16A_ADDI + SP<<D16A + 12<<S16A ' CALL addrg
 word I16A_MOV + (r13)<<D16A + (r0)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r22)<<D16A + (r13)<<S16A ' CVI, CVU or LOAD
 word I16A_CMPI + (r22)<<D16A + (0)<<S16A
