...
'
 ...
 alignl_label
C_sm0s_69c22c9a_wifi_P_oll_R_esponse_L000001 ' <symbol:wifi_Poll_Response>
 alignl_p1
 ...
 alignl_p1
 long I32_JMPA + (@C_sm0s_69c22c9a_wifi_P_oll_R_esponse_L000001_4)<<S32 ' JUMPV addrg
 alignl_label
C_sm0s_69c22c9a_wifi_P_oll_R_esponse_L000001_3
 alignl_p1
 ...
 alignl_p1
 long I32_BRAE + (@C_sm0s_69c22c9a_wifi_P_oll_R_esponse_L000001_6)<<S32 ' GEI4 reg coni
 word I16A_MOVI + R0<<D16A + (15)<<S16A ' RET coni
 alignl_p1
 long I32_JMPA + (@C_sm0s_69c22c9a_wifi_P_oll_R_esponse_L000001_2)<<S32 ' JUMPV addrg
 alignl_label
C_sm0s_69c22c9a_wifi_P_oll_R_esponse_L000001_6
 alignl_label
C_sm0s_69c22c9a_wifi_P_oll_R_esponse_L000001_4
 alignl_p1
 long I32_MOVI + RI<<D32 + (254)<<S32
 word I16A_CMPS + (r17)<<D16A + RI<<S16A
 alignl_p1
 long I32_BRNZ + (@C_sm0s_69c22c9a_wifi_P_oll_R_esponse_L000001_3)<<S32 ' NEI4 reg coni
 alignl_p1
 long I32_JMPA + (@C_sm0s_69c22c9a_wifi_P_oll_R_esponse_L000001_9)<<S32 ' JUMPV addrg
 alignl_label
C_sm0s_69c22c9a_wifi_P_oll_R_esponse_L000001_8
 alignl_p1
 long I32_LODS + (r2)<<D32S + ((1000)&$7FFFF)<<S32 ' reg ARG cons
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
 alignl_p1
 ...
 word I16A_CMPSI + (r17)<<D16A + (0)<<S16A
 alignl_p1
 long I32_BRAE + (@C_sm0s_69c22c9a_wifi_P_oll_R_esponse_L000001_11)<<S32 ' GEI4 reg coni
 word I16A_MOVI + R0<<D16A + (15)<<S16A ' RET coni
 alignl_p1
 long I32_JMPA + (@C_sm0s_69c22c9a_wifi_P_oll_R_esponse_L000001_2)<<S32 ' JUMPV addrg
 alignl_label
C_sm0s_69c22c9a_wifi_P_oll_R_esponse_L000001_11
 word I16A_CMPSI + (r17)<<D16A + (13)<<S16A
 alignl_p1
 long I32_BR_Z + (@C_sm0s_69c22c9a_wifi_P_oll_R_esponse_L000001_13)<<S32 ' EQI4 reg coni
 ...
 alignl_p1
 long I32_JMPA + (@C_sm0s_69c22c9a_wifi_P_oll_R_esponse_L000001_14)<<S32 ' JUMPV addrg
 alignl_label
C_sm0s_69c22c9a_wifi_P_oll_R_esponse_L000001_13
 alignl_p1
 long I32_LODF + ((-264)&$FFFFFF)<<S32
 ...
 alignl_p1
 long @C_sm0s_69c22c9a_wifi_P_oll_R_esponse_L000001_17_L000018 ' reg ARG ADDRG
 alignl_p1
 long I32_LODF + ((-264)&$FFFFFF)<<S32 
 ...
 alignl_p1
 long I32_BRNZ + (@C_sm0s_69c22c9a_wifi_P_oll_R_esponse_L000001_15)<<S32 ' NEI4 reg coni
 ...
 alignl_p1
 long I32_BRNZ + (@C_sm0s_69c22c9a_wifi_P_oll_R_esponse_L000001_19)<<S32 ' NEI4 reg coni
 word I16A_RDLONG + (r0)<<D16A + (r19)<<S16A ' reg <- INDIRI4 reg
 alignl_p1
 long I32_JMPA + (@C_sm0s_69c22c9a_wifi_P_oll_R_esponse_L000001_2)<<S32 ' JUMPV addrg
 alignl_label
C_sm0s_69c22c9a_wifi_P_oll_R_esponse_L000001_19
 word I16A_MOV + (r2)<<D16A + (r19)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r3)<<D16A + (r21)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r4)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
 word I16B_LODL + (r5)<<D16B
 alignl_p1
 long @C_sm0s_69c22c9a_wifi_P_oll_R_esponse_L000001_23_L000024 ' reg ARG ADDRG
 ...
 alignl_p1
 long I32_BRNZ + (@C_sm0s_69c22c9a_wifi_P_oll_R_esponse_L000001_21)<<S32 ' NEI4 reg coni
 word I16A_MOVI + R0<<D16A + (0)<<S16A ' RET coni
 alignl_p1
 long I32_JMPA + (@C_sm0s_69c22c9a_wifi_P_oll_R_esponse_L000001_2)<<S32 ' JUMPV addrg
 alignl_label
C_sm0s_69c22c9a_wifi_P_oll_R_esponse_L000001_21
 alignl_label
C_sm0s_69c22c9a_wifi_P_oll_R_esponse_L000001_15
 word I16A_MOVI + R0<<D16A + (16)<<S16A ' RET coni
 alignl_p1
 long I32_JMPA + (@C_sm0s_69c22c9a_wifi_P_oll_R_esponse_L000001_2)<<S32 ' JUMPV addrg
 alignl_label
C_sm0s_69c22c9a_wifi_P_oll_R_esponse_L000001_14
 alignl_label
C_sm0s_69c22c9a_wifi_P_oll_R_esponse_L000001_9
 alignl_p1
 long I32_MOVI + RI<<D32 + (256)<<S32
 word I16A_CMPS + (r15)<<D16A + RI<<S16A
 alignl_p1
 long I32_BR_B + (@C_sm0s_69c22c9a_wifi_P_oll_R_esponse_L000001_8)<<S32 ' LTI4 reg coni
 word I16A_MOVI + R0<<D16A + (16)<<S16A ' RET coni
 alignl_label
C_sm0s_69c22c9a_wifi_P_oll_R_esponse_L000001_2
...
C_wifi_P_O_L_L__29
 ...
 word I16B_CPREP + 50<<S16B ' arg size, rpsize = 12, spsize = 12
 alignl_p1
 long I32_CALA + (@C_sm0s_69c22c9a_wifi_P_oll_R_esponse_L000001)<<S32
 word I16A_ADDI + SP<<D16A + 8<<S16A ' CALL addrg
 word I16A_MOV + (r15)<<D16A + (r0)<<S16A ' CVI, CVU or LOAD
 word I16A_CMPSI + (r15)<<D16A + (0)<<S16A
 alignl_p1
...
C_wifi_P_O_L_L__30_L000031 ' <symbol:30>
 ...
 alignl_label
C_sm0s_69c22c9a_wifi_P_oll_R_esponse_L000001_23_L000024 ' <symbol:23>
 byte 61
 byte 37
 byte 99
 byte 44
 ...
 alignl_label
C_sm0s_69c22c9a_wifi_P_oll_R_esponse_L000001_17_L000018 ' <symbol:17>
 byte 61
 byte 37
 byte 99
 byte 44
