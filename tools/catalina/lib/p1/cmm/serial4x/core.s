...
DAT ' initialized data segment
 ...
 alignl_label
C_s848_69c22c9a_rxbase_L000002 ' <symbol:rxbase>
 long $0

 alignl_label
C_s8481_69c22c9a_lock_L000003 ' <symbol:lock>
 long -1
...
DAT ' code segment
 ...
 alignl_label
C_s8482_69c22c9a_initialize_L000004 ' <symbol:initialize>
 alignl_p1
 long I32_NEWF + 8<<S32
 alignl_p1
 long I32_PSHM + $540000<<S32 ' save registers
 alignl_p1
 long I32_LODI + (@C_s848_69c22c9a_rxbase_L000002)<<S32
 word I16A_MOV + (r22)<<D16A + RI<<S16A ' reg <- INDIRP4 addrg
 word I16A_CMPI + (r22)<<D16A + (0)<<S16A
 alignl_p1
 long I32_BRNZ + (@C_s8482_69c22c9a_initialize_L000004_6)<<S32 ' NEU4 reg coni
 ...
 alignl_p1
 long I32_BR_B + (@C_s8482_69c22c9a_initialize_L000004_8)<<S32 ' LTI4 reg coni
 alignl_p1
 ...
 alignl_p1
 long I32_LODA + (@C_s848_69c22c9a_rxbase_L000002)<<S32
 word I16A_WRLONG + (r20)<<D16A + RI<<S16A ' ASGNP4 addrg reg
 word I16B_LODL + (r20)<<D16B
 alignl_p1
 long @C_s8481_69c22c9a_lock_L000003 ' reg <- addrg
 word I16A_SHRI + (r22)<<D16A + (24)<<S16A ' SHRU4 reg coni
 alignl_p1
 long I32_LODA + (@C_s8481_69c22c9a_lock_L000003)<<S32
 word I16A_WRLONG + (r22)<<D16A + RI<<S16A ' ASGNI4 addrg reg
 word I16A_RDLONG + (r22)<<D16A + (r20)<<S16A ' reg <- INDIRI4 reg
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl_p1
 long I32_BRNZ + (@C_s8482_69c22c9a_initialize_L000004_10)<<S32 ' NEI4 reg coni
 alignl_p1
 ...
 alignl_p1
 long I32_LODI + (@C_s8481_69c22c9a_lock_L000003)<<S32
 word I16A_MOV + (r22)<<D16A + RI<<S16A ' reg <- INDIRI4 addrg
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl_p1
 long I32_BR_B + (@C_s8482_69c22c9a_initialize_L000004_11)<<S32 ' LTI4 reg coni
 word I16B_LODF + ((-12)&$1FF)<<S16B
 word I16A_RDLONG + (r22)<<D16A + RI<<S16A ' reg <- INDIRU4 addrl16
 alignl_p1
 long I32_LODI + (@C_s8481_69c22c9a_lock_L000003)<<S32
 ...
 alignl_p1
 long I32_JMPA + (@C_s8482_69c22c9a_initialize_L000004_11)<<S32 ' JUMPV addrg
 alignl_label
C_s8482_69c22c9a_initialize_L000004_10
 ...
 word I16A_WRLONG + (r22)<<D16A + RI<<S16A ' ASGNI4 addrg reg
 alignl_label
C_s8482_69c22c9a_initialize_L000004_11
 alignl_label
C_s8482_69c22c9a_initialize_L000004_8
 alignl_label
C_s8482_69c22c9a_initialize_L000004_6
' C_s8482_69c22c9a_initialize_L000004_5 ' (symbol refcount = 0)
...
C_s_rxflush ' <symbol:s_rxflush>
 ...
 alignl_p1
 long I32_CALA + (@C_s8482_69c22c9a_initialize_L000004)<<S32 ' CALL addrg
 alignl_label
C_s_rxflush_15
