...
'
 ...
 alignl_label
C_s11u8_69c22cad__seed_L000001 ' <symbol:_seed>
 alignl_p1
 long I32_PSHM + $400000<<S32 ' save registers
 alignl_p1
 long I32_MOV + (r22)<<D32 + (CNT)<<S32 ' reg <- INDIRU4 addrg special
 word I16A_MOV + (r0)<<D16A + (r22)<<S16A ' CVI, CVU or LOAD
' C_s11u8_69c22cad__seed_L000001_2 ' (symbol refcount = 0)
...
C_getrand ' <symbol:getrand>
 ...
 alignl_p1
 long I32_CALA + (@C_s11u8_69c22cad__seed_L000001)<<S32 ' CALL addrg
