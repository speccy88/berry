...
'
 ...
 alignl_label
C_s3qg_69c22c85_two_digits_L000001 ' <symbol:two_digits>
 alignl_p1
 ...
 alignl_p1
 long I32_BRNZ + (@C_s3qg_69c22c85_two_digits_L000001_3)<<S32 ' NEI4 reg coni
 ...
 word I16A_WRBYTE + (r22)<<D16A + (r4)<<S16A ' ASGNU1 reg reg
 alignl_label
C_s3qg_69c22c85_two_digits_L000001_3
...
' C_s3qg_69c22c85_two_digits_L000001_2 ' (symbol refcount = 0)
 word I16B_POPM + $80<<S16B ' restore registers, do not pop frame, do return
 alignl_p1

 alignl_label
C_s3qg1_69c22c85_four_digits_L000005 ' <symbol:four_digits>
 alignl_p1
 long I32_PSHM + $500000<<S32 ' save registers
 alignl_p1
 ...
 word I16A_MOV + (r0)<<D16A + (r22)<<S16A ' CVI, CVU or LOAD
' C_s3qg1_69c22c85_four_digits_L000005_6 ' (symbol refcount = 0)
 word I16B_POPM + $80<<S16B ' restore registers, do not pop frame, do return
 alignl_p1
...
C_asctime_16
 ...
 alignl_p1
 long I32_CALA + (@C_s3qg_69c22c85_two_digits_L000001)<<S32
 ...
 word I16B_CPREP + 33<<S16B ' arg size, rpsize = 8, spsize = 8
 alignl_p1
 long I32_CALA + (@C_s3qg1_69c22c85_four_digits_L000005)<<S32
 word I16A_ADDI + SP<<D16A + 4<<S16A ' CALL addrg
