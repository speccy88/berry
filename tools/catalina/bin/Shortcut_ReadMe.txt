...
Shortcut.exe /F:filename /A:C|E|Q [/T:target] [/P:parameters] [/W:workingdir]
 ...
 Copyright 2000-2013 Marty List, www.OptimumX.com
...
1.20 	02/01/2013
- Recompiled as a 64-bit executiable.
- Renamed the original 32-bit executable to Shortcut32.exe.

1.11 	07/04/2005
- Fixed display problem for hotkeys with extended characters.
- Removed reference to .URL files in the syntax, since URL files are not supported.
