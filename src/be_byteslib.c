...
#if !(defined(__CATALINA__) && defined(BE_P2_CUSTOM_PRECOMPILED_BUILTINS) && BE_P2_CUSTOM_PRECOMPILED_BUILTINS)
/********************************************************************
...
be_local_closure(getbits,   /* name */
  be_nested_proto(
    ...
    ( &(const binstruction[32]) {  /* code */
      0x180C0500, 0x740E0002, 0x540E001F, 0x240C0403, 0x780E0000, 0xB0060302,
      0x580C0000, 0x3C100303, 0x54160007, 0x10040205, 0x58140000, 0x24180500,
      0x781A0011, 0x541A0007, 0x04180C01, 0x241C0C02, 0x781E0000, 0x5C180400,
      0x381E0806, 0x041C0F04, 0x381C0E01, 0x94200004, 0x2C201007, 0x3C201001,
      0x38201005, 0x300C0608, 0x00140A06, 0x04080406, 0x58040000, 0x00100904,
      0x7001FFEB, 0x80040600,
    })
  )
);
/*******************************************************************/
...
be_local_closure(setbits,   /* name */
  be_nested_proto(
    ...
    &be_const_str_solidified,
    ( &(const binstruction[37]) {
      0x14100500, 0x74120002, 0x5412001F, 0x24100404, 0x78120000, 0xB0060302,
      0x60100009, 0x5C140600, 0x7C100200, 0x5C0C0800, 0x3C100303, 0x54160007,
      0x10040205, 0x24140500, 0x78160014, 0x54160007, 0x04140A01, 0x24180A02,
      0x781A0000, 0x5C140400, 0x381A0805, 0x04180D04, 0x541E00FE, 0x38200C01,
      0x041C0E08, 0x94200004, 0x2C201007, 0x2C240606, 0x38241201, 0x30201009,
      0x98000808, 0x3C0C0605, 0x04080405, 0x58040000, 0x00100904, 0x7001FFE8,
      0x80040000,
    })
  )
);
