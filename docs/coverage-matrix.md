...
| Boot on selected board | Verified | `p2-edge32-flash` boots from SPI flash on P2 Edge 32 MB. `p2-xmm-flash` boots through the sparse fast loader with visible PSRAM/VM startup spinners. | Keep re-verifying after substantial firmware changes. |
