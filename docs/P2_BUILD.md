...
- direct `loadp2 -SPI build/p2/catalina/berry_p2.binary` is not the Catalina flash path; Catalina binaries need the `flshload.t` wrapper generated by `make p2-flash`
