...
typedef struct berry_p2_fs_info {
    ...
    int root_zero_entry_count;
    int root_deleted_entry_count;
    int root_hidden_entry_count;
    int root_lfn_entry_count;
    int root_first_byte;
    int root_first_attr;
    ...
    char root_first_name[16];
    char root_sample[128];
    char read_value[8];
} berry_p2_fs_info;
