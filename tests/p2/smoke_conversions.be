...
assert(type(bytes()) == "instance")
assert(classname(bytes()) == "bytes")
assert(type(range(0, 1)) == "instance")
assert(classname(range(0, 1)) == "range")
