...
assert(introspect.get(mod, "missing") == nil)
assert(type(introspect.get(mod, "missing", true)) == "module")
...
assert(introspect.get(obj, "inc")(obj, 7) == 42)
...
assert(recovered == nil || (isinstance(recovered, list) && recovered == [10, 20, 30]))
