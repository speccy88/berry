...
P2_INCFLAGS := -I"$(P2_INCLUDE_DIR)" -I"src" -I"default"
...
$(P2_IMAGE): $(P2_SRCS) $(P2_PREBUILD_DEPS) $(P2_CATALINA_DOCKER_SCRIPT) | $(P2_BUILD_DIR) p2-tools p2-prebuild
	$(Q) CATALINA_DIR="$(CATALINA_DIR)" FLEXPROP_DIR="$(FLEXPROP_DIR)" \
...
$(P2_IMAGE): $(P2_SRCS) $(P2_PREBUILD_DEPS) | $(P2_BUILD_DIR) p2-tools p2-prebuild
