...
if spin2 == nil
    ...
    print("high-level guarded images:", guarded.size())
    print("safe-reject execution:", "skipped: try/except can hang on current P2 image")

    var runnable = [ ["S2_27DIT.BIN"] ]
    var i = 0
    while i < runnable.size()
        var names = runnable[i]
        file = pick(names)
...
print("spin2 standalone suite done")
